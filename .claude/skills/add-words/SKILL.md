...
**Что чинить.** Только подтверждённые реальные ошибки огласовки — заменой на форму-эталон Накдана. Спорные (конструкт/идиома/заимствование) — оставить как есть либо вынести на ручное решение. При правке `original` не забыть про FILL_IN_BLANK freshness (см. 7.5) — правка никуда в `example` инвалидирует хеш.
