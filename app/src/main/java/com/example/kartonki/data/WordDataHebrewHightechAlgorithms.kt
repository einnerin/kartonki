...
object WordDataHebrewHightechAlgorithms {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 191002, setId = 1910, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִבְנֶה דִּינָמִי שֶׁבּוֹ כָּל אֵיבָר מַחְזִיק הַפְנָיָה לָאֵיבָר הַבָּא בִּתְוַךְ הַזִּכָּרוֹן.",
        ...
        WordEntity(id = 191005, setId = 1910, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִבְנֶה הִיֵּרַרְכִּי שֶׁבּוֹ לְכָל צֹמֶת יֵשׁ לְכָל הַיּוֹתֵר שְׁנֵי בָּנִים.",
        ...
        WordEntity(id = 191008, setId = 1910, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "תְּלוּת בֵּין מוֹדּוּלִים מְיֻצֶּגֶת בְּדֶרֶךְ כְּלָל גְּרַף מְכֻוָּן.",
        ...
        WordEntity(id = 191011, setId = 1910, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הַפִּתְרוֹן הִשְׁתַּמֵּשׁ בְּמַעֲבָר עַל עֵץ לְפִי הָעֳמֵק.",
        ...
        WordEntity(id = 191012, setId = 1910, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תַּהֲלִיךְ שֶׁמַּמִּיר קְלַט בְּגֹדֶל כְּלָשֵׁהוּ לְפֶלֶט קָצָר בְּגֹדֶל קָבוּעַ.",
        ...
        WordEntity(id = 191013, setId = 1910, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "בְּקוֹרֵס מָבוֹא מַתְחִילִים תָּמִיד עִם מִיּוּן בּוּעוֹת.",
        ...
        WordEntity(id = 191015, setId = 1910, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הוּא נָתַן תְּשׁוּבָה נְכוֹנָה אֲבָל הִתְקַשָּׁה לְהוֹכִיחַ O גָּדוֹל בְּכַתָּב.",
        ...
        WordEntity(id = 191016, setId = 1910, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מֶשֶׁךְ הַחִישּׁוּב שֶׁל אַלְגוֹרִיתְם עַל קְלַט קוֹנְקְרֶטִי, נִמְדָּד בִּפְעֻלּוֹת אוֹ בְּשֵׁנִיּוֹת.",
            definitionNative = "Длительность вычисления алгоритма на конкретном входе, в операциях или секундах.",
            example = "הַפְּרוֹפַיילֶר חָשַׂף שֶׁמֵּחֵצִית מִזְּמַן הָרִיצָה הוֹלֵךְ עַל שְׁאִילְתָּה אַחַת.",
        ...
        WordEntity(id = 191019, setId = 1910, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "עִקָּרוֹן שֶׁמַּסְתִּיר אֶת הַמַּצָּב הַפְּנִימִי שֶׁל אוֹבְּיֶיקְט וְחוֹשֵׂף רַק מִמְשַׁק מֻגְדָּר.",
        ...
        WordEntity(id = 191020, setId = 1910, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מַנְגְּנוֹן שֶׁבּוֹ מַחְלָקָה חֲדָשָׁה מְקַבֶּלֶת תְּכוּנוֹת וּפוּנְקְצִיּוֹת מִמַּחְלַקַּת אָב.",
            definitionNative = "Механизм, при котором новый класс получает свойства и методы от родительского.",
            example = "הָאַרְכִיטֵקְט הִמְלִיץ לְהַחְלִיף הוֹרָשָׁה בְּהֶרְכֵּב לְצֹרֶךְ גְמִישׁוּת.",
