...
object WordDataHebrewIdiomsTanakh {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definitionNative = "С полной самоотдачей и без колебаний — слова из Шма (Втор 6:5).",
        ...
        WordEntity(
            ...
            definition = "שִׁנּוּי פְּנִימִי עָמֹק שֶׁמַּתְחִיל גִּישָׁה אַחֶרֶת לַחַיִּים — נְבוּאַת יְחֶזְקֵאל.",
        ...
        WordEntity(
            ...
            definition = "הִגִּיעַ הָרֶגַע לַעֲבֹר מִמַּחֲשָׁבָה לִפְעֻלָּה — שַׁעַת מִבְחָן.",
        ...
        WordEntity(
            ...
            definitionNative = "Постоянно, непрерывно — высокий литературный регистр (Суд 11:40, Иер).",
        ...
        WordEntity(
            ...
            example = "בְּרֹב יָמִים הָאַגָּדָה הַזֹּאת הָפְכָה לְמַסֹּרֶת אֲמִתִּית.",
        ...
        WordEntity(
            ...
            definitionNative = "Плодородный, благодатный край — образ Земли Израиля в Торе (Исх 3:8).",
            example = "תֵּל אָבִיב הָיְתָה בְּעֵינָיו אֶרֶץ זָבַת חָלָב וּדְבָשׁ אֲמִתִּית.",
        ...
        WordEntity(
            ...
            definitionNative = "Огромное несосчитываемое количество — постоянное сравнение в Танахе.",
        ...
        WordEntity(
            ...
            definitionNative = "То, что даёт силу и смысл — метафора из райского сада (Быт 2:9).",
            example = "הַתּוֹרָה הִיא עֵץ הַחַיִּים בִּשְׁבִיל הָעָם הַיְּהוּדִי לְכָל הַזְּמַנִּים.",
        ...
        WordEntity(
            ...
            definitionNative = "Символ запретного или опасного знания — образ из истории Адама и Евы (Быт 2:17).",
        ...
        WordEntity(
            ...
            definitionNative = "Жизнь или дело лишены смысла — открытие книги Экклезиаста (1:2).",
        ...
        WordEntity(
            ...
            definitionNative = "Нравственный образец для других народов — цитата из Исайи (49:6).",
        ...
        WordEntity(
            ...
            definition = "מַשֶּׁהוּ רַע שֶׁקּוֹרֶה כְּאִלּוּ בְּכַוָּנָה זֵדוֹנִית — מַזָּל בִּיֵּשׁ קִיצוֹנִי.",
        ...
        WordEntity(
            ...
            example = "כֻּלָּם נֶעֶמְדוּ לִשְׁעָה שֶׁל שֶׁבַח וַהוֹדָיָה אַחֲרֵי הַנֵּס.",
