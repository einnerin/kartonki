...
object WordDataHebrewMobileL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_leadership",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_monorepo",
        ...
        WordEntity(
            ...
            definition = "פֵּרוּק אַפְּלִיקַצְיָה גְּדוֹלָה לְחֵלְקֵי קוֹד עַצְמָאִיִּים וּקְטַנִּים יוֹתֵר.",
        ...
        WordEntity(
            ...
            example = "הַפְשָׁטַת פְּלַטְפוֹרְמָה אִפְשְׁרָה לִכְתֹּב לוֹגִיקָה עִסְקִית פַּעַם אַחַת בְּלִבַּד.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_release_strategy",
        ...
        WordEntity(
            ...
            definition = "לוּחַ זְמַנִּים קָבוּעַ שֶׁל הוֹצָאַת גִּרְסָאוֹת בְּלִי הִתְחַשְּׁבוּת בְּמָה שֶׁמּוּכָן.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_compliance",
            ...
            example = "הַנְחָיוֹת אַפְּ סְטוֹר אוֹסְרוֹת תַּשְׁלוּם דֶּרֶךְ צַד שְׁלִישִׁי בְּתוֹךְ אַפְּלִיקַצְיָה.",
        ...
        WordEntity(
            ...
            definition = "אֹסֶף הַחֻקִּים שֶׁל גוּגְל לִתְכָנִים, פִּרְסוּם וַהַרְשָׁאוֹת בְּכָל אַפְּלִיקַצְיָה לְאַנְדְּרוֹאִיד.",
        ...
        WordEntity(
            ...
            example = "תָּוִיתָ פְּרָטִיּוּת אֲדֻמָּה הֵרִיחָה לָקוֹחוֹת מֵהַהוֹרָדָה בָּרֶגַע הָאַחֲרוֹן.",
        ...
        WordEntity(
            ...
            example = "שְׁקִיפוּת מַעֲקָב הִקְטִינָה לָנוּ אֶת הַהַכְנָסוֹת מִפִּרְסֹמֶת בִּשְׁלוֹשִׁים אָחוּז.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_perf_advanced",
            original = "אִינְסְטְרוּמֶנְטַצְיָה", translation = "инструментация (для трассировки)",
            definition = "הַכְנָסַת נְקֻדּוֹת מְדִידָה זְעִירוֹת לְתוֹךְ הַתּוֹכְנָה כְּדֵי לִרְאוֹת מָה קוֹרֶה בִּזְמַן רִיצָה.",
        ...
        WordEntity(
            ...
            definition = "קֹבֶץ מְפֹרָט שֶׁמַּרְאֶה כָּל פְּעֻלָּה שֶׁל הַמַּעֲבֵד וְהַזִּכָּרוֹן בְּמַהֲלַךְ הָרִיצָה בְּאַנְדְּרוֹאִיד.",
        ...
        WordEntity(
            ...
            definition = "קֹבֶץ הֲנַחֲיָהּ לַמַּהֲדֵּר שֶׁמְּסַמֵּן אֵילוּ נְתִיבֵי קוֹד לְהָכִין מֵרֹאשׁ לְהָאָצָה.",
        ...
        WordEntity(
            ...
            example = "הֲסָרַת קוֹד מֵת מָחֲקָה שְׁתֵּי סְפְרִיּוֹת שֶׁשָּׁכַחְנוּ לְהָסִּיר.",
