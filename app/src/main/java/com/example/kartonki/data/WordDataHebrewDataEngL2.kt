...
object WordDataHebrewDataEngL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הוֹסַפְתִּי תְּנָאֵי סִינּוּן עַל הַתַּאֲרִיךְ, וְהַדּוּחַ הִתְקַצֵּר פִּי עֲשָׂרָה.",
        ...
        WordEntity(
            ...
            definition = "סִדּוּר תּוֹצָאוֹת לְפִי עַמּוּדָה — מֵהַקָּטָן לַגָּדוֹל, מֵהַחַדָּשׁ לַיָּשָׁן וְכוּ׳.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "data_excel",
        ...
        WordEntity(
            ...
            example = "טַבְלַת צִיר חָשְׂפָה שֶׁשְּׁלֹשָׁה מוּצָרִים אַחֲרָאִים עַל מֶחֱצִית הָרֶוַח.",
        ...
        WordEntity(
            ...
            definition = "סֵדֶר פְּעֻלּוֹת מֻקְלָט שֶׁאֶקְסֶל מַפְעִיל מֵחָדָשׁ בְּלַחִיצַת כַּפְתּוֹר אַחַת — חוֹסֵךְ עֲבוֹדָה יַדָּנִית.",
            definitionNative = "Записанная последовательность действий — Excel повторяет её по одному клику, экономя ручной труд.",
            example = "כָּתַבְתִּי מַקְרוֹ שֶׁמְּעַצֵּב אֶת הַדּוּחַ הַשְּׁבוּעִי בִּשְׁתֵּי שְׁנִיּוֹת.",
        ...
        WordEntity(
            ...
            definition = "דַּף נִפְרָד בְּתוֹךְ קֹבֶץ אֶקְסֶל אֶחָד — אֶפְשָׁר לִפְתֹּחַ כַּמָּה דַּפִּים בְּלָשׁוֹנִיּוֹת לְמַטָּה.",
            ...
            exampleNative = "Я разбил отчёт на три листа — по одному на каждый квартал.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "data_bi",
        ...
        WordEntity(
            ...
            definition = "אֵיבָר חָזוּתִי בּוֹדֵד עַל הַמָּסָךְ — גְּרָף, מָחוֹג אוֹ מִסְפָּר גָּדוֹל — שֶׁמַּצִּיג מֵידָע אֶחָד.",
        ...
        WordEntity(
            ...
            example = "סְלַייסֶר שֶׁל אֵזוֹר מַתְמַקֵּד אוֹתִי בְּמֶרְכַּז הָאָרֶץ בְּלָחִיצָה אַחַת.",
        ...
        WordEntity(
            ...
            definition = "מִסְפָּר אֶחָד שֶׁמּוֹדֵד הֶבֵּט מָסוּיָּם בָּעֵסֶק — הַכְנָסָה, אֲחוּז עֲזִיבָה אוֹ זְמַן תְּגוּבָה.",
            definitionNative = "Одно число, измеряющее аспект бизнеса — выручка, процент оттока или время отклика.",
            example = "הַמֶּטְרִיקָה הַחֲשׁוּבָה לָנוּ הַשָּׁנָה הִיא אֲחוּז הַחֲזָרָה שֶׁל לְקוֹחוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "data_scripts",
            ...
            example = "סְקְרִיפְּט פַּייתוֹן רָץ כָּל בֹּקֶר וּמָכִּין אֶת הַדּוּחַ הַיּוֹמִי.",
        ...
        WordEntity(
            ...
            definition = "פוֹרְמַט קֹבֶץ פָּשׁוּט שֶׁבּוֹ כָּל שׁוּרָה הִיא רְשׁוּמָה וְהָעַמּוּדוֹת מֻפְרָדוֹת בְּפְסִיקִים.",
        ...
        WordEntity(
            ...
            definition = "פוֹרְמַט מֻבְנֶה לְמֵידָע מְקֻנָּן שֶׁמַּעֲבִירִים בֵּין שֵׁרוּתִים — שָׂדוֹת, רְשִׁימוֹת וְאוֹבְּיֶיקְטִים מְקֻנָּנִים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "data_sources",
            ...
            exampleNative = "Мы подключили три источника данных к новому отчёту.",
            isFillInBlankSafe = false,
        ),
        WordEntity(
        ...
        WordEntity(
            ...
            definition = "עָרוּץ פָּתוּחַ בֵּין הַסְּקְרִיפְּט לַמַּסָּד — דֶּרֶךְ כְּתֹבֶת, מִשְׁתַּמֵּשׁ וְסִיסְמָה — שֶׁדַּרְכּוֹ עוֹבְרוֹת שְׁאֵלוֹת.",
            definitionNative = "Открытый канал между скриптом и базой — через адрес, логин и пароль — по нему ходят запросы.",
            example = "הַחִבּוּר לְמַסַּד נָפַל בְּאֶמְצַע הַלַּיְלָה וְכָל הָעֲבוֹדָה נֶעֶצְרָה.",
        ...
        WordEntity(
            ...
            definition = "חִבּוּר מַתְמִיד בֵּין שְׁתֵּי מַעֲרָכוֹת שֶׁמַּחֲלִיפוֹת מֵידָע אוֹטוֹמָטִית — בְּלִי הַעֲבָרָה יָדָנִית.",
