...
object WordDataHebrewPoliticsIsraeli {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190901, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הָאֲגֻדָּה הִגִּישָׁה עַתִּירָה לְבָג\"ץ עַל הֶחְלָטַת הַשַּׂר.",
        ...
        WordEntity(id = 190902, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הָרְשׁוּת הַמְּבַצַּעַת אַחֲרָאִית עַל הַתַּקְצִיב הַשּׁוֹטֵף.",
        ...
        WordEntity(id = 190904, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פָּקִיד בָּכִיר שֶׁמְּיַעֵץ לַמֶּמְשָׁלָה בְּשֶׁאֵלוֹת חֹק וּמְיַצֵּג אֶת הַמְּדִינָה בְּבֵית הַמִּשְׁפָּט.",
        ...
        WordEntity(id = 190905, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "חֲבֵר כְּנֶסֶת שֶׁמְּנַהֵל אֶת הַיְּשִׁיבוֹת בָּאוּלָם וְשׁוֹמֵר עַל סְדָרֵי הַדִּיּוּן.",
        ...
        WordEntity(id = 190908, setId = 1909, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מִפְלַגַּת מֶרְכָּז חִילוֹנִית שֶׁהֻקְמָה בְּ-2012 וּמְכֻוֶּנֶת לְמַעֲמַד הַבֵּינַיִם.",
        ...
        WordEntity(id = 190910, setId = 1909, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "יַהֲדוּת הַתּוֹרָה דּוֹרֶשֶׁת תַּקְצִיב לַחֲרֵדִים בְּכָל מַשָּׂא וּמַתָּן קוֹאָלִיצְיוֹנִי.",
        ...
        WordEntity(id = 190912, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הָרְשִׁימָה הַקְּטַנָּה לֹא עָבְרָה אֶת אֲחוּז חֲסִימָה וְנֶעֶלְמָה.",
        ...
        WordEntity(id = 190916, setId = 1909, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מֶחְקַר דַּעַת קָהָל שֶׁמּוֹדֵד אֵיךְ אֶזְרָחִים עוֹמְדִים לְהַצְבִּיעַ לִפְנֵי יוֹם הַבְּחִירוֹת.",
            definitionNative = "Опрос мнений, что меряет, как граждане собираются голосовать накануне выборов.",
            example = "סְקַר בְּחִירוֹת חָדָשׁ מֶצְבִּיעַ עַל גִּדּוּל קַל בְּמֶרְכַּז.",
        ...
        WordEntity(id = 190918, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "קְבוּצוֹת חַבָּרֵי הַכְּנֶסֶת שֶׁאֵינָן חֵלֶק מֵהַקּוֹאַלִיצְיָה הַשּׁוֹלֶטֶת.",
        ...
        WordEntity(id = 190919, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "וַעֲדַת כְּנֶסֶת רֲגִישָׁה שֶׁדָּנָה בִּעִנְיָנֵי בִּטָּחוֹן וְיַחֲסֵי חוּץ בְּחֶדֶר סָגוּר.",
        ...
        WordEntity(id = 190920, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "וַעֲדַת הַכַּסְפִּים אִשְּׁרָה הַעֲבָרָה לְמִשְׂרַד הַרְוָחָה.",
        ...
        WordEntity(id = 190921, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תַּהֲלִיךְ בּוֹ הַנָּשִׂיא מַטִּיל מַנְדָּט וְהַנַּבְחָר אוֹסֵף שֻׁתָּפוֹת לְרֹב בַּכְּנֶסֶת.",
            ...
            example = "הֲקָּמַת הַמֶּמְשָׁלָה לָקְחָה כִּמְעַט שִׁשָּׁה שָׁבוּעוֹת.",
        ...
        WordEntity(id = 190922, setId = 1909, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "סִיּוּם מֻקְדַּם שֶׁל הַכְּנֶסֶת שֶׁמַּחְזִיר אֶת הָאֶזְרָחִים לְקַלְפִּיּוֹת לִפְנֵי תּוֹם הַכָּהֲנָה.",
        ...
        WordEntity(id = 190924, setId = 1909, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "הוֹדָעָה רִשְׁמִית שֶׁל נִבְחָר עַל עֲזִיבָה מֵרָצוֹן שֶׁל הַתַּפְקִיד הַצִּבּוּרִי.",
