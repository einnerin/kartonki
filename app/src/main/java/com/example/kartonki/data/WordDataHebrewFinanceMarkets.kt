...
object WordDataHebrewFinanceMarkets {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 189901, setId = 1899, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הַבַּנְק מַחֲזִיק מִילְיוֹנֵי דּוֹלָר נְיַר עֵרֶךְ לְלָקוֹחוֹתָיו.",
        ...
        WordEntity(id = 189903, setId = 1899, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "סַל נְכָסִים נִסְחַר בְּבּוּרְסָה כְּמוֹ מְנָיָה בּוֹדֶדֶת, לְרֹב עוֹקֵב אַחֲרֵי מַדָּד.",
        ...
        WordEntity(id = 189905, setId = 1899, languagePair = "he-ru", rarity = "RARE",
            ...
            translation = "опцион",
            definition = "זְכוּת בִּתְשַׁלּוּם — בְּלִי חוֹבָה — לִקְנוֹת אוֹ לִמְכֹּר נֶכֶס בִּמְחִיר קָבוּעַ עַד תַּאֲרִיךְ מוּסְכָּם.",
        ...
        WordEntity(id = 189906, setId = 1899, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "חַקְלָאֵי חִיטָּה נוֹעֲלִים מְחִיר דֶּרֶךְ חוֹזֶה עֲתִידִי לִפְנֵי שֶׁזּוֹרְעִים בָּאָבִיב.",
        ...
        WordEntity(id = 189907, setId = 1899, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "קֶרֶן הַשְׁקָעוֹת אַגְרֵסִיבִית לְמִשְׁקִיעִים אֲמִידִים — מַשְׁתַּמֶּשֶׁת בְּמִינּוּף, שׁוֹרְט וְנִגְזָרִים.",
        ...
        WordEntity(id = 189908, setId = 1899, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "שׁוּק שׁוֹר אָרֹךְ הִכְפִּיל אֶת חֶסְכוֹנוֹתֵיהֶם בְּתוֹךְ שָׁלוֹשׁ שָׁנִים בִּלְבַד.",
        ...
        WordEntity(id = 189910, setId = 1899, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תַּשְׁלוּם בְּמַזֻּוָּמָן שֶׁחֶבְרָה מְחַלֶּקֶת לְבַעֲלֵי הַמְּנָיוֹת מֵרֶוַח, לְרֹב פַּעֲמַיִם אוֹ אַרְבַּע פְּעָמִים בְּשָׁנָה.",
        ...
        WordEntity(id = 189914, setId = 1899, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "אַלְגוֹרִיתְמִים מֲהִירִים סוֹגְרִים כָּל אַרְבִּיטְרָז׳ קָטָן בְּתוֹךְ אַלְפִּיּוֹת שְׁנִיָּה.",
        ...
        WordEntity(id = 189915, setId = 1899, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "קְנִיָּה וּמְכִירָה מְהִירוֹת וּמְסֻכָּנוֹת לְמַטָּרַת רֶוַח קָצָר מִתְּנוּדוֹת מְחִירִים, וְלֹא מֵעֵרֶךְ אֲרֻכַּת טְוָח.",
            definitionNative = "Быстрая рискованная купля-продажа ради короткой прибыли от колебаний цен, а не от долгой стоимости.",
            example = "סְפֵקוּלַצְיָה טְהוֹרָה מֲנִּיעָה רֹב גַּלֵּי הַקְּרִיפְּטוֹ — וְלָכֵן הַנְּפִילוֹת כֹּה חַדּוֹת.",
        ...
        WordEntity(id = 189916, setId = 1899, languagePair = "he-ru", rarity = "RARE",
            original = "בְּרוֹקֶר",
            translation = "брокер",
            definition = "מְתַוֵּךְ מוּסְמָךְ שֶׁמַּעֲבִיר הוֹרָאוֹת קְנִיָּה אוֹ מְכִירָה שֶׁל נְיַר עֵרֶךְ בְּשֵׁם הַלָּקוֹחַ.",
        ...
        WordEntity(id = 189918, setId = 1899, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "גּוּף שֶׁמְּלַוֶּה הַנְפָּקַת נְיַר עֵרֶךְ — קוֹבֵעַ מְחִיר וְעָרֵב לַחֲבָרָה שֶׁתִּמָּכֵר כָּל הַכַּמּוּת.",
            definitionNative = "Организация, сопровождающая выпуск ценных бумаг — назначает цену и гарантирует фирме продажу всего объёма.",
            example = "הַחַתָּם דָּחָה אֶת הַהַנְפָּקָה בְּחֹדֶשׁ כְּשֶׁהַשּׁוּק הִתְקָרֵר.",
        ...
        WordEntity(id = 189925, setId = 1899, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "קַצָּב סִיכּוּן בִּשְׁוָקִים מִתְפַּתְּחִים הִתְכַּוֵּץ שָׁנִים וְאָז הִתְפּוֹצֵץ בַּמִּלְחָמָה.",
