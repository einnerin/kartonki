...
object WordDataHebrewBatch54 {
    ...
    val sets: List<WordSetEntity> get() = listOf(
        ...
        WordSetEntity(
            ...
            name = "Строительство: основы — базовые термины строительной индустрии Израиля",
        ...
        WordSetEntity(
            ...
            name = "Строительство: профессиональный — высокопрофессиональные термины строительной отрасли",
        ...
        WordSetEntity(
            ...
            name = "Строительство: профессиональный — архитектурно-инженерная документация и градостроительство",
