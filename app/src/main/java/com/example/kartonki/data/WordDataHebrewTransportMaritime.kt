...
object WordDataHebrewTransportMaritime {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 189802, setId = 1898, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "הַמִּילְיוֹנֵר מַחֲזִיק יָאכְטָה בִּמְפָרֵץ הֶרְצְלִיָּה.",
        ...
        WordEntity(id = 189803, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "טִיּוּל קָטָמָרָן בְּאֵילַת מַתְאִים לְמִשְׁפָּחוֹת עִם יְלָדִים קְטַנִּים.",
        ...
        WordEntity(id = 189804, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            original = "גּוֹרֶרֶת",
            translation = "буксир",
            definition = "סְפִינָה חֲזָקָה שֶׁמּוֹשֶׁכֶת אוֹ דּוֹחֶפֶת כְּלֵי שַׁיִט גְּדוֹלִים אֶל הַמַּזַּח אוֹ מִמֶּנּוּ.",
        ...
        WordEntity(id = 189806, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            original = "מִכָלִית",
            translation = "танкер",
            definition = "כְּלִי שַׁיִט גָּדוֹל לְהוֹבָלַת נוֹזְלִים בְּכַמּוּת עֲצוּמָה — לְרֹב נֵפְט אוֹ גָּז.",
        ...
        WordEntity(id = 189807, setId = 1898, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "כְּלִי שַׁיִט קָטָן עִם מָנוֹעַ מָהִיר, מוּעָדָף לְמַסָּע קָצָר אוֹ סְפּוֹרְט מַיִם.",
        ...
        WordEntity(id = 189810, setId = 1898, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "עוֹגֶן",
            translation = "якорь",
            definition = "מַתֶּכֶת כְּבֵדָה עַל שַׁרְשֶׁרֶת, שׁוֹמֶרֶת סְפִינָה בִּמְקוֹמָהּ עַל קַרְקָעִית הַיָּם.",
            definitionNative = "Тяжёлый металл на цепи; удерживает плавсредство на месте, зацепившись за дно.",
            example = "הַקַּפִּיטָן הוֹרִיד עוֹגֶן בְּמִפְרַץ שָׁקֵט לְלִינַת לַיְלָה.",
        ...
        WordEntity(id = 189812, setId = 1898, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "סַבָּא לִמֵּד אוֹתִי לֶאֱחֹז בַּמָּשּׁוֹט בִּשְׁתֵּי יָדַיִם בְּלִי לִשְׁבֹּר אֶת הַמַּיִם.",
        ...
        WordEntity(id = 189815, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הַמִּגְדַּלוֹר בִּסְלַעֵי קֵיסָרְיָה דּוֹלֵק כָּל לַיְלָה.",
        ...
        WordEntity(id = 189816, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            original = "מָצוֹף",
            translation = "буй",
            definition = "כַּדּוּר צָף הַעֲגוּן לְקַרְקָעִית, מְסַמֵּן לְמַלָּחִים תְּעָלָה, שִׂרְטוֹן אוֹ אֵזוֹר שְׁחִיָּה.",
        ...
        WordEntity(id = 189817, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הַנּוֹסְעִים מַמְתִּינִים עַל הַמַּזַּח עִם הַמִּזְוָדוֹת.",
        ...
        WordEntity(id = 189818, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "פּוֹעֲלֵי הַנָּמֵל הֶעֱבִירוּ צִינּוֹר עֲנָק עַל אַסְדָּה רְחָבָה.",
        ...
        WordEntity(id = 189820, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "מַעְגַּן יָאכְטוֹת בְּהֶרְצְלִיָּה מָלֵא בְּסוֹף הַשָּׁבוּעַ.",
        ...
        WordEntity(id = 189821, setId = 1898, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "אָמָּנוּת מְצִיאַת הַדֶּרֶךְ בַּיָּם בְּעֶזְרַת מַפּוֹת, כּוֹכָבִים אוֹ מַכְשִׁירִים אֶלֶקְטְרוֹנִיִּים.",
        ...
        WordEntity(id = 189822, setId = 1898, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מַסַּע סְפִינָה מִנְּקֻדָּה אַחַת אֶל אַחֶרֶת, לְרֹב לְמֶרְחַק יָמִים אוֹ שָׁבוּעַ.",
        ...
        WordEntity(id = 189823, setId = 1898, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תְּנוּעָה יוֹמִית שֶׁל מִפְלַס הַיָּם — עוֹלֶה וְיוֹרֵד פַּעֲמַיִם בְּיוֹם בִּגְלַל מְשִׁיכַת הַיָּרֵחַ.",
        ...
        WordEntity(id = 189824, setId = 1898, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מַעֲבַר מַיִם צַר שֶׁבְּנֵי אָדָם חָפְרוּ כְּדֵי לְקַצֵּר דֶּרֶךְ בֵּין יַמִּים אוֹ נְהָרוֹת.",
