...
object WordDataHebrewRetailL4 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "retail_store_operations",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "retail_store_operations",
            ...
            example = "אִינְוֶנְטָר שֶׁל סוֹף הַשָּׁנָה נִמְשָׁךְ לַיְלָה שָׁלֵם.",
        ...
        WordEntity(
            ...
            definition = "סִכּוּם רַשְּׁמִי שֶׁל הַכְנָסוֹת וְהוֹצָאוֹת בְּסוֹף תְּקוּפַת דִּוּוּחַ.",
            definitionNative = "Официальное подведение итогов выручки и расходов за отчётный период.",
            example = "סֲגִירַת חוֹדֶשׁ דּוֹרֶשֶׁת הַשְׁוָאָה בֵּין מְלַאי לַסְּפָרִים.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "retail_visual_merch",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "retail_visual_merch",
        ...
        WordEntity(
            ...
            definition = "אוֹר מְכֻוָּן עַל מַדָּף כְּדֵי לְהַבְלִיט מוּצָר וּלְמַשֹּׁךְ עַיִן.",
            definitionNative = "Направленный свет на полку, чтобы выделить товар и притянуть взгляд.",
            example = "תְּאוּרַת מַדָּף חַמָּה הִגְבִּירָה אֶת מְכִירוֹת הַיַּיִן.",
        ...
        WordEntity(
            ...
            example = "הַצָּגַת חַלּוֹן הֶחֲדָשָׁה מָשְׁכָה הוֹלְכֵי רֶגֶל מֵרָחוֹק.",
        ...
        WordEntity(
            ...
            definition = "מַדָּע שֶׁבּוֹחֵן אֵיךְ אָדָם בּוֹחֵר מָה לִּקְנוֹת בְּתוֹךְ הֶחֲנוּת.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "retail_kpi_metrics",
        ...
        WordEntity(
            ...
            definition = "סְכוּם מְכִירוֹת מְמֻצָּע בְּכָל שַׁעַת פְּעִילוּת בַּחֲנוּת.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "retail_supplier_deals",
            original = "הֶסְכֵּם רָב-שְׁנָתִי", translation = "многолетний договор",
            definition = "חוֹזֶה אָרֹךְ טַוָוח עִם סַפָּק עַל אַסְפָּקָה קְבוּעָה לִשְׁנָתַיִם וָמַעְלָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "retail_supplier_deals",
            original = "רֶטְרוֹבּוֹנוּס", translation = "ретробонус от поставщика",
            definition = "הַחְזֵר כֶּסֶף שֶׁסַּפַּק נוֹתֵן לַחֲנוּת אַחֲרֵי שֶׁעָבְרוּ סַף יַעַד מוּסְכָּם.",
        ...
        WordEntity(
            ...
            example = "תְּנָאֵי מַדָּף הוֹסִיפוּ עַשְׂרוֹת אַלְפֵי שֶׁקֶל לַחוֹזֶה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "retail_loss_prevention",
        ...
        WordEntity(
            ...
            example = "פָּחַת מְלַאי שֲׁנָתִי עָמַד עַל אָחוּז וָחֵצִי מֵהַמַּחְזוֹר.",
        ...
        WordEntity(
            ...
            example = "תָּגֵּי אַבְטָחָה מְקֻבָּעִים בִּפְרִיטֵי לְבוּשׁ יְקָרִים.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר שֶׁמַּקְלִיט מָה קּוֹרֶה בָּאוּלָם לְזִהוּי גַּנָּבִים אַחַר כָּךְ.",
            definitionNative = "Прибор, записывающий зал, чтобы потом распознать злоумышленников.",
            example = "מַצְלֵמַת אַבְטָחָה תָּפְסָה אֶת הָאִישׁ לְיַד מַדַּף הַיַּיִן.",
        ...
        WordEntity(
            ...
            example = "לְקוּחַ נִסְתָּר הִגִּישׁ דּוּחַ עַל הַזְמָנַּת תּוֹר אֶצְלֵנוּ.",
