...
object WordDataHebrewMobileL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_perf",
        ...
        WordEntity(
            ...
            definition = "מֵ|עַקָּב אַחַר תַּהֲלִיכִים בָּרָם כְּדֵי לִמְצֹא דְּלִיפוֹת וּמַבְנִים שֶׁתּוֹפְסִים יוֹתֵר מִדַּי.",
        ...
        WordEntity(
            ...
            definition = "כַּמָּה אֶנֶרְגִּיָה הָאַפְּלִיקַצְיָה לוֹקַחַת בְּרֶקַע וּבַחֲזִית בְּמַהֲלַךְ שָׁעוֹת שִׁמּוּשׁ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_distribution",
        ...
        WordEntity(
            ...
            definition = "שְׁלַב בּוֹ קְבוּצַת מִשְׁתַּמְּשִׁים מְצֻמְצֶמֶת מְקַבֶּלֶת גִּרְסָה מֻקְדֶּמֶת לְאִתּוּר בָּגִים.",
        ...
        WordEntity(
            ...
            definition = "פְּלַטְפוֹרְמָה שֶׁל אֵפֶּל לַהֲפָצַת גִּרְסָאוֹת נִסָּיוֹן לְבוֹדְקִים פְּנִימִיִּים וְחִיצוֹנִיִּים.",
        ...
        WordEntity(
            ...
            definition = "מָסָךְ שֶׁל גוּגְל לְנִהוּל הַעֲלָאוֹת, סְטָטִיסְטִיקוֹת וּמְשׁוּבֵי מִשְׁתַּמְּשִׁים שֶׁל אַנְדְּרוֹאִיד.",
        ...
        WordEntity(
            ...
            example = "רוֹלְאַאוּט מֲדּוּרָג בְּמוֹבַייל הִתְחִיל מֵחָמֵשׁ אָחוּז וְעָלָה בְּכָל יוֹם.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_features",
            original = "פּוּשׁ נוֹטִיפִיקַצְיָה", translation = "push-уведомление",
            definition = "הוֹדָעָה קְצָרָה שֶׁמִּגִּיעָה לְמָסַּךְ הַנְּעִילָה גַּם כְּשֶׁהָאַפְּלִיקַצְיָה סְגוּרָה.",
        ...
        WordEntity(
            ...
            definition = "תַּשְׁלוּם עֲבוּר תֹּכֶן אוֹ יְכֹלֶת נוֹסֶפֶת מִבְּלִי לָצֵאת מֵהַמָּסָּךְ שֶׁל הַשֵּׁרוּת.",
        ...
        WordEntity(
            ...
            example = "אִימּוּת בִּיּוֹמֶטְרִי הֶחְלִיף סִיסְמָאוֹת בְּכָל אַפְּלִיקַצְיוֹת הַבַּנְק.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_data",
        ...
        WordEntity(
            ...
            definition = "אָחְסוּן זְמַנִּי שֶׁל נְתוּנִים עַל הַמַּכְשִׁיר כְּדֵי לֹא לְהוֹרִיד אֶת אוֹתוֹ דָּבָר שׁוּב.",
        ...
        WordEntity(
            ...
            definition = "הַשְׁוָאָה אוֹטוֹמָטִית בֵּין הַמַּכְשִׁיר לַעֲנַן כְּדֵי שֶׁשְּׁנֵיהֶם יַחֲזִיקוּ אוֹתוֹ מֵידָע.",
        ...
        WordEntity(
            ...
            example = "פְּתִירַת קוֹנְפְלִיקְטִים בְּחָרֶהָ תָּמִיד אֶת הָעִדְכּוּן הָאַחֲרוֹן בִּזְמַן.",
        ...
        WordEntity(
            ...
            example = "אַחְסוּן מוּצְפָּן הַגֵּן עַל הַמֵּידָע גַּם אַחֲרֵי גְּנֵבַת הַטֵּלֵפוֹן.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "mobile_advanced",
