...
object WordDataHebrewAppearanceL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "חֵלֶק קִדְמִי שֶׁל הַגּוּף בֵּין הֶחָזֶה וְהָאַגָּן — בּוֹ הָאֳכֵל מִתְעַכֵּל.",
        ...
        WordEntity(
            ...
            definition = "עֶצֶם לְבָנָה קְטַנָּה בַּפֶּה — בָּהּ לוֹעֲסִים אֶת הָאֳכֵל.",
        ...
        WordEntity(
            ...
            example = "אִמָּא נָתְנָה לִי נְשִׁיקָה עַל הַמֶּצַח לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            definition = "הַחֵלֶק הָאֲחוֹרִי שֶׁל הַגּוּף — בֵּין הַכְּתֵפַיִם וְהָאַגָּן.",
        ...
        WordEntity(
            ...
            example = "הַתִּינוֹק יָשֵׁן בַּעֲגָלָה לְיַד הַחַלּוֹן.",
