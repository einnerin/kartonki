...
object WordDataHebrewAppearanceL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "עִם הַשָּׁנִים שֹׁרֶשׁ הַשֵּׂעָר שֶׁלּוֹ נָסוֹג קְצָת אָחוֹרָה.",
        ...
        WordEntity(
            ...
            example = "הִיא עָנְדָה עֲגִיל קָטָן זָהָב עַל הַתְּנוּךְ.",
        ...
        WordEntity(
            ...
            example = "הוּא הֵרִים גַּבָּה אַחַת בְּתֶמָּהוֹן כְּשֶׁשָּׁמַע אֶת הַחֲדָשׁוֹת.",
        ...
        WordEntity(
            ...
            definition = "אַחַת הָעֲצָמוֹת הַקְּטַנּוֹת שֶׁמַּרְכִּיבוֹת אֶת עַמּוּד הַשִּׁדְרָה לְאֹרֶךְ הַגַּב.",
            definitionNative = "Одна из мелких костей, что складываются в позвоночник вдоль спины.",
            example = "הָרוֹפֵא בָּדַק כֹּל חֻלְיָה בְּזַהִירוּת אַחֲרֵי שֶׁנָּפַל מֵהַסּוּלָּם.",
        ...
        WordEntity(
            ...
            definition = "הַשְּׁרִיר הַעֲגֹל בְּחֵלֶק הַקִּדְמִי שֶׁל הַזְּרוֹעַ הָעֶלְיוֹנָה.",
        ...
        WordEntity(
            ...
            definition = "אִשָּׁה קְטַנָּה וַעֲדִינָה בְּמַבְנֶה גּוּפָהּ — נְמוּכָה וְדַקָּה.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי שָׁנָה בַּחֲדַר הַכֹּשֶׁר הִיא נִרְאֲתָה חֲטוּבָה וַחֲזָקָה.",
        ...
        WordEntity(
            ...
            example = "עוֹרֵךְ הַדִּין הַמְטֻפָּח הִגִּיעַ מֻקְדַּם לִפְגִישַׁת הַבֹּקֶר הַחֲשׁוּבָה.",
