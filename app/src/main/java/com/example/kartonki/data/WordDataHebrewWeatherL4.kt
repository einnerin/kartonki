...
object WordDataHebrewWeatherL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "כֶּתֶם אוֹר בָּהִיר לְצַד הַשֶּׁמֶשׁ שֶׁנּוֹצַר עַל יְדֵי גְּבִישֵׁי קֶרַח שְׁטוּחִים.",
        ...
        WordEntity(
            ...
            example = "הַנַּהָג רָאָה מִקְסַם שֶׁל מַיִם עַל הַכְּבִישׁ הַלּוֹהֵט.",
        ...
        WordEntity(
            ...
            example = "סוּפַת אָבָק הִשְׁתִּיקָה אֶת הַנְּמָל בְּאֵילַת לְכָל הַיּוֹם.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ שֶׁל הַעֲבָרַת חֹם אוֹ לַחוּת בְּאוֹפֶן אָפָּקִי דֶּרֶךְ זֵרָם רוּחַ יַצִּיב.",
            definitionNative = "Процесс переноса тепла или влаги по горизонтали ровным потоком ветра.",
            example = "הַסָּעָה שֶׁל אֲוִיר חַם מִדָּרוֹם הִמָּסָּה אֶת הַשֶּׁלֶג בְּלַיְלָה אֶחָד.",
        ...
        WordEntity(
            ...
            definition = "סוּפָה טְרוֹפִּית עֲנָקִית עִם רוּחוֹת שֶׁל מֵאַתְּ קִילוֹמֶטֶר לְשָׁעָה וִיוֹתֵר.",
            definitionNative = "Огромная тропическая буря с ветрами в сотню километров в час и больше.",
            example = "הוּרִיקָן שָׁטַף אֶת חוֹף פְלוֹרִידָה וְהִשְׁאִיר חֻרְבַּן אַחֲרָיו.",
        ...
        WordEntity(
            ...
            example = "מְעַרְבֶּלֶת שֶׁל עָלִים וַעֲפָרִית עָבְרָה דֶּרֶךְ הַחַצֵּר.",
        ...
        WordEntity(
            ...
            example = "רֹעָם כָּבֵד נִשְׁמָע מֵעַל הַהָרִים כָּל הַלַּיְלָה.",
        ...
        WordEntity(
            ...
            definition = "רוּחַ קְבוּעָה שֶׁנּוֹשֶׁבֶת מִצַּד אֶחָד בָּאֱזוֹרִים הַטְּרוֹפִּיִּים שָׁנָה שְׁלֵמָה.",
            definitionNative = "Постоянный ветер, что дует с одной стороны в тропических широтах круглый год.",
            example = "סִירוֹת מִפְרָשׂ הִשְׁתַּמְּשׁוּ בְּ רוּחַ פַּסַּט לַחֲצוֹת אֶת הָאַטְלַנְטִי.",
        ...
        WordEntity(
            ...
            example = "הַשָּׁמַיִם הִתְפַּשְּׁטוּ אֲזּוּרִיִּים מֵעַל הַחוֹף הַשָּׁקֵט.",
        ...
        WordEntity(
            ...
            definition = "מָלֵא רַעַם עַז וְקוֹלוֹת חֲזָקִים — עַל שָׁמַיִם, סוּפָה אוֹ עָנָן.",
