...
object WordDataHebrewBureauL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "כִּתְבוּ אֶת הַמִּסְפָּר זֶהוּת בָּרֻבְּרִיקָה הָעֶלְיוֹנָה שֶׁל הַטֹּפֶס.",
        ...
        WordEntity(
            ...
            example = "אִבַּדְתִּי אֶת הַנִּסְפָּח וְצָרִיךְ לְהַזְמִין אוֹתוֹ מֵחָדָשׁ.",
        ...
        WordEntity(
            ...
            definition = "הוֹצָאָה שֶׁל מִסְמָךְ זֵהֶה בִּמְקוֹם זֶה שֶׁפָּג, בְּלִי לְשַׁנּוֹת אֶת תָּכְנוֹ.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי הַהַחְתָּמָה אֶפְשָׁר לָצֵאת בִּטֶרְמִינַל הַיְצִיאָה.",
        ...
        WordEntity(
            ...
            example = "הִתְקַשַּׁרְתִּי לְרָשׁוּת הָאֻכְלוּסִין לְזַמֵּן תּוֹר חָדָשׁ.",
        ...
        WordEntity(
            ...
            example = "הַזְּכָאוּת לַסַּל קְלִיטָה תָּקֶּפָּה בְּשָׁנָה הָרִאשׁוֹנָה.",
        ...
        WordEntity(
            ...
            example = "שִׁלַּמְתִּי אֶת הָאַגְרָה בַּדֹּאַר וְקִבַּלְתִּי שׁוֹבֵר.",
        ...
        WordEntity(
            ...
            definition = "תַּשְׁלוּם נוֹסָף עַל חוֹזִים וּמִסְמָכִים יְקָרִים — הָיָה נֶחְתַּם פַּעַם בִּדְבָקִיּוֹת קְטַנּוֹת.",
            definitionNative = "Дополнительный платёж за договоры и дорогие документы — раньше его клеили маленькими наклейками.",
            example = "בִּטְלוּ אֶת הַמַּס בּוּלִים עַל מְכִירַת דִּירוֹת בִּשְׁנַת אַלְפַּיִם וְשֵׁשׁ.",
        ...
        WordEntity(
            ...
            definition = "מִכְתָּב קָצָר שֶׁאָדָם שׁוֹלֵחַ לְמִשְׂרַד כְּדֵי לְבַקֵּשׁ עֶזְרָה אוֹ הַסְבָּרָה.",
        ...
        WordEntity(
            ...
            example = "צָרִיךְ תַּרְגּוּם נוֹטַרְיוֹנִי שֶׁל הַתְּעוּדָה לְהַגָּשָׁה לַמּוֹסָד.",
