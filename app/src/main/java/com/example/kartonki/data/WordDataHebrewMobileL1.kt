...
object WordDataHebrewMobileL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "טֶלֶפוֹן חָכָם עִם מָסָךְ גָּדוֹל שֶׁמָּרִיץ תּוֹכְנוֹת רַבּוֹת וּמִתְחַבֵּר לָרֶשֶׁת.",
        ...
        WordEntity(
            ...
            definition = "חֲתִיכָה קְטַנָּה בְּתוֹךְ הַמַּכְשִׁיר שֶׁאוֹגֶרֶת חַשְׁמַל וְנוֹתֶנֶת לוֹ לִפְעוֹל בְּלִי כַּבֵּל.",
        ...
        WordEntity(
            ...
            definition = "כַּבֵּל וְתוֹסֶפֶת לַקִּיר שֶׁמְּמַלְּאִים אֶת הַסּוֹלְלָה כְּשֶׁהִיא נֶחְלֶשֶׁת.",
        ...
        WordEntity(
            ...
            definition = "הַדַּף הָרִאשׁוֹן שֶׁנִּפְתַּח אַחֲרֵי לְחִיצָה עַל כַּפְתּוֹר הַבַּיִת אוֹ פְּתִיחַת הַטֶּלֶפוֹן.",
            definitionNative = "Первая страница — открывается после кнопки «домой» или разблокировки телефона.",
            example = "שַׂמְתִּי בָּהֳוָם סְקְרִין רַק שָׁלוֹשׁ אַפְּלִיקַצְיוֹת חֲשׁוּבוֹת.",
        ...
        WordEntity(
            ...
            example = "כִּבִּיתִי אֶת הַמֶּתֶג שֶׁל הַהוֹדָעוֹת בַּלַּיְלָה לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            definition = "מַגָּע קָצָר שֶׁל אֶצְבַּע אַחַת בַּמָּסָךְ — הַפְּעֻלָּה הָרֲגִילָה לִפְתִיחַת תּוֹכְנָה.",
        ...
        WordEntity(
            ...
            definition = "תְּנוּעַת אֶצְבַּע מֲהִירָה לְצַד מְסֻיָּם בַּמָּסָךְ — לְמַעֲבָר בֵּין דַּפִּים אוֹ הוֹדָעוֹת.",
        ...
        WordEntity(
            ...
            example = "קְלִיק כָּפוּל עַל הַתְּמוּנָה בָּאִינְסְטַגְרָם נָתַן לְחָבֵר לֵב אָדֹם.",
