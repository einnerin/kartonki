...
object WordDataEnglishIdiomsL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 40604, setId = 406, languagePair = "en-ru", rarity = "UNCOMMON",
            ...
            definitionNative = "Признать поражение и перестать пытаться — «бросить полотенце» из бокса.",
        ...
        WordEntity(id = 40612, setId = 406, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "Момент, когда нужно выбрать одно из двух направлений в жизни.",
        ...
        WordEntity(id = 40617, setId = 406, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "Решительно и смело взяться за трудную ситуацию или проблему.",
        ...
        WordEntity(id = 40621, setId = 406, languagePair = "en-ru", rarity = "UNCOMMON",
            ...
            definitionNative = "Совсем не сработать — особенно когда пытался развлечь или впечатлить.",
        ...
        WordEntity(id = 40622, setId = 406, languagePair = "en-ru", rarity = "UNCOMMON",
            ...
            definitionNative = "Очень быстро разлететься в интернете — миллионы просмотров за дни.",
        ...
        WordEntity(id = 40625, setId = 406, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "Задать более высокий стандарт качества для всех остальных.",
