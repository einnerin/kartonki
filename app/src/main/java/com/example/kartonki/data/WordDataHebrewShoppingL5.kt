...
object WordDataHebrewShoppingL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "דְּמוּת קְבוּעָה (גִּבּוֹר, חָכָם, מוֹרֵד) שֶׁמּוּתָג מְשַׂחֵק מוּל הַקְּהָל.",
        ...
        WordEntity(
            ...
            example = "מָדַדְנוּ נֶתַח קוֹלוֹת שֶׁל שְׁלֹשִׁים אָחוּז בְּקָטֵגוֹרְיָה.",
        ...
        WordEntity(
            ...
            example = "סְטַארְבַּקְס יוֹצֵר הֵד הַמּוּתָג דֶּרֶךְ פִּסְגַּת הַחֲוָיָה בְּחַנּוּת.",
        ...
        WordEntity(
            ...
            definition = "כְּשֶׁרֹשֶׁם חִיּוּבִי בְּתָחוּם אֶחָד מַטֶּה אֶת הַשִּׁפּוּט בִּשְׁאַר הַתְּחוּמִים.",
        ...
        WordEntity(
            ...
            definition = "חֲקִיקָה יִשְׂרְאֵלִית הַמְּגִנָּה עַל קוֹנִים מִפְּנֵי הַטְעָיָה וּתְנָאִים מַקְפְּחִים.",
        ...
        WordEntity(
            ...
            example = "הוּא לֹא קָרָא אֶת כְּתַב מַסְתִּיר וְלָכֵן הִפְסִיד בְּבֵית מִשְׁפָּט.",
        ...
        WordEntity(
            ...
            definition = "כְּשֶׁיַּצְרָן דּוֹרֵשׁ מִקּוֹנִים לְהַחְזִיר פְּרִיט בִּגְלַל סַכָּנָה אוֹ פְּגָם רַצִּינִי.",
        ...
        WordEntity(
            ...
            definition = "הֲלִּיךְ מִשְׁפָּטִי שֶׁבּוֹ אִישׁ אֶחָד תּוֹבֵעַ בִּשְׁבִיל קְבוּצָה גְּדוֹלָה שֶׁל נִפְגָּעִים.",
        ...
        WordEntity(
            ...
            definition = "סְטִיָּה שִׁיטָתִית שֶׁל הַמַּחֲשָׁבָה מֵהַגָּיוֹן יָבֵשׁ בִּגְלַל קִצּוּרֵי דֶרֶךְ נַפְשִׁיִּים.",
            definitionNative = "Систематический сдвиг мышления от чистой логики из-за умственных коротких путей.",
            example = "הִטָּיָה קוֹגְנִיטִיבִית גוֹרֶמֶת לָנוּ לְהַעֲדִיף הַפְסֵד מֵהָרָוָחָה.",
        ...
        WordEntity(
            ...
            definition = "כְּשֶׁאֲנָשִׁים מַחְלִיטִים מָה לִּקְנוֹת לְפִי מָה שֶּׁאֲחֵרִים כְּבָר עָשׂוּ.",
            definitionNative = "Когда человек решает, что купить, ориентируясь на действия других людей.",
            example = "חַוּוֹת דַּעַת חִיּוּבִיּוֹת בְּאָמָּזוֹן הֵן הוֹכָחָה חֶבְרָתִית חֲזָקָה.",
        ...
        WordEntity(
            ...
            definition = "הַמָּקוֹם הַרְצוּי שֶׁמּוּתָג רוֹצֶה לִתְפֹּס בַּמַּחֲשָׁבָה שֶׁל הַקּוֹנֶה.",
            definitionNative = "Желаемое место, которое марка хочет занять в голове у покупателя.",
            example = "מִקּוּם בַּשּׁוּק שֶׁל וּלְווֹ מְבֻסָּס עַל בְּטִיחוּת מֵעַל הַכֹּל.",
        ...
        WordEntity(
            ...
            example = "תַּעֲרִיף מֶכֶס עַל יַיִן מְיֻבָּא עוֹמֵד עַל שִׁשִּׁים אָחוּז.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי מַס יְבוּא הַטֶּלֶפוֹן הִתְיַקֵּר בְּמֵאֳתַיִם שֶׁקֶל.",
        ...
        WordEntity(
            ...
            definition = "חוֹזֶה בֵּין מְדִינוֹת שֶׁמְּבַטֵּל אוֹ מַפְחִית אֶת הַמֶּכֶס בֵּינֵיהֶן.",
        ...
        WordEntity(
            ...
            definition = "אִסּוּר רִשְׁמִי שֶׁמְּדִינָה מַטִּילָה עַל קֵנֶה אוֹ מְכִירָה מוּל מְדִינָה אַחֶרֶת.",
