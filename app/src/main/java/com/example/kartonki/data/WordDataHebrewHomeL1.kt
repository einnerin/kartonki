...
object WordDataHebrewHomeL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר חַשְׁמַלִּי שֶׁשּׁוֹאֵב לְכֵלוּךְ וְאָבָק מֵהָרִצְפָּה.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי עִם יָדִית אֲרֻכָּה וְזִיפִים שֶׁמְּטַאְטְאִים בּוֹ אֶת הָרִצְפָּה.",
            definitionNative = "Инструмент с длинной ручкой и щетиной, которым подметают пол.",
            example = "הִיא לָקְחָה מַטְאֲטֵא וְהוֹצִיאָה אֶת הָאָבָק לָחָצֵר.",
        ...
        WordEntity(
            ...
            definition = "כִּסּוּי גּוּמִי לַיָּדַיִם שֶׁמָּגִּן מֵחָמָרֵי נִקּוּי בִּזְמַן עֲבוֹדָה.",
        ...
        WordEntity(
            ...
            definition = "מִשְׁטַח עֲבוֹדָה גָּבוֹהַּ בַּמִּטְבָּח שֶׁעָלָיו מְכִינִים אֹכֶל.",
        ...
        WordEntity(
            ...
            definition = "כִּסּוּי בַּד שֶׁעוֹטְפִים בּוֹ אֶת הַכָּרִית לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            definition = "הַחֵלֶק הָעֶלְיוֹן שֶׁל הַבַּיִת שֶׁמָּגִּן עַל הַדִּיָּרִים מִגֶּשֶׁם וְשֶׁמֶשׁ.",
