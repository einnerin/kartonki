...
object WordDataHebrewBatch40 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "psych_attention_memory",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "psych_cognition",
        ...
        WordEntity(
            ...
            definition = "פֵּרוּק בְּעָיָה לְחֶלָּקִים קְטַנִּים וּבְדִיקָתָם בָּזֶה אַחַר זֶה.",
            definitionNative = "Разбор задачи на маленькие части и их пошаговое изучение.",
            example = "חִשִּׁיבָה אָנָלִיטִית עוֹזֶרֶת לִמְהַנְדֵּס לִמְצֹא תַּקָּלָה בַּמַּעֲרֶכֶת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "psych_emotions",
        ...
        WordEntity(
            ...
            definition = "מַצָּב מִתְמַשֵּׁךְ שֶׁל עַצְבוּת, חֹסֶר אֵנֶרְגְּיָה וְאָבְדַן עִנְיָן בַּחַיִּים.",
        ...
        WordEntity(
            ...
            example = "הֵרָגֵל לָרַעַשׁ שֶׁל הָרְחוֹב הוֹפִיעַ אַחֲרֵי שָׁבוּעַ בַּדִּירָה.",
        ...
        WordEntity(
            ...
            definition = "תְּשׂוּמַת לֵב עָרָנִית לָרֶגַע הַזֶּה בְּלִי שִׁיפּוּט וּבְלִי הַסָּחָה.",
            definitionNative = "Бодрое внимание к настоящему мгновению без оценок и отвлечений.",
            example = "תְּרַגֵּל מוֹדָעוּת מֵלֵאָה חָמֵשׁ דַּקּוֹת בַּבֹּקֶר לִפְנֵי הָעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "psych_therapy",
            original = "מֶנְגָּנוֹן הֲגָנָה", translation = "защитный механизм",
            definition = "פְּעֻלָּה לֹא מוּדַעַת שֶׁל הַנֶּפֶשׁ לְהַקְטִין כְּאֵב פְּנִימִי וּמַתַּח.",
            definitionNative = "Бессознательное действие психики ради уменьшения внутренней боли и тревоги.",
            example = "הַכְחָשָׁה הִיא מֶנְגָּנוֹן הֲגַנָּה נָפוֹץ מוּל בְּשׂוֹרָה רָעָה.",
        ...
        WordEntity(
            ...
            definition = "טֶכְנִיקָה שֶׁבָּהּ הַמְטֻפָּל אוֹמֵר כָּל מַחֲשָׁבָה הָעוֹלָה בְּלִי סִנּוּן.",
        ...
        WordEntity(
            ...
            definition = "הַיְכֹלֶת לְהַרְגִּישׁ וְלָבִין מָה שֶּׁעוֹבֵר עַל אָדָם אַחֵר.",
