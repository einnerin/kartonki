...
object WordDataHebrewBaristaL1L2L3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_drinks_basic",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_other_drinks",
            ...
            example = "אִמָּא רוֹצָה תֵּה יָרֹק עִם נַעֲנַע.",
        ...
        WordEntity(
            ...
            example = "הַיֶּלֶד אוֹהֵב קָקָאוֹ חַם בְּעֶרֶב חָרְפִּי.",
        ...
        WordEntity(
            ...
            example = "סִחַטְנוּ מִיץ תַּפּוּזִים לְלָקּוֹחוֹת בַּבֹּקֶר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_food",
        ...
        WordEntity(
            ...
            example = "לְקַחְתִּי כָּרִיךְ לָעֲבוֹדָה בִּגְלַל זְמַן קָצָר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_extras",
            original = "סֻכָּר", translation = "сахар",
            definition = "אָבָק לָבָן וּמָתוֹק שֶׁמּוֹסִיפִים לְמַשְׁקֶה אוֹ לְעוּגָה.",
        ...
        WordEntity(
            ...
            definition = "חֵלֶק שָׁמֵן וְעָבֶה שֶׁל הַחֲלַב הַטּוֹב לְמַשְׁקֶה אוֹ לְקִנּוּחַ.",
        ...
        WordEntity(
            ...
            definition = "אָבָק חוּם וְרֵיחָנִי שֶׁל קְלִפַּת עֵץ לְפִיזוּר עַל הַקֶּצֶף.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_service",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_equipment",
            original = "בָּרִיסְטָה", translation = "бариста",
            definition = "אִישׁ הַמִּקְצוֹעַ שֶׁמָּכִין מַשְׁקָאוֹת חַמִּים מֵאֲחוֹרֵי הַדֶּלְפֵּק.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_equipment",
            ...
            example = "מְכוֹנַת אֶסְפְּרֶסוֹ חֲדָשָׁה הִגִּיעָה אֶתְמוֹל מֵאִיטַלְיָה.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר עִם לֶהָבִים שֶׁטּוֹחֵן גַּרְעִינִים לָאָבָק עָדִין אוֹ גַּס.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_recipe",
            original = "טְחִינָה", translation = "помол",
            definition = "מִדַּת הָעֲדִינוּת שֶׁל הַגַּרְעִינִים אַחֲרֵי הָעֲבוֹדָה בַּמַּטְחֵנָה.",
        ...
        WordEntity(
            ...
            example = "הַמִּנּוּן הַסַּטַּנְדַּרְטִי אֶצְלֵנוּ הוּא שְׁמוֹנֶה עָשָׂר גְּרָם.",
            exampleNative = "Стандартный מִנּוּן у нас — восемнадцать грамм.",
        ),
        WordEntity(
            id = 174008, setId = 1740, languagePair = "he-ru", rarity = "RARE",
            pos = "phrase", semanticGroup = "barista_recipe",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_milk_art",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_milk_art",
            original = "קֶצֶף חָלָב", translation = "молочная пена",
            definition = "שִׁכְבָה אֲוִירִית וְלוֹהַטֶת בְּרֹאשׁ הַכּוֹס מֵאֲוִיר וְנוֹזֵל לָבָן.",
         ...
         fillInBlankExclusions = listOf(174011L)),
        WordEntity(
        ...
        WordEntity(
            ...
            definition = "צִיּוּר בְּצוּרַת עָלֶה שֶׁל שֻׁשָּׁן אוֹ שֶׁל שֶׁרֶךְ עִם פַּסִּים סִימֶטְרִיִּים.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_pos_screen",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_pos_screen",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_shift",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_shift",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_specialty",
            ...
            example = "אֲנַחְנוּ מַגִּישִׁים רַק סְפֵּשַׁלְטִי טָרִי מִחֲוַוֹת קְטַנּוֹת.",
        ...
        WordEntity(
            ...
            definition = "זַן עָדִין בַּעַל חֲמְצִיּוּת רַעֲנָנָה הַגָּדֵל בְּהָרִים גְּבוֹהִים.",
            definitionNative = "Деликатный вид с яркой кислинкой, что растёт в высокогорных областях.",
            example = "אֲרָבִּיקָה מֵאָתְיוֹפְּיָה נִשְׁאֶרֶת אַהֲבָתִי הַגְּדוֹלָה.",
        ...
        WordEntity(
            ...
            definition = "זַן חָזָק וּמַר שֶׁמָּכִיל פִּי שְׁנַיִם קָפָאִין מֵאֲרָבִּיקָה רְגִילָה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_specialty",
        ...
        WordEntity(
            ...
            definition = "צֵרוּף שֶׁל זַנִּים שׁוֹנִים לְאִזּוּן בֵּין חֲמְצִיּוּת לְגוּף וּמְתִיקוּת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_roast",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_roast",
        ...
        WordEntity(
            ...
            example = "אִיטַלְיָה אוֹהֶבֶת קְלִיָּה כֵּהָה וְעֲשִׁירָה.",
        ...
        WordEntity(
            ...
            definition = "עֲקֻמַּת זְמַן וְחֹם מְדֻיֶּקֶת שֶׁבָּהּ עוֹבֵד הַקַּלַּאי לְכָל זַן בִּפְרָט.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_taste",
            ...
            example = "טַעַם שֶׁנִּשְׁאַר אָרֹךְ מְעִיד עַל גַּרְעִין מְעוּלֶה.",
        ...
        WordEntity(
            ...
            definition = "תַּרְשִׁים מְקֻבָּל בִּמְקָצּוֹעַ הַמְצַיֵּג מִשְׁפָּחוֹת שֶׁל אָרוֹמוֹת אֶפְשָׁרִיּוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_extraction",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_extraction",
        ...
        WordEntity(
            ...
            definition = "בְּעָיָה שֶׁבָּהּ הַמַּיִם הוֹצִיאוּ גַּם חֳמָרִים מָרִים בִּגְלַל זְמַן יוֹתֵר מִדַּי אָרֹךְ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_industry",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_industry",
            original = "סַחַר יָשִׁיר", translation = "прямая торговля",
            definition = "מִסְחָר בֵּין הַחַוָּה לַקַּלַּאי בְּלִי מְתַוְּכִים — תַּשְׁלוּם הוֹגֵן יוֹתֵר.",
        ...
        WordEntity(
            ...
            definition = "תָּלוּי שֶׁל אֵיכוּת הַזַּן בִּזְמַן הָאָסִיף בַּחַוָּה בְּמְהַלַּךְ הַשָּׁנָה.",
