...
object WordDataHebrewEveryday {
    ...
    val sets = listOf(
        WordSetEntity(id = 1004, name = "Приветствия", description = "Базовые фразы и вежливость",     languagePair = "he-ru", orderIndex = 4,
            topic = "Приветствия",
            level = 1),
        WordSetEntity(id = 1005, name = "Семья",          description = "Родственники и окружение",      languagePair = "he-ru", orderIndex = 5,
            topic = "Семья",
            level = 1),
        WordSetEntity(id = 1006, name = "Еда и кулинария",         description = "Продукты, блюда и кухня",   languagePair = "he-ru", orderIndex = 6,
            topic = "Еда и кулинария",
            level = 1),
        WordSetEntity(id = 1007, name = "Дом и быт",             description = "Помещения и предметы быта", languagePair = "he-ru", orderIndex = 7,
            topic = "Дом и быт",
            level = 2),
    )
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "בִּרְכַּת בֹּקֶר הַנֶּאֱמֶרֶת בתחילת הַיּוֹם.",
        ...
        WordEntity(
            ...
            definition = "מִלָּה לְהַבִּיעַ הַכָּרַת הַטּוֹב כְּלַפֵּי מִישֶׁהוּ עַל עֶזְרָה.",
        ...
        WordEntity(
            ...
            definition = "תְּשׁוּבָה חִיּוּבִית לִשְׁאֵלָה.",
        ...
        WordEntity(
            ...
            definition = "תְּשׁוּבָה שְׁלִילִית לִשְׁאֵלָה.",
        ...
        WordEntity(
            ...
            example = "יוֹם טוֹב, מָה הַחֲדָשׁוֹת?",
        ...
        WordEntity(
            ...
            definition = "ביטוי פרידה מקובל בַּשָּׂפָה הָעִבְרִית.",
        ...
        WordEntity(
            ...
            definition = "ביטוי הַסְכָּמָה אוֹ אישור שֶׁהַכֹּל כַּשּׁוּרָה.",
        ...
        WordEntity(
            ...
            definition = "ביטוי שֶׁבַח לְהַצְלָחָה אוֹ לְאֵיכוּת גְּבוֹהָה.",
        ...
        WordEntity(
            ...
            definition = "הַהוֹרֶה הַזָּכָר בַּמִּשְׁפָּחָה.",
            definitionNative = "Мужской родитель в семье.",
            example = "אָב שֶׁלִּי עוֹבֵד כְּמִהְנַדֵּס.",
        ...
        WordEntity(
            ...
            definition = "הַהוֹרֶה הַנְּקֵבָה בַּמִּשְׁפָּחָה.",
        ...
        WordEntity(
            ...
            example = "בֵּן שֶׁלָּהֶם לוֹמֵד בָּאוּנִיבֶרְסִיטָה.",
        ...
        WordEntity(
            ...
            example = "סַבָּא שֶׁלִּי מְסַפֵּר סִיפּוּרִים נִפְלָאִים.",
        ...
        WordEntity(
            ...
            definition = "אָדָם מִמִּין נְקֵבָה בַּגּוּר, אוֹ הַנָּשׂוּי לְאִישׁ.",
        ...
        WordEntity(
            ...
            example = "צָעִיר יָכוֹל לִלְמוֹד מַהֵר.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(100501L, 100502L, 100503L, 100504L, 100505L, 100506L, 100507L, 100508L, 100509L, 100510L, 100511L, 100512L, 100513L, 100514L, 100517L, 100518L, 100519L, 100520L, 100521L, 100522L, 100523L, 100524L)),
        ...
        WordEntity(
            ...
            definition = "כָּל מָה שֶּׁאוֹכְלִים כְּדֵי לִחְיוֹת.",
        ...
        WordEntity(
            ...
            example = "מַיִם קָרִּים טוֹבִים בַּקַּיִץ.",
        ...
        WordEntity(
            ...
            definition = "מַאֲפֶה הַעֲשׂוּי מִקֶּמַח וּמַיִם.",
            definitionNative = "Выпечка из муки и воды.",
            example = "לֶחֶם טָרִי מֵרֵיחַ נִפְלָא.",
        ...
        WordEntity(
            ...
            example = "יֶרֶק חָשׁוּב לְתָזּוּנָה בְּרִיאָה.",
        ...
        WordEntity(
            ...
            definition = "מַשְׁקֶה חַם וְכֵהֶה הַעֲשׂוּי מִגַּרְעִינִים קְלוּיִים.",
        ...
        WordEntity(
            ...
            definition = "מַשְׁקֶה חַם הַעֲשׂוּי מֵעָלִים מְיוּבָּשִׁים.",
        ...
        WordEntity(
            ...
            definition = "מַנָּה קָרָה עֲשׂוּיָה מִיְּרָקוֹת חֲתוּכִים.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל קָפוּא וּמָתוֹק הַעֲשׂוּי מֵחָלָב.",
        ...
        WordEntity(
            ...
            definition = "מוּצָר חֲלָבִי הַעֲשׂוּי מֵחָלָב קָרוּשׁ.",
        ...
        WordEntity(
            ...
            definition = "מַאֲפֶה אִיטַלְקִי עָגוֹל עִם עַגְבָנִיּוֹת, גְּבִינָה וְתּוֹסָפוֹת.",
            definitionNative = "Итальянская круглая выпечка с томатами, сыром и добавками.",
            example = "פִּיצָּה עִם פַּטְרִיּוֹת הִיא הָאֲהוּבָה עָלַי.",
            exampleNative = "פִּיצָּה с грибами — моя любимая.",
         fillInBlankExclusions = listOf(100601L, 100603L, 100605L, 100606L, 100607L, 100608L, 100609L, 100610L, 100611L, 100615L, 100616L, 100617L, 100618L, 100621L, 100622L, 100623L, 100624L)),
        ...
        WordEntity(
            ...
            example = "מִטָּה שֶׁלִּי רַכָּה וְנוֹחָה.",
        ...
        WordEntity(
            ...
            definition = "רָהִיט לִישִׁיבָה לְאָדָם אֶחָד.",
        ...
        WordEntity(
            ...
            definition = "רָהִיט אֻפְקִי עִם רַגְלַיִם לַאֲרוּחוֹת אוֹ לַעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            definition = "פֶּתַח בַּקִּיר לַכְּנִיסָה וְהַיְצִיאָה, שֶׁנִּסְגַּר בְּצִיר.",
        ...
        WordEntity(
            ...
            definition = "פֶּתַח בַּקִּיר שֶׁמַּכְנִיס אוֹר וַאֲוִיר.",
        ...
        WordEntity(
            ...
            definition = "מַתַּקַּן הַמְּזַרְזֵק מַיִם לִרְחִיצָה.",
        ...
        WordEntity(
            ...
            definition = "מַתַּקָּן לִנְעִילַת דֶּלֶת.",
        ...
        WordEntity(
            ...
            definition = "מַתָּקָן לִמְדִידַת הַזְּמַן.",
        ...
        WordEntity(
            ...
            definition = "אֵנֶרְגִּיָה הַמַּפְעִילָה מְכוֹנוֹת וּמָנּוֹרוֹת.",
            definitionNative = "Энергия, приводящая в действие машины и лампы.",
            example = "חַשְׁמַל נִכְבָּה בְּזַמַּן הַסּוּפָה.",
        ...
        WordEntity(
            ...
            definition = "מַתַּקָּן לְקֵרוּר אוֹ חִמּוּם הָאֲוִיר בַּחֶדֶר.",
        ...
        WordEntity(
            ...
            definition = "מַתַּקָּן לְשִׁמּוּר אֹכֶל בְּקֹר.",
        ...
        WordEntity(
            ...
            definition = "חֶדֶר רָחְצָה עִם מַקְלַחַת אוֹ אַגָּן גָּדוֹל לְנִיקּוּי הַגּוּף.",
        ...
        WordEntity(
            ...
            definition = "חֶדֶר שֶׁיֵּשׁ בּוֹ אַסְלָה לְצָרְכֵי הָאָדָם.",
        ...
        WordEntity(
            ...
            definition = "מִבְנֶה שֶׁל שְׁלַבִּים לַעֲלִיָּה מִקּוֹמָה לְקוֹמָה.",
         ...
         fillInBlankExclusions = listOf(100701L, 100702L, 100703L, 100707L, 100708L, 100709L, 100710L, 100711L, 100712L, 100719L, 100720L, 100721L, 100722L)),
    )
}
