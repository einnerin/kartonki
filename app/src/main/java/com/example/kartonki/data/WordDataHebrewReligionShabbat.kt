...
object WordDataHebrewReligionShabbat {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190508, setId = 1905, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "סֵדֶר תְּפִילָּה מְיֻחָד לְשַׁבָּת וְלַחַגִּים, נֶאֱמַר מִיָּד אַחֲרֵי קְרִיאַת הַתּוֹרָה.",
            definitionNative = "Особый молитвенный чин субботы и праздников, читаемый сразу после чтения Торы.",
            example = "אַחֲרֵי מוּסַף הַקְּהִילָּה יָצְאָה לְקִדּוּשׁ בָּאוּלָם.",
        ...
        WordEntity(id = 190510, setId = 1905, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "פָּרְשַׁת הַשָּׁבוּעַ הַזּוֹ מְסַפֶּרֶת עַל יְצִיאַת מִצְרַיִם.",
        ...
        WordEntity(id = 190511, setId = 1905, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הַסָּבְתָּא הִגִּישָׁה קֻפְסַת בְּשָׂמִים סְבִיב הַשֻּׁלְחָן.",
        ...
        WordEntity(id = 190512, setId = 1905, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "פָּמוֹט עָבַר בִּירוּשָּׁה מִסַּבְתָּא בְּפּוֹלִין.",
        ...
        WordEntity(id = 190519, setId = 1905, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הַחֲסִידִים נִשְׁאֲרוּ לִמְלַוֶּה מַלְכָּה עִם גִּטָּרָה עַד חֲצוֹת.",
        ...
        WordEntity(id = 190520, setId = 1905, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "הֶסְבֵּר קָצָר שֶׁאוֹמְרִים בֵּין הַמָּנוֹת, סְבִיב פָּרְשַׁת הַשָּׁבוּעַ הַנּוֹכְחִית.",
        ...
        WordEntity(id = 190521, setId = 1905, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מַעֲמָד שֶׁל חֵפֶץ שֶׁאָסוּר לָגַעַת בּוֹ בַּיּוֹם הַשְּׁבִיעִי — כְּסָפִים, עֵטִים, פְּטִישׁ.",
        ...
        WordEntity(id = 190523, setId = 1905, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "תַּיִל דַּק שֶׁמַּקִּיף שְׁכוּנָה וּמְאַחֵד אֶת חַצֵרוֹתֶיהָ לִרְשׁוּת אַחַת, כְּדֵי שֶׁמֻּתָּר יִהְיֶה לָשֵׂאת.",
        ...
        WordEntity(id = 190524, setId = 1905, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "בְּצֵאת הַשַּׁבָּת הָאָב חָזַר לַטֶּלֶפוֹן וְלְחֲדָשׁוֹת.",
