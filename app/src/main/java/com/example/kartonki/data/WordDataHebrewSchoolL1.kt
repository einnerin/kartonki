...
object WordDataHebrewSchoolL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁעֵינַיִם רוֹאוֹת — אָדֹם, כָּחוֹל אוֹ יָרוֹק עַל דַּף אוֹ עֶצֶם.",
        ...
        WordEntity(
            ...
            definition = "לְקַבֵּל יְדַע חָדָשׁ עַל יְדֵי הַקְשָׁבָה, קְרִיאָה וְתַרְגּוּל.",
        ...
        WordEntity(
            ...
            example = "אֲנִי אוֹהֵב לִקְרֹא לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            example = "הַיְלָדִים יוֹצְאִים לְשַׂחֵק בָּחָצֵר אַחֲרֵי הַשִּׁעוּרִים.",
        ...
        WordEntity(
            ...
            definition = "בְּדִיקָה כְּתוּבָה שֶׁבּוֹדֶקֶת מָה הַתַּלְמִיד יוֹדֵעַ.",
            definitionNative = "Письменная проверка, которая показывает, что ребёнок знает.",
            example = "מָחָר יֵשׁ לָנוּ מִבְחָן בַּהִיסְטוֹרְיָה.",
