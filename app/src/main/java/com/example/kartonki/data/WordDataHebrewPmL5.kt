...
object WordDataHebrewPmL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_leadership",
        ...
        WordEntity(
            ...
            definition = "מְנַהֵל שֶׁבַּעֲלֵיהוּ הַחוֹבָה לְהַגְדִּיל אֶת מִסְפַּר הַמִּשְׁתַּמְּשִׁים וְאֶת הַהַכְנָסוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_portfolio",
            original = "תִּיק מוּצָרִים", translation = "продуктовый портфель",
            definition = "אוֹסֶף שֶׁל כָּל הַמּוּצָרִים שֶׁל הַחֶבְרָה שֶׁמְּנֻהֲלִים יַחַד כִּמְכֻלָּל אֶחָד.",
        ...
        WordEntity(
            ...
            example = "קַו עֲסָקִים שֶׁל אַבְטָחַת מֵידָע גָּדַל מַהֵר מִכָּל הַשְּׁאָר בָּרֹבַע הַזֶּה.",
        ...
        WordEntity(
            ...
            definition = "קְבוּצָה שֶׁל הַצָּעוֹת קְרוֹבוֹת זוֹ לָזוֹ שֶׁחוֹלְקוֹת קְהַל יַעַד וְזֶהוּת מוּתְגִית.",
            definitionNative = "Группа близких предложений — общая аудитория и общая узнаваемость бренда.",
            example = "מִשְׁפַּחַת מוּצָרִים שֶׁל אוֹפִיס שֻׁוְּוְקָה תַּחַת חֲבִילָה אַחַת לְלָקוֹחוֹת אַרְגּוּנִיִּים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_ma",
            original = "אוֹדִיט מוּצָרִי", translation = "продуктовый аудит при M&A",
            definition = "בְּדִיקָה מַעֲמִיקָה שֶׁל מַצַּב הַהַצָּעוֹת אֵצֶל חֶבְרַת מַטָּרָה לִפְנֵי שֶׁחוֹתְמִים עַל הָעִסְקָה.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ הַתְאָמַת חָזוֹן וּמַפַּת דֶּרֶךְ בֵּין שְׁתֵּי קְבוּצוֹת פִּתּוּחַ אַחֲרֵי שֶׁאוּחֲדוּ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_org_design",
        ...
        WordEntity(
            ...
            example = "סֻלָּם קַרְיֶרָה בָּרוּר הוּא אֶחָד מִכְּלֵי שִׁמּוּר עוֹבְדִים הַחֲזָקִים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_advanced_concepts",
            original = "מַפַּת וָורְדְלִי", translation = "Wardley map (карта Уордли)",
            definition = "תַּרְשִׁים שֶׁמַּרְאֶה לְאָן רְכִיבֵי הַמַּעֲרֶכֶת זָזִים מִחִדּוּשׁ לָאֲחִידוּת לְאֹרֶךְ זְמַן.",
            definitionNative = "Схема — куда движутся компоненты системы от новизны к стандартизации со временем.",
            example = "מַפַּת וָורְדְלִי גִּלְּתָה שֶׁכֻּלָּנוּ בּוֹנִים תַּשְׁתִּית שֶׁכְּבָר זוֹלָה בַּעֲנַן.",
        ...
        WordEntity(
            ...
            definition = "גִּישָׁה מַעֲמִיקָה שֶׁבּוֹדֶקֶת לֹא רַק אֵיזוֹ מְשִׂימָה הַלָּקוֹחַ פּוֹתֵר אֶלָּא גַּם רָגְשׁוֹת וְהֶקְשֵׁר.",
            definitionNative = "Глубокий подход — изучает не только задачу клиента, но и его эмоции и контекст.",
            example = "מַסְגֶּרֶת ג'וֹבְּס מַעֲמִיקָה הוֹבִילָה אוֹתָנוּ לְעַצֵּב מָסָךְ אַחֵר לְגַמְרֵי.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי שֶׁמְּסַוֵּג יְכֹלוֹת לְאַרְבָּעָה סוּגִים — חוֹבָה, רְצוּיוֹת, מַפְתִּיעוֹת וְשִׁכְבַּת אֲדִישׁוּת.",
            definitionNative = "Инструмент — делит возможности на четыре типа: обязательные, желаемые, удивляющие и безразличные.",
            example = "מוֹדֶל קָאנוֹ עָזַר לִקְבֹּעַ אֵיזוֹ פִיצֶ'רִים בֶּאֱמֶת יִשְׂמְחוּ אֶת הַלָּקוֹחוֹת.",
        ...
        WordEntity(
            ...
            definition = "גִּישָׁה שֶׁבָּהּ הַהַצָּעָה עַצְמָהּ מוֹשֶׁכֶת מִשְׁתַּמְּשִׁים חֲדָשִׁים בְּלִי תְּלוּת בְּמַעֲרַךְ מְכִירוֹת אַקְטִיבִי.",
