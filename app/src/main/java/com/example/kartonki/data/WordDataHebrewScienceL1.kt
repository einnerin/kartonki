...
object WordDataHebrewScienceL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁיּוֹצֵא בְּסוֹף בְּדִיקָה אוֹ פְּעֻלָּה אֲרֻכָּה.",
            definitionNative = "То, что выходит в конце проверки или долгого действия.",
            example = "הַתּוֹצָאָה שֶׁל הַבְּדִיקָה הָיְתָה שׁוֹנָה מִמָּה שֶּׁחָשַׁבְנוּ.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁאוֹמְרִים בַּסּוֹף אַחֲרֵי שֶׁסִּיְּמוּ אֶת כָּל הַבְּדִיקוֹת.",
        ...
        WordEntity(
            ...
            example = "רֵיחַ הַגַּז הָרָגִישׁ אוֹתָנוּ לִבְרֹחַ מֵהַבַּיִת מִיָּד.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁמַּגִּיעַ מֵהַשֶּׁמֶשׁ אוֹ מִנּוּרָה וּמַרְאֶה לָנוּ דְּבָרִים.",
