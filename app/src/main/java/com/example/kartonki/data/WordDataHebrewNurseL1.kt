...
object WordDataHebrewNurseL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "חֲדַר חוֹלִים מָכִּיל אַרְבַּע מִטּוֹת וְאַרְבָּעָה אֲרוֹנוֹת.",
        ...
        WordEntity(
            ...
            definition = "נְעַלַּיִם רַכּוֹת וְקַלּוֹת שֶׁלּוֹבְשִׁים בְּתוֹךְ הַחֶדֶר.",
        ...
        WordEntity(
            ...
            definition = "בֶּגֶד פָּשׁוּט לִמְטוּפָּלִים שֶׁנִּפְתַּח מֵאָחוֹר וְקַל לְהַחְלִיף.",
        ...
        WordEntity(
            ...
            example = "סָבְתָא הֶחְלִיפָה לִכְּתֹנֶת לַיְלָה כְּחֻלָּה.",
        ...
        WordEntity(
            ...
            example = "אִמָּא נָתְנָה לוֹ סִירוֹפּ נֶגֶד שִׁעוּל לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            example = "טִפּוּל יוֹמִי מַתְחִיל בִּשְׁמוֹנֶה וְכוֹלֵל מְקַלַּחַת קַלָּה.",
        ...
        WordEntity(
            ...
            definition = "סִיּוּר שֶׁל הַצֶּוֶת בֵּין הַמִּטּוֹת לְבַדֹּק כָּל מְטוּפָּל בַּמַּחְלָקָה.",
            definitionNative = "Прохождение команды по койкам, чтобы взглянуть на каждого больного.",
            example = "סֶבֶב בֹּקֶר מַתְחִיל מִיָּד אַחֲרֵי קַבָּלַת הַמִּשְׁמֶרֶת.",
