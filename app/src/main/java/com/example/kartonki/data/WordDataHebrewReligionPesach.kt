...
object WordDataHebrewReligionPesach {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190604, setId = 1906, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הָאֹרֶז קִבֵּל תַּו כַּשְׁרוּת לְפֶסַח מֵהָרַבָּנוּת.",
        ...
        WordEntity(id = 190605, setId = 1906, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "סֵדֶר פֶּסַח אֶצְלָם נִמְשָׁךְ עַד שָׁלוֹשׁ לִפְנוֹת בֹּקֶר.",
        ...
        WordEntity(id = 190606, setId = 1906, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "בְּלֵיל הַסֵּדֶר אֲנַחְנוּ מַזְמִינִים אֶת הַסָּבְתָּא וְהַסַּבָּא.",
        ...
        WordEntity(id = 190607, setId = 1906, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "קְעַרַּת הַסֵּדֶר עָמְדָה בְּמֶרְכַּז הַשֻּׁלְחָן.",
        ...
        WordEntity(id = 190609, setId = 1906, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הוּא שָׁתָה אֶת הַכּוֹס בְּהַסָּבָה כְּמוֹ הָאַחֲרוֹנִים.",
        ...
        WordEntity(id = 190613, setId = 1906, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "יָרָק חָרִיף שֶׁמְּמַלֵּא אֶת תַּפְקִיד הַיָּרָק הַמַּר בִּסְעוּדַת הַלַּיְלָה לְפִי מִנְהֲגֵי אֵירוֹפָּה.",
            definitionNative = "Острый овощ, исполняющий роль горькой зелени в ночной трапезе по европейскому обычаю.",
            example = "הוּא גָּרַד חַזֶּרֶת טְרִיָּה לְכָל הָאוֹרְחִים.",
        ...
        WordEntity(id = 190617, setId = 1906, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "שִׁיר אֲרַמִּי מַצְטַבֵּר שֶׁסּוֹגֵר אֶת הַלַּיְלָה, עַל גְּדִי שֶׁאַבָּא קָנָה בִּשְׁנֵי זוּזִים.",
        ...
        WordEntity(id = 190623, setId = 1906, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "אַרְבָּעָה יָמִים בְּאֶמְצַע הַחַג, שֶׁבָּהֶם רֹב הַמְּלָאכוֹת מוּתָּרוֹת אֲבָל הָאֹפִי שֶׁל מוֹעֵד נִשְׁמַר.",
