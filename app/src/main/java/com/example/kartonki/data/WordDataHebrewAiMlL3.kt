...
object WordDataHebrewAiMlL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "aiml_basics",
        ...
        WordEntity(
            ...
            example = "הַחֻקֵר אָסָף דַּאטָסֶט שֶׁל מִילְיוֹן צִילוּמֵי רֶנְטְגֶן מִשְׁלוֹשָׁה בָּתֵי חוֹלִים.",
        ...
        WordEntity(
            ...
            example = "הָאִימוּן רָץ שְׁלוֹשָׁה יָמִים עַל שְׁמוֹנֶה כַּרְטִיסֵי מָסָךְ חֲזָקִים.",
        ...
        WordEntity(
            ...
            example = "רֶשֶׁת נֵירוֹנִים עֲמֻקָּה מְזַהָה רַעַשׁ חָשׁוּד בְּהַקְלָטוֹת שֶׁל מֲנוֹעִים.",
        ...
        WordEntity(
            ...
            example = "הוֹסַפְנוּ פִיצֶ׳ר חָדָשׁ עַל מֶשֶׁךְ הַסֶּשֶׁן וְהַדִּיּוּק עָלָה בְּאַרְבָּעָה אֲחוּזִים.",
        ...
        WordEntity(
            ...
            definition = "יְצִירַת גָּרְסָאוֹת שׁוֹנוֹת שֶׁל אוֹתָהּ דֻּגְמָה — סִיבוּב, חִתּוּךְ אוֹ הוֹסָפַת רַעַשׁ — לִגְדִילַת הַסֵּט.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "aiml_training",
        ...
        WordEntity(
            ...
            definition = "הַגְדָּרָה שֶׁבּוֹחֲרִים יַדָּנִּית לִפְנֵי הָרִיצָה — קֶצֶב לְמִידָה, מִסְפַּר שִׁכְבוֹת וְכוֹ׳.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "aiml_training",
            original = "וָלִידַצְיָה", translation = "валидация",
            ...
            example = "צִיוּן הַוָלִידַצְיָה הָיָה גָּבוֹהַּ אֲבָל בִּפְרוֹדַקְשֶׁן הַתּוֹצָאוֹת אַכְזְבוּ.",
            exampleNative = "Балл וָלִידַצְיָה был высокий, но в проде результаты разочаровали.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "aiml_models",
            original = "קְלַסִיפִיקַצְיָה", translation = "классификация",
            definition = "מְשִׂימָה שֶׁבָּהּ צָרִיךְ לְשַׁיֵּךְ דֻּגְמָה לְאַחַת מִכַּמָּה קָטֵגוֹרְיוֹת קְבוּעוֹת מֵרֹאשׁ.",
            definitionNative = "Задача — отнести пример к одной из нескольких заранее заданных категорий.",
            example = "קְלַסִיפִיקַצְיָה שֶׁל אִי-מֵיילִים לִסְפַּאם וְלֹא-סְפַּאם הִיא דֻּגְמָה קְלָאסִית.",
        ...
        WordEntity(
            ...
            definition = "חֲלוּקָה שֶׁל דֻּגְמָאוֹת לְקָבּוּצוֹת דּוֹמוֹת בְּלִי שֶׁאָמְרוּ לַמּוֹדֵל מָה הַתְּשׁוּבָה הַנְּכוֹנָה.",
            definitionNative = "Деление примеров на похожие группы — без подсказки модели, какой ответ правильный.",
            example = "קְלַסְטֶרִינְג שֶׁל לָקוֹחוֹת חָשַׂף שָׁלוֹשׁ קֲבּוּצוֹת קְנִיָּה שׁוֹנוֹת לְגַמְרֵי.",
        ...
        WordEntity(
            ...
            example = "אֶמְבֶּדִינְג שֶׁל הַמִּלִּים מְאַפְשֵׁר חִפּוּשׂ סֶמַנְטִי בְּמַסַּד הַיְּדָע.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "aiml_compute",
            original = "GPU", translation = "GPU",
            definition = "כַּרְטִיס מָאָרֶץ שֶׁמְּחַשֵּׁב מִילְיוֹנֵי פְּעֻלּוֹת מַטְרִיצָה בְּמַקְבִּיל — לֵב הַלְּמִידָה הָעֲמֻקָּה.",
        ...
        WordEntity(
            ...
            definition = "שְׁבָב מְיֻחָד שֶׁל גוּגֶל לְתַהֲלִיכֵי לְמִידָה — מְהִיר מְאוֹד אֲבָל זָמִין רַק בַּעֲנַן שֶׁלָּהֶם.",
            definitionNative = "Спец-чип Google для обучения — очень быстрый, но доступен только в их облаке.",
            example = "אִימַּנּוּ אֶת הַמּוֹדֵל עַל TPU כְּדֵי לְהַסְפִּיק לִפְנֵי הַדֶּדְּלַיְין.",
        ...
        WordEntity(
            ...
            definition = "סְבִיבַת תִּכְנוּת שֶׁל NVIDIA שֶׁמְּאַפְשֶׁרֶת לְהָרִיץ קוֹד מַקְבִּילִי עַל כַּרְטִיסֵי הַמָּסָךְ שֶׁלָּהּ.",
        ...
        WordEntity(
            ...
            definition = "זִכָּרוֹן עַל כַּרְטִיס הַמָּסָךְ שֶׁמַּחְזִיק מִשְׁקְלֵי מוֹדֵל וּבָאצ׳ים בִּזְמַן רִיצָה.",
