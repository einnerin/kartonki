...
object WordDataHebrewLogisticsL3 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "מַסְגָּרוֹת מַתַּכֶת גְּבוֹהוֹת לְהַנָּחַת סְחוֹרָה בְּקוֹמוֹת.",
        ...
        WordEntity(
            ...
            example = "פִּקּוּחַ מְלַאי קַפְּדָנִי מוֹנֵעַ הַזְמָנוֹת מְבֻטָּלוֹת.",
        ...
        WordEntity(
            ...
            example = "מַשָּׂאִית הִתְקָרְבָה לְפֶתַח טְעִינָה מִסְפַּר שָׁלֹשׁ.",
        ...
        WordEntity(
            ...
            example = "תַּכְּנוּן מַסְלוּלִים חָכָם חוֹסֵךְ שָׁעָה בְּכָל סִבּוּב.",
        ...
        WordEntity(
            ...
            example = "תִּזְמוּן מִשְׁלוֹחִים לַחֲנוּיוֹת הַמָּזוֹן נִקְבַּע אֶמֶשׁ.",
        ...
        WordEntity(
            ...
            example = "סְבַב הוֹבָלָה אֶחָד עוֹבֵר בִּשְׁמוֹנֶה חֲנוּיוֹת בָּעִיר.",
        ...
        WordEntity(
            ...
            example = "תַּג אִיתוּר עַל הַמְּכוֹלָה מַסְפִּיק לִשְׁלוֹשִׁים יוֹם.",
        ...
        WordEntity(
            ...
            definition = "פְּגִישָׁה קְצָרָה לִפְנֵי נְסִיעָה עִם הֶסְבֵּר עַל מַסְלוּל וְלְקוֹחוֹת.",
        ...
        WordEntity(
            ...
            example = "חֲלוּקַת מִשְׁמָרוֹת חֲדָשָׁה הִקְלָה עַל נֶהָגֵי הַסּוֹף שָׁבוּעַ.",
        ...
        WordEntity(
            ...
            example = "סְבַב נְהָגִים מוֹנֵעַ מֵעִיפוּת מִדַּרְכֵי שִׁגְרָה.",
        ...
        WordEntity(
            ...
            example = "מִשְׁלוֹחַ נִכְנַס מִסִּין יַגִּיעַ בִּתְחִלַּת הַשָּׁבוּעַ.",
        ...
        WordEntity(
            ...
            definition = "מוּצָר שֶׁעָבַר אֶת כָּל שַׁלַּבֵּי הַיְּצוּר וּמוּכָן לִשְׁלִיחָה לַלָּקוֹחַ.",
