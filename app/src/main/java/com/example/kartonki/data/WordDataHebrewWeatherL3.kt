...
object WordDataHebrewWeatherL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מַדְּעָן שֶׁחוֹקֵר אֶת הָאֲוִיר וְחוֹזֶה מָה יִּקְרֶה בַּשָּׁמַיִם.",
        ...
        WordEntity(
            ...
            definition = "הַגְּבוּל בֵּין אֲוִיר חַם לָאֲוִיר קַר שֶׁבּוֹ הַמֶּזֶג מִשְׁתַּנֶּה מְהֵרָה.",
        ...
        WordEntity(
            ...
            example = "אַנְטִיצִיקְלוֹן יַצִּיב שַׁלָּט בְּכָל הָאֵזוֹר שָׁבוּעַ שָׁלֵם.",
        ...
        WordEntity(
            ...
            definition = "תְּנוּעָה חֲזָקָה וּקְצָרָה שֶׁל אֲוִיר שֶׁמַּפִּילָה כּוֹבָעִים וּמַעֲנַפִּים.",
        ...
        WordEntity(
            ...
            example = "הַטַּיָּס הִזְהִיר עַל טוּרְבּוּלֶנְצְיָה צְפוּיָה מֵעַל הַהָרִים.",
        ...
        WordEntity(
            ...
            definition = "לֹא חַם מִדַּי וְלֹא קַר מִדַּי — אָפְיָנִי לְאֵזוֹרִים בֵּין הַטְּרוֹפִּים לַקֹּטֶב.",
        ...
        WordEntity(
            ...
            definition = "יוֹרֵד בְּכַמּוּת עֲצוּמָה כְּמוֹ מַבּוּל — מָצִּיף רְחוֹבוֹת וְשָׂדוֹת בִּמְהִירוּת.",
