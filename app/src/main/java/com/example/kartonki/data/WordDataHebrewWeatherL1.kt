...
object WordDataHebrewWeatherL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הַשֶּׁמֶשׁ זָרְחָה בַּחַלּוֹן הַחֶדֶר שֶׁלִּי.",
        ...
        WordEntity(
            ...
            definition = "הַגּוּף הַעֲגֹל שֶׁמֵּאִיר אֶת הַלַּיְלָה וּמַחֲלִיף צוּרָה כָּל חֹדֶשׁ.",
        ...
        WordEntity(
            ...
            definition = "אֳפִי הַמֶּזֶג הַשָּׁכִיחַ בְּאֵזוֹר מְסֻיָּם לְאֹרֶךְ שָׁנִים.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁאָנוּ נוֹשְׁמִים — בְּלִי צֶבַע, בְּלִי רֵיחַ וּבְלִי טַעַם.",
        ...
        WordEntity(
            ...
            definition = "יָמִים שֶׁל אֲוִיר יָבֵשׁ וְלוֹהֵט שֶׁמַּגִּיעַ מֵהַמִּדְבָּר וּמֵעִיף אָבָק.",
        ...
        WordEntity(
            ...
            definition = "כְּשֶׁיֵּשׁ הַרְבֵּה אֵדֵי מַיִם בָּאֲוִיר וְקָצַת מַזִּיעִים גַּם בִּצֵל.",
            ...
            exampleNative = "Воздух לַח и тяжёлый — мешает уснуть до самого утра.",
        ...
        WordEntity(
            ...
            definition = "לְהַפֹּךְ לְמוּצָק בִּגְלַל קֹר חָזָק — כְּמוֹ מַיִם שֶׁהוֹפְכִים לְקֶרַח.",
        ...
        WordEntity(
            ...
            definition = "לְהַפֹּךְ מוּצָק לְנוֹזֵל בְּעֶזְרַת חֹם — כְּמוֹ קֶרַח אוֹ שׁוֹקוֹלָד.",
