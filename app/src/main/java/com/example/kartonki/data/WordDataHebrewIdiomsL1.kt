...
object WordDataHebrewIdiomsL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definitionNative = "Покупка вслепую — не знаешь заранее, что именно получишь.",
        ...
        WordEntity(
            ...
            definitionNative = "Самый важный, решающий миг — проверка, кто реально готов.",
        ...
        WordEntity(
            ...
            definitionNative = "Событие вот-вот случится — буквально считаные мгновения до начала.",
        ...
        WordEntity(
            ...
            definitionNative = "Долго и упорно думать над сложной задачей, ища выход.",
        ...
        WordEntity(
            ...
            definitionNative = "Игнорировать проблему вместо решения — делать вид, что её нет.",
