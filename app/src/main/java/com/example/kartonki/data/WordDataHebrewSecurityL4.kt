...
object WordDataHebrewSecurityL4 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "שִׁיחְזוּר מְדֻיָּק שֶׁל מָה שֶּׁקָּרָה כְּדֵי לְהָבִין אֵיךְ זֶה הִתְפַּתֵּחַ.",
        ...
        WordEntity(
            ...
            definition = "תְּעוּדָה הַמַּעֲנִיקָה לְאָדָם זְכוּת לַעֲבֹד כִּשְׁמַר מוּסְמָךְ.",
        ...
        WordEntity(
            ...
            definition = "הֶיתֵּר רִשְׁמִי לִגֶּשֶׁת לָחֳמָרִים סוֹדִיִּים אַחֲרֵי בְּדִיקָה אִישִׁית.",
        ...
        WordEntity(
            ...
            definition = "אָדָם אוֹ קְבוּצָה הַמַּכָּוְּנִים לְהַזִּיק לָאֲתָר אוֹ לְעוֹבְדָיו.",
        ...
        WordEntity(
            ...
            example = "נֹהַל הַסְתַּגְּרוּת הוּפְעַל מִיָּד לְאַחַר הָאַזְעָקָה.",
        ...
        WordEntity(
            ...
            example = "הַשְׁבָּתַת אִיּוּם בּוּצְעָה תּוֹךְ עֶשֶׂר שְׁנִיּוֹת מֵהָאַזְעָקָה.",
        ...
        WordEntity(
            ...
            definition = "פְּגִישָׁה אַחֲרֵי הָאֵירוּעַ לִלְמֹד מָה עָבַד וּמָה לְשַׁפֵּר בַּפַּעַם הַבָּאָה.",
        ...
        WordEntity(
            ...
            example = "תַּקָּנוֹן הַפְעָלָה אוֹסֵר יְרִי בְּלִי אַזְהָרָה קוֹדֶמֶת.",
