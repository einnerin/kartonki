...
object WordDataHebrewDataEngL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "de_realtime",
            ...
            example = "קָאפְקָה מַעֲבִירָה אֶצְלֵנוּ עֶשְׂרִים אֶלֶף אֵירוּעִים בְּשֶׁנִּיָּהּ בִּשְׁעוֹת הַשִּׂיא.",
        ...
        WordEntity(
            ...
            definition = "שֵׁרוּת מֶרְכָּזִי שֶׁמַּעֲבִיר אֵירוּעִים בֵּין מְפַרְסְמִים לְצַרְכָנִים בְּלִי לְצָוֵּד אוֹתָם זֶה לְזֶה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "de_serving",
        ...
        WordEntity(
            ...
            example = "אוֹלְטִיפִּי לֹא מַתְאִים לִשְׁאֵלוֹת שֶׁעוֹבְרוֹת עַל מִילְיוֹנֵי שׁוּרוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "de_governance",
        ...
        WordEntity(
            ...
            definition = "הֶסְכֵּם פוֹרְמָלִי בֵּין צוֹרֵךְ הַמֵּידָע לְבֵין הַסַּפָּק עַל מִבְנֶה וְאֵיכוּת מָה שֶּׁמּוּעֲבָר.",
        ...
        WordEntity(
            ...
            definition = "אִישׁ אַחֲרַאי בָּעֵסֶק שֶׁשּׁוֹמֵר עַל אֵיכוּת הַמֵּידָע וְעַל זֶה שֶׁכָּל אֶחָד מֵבִין מָה הוּא רוֹאֶה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "de_quality_advanced",
        ...
        WordEntity(
            ...
            definition = "סְקִירָה אוֹטוֹמָטִית שֶׁל שָׂדוֹת — טְוָוחֵי עֵרֶךְ, אָחוּז רֵיקִים, פִּזּוּר — לִפְנֵי שֶׁבּוֹנִים פַּייפְּלַיין.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "de_team",
        ...
        WordEntity(
            ...
            definition = "קְבוּצָה אַחְרָאִית עַל הַתַּשְׁתִּית הַמְּשֻׁתֶּפֶת — כְּלִים, שֵׁרַתִּים וְהֶרְשָׁאוֹת לַכָּל הַחֶבְרָה.",
            definitionNative = "Группа отвечает за общую инфраструктуру — инструменты, серверы и доступы для всей фирмы.",
            example = "צֶוֶות פְּלַטְפוֹרְמָה דּוֹחֵף שִׁדְרוּג שֶׁל סְנוֹאוּפְלֵיק בְּכָל הַחֲטִיבָה.",
        ...
        WordEntity(
            ...
            example = "רוֹטַצְיַת תּוֹרָנוּת אֶצְלֵנוּ מִתְחַלֶּפֶת כָּל יוֹם רִאשׁוֹן בַּבֹּקֶר.",
