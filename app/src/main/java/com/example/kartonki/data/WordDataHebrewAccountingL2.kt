...
object WordDataHebrewAccountingL2 {
    ...
    val words: List<WordEntity> get() = listOf(
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ כתוב להוצאת כסף מחשבון בנק עבור מקבל מסוים.",
        ...
        WordEntity(
            ...
            example = "הבנקאי נתן לי פִּנְקָס שֵׁקִים חדש בסניף.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ חודשי לעובד עם פירוט שכר ניכויים והפרשות.",
            definitionNative = "Месячная распечатка от работодателя с разбивкой выплат и удержаний.",
            example = "המנהלת שלחה את ה תְּלוּשׁ מַשְׂכֹּרֶת במייל.",
        ...
        WordEntity(
            ...
            definition = "כל רישום של תנועת כסף או נֶכֶס בספרי החברה.",
        ...
        WordEntity(
            ...
            example = "ה מַחְזוֹר עִסְקִי גדל בעשרים אֲחוּז השנה.",
        ...
        WordEntity(
            ...
            definition = "אָחוּז שמוסיפים לעלות הקנייה כדי לקבוע את מְחִיר המכירה.",
            definitionNative = "Процент, который добавляют к закупочной цене, чтобы получить продажную.",
            example = "החנות גובה תּוֹסֶפֶת מְחִיר של שלושים אָחוּז.",
        ...
        WordEntity(
            ...
            example = "הרישום עבר ל סֵפֶר רָאשִׁי בסוף החודש.",
        ...
        WordEntity(
            ...
            example = "ה סֵפֶר מְכִירוֹת מתעדכן עם כל חשבונית.",
        ...
        WordEntity(
            ...
            example = "כל ספק נכנס ל סֵפֶר רְכִישׁוֹת באותו יום.",
        ...
        WordEntity(
            ...
            example = "רואת החשבון הכינה מַאֲזָן בּוֹחֵן לסוף הרבעון.",
