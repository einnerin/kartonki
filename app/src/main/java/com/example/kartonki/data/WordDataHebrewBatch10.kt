...
object WordDataHebrewBatch10 {
    ...
    val sets = listOf(
        WordSetEntity(id = 1053, name = "Религия и праздники",              description = "Еврейские праздники, традиции и обряды", languagePair = "he-ru", orderIndex = 53,
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "פְּנִיָּה לֶאֱלֹהִים בְּדִבּוּר אוֹ בְּלֵב, בְּיָחִיד אוֹ בְּצִבּוּר.",
            definitionNative = "Обращение к Богу словами или в мыслях, лично или в общине.",
            example = "אָמַרְנוּ תְּפִילַת הַמּוֹצִיא לִפְנֵי הָאֲרוּחָה הַחֲגִּיגִית.",
        ...
        WordEntity(
            ...
            example = "הָיְתָה חֲגִּיגָה גְּדוֹלָה בַּכִּיכָּר עִם מוּסִיקָה וְרִיקּוּדִים.",
        ...
        WordEntity(
            ...
            definition = "אֵשׁ גְּדוֹלָה שֶׁמַּדְלִיקִים בַּחוּץ, בִּמְיֻחָד בְּלָג בָּעֹמֶר.",
            definitionNative = "Большой огонь, зажигаемый на улице, особенно на Лаг ба-Омер.",
            example = "הַיְּלָדִים שָׁרוּ סְבִיב הַמְּדוּרָה בְּלָג בָּעֹמֶר.",
        ...
        WordEntity(
            ...
            example = "בְּשָׁבוּעוֹת נוֹהֲגִים לֶאֱכֹל מַאַכֲלֵי חָלָב.",
        ...
        WordEntity(
            ...
            definition = "חַג יְהוּדִי הַנֶּחְגָּג בִּשְׂרֵפוֹת מְדוּרוֹת, בֵּל\"ג לָעֹמֶר.",
            definitionNative = "Еврейский праздник, отмечаемый кострами, на 33-й день омера.",
            example = "הַיְּלָדִים אָסְפוּ עֵצִים לַמְּדוּרָה שֶׁל לָג בָּעֹמֶר.",
        ...
        WordEntity(
            ...
            definition = "מִבְנֶה זְמַנִּי הַנִּבְנֶה לְחַג הַסֻּכּוֹת, בְּגַגּוֹ פָּלְמִית אוֹ עֲנָפִים.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי נְגִינָה עָשׂוּי מִקֶּרֶן אַיִל שֶׁתּוֹקְעִים בּוֹ בְּרֹאשׁ הַשָּׁנָה.",
        ...
        WordEntity(
            ...
            example = "אִמָּא מַדְלִיקָה נֵרוֹת בְּבוֹא הַשַּׁבָּת וּמְבָרֶכֶת עַל הַהַדְלָקָה.",
        ...
        WordEntity(
            ...
            definition = "נֵרוֹת מְיֻחָדִים שֶׁמַּדְלִיקִים בְּחַנֻּכִּיָּה שְׁמוֹנָה לֵילוֹת בְּחַנֻּכָּה.",
        ...
        WordEntity(
            ...
            definition = "הַפֵּרוֹת הָרִאשׁוֹנִים שֶׁהִבְשִׁילוּ בַּיְּבוּל, שֶׁנָּהֲגוּ לָהָבִיא אוֹתָם לַמִּקְדָּשׁ בְּחַג הַשָּׁבוּעוֹת.",
        ...
        WordEntity(
            ...
            example = "הַיְּלָדִים לָבְשׁוּ תַּחְפּוֹשׂוֹת וּמַסֵּכּוֹת בְּפּוּרִים.",
        ...
        WordEntity(
            ...
            example = "הַגֵּר עָבַר תְּהַלִּיךְ גִּיּוּר וְנִקְלַט בַּקְּהִלָּה.",
