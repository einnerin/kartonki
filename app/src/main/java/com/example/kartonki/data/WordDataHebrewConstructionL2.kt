...
object WordDataHebrewConstructionL2 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            example = "הַמַּשָּׂאִית פֵּרְקָה עֲרֵמַת חָצָץ לְיַד הַבְּנִיָּה.",
        ...
        WordEntity(
            ...
            definition = "לוּחַ קְטַן וְקָשֶׁה שֶׁמַּדְבִּיקִים עַל רִצְפָּה אוֹ קִיר אַמְבַּטְיָה.",
            definitionNative = "Маленькая твёрдая пластина, которую клеят на пол или на стену.",
            example = "הַבַּנַּאי הִדְבִּיק אָרִיחַ נוֹסָף לְיַד הָאַמְבַּטְיָה.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי עִם לַהַב רָחָב לְעִבּוּד אֲדָמָה אוֹ פִּסּוּל סֲלָּעִים.",
        ...
        WordEntity(
            ...
            definition = "עָגַלַּת יָד עִם גַּלְגַּל אֶחָד לְהוֹבָלַת חֹמֶר כָּבֵד בָּאֲתָר.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר נַיָּיָּד שֶׁעוֹשֶׂה חוֹרִים בְּקִיר אוֹ בְּעֵץ בְּזְרִיזוּת.",
            definitionNative = "Переносной прибор, который быстро делает дыры в стене или дереве.",
            example = "הוּא חִבֵּר אֶת הַמְּקַדֵּחַ חַשְׁמַלִּי לַשֶּׁקַע בַּקִּיר.",
        ...
        WordEntity(
            ...
            example = "הוּא בִּקֵּשׁ לִמְדֹּד אֶת הַחַלָּל לִפְנֵי הַחִתּוּךְ.",
