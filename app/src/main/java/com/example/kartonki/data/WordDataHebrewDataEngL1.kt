...
object WordDataHebrewDataEngL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "כָּל מִסְפַּר בָּעַמּוּדָה הַזּוֹ אָמוּר לִהְיוֹת חִיוּבִי.",
        ...
        WordEntity(
            ...
            example = "שָׁלַחְתִּי לְךָ קֹבֶץ עִם כָּל הַמְּכִירוֹת שֶׁל הַחֹדֶשׁ הַשֶּׁעָבָר.",
        ...
        WordEntity(
            ...
            example = "צֵרַפְתִּי מִסְמָךְ עִם הַסְבֵּר עַל הַשֵּׁדוֹת הַחֲדָשִׁים בַּטַּבְלָה.",
        ...
        WordEntity(
            ...
            definition = "כַּמָּה מָקוֹם הַקֹּבֶץ תּוֹפֵס בַּמַּחְשֵׁב — נִמְדָּד בְּמֶגָה אוֹ ג׳יגָה.",
        ...
        WordEntity(
            ...
            example = "כָּל שׁוּרָה בַּטַּבְלָה הַזּוֹ הִיא הַזְמָנָה אַחַת מֵהָאֲתָר.",
        ...
        WordEntity(
            ...
            definition = "קֹבֶץ גָּדוֹל שֶׁמָּכִיל הַעְתָּקָה שְׁלֵמָה שֶׁל הַטַּבְלָה — בְּדֶרֶךְ כְּלָל לְגִבּוּי אוֹ לִבְדִיקָה.",
