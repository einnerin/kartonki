...
object WordDataHebrewBarberL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "טֶכְנִיקָה שֶׁל חֲתִיכָה נְקוּדָתִית בַּקְּצָווֹת לְהֲסָּרַת פְּסֹלֶת.",
            definitionNative = "Точечная подрезка кончиков для удаления повреждённого края.",
            example = "דַּסְטִינְג חַדְּשִׁי שׁוֹמֵר עַל הַתַּסְפֹּרֶת בְּלִי לְקַצֵּר אֹרֶךְ.",
        ...
        WordEntity(
            ...
            example = "הַכָּהוּי הַחָדָשׁ נוֹתֵן עֹמֶק בְּלִי לִפְגֹּעַ בַּקּוֹצָה.",
        ...
        WordEntity(
            ...
            definition = "מִדַּת הַחֹמֶר הַמְּדֻיֶּקֶת לְפִי מִשְׁקָל הַשֵּׂעָר וְעָבְיוֹ.",
        ...
        WordEntity(
            ...
            example = "קֶשֶׁר דִּיסוּלְפִידִי נִשְׁבַּר בַּחֻמְצָה וְנִבְנֶה מֵחָדָשׁ אַחֲרֵי שְׁטִיפָה.",
        ...
        WordEntity(
            ...
            example = "אֱלַסְטִיוּת חַלָּשָׁה רוֹמֶזֶת עַל קוֹצוֹת פַּגּוּעוֹת מֵעֹמֶק.",
        ...
        WordEntity(
            ...
            definition = "מִידַת הַזְּמַן שֶׁתּוֹצָאָה שׁוֹרֶדֶת בְּלִי לְאַבֵּד מֵהַחַדּוּת.",
        ...
        WordEntity(
            ...
            example = "הֲגַנָּה תֶּרְמִית חוֹסֶכֶת נֵזֶק בַּשִּׁמּוּשׁ הַיּוֹמְיוֹמִי.",
        ...
        WordEntity(
            ...
            example = "הָאִידּוּי הַחָדָשׁ עוֹשֶׂה תַּלְתַּלִּים רְחָבִים וְרַכִּים.",
