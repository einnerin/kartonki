...
object WordDataHebrewSchoolL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מוֹסָד מֶמְשַׁלְתִּי שֶׁקּוֹבֵעַ אֶת מֲדִּינִיּוּת הַלִּמּוּדִים בְּכָל בָּתֵּי הַסֵּפֶר.",
        ...
        WordEntity(
            ...
            example = "רֵפוֹרְמַת דּוֹבְרַת הִצִּיעָה לְקַצֵּר אֶת מִסְפַּר הַתַּלְמִידִים בַּכִּתָּה.",
        ...
        WordEntity(
            ...
            definition = "רַעֲיוֹן מֶרְכָּזִי שֶׁעֲבוֹדָה אָקָדֵמִית בָּאָה לְהוֹכִיחַ אוֹ לְבַסֵּס בִּרְאָיוֹת.",
        ...
        WordEntity(
            ...
            definition = "רְשִׁימָה מְסֻדֶּרֶת שֶׁל מֲקוֹרוֹת שֶׁעֲלֵיהֶם נִשְׁעֶנֶת עֲבוֹדָה אָקָדֵמִית.",
        ...
        WordEntity(
            ...
            definition = "כְּתָבָה אָקָדֵמִית שֶׁעָבְרָה בְּדִיקָה שֶׁל מֻמְחִים אָנוֹנִימִיִּים לִפְנֵי פִּרְסוּם.",
            definitionNative = "Научная публикация, которую перед выходом проверили анонимные эксперты в той же области.",
            example = "מַאֲמָר שָׁפוּט נֶחְשַׁב לְמָקוֹר אָמִין בְּעוֹלַם הָאָקָדֶמְיָה.",
        ...
        WordEntity(
            ...
            definition = "גִּישָׁה שֶׁבָּהּ הַיֶּלֶד בּוֹחֵר בְּעַצְמוֹ פְּעִילוּת וְלוֹמֵד דֶּרֶךְ חֳמָרִים מוּחָשִׁיִּים.",
        ...
        WordEntity(
            ...
            example = "הוֹרָאָה מְדֻיֶּרֶת מַצְלִיחָה לְעָזֵּר גַּם לְחַלָּשִׁים וְגַם לְמַצְטַיְּנִים.",
        ...
        WordEntity(
            ...
            example = "לִמּוּד מְבֻסָּס פְּרוֹיֶקְט מַחְלִיף מִבְחָנִים בְּהַצָּגַת חֲקִירָה לַכִּתָּה.",
        ...
        WordEntity(
            ...
            example = "שִׁלּוּב שֶׁל יְלָדִים עִם אוֹטִיזְם דּוֹרֵשׁ סַיַּעַת אִישִׁית בַּכִּתָּה.",
        ...
        WordEntity(
            ...
            definition = "אִישּׁוּר רִשְׁמִי שֶׁמּוֹסָד יָכוֹל לְהַעֲנִיק תְּאָרִים בְּעוֹלַם הַלִּמּוּדִים הַגְּבוֹהִים.",
            definitionNative = "Официальное подтверждение, что заведение вправе присваивать степени в высшей школе.",
            example = "הַמִּכְלָלָה קִבְּלָה הַסְמָכָה אָקָדֵמִית רַק אַחֲרֵי שָׁלוֹשׁ שְׁנוֹת בְּדִיקָה.",
        ...
        WordEntity(
            ...
            example = "מְנַהֵל בֵּית סֵפֶר חָדָשׁ נִכְנַס לְתַפְקִיד בְּסֶפְּטֶמְבֶּר.",
        ...
        WordEntity(
            ...
            definition = "מוֹרֶה שֶׁאַחְרַאי עַל כָּל הַכִּתּוֹת בְּאוֹתוֹ גִיל וּמְתָאֵם בֵּין הַמְּחַנְּכוֹת שֶׁלָּהֶן.",
            definitionNative = "Учитель, который отвечает за все классы одного возраста и согласует работу их классных руководителей.",
            example = "רַכַּז שִׁכְבָה אִרְגֵּן יוֹם עִיּוּן מְשֻׁתָּף לְכָל הַכִּתּוֹת הַשְּׁבִיעִיּוֹת.",
