...
object WordDataHebrewArchL4 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            example = "הַיְסוֹד נִבְנָה מִבֶּטוֹן מְזֻיַּן עָמֹק.",
        ...
        WordEntity(
            ...
            example = "שֶׁלֶד מִבְנֶה מִפְּלָדָה הוּא הַעֲמִיד בְּיוֹתֵר.",
        ...
        WordEntity(
            ...
            definition = "קִיר פְּנִימִי קַל הַמַּפְרִיד חֲדָרִים בְּלִי לָשֵׂאת מִשְׁקָל.",
        ...
        WordEntity(
            ...
            definition = "חֹמֶר רַךְ לְבַנִּיָּה פְּנִימִית שֶׁל קִירוֹת קַלִּים.",
        ...
        WordEntity(
            ...
            definition = "עֲבוֹדָה הַמּוֹנַעַת חֲדִירַת מַיִם דֶּרֶךְ הַגַּג אוֹ הַקִּירוֹת.",
        ...
        WordEntity(
            ...
            example = "הַבַּנַּאי עֶרְבֵּב טִיט טָרִי לִפְנֵי הַשָּׁעָה הַשְּׁמִינִית.",
        ...
        WordEntity(
            ...
            definition = "הַצָּגָה אֳנָכִית שֶׁל הַמִּבְנֶה כְּאִלּוּ נֶחְתָּךְ בְּסַכִּין דִּמְיוֹנִית.",
        ...
        WordEntity(
            ...
            example = "הַבַּיִת הָעוֹמֵד מֵעַל הַמַּפָּל הוּא סֵמֶל אַדְרִיכָלוּת אוֹרְגָנִית.",
        ...
        WordEntity(
            ...
            example = "פִּילַסְטֶר עָדִין מֲעַטֵּר אֶת חֲזִית הַבַּיִת הַקְּלָאסִי.",
        ...
        WordEntity(
            ...
            definition = "פַּס מְעֻטָּר אָפֻּקִּי שֶׁעוֹבֵר לְאֹרֶךְ חֵלֶק עֶלְיוֹן שֶׁל קִיר.",
