...
object WordDataHebrewHealthFitnessL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "תָּכְנִית כְּתוּבָה עִם שְׁלַבִּים וּזְמַנִּים לַחֲזָרָה בִּטּוּחָה לִפְעִילוּת אַחֲרֵי פְּצִיעָה.",
        ...
        WordEntity(
            ...
            example = "אוֹרֶז לָבָן עִם מַדָּד גְּלִיקֵמִי גָּבוֹהַּ לֹא מַתְאִים לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטָה שֶׁל אֲכִילָה בְּחַלּוֹן זְמַן צַר וְהִמָּנְעוּת מֵאֹכֶל בִּשְׁאַר הַשָּׁעוֹת.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטָה שֶׁל יָמִים גְּבוֹהִים וְיַמִּים נְמוּכִים שֶׁל סֻכָּרִים בַּלּוּחַ הַשְּׁבוּעִי.",
            definitionNative = "Чередование высоких и низких дней по сахарам в недельном плане.",
            example = "מַחֲזוֹר פַּחְמֵימוֹת מְשַׁמֵּר מַסַּת שְׁרִיר בִּתְקוּפַת הַרֲזָיָה.",
        ...
        WordEntity(
            ...
            example = "תַּרְגּוּל קְשִׁיבוּת חָמֵשׁ דַּקּוֹת בַּבֹּקֶר מַרְגִּיעַ לִי אֶת הַיּוֹם.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטַת פְּסִיכוֹתֵרַפְּיָה מֻבְנֵית הַמְּלַמֶּדֶת לְזַהוֹת מַחְשְׁבוֹת מְעַוְּתוֹת וּלְשַׁנּוֹת תְּגוּבוֹת.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁל אֲזִילָה רִגְשִׁית וַחֲסַר מוֹטִיבַצְיָה בְּעֲבוֹדָה מִתְמַשֶּׁכֶת תַּחַת לַחַץ.",
            definitionNative = "Эмоциональная опустошённость и потеря мотивации от долгой работы под давлением.",
            example = "תָּשִּׁישׁוּת מִקְצוֹעִית הִכְרִיחָה אוֹתָהּ לָקַחַת חֳדָשָׁיִם חֻפְשָׁה בְּלִי תַשְׁלוּם.",
        ...
        WordEntity(
            ...
            example = "הִיגְיֵנַת שֵׁנָה בְּסִיסִית כּוֹלֶלֶת הַפְסָקַת מָסַךְ שָׁעָה לִפְנֵי הַמִּטָּה.",
        ...
        WordEntity(
            ...
            definition = "מַחֲלָה נַפְשִׁית מְאֻבְחֶנֶת שֶׁל פַּחַד מֻגְזָם וּמְתָמִּיד הַמַּפְרִיעַ לְתִפְקוּד יוֹמְיוֹמִי.",
        ...
        WordEntity(
            ...
            definition = "תְּחוּם הַחוֹקֵר אֶת מַסְלוּל וּמְהִירוּת חֶלְקֵי הַגּוּף בְּלִי לְהִתְיַחֵס לַכֹּחַ.",
        ...
        WordEntity(
            ...
            example = "טְוָוח תְּנוּעָה מָלֵא בַּכָּתֵף נִמְדָּד בְּזָוִית מַעֲלוֹת מֵעַל הָרֹאשׁ.",
        ...
        WordEntity(
            ...
            example = "אָנָלִיזַת הֲלִיכָה בַּמַּעְבָּדָה גִּלְּתָה אִי סִימֶטְרְיָה אַחֲרֵי הַשֶּׁבֶר.",
        ...
        WordEntity(
            ...
            definition = "קַו דִּמְיוֹנִי שֶׁעוֹבֵר דֶּרֶךְ הַגּוּף וּמְשַׁמֵּשׁ נְקֻדַּת אֲחָזוּת לְזָוִית הַתְּנוּעָה.",
            definitionNative = "Воображаемая линия через тело — точка отсчёта для угла движения.",
            example = "מַחְקַר תְּנוּעָה מַגְדִּיר תָּמִיד אֶת צִיר אָנָטוֹמִי לִפְנֵי מְדִידוֹת.",
        ...
        WordEntity(
            ...
            definition = "עִקָּרוֹן שֶׁל הַעֲלָאָה הַדֲרְגָּתִית בִּכָּבֶד אוֹ בְּכַמּוּת לְכָל אִמּוּן עוֹקֵב.",
        ...
        WordEntity(
            ...
            example = "שָׁבוּעַ הַפְחָתָה כָּל אַרְבָּעָה שָׁבוּעוֹת מוֹנֵעַ פְּצִיעוֹת בְּטֶרֶם זְמַן.",
        ...
        WordEntity(
            ...
            definition = "הָעֲצִימוּת שֶׁמֵּעָלֶיהָ הַגּוּף לֹא מַסְפִּיק לְהָזִּין שְׁרִירִים בְּחַמְצָן בִּלְבַד.",
        ...
        WordEntity(
            ...
            definition = "שָׁבוּעוֹת אַחֲרוֹנִים לִפְנֵי תַחֲרוּת שֶׁבָּהֶם מַפְחִיתִים נֶפַח כְּדֵי לְהַגִּיעַ רַעֲנָן.",
