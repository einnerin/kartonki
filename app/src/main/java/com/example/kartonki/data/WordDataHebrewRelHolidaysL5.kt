...
object WordDataHebrewRelHolidaysL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "חוֹקְרֵי הַלִּיטוּרְגְיָה מַשְׁוִוִּים נֻסְחָאוֹת מִתְּקוּפוֹת שׁוֹנוֹת.",
        ...
        WordEntity(
            ...
            definition = "מַעֲרֶכֶת מָאֲזֶרֶת שֶׁל מַעֲשִׂים מְקוּדָּשִׁים סְבִיב דְּמוּת אוֹ אִידֵיאָה אֱלֹהִית.",
            definitionNative = "Связная система священнодействий, выстроенная вокруг божества или сакральной идеи.",
            example = "אַנְתְּרוֹפּוֹלוֹגִים מַשְׁוִוִּים פּוּלְחָן יְהוּדִי לְזֶה שֶׁל עַמֵּי קֶדֶם.",
        ...
        WordEntity(
            ...
            definition = "טֶקֶס הַמְּלַוֶּה מַעֲבַר חַיִּים — לֵדָה, בַּגְרוּת, נִשּׂוּאִין אוֹ פְּטִירָה.",
        ...
        WordEntity(
            ...
            definition = "שִׁלּוּב שִׁכְבוֹת שֶׁל מָסֳּרוֹת שׁוֹנוֹת בְּתוֹךְ טֶקֶס מְקוּדָּשׁ אֶחָד.",
        ...
        WordEntity(
            ...
            example = "אַנְתְּרוֹפּוֹלוֹגִים מְבַכְּרִים מֶחְקָר פְּרַקְסִיס עַל פְּנֵי הַצְהָרוֹת אֱמוּנָה.",
        ...
        WordEntity(
            ...
            example = "מֶחְקַר הַמּוֹעֲדִים בּוֹחֵן אֶת הִתְפַּתְּחוּת הַלּוּחַ הַתַּלְמוּדִי.",
        ...
        WordEntity(
            ...
            definition = "מַעֲרֶכֶת אָקָדֵמִית שֶׁל סִדּוּר אֵרוּעִים וּתְקוּפוֹת לְפִי רֶצֶף הַזְּמַן.",
        ...
        WordEntity(
            ...
            definition = "חֲלוּקָה אָקָדֵמִית שֶׁל זְמַן רָצוּף לִתְקוּפוֹת בַּעֲלוֹת מַאֲפְיָנִים מְשׁוּתָּפִים.",
        ...
        WordEntity(
            ...
            definition = "מַעֲשֶׂה שִׁיטָתִי שֶׁל פֵּרוּשׁ הַטֶּקְסְט הַקָּדוֹשׁ בִּכְלֵי הַחֵקֶר הָאָקָדֵמִי.",
        ...
        WordEntity(
            ...
            definition = "תְּחוּם אָקָדֵמִי הַחוֹקֵר אֶת סִפּוּרֵי חַזַ\"ל וּמַשְׁמְעוּתָם הַסִּפְרוּתִית.",
            definitionNative = "Научная дисциплина, изучающая повествовательное наследие мудрецов и его смысл.",
            example = "אַגָדִיסְטִיקָה מַשְׁוָוֶה גִּרְסָאוֹת שֶׁל סִיפּוּרֵי הַתַּלְמוּד הַבָּבְלִי וְהַיְרוּשַׁלְמִי.",
        ...
        WordEntity(
            ...
            example = "אִיקוֹנוֹגְרַפְיָה שֶׁל פַּסּוּקֵי מְגִלּוֹת מַרְאָה הַשְׁפָּעוֹת בִּיזַנְטִיוֹת.",
        ...
        WordEntity(
            ...
            definition = "מַעֲרֶכֶת אֶמְצָעִים סִפְרוּתִיִּים שֶׁל פִּיּוּטֵי הַחַגִּים — חָרוּז, מִשְׁקָל, רֶמֶז.",
            definitionNative = "Поэтические приёмы праздничных гимнов — рифма, размер, образный намёк.",
            example = "פּוֹאֶטִיקָה לִיטוּרְגִית שֶׁל הַקָּלִּיר נִלְמֶדֶת בָּאוּנִיבֶרְסִיטָאוֹת בָּעוֹלָם.",
