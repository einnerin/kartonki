...
object WordDataHebrewBatch7 {
    ...
    val sets = listOf(
        WordSetEntity(id = 1044, name = "קניות בסופרמרקט",     description = "קניות, מחירים ומוצרים A2/B1",          languagePair = "he-ru", orderIndex = 44),
        WordSetEntity(id = 1045, name = "בית חולים ורפואה",     description = "אשפוז, ניתוחים ורפואה B1/B2",          languagePair = "he-ru", orderIndex = 45),
        WordSetEntity(id = 1046, name = "תחבורה ציבורית",       description = "אוטובוסים, רכבת ורב-קו A2/B1",        languagePair = "he-ru", orderIndex = 46),
    )
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_basics", transliteration = "kupa",
            original = "קֻפָּה", translation = "касса",
            definition = "עֶמְדָּה בְּסּוּפֶּרְמַרְקֶט שֶׁבָּהּ מְשַׁלְּמִים עַל הַקְּנִיּוֹת.",
            definitionNative = "Стойка в супермаркете, где оплачивают покупки.",
            example = "הַתּוֹר בַּקֻּפָּה הָיָה אָרֹךְ לִפְנֵי שַׁבָּת.",
            exampleNative = "Очередь в קֻפָּה была длинной перед субботой.",
        ),
        WordEntity(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_basics", transliteration = "kabala",
            original = "קַבָּלָה", translation = "чек, квитанция",
            definition = "מְסַמֵּךְ הַמְּאַשֵּׁר תַּשְׁלוּם עַל קְנִיָּה.",
            definitionNative = "Документ, подтверждающий оплату покупки.",
            example = "שָׁמַרְתִּי אֶת הַקַּבָּלָה לְמִקְרֶה שֶׁל הַחְזָרָה.",
            exampleNative = "Я сохранил קַבָּלָה на случай возврата.",
        ),
        WordEntity(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_basics", transliteration = "mekhlaka",
            original = "מֵחְלָקָה", translation = "отдел (в магазине)",
            definition = "חֵלֶק מְסֻיָּם בַּסּוּפֶּרְמַרְקֶט הַמַּכִּיל קְבוּצַת מוּצָרִים מְסֻיֶּמֶת.",
            definitionNative = "Определённая часть супермаркета с группой однотипных товаров.",
            example = "מֵחְלָקַת הַקִּירוּר נִמְצֵאת בְּסוֹף הַחֲנוּת.",
            exampleNative = "מֵחְלָקָה холодильников находится в конце магазина.",
        ),
        WordEntity(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_basics", transliteration = "mishkal",
            original = "מַשְׁקָל", translation = "вес, весы",
            definition = "מִדַּת הַכֹּבֶד שֶׁל מוּצָר, אוֹ מַכְשִׁיר לְמִדִּידַת כֹּבֶד.",
            definitionNative = "Мера тяжести товара или прибор для измерения тяжести.",
            example = "הַמַּשְׁקָל שֶׁל הַבָּשָׂר נָתַן מְחִיר אוֹטוֹמָטִי.",
            exampleNative = "מַשְׁקָל мяса автоматически выдал цену.",
        ),
        WordEntity(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "hospital_basics", transliteration = "mekhlaka",
            original = "מִחְלָקָה", translation = "отделение (больничное)",
            definition = "חֵלֶק מְסֻיָּם בְּבֵית חוֹלִים הַמְּתַפֵּל בְּסוּג מְסֻיָּם שֶׁל מַחֲלוֹת.",
            definitionNative = "Определённое отделение больницы, занимающееся определённым видом заболеваний.",
            example = "הָאָב אֻשְׁפַּז בְּמִחְלֶקֶת הַלֵּב.",
            exampleNative = "Отец был госпитализирован в кардиологическую מִחְלָקָה.",
        ),
        WordEntity(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "hospital_basics", transliteration = "ambulans",
            original = "אַמְבּוּלָנְס", translation = "скорая помощь, машина скорой помощи",
            definition = "רֶכֶב מְצֻיָּד לְהוֹבָלַת חוֹלִים וּפְצוּעִים לְבֵית חוֹלִים.",
            definitionNative = "Оснащённый автомобиль для перевозки больных и раненых в больницу.",
            example = "קָרָאנוּ לְאַמְבּוּלָנְס כְּשֶׁאַבָּא אִבֵּד הַכָּרָה.",
            exampleNative = "Мы вызвали אַמְבּוּלָנְס, когда папа потерял сознание.",
        ),
        WordEntity(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "transport_people", transliteration = "nahag",
            original = "נָהָג", translation = "водитель",
            definition = "אָדָם הַמַּנְהִיג כְּלִי רֶכֶב כְּגוֹן אוֹטוֹבּוּס אוֹ מוֹנִית.",
            definitionNative = "Человек, управляющий транспортным средством — автобусом или такси.",
            example = "שָׁאַלְתִּי אֶת הַנָּהָג אֵיזוֹ תַּחֲנָה הִיא הַבָּאָה.",
            exampleNative = "Я спросил נָהָג, какая следующая остановка.",
        ),
        WordEntity(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "transport_basics", transliteration = "maslul",
            original = "מַסְלוּל", translation = "маршрут, трасса",
            definition = "הַדֶּרֶךְ שֶׁבָּהּ נוֹסֵעַ כְּלִי תַּחְבּוּרָה מִמּוֹצָא לְיַעַד.",
            definitionNative = "Путь, по которому движется транспортное средство от начального до конечного пункта.",
            example = "הַמַּסְלוּל שֶׁל הָאוֹטוֹבּוּס עֻדְכַּן בַּלּוּחַ.",
            exampleNative = "מַסְלוּל автобуса обновлён в расписании.",
        ),
        WordEntity(
