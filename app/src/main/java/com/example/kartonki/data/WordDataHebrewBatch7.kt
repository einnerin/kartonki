...
object WordDataHebrewBatch7 {
    ...
    val sets = listOf(
        WordSetEntity(id = 1044, name = "Еда и кулинария: продвинутый 3",            description = "Покупки, цены и товары",          languagePair = "he-ru", orderIndex = 44,
            ...
            level = 2),
        WordSetEntity(id = 1045, name = "Медицина: продвинутый 3",   description = "Госпитализация, операции и медицина", languagePair = "he-ru", orderIndex = 45,
            topic = "Медицина",
            level = 2),
        WordSetEntity(id = 1046, name = "Транспорт: продвинутый 3", description = "Автобусы, поезда и Рав-Кав",     languagePair = "he-ru", orderIndex = 46,
            topic = "Транспорт",
            level = 2),
    )
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "hospital_treatment", transliteration = "teudat shichrur",
            original = "תָּעוּדַת שִחְרוּר", translation = "выписка из больницы; выписной эпикриз",
            definition = "מִסְמָךְ רְשׁמִי הַמְאַשְׁשֵר אֶת שְׁחְרוּר הַשְׁשָּה מוּשְּב הַחוֹלִים.",
        ...
        WordEntity(
            ...
            original = "כְּבִישׁ מָהִיר", translation = "скоростная трасса; автострада",
            definition = "כְּבִישׁ עִם מִסְלוֹלִים מְרֻבְּים לְתְנוּעָה מְהִירָה.",
        ...
        WordEntity(
            ...
            original = "מַסּוֹף נוֹסְעִים", translation = "пассажирский терминал",
            definition = "אוּלָם נוֹסְעִים בְּשְׁדֵה תְּעוּפָה אוֹ נָמֵל לְקַבָּלַת נוֹסְעִים.",
        ...
        WordEntity(
            ...
            original = "צוֹמֶת", translation = "перекрёсток; развязка",
            definition = "נְקוּדַת חִיתּוּךְ שֶׁל שְׁנֵי כְּבִישִׁים אוֹ יוֹתֵר.",
