...
object WordDataHebrewBatch7 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_basics",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_people",
        ...
        WordEntity(
            ...
            definition = "מִשְׁטָח אֲנָכִי בְּחֵנוּת שֶׁמַּצִּיגִים עָלָיו מוּצָרִים לִמְכִירָה.",
            definitionNative = "Горизонтальная поверхность в магазине, на которой выставлены товары.",
            example = "חִיפַּשְׁתִּי אֶת הַשּׁוֹקוֹלָד בְּמַדַּף הַמִּתּוּקִים.",
        ...
        WordEntity(
            ...
            pos = "adjective", semanticGroup = "supermarket_quality",
            original = "טָרִי", translation = "свежий",
            definition = "מָזוֹן שֶׁלֹּא עָבַר עִבּוּד וְנִמְכַּר בְּמַצְּבוֹ הַטִּבְעִי.",
            definitionNative = "Продукт, не прошедший обработку и продаваемый в натуральном виде.",
            example = "הַלֶּחֶם הַטָּרִי נִמְכַּר בַּבֹּקֶר בִּלְבַד.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_labels",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_deals",
        ...
        WordEntity(
            ...
            definition = "הַצָּעָה מְיֻחֶדֶת לִמְכִירַת מוּצָר בְּמְחִיר מוּפְחָת לִזְמַן מוּגְבָּל.",
            definitionNative = "Специальное предложение по продаже товара по сниженной цене на ограниченный срок.",
            example = "יֵשׁ מַבְצָע שֶׁל קְנֵה שְׁנַיִם קַבֵּל שְׁלוֹשָׁה עַל שׁוֹקוֹלָד.",
        ...
        WordEntity(
            ...
            definition = "מַדָּף אוֹ שׁוּרַת מַדָּפִים בְּחַנּוּת שָׁם מְסֻדָּרִים מוּצָרִים לְמֶכֶר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_dairy",
            original = "יוֹגוּרְט", translation = "йогурт",
            definition = "מוּצַר חָלָב מְּחֻמָּץ עָשִׁיר בְּחֶלְבּוֹנוֹת וּבְּחִידְקֵי חָלָב.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_dairy",
            original = "שַׁמֶּנֶת", translation = "сметана",
            definition = "מוּצַר חָלָב שֶׁנּוֹצַר מֵחֶמְאַת חָלָב בַּעַל מְרָקָּם עָבֶה.",
            definitionNative = "Молочный продукт, получаемый из сливок молока, с густой консистенцией.",
            example = "הוֹסַפְתִּי שַׁמֶּנֶת לְמָרָק הַגֶּזֶר.",
            exampleNative = "Я добавил שַׁמֶּנֶת в морковный суп.",
         fillInBlankExclusions = listOf(104418L, 104421L, 104422L, 104423L)),
        WordEntity(
            id = 104420, setId = 1044, languagePair = "he-ru", rarity = "UNCOMMON",
            pos = "noun", semanticGroup = "supermarket_meat",
            original = "נַקְנִיק", translation = "сосиска, колбаса",
            ...
            example = "קָנִיתִי נַקְנִיקִיּוֹת לַמַּנְגָּל בְּשִׁישִׁי.",
            exampleNative = "Я купил נַקְנִיק для мангала в пятницу.",
            isFillInBlankSafe = false,
        ),
        WordEntity(
            id = 104421, setId = 1044, languagePair = "he-ru", rarity = "UNCOMMON",
            pos = "noun", semanticGroup = "supermarket_basics",
            original = "קִטְנִיּוֹת", translation = "бобовые (горох, фасоль, чечевица)",
            definition = "קֲבּוּצַת מָזוֹן הַכּוֹלֶלֶת עֲדָשִׁים, שְׁעוּעִית, חוּמּוּס וְאֶפּוּנָה.",
            definitionNative = "Группа продуктов: чечевица, фасоль, нут, горох.",
            example = "קִטְנִיּוֹת הֵן מָקוֹר מֻצָּלָן לְחֶלְבּוֹן צְמָחוֹנִי.",
        ...
        WordEntity(
            ...
            definition = "חָמְרֵי טַעַם וְרֵיחַ הַמּוּסָפִים לְמָזוֹן לְהַעֲשָׁרַת הַטַּעַם.",
            definitionNative = "Ароматические добавки к пище для усиления вкуса.",
            example = "הִיא הוֹסִיפָה תְּבַלִּין רַבִּים לְמָרָק.",
        ...
        WordEntity(
            ...
            definition = "זְרָעִים קְטַנִּים הַמְּשַׁמְּשִׁים לְבִישּׁוּל, בִּמְיֻחָד בְּלֶחֶם וְסְלָטִים.",
            definitionNative = "Маленькие семена, используемые в кулинарии, особенно для хлеба и салатов.",
            example = "לַחַמָּנִיּוֹת עִם שֻׁמְשּׁוּם פּוֹפּוּלָרִיּוֹת בְּיִשְׂרָאֵל.",
        ...
        WordEntity(
            ...
            definition = "פֵּרוֹת יַבְּשִׁים עֲשִׁירִים בְּשׁוּמָנִים בְּרִיאִים כְּגוֹן שְׁקֵדִים, פִּיסְטוּקִים וְקָשְׁיוּ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "supermarket_basics",
            original = "רִיבָה", translation = "джем, варенье",
            definition = "מַמְרַח פֵּרוֹת מְבֻשָּׁל עִם סֻכָּר הַמְּשַׁמֵּשׁ לִמְרִיחָה עַל לֶחֶם.",
            ...
            exampleNative = "Я приготовил домашнее клубничное רִיבָה из ягод в саду.",
         isFillInBlankSafe = false),
