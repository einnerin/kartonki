...
object WordDataHebrewBatch7 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "hospital_basics", transliteration = "lakhatz dam",
            original = "לַחַץ דָּם", translation = "артериальное давление",
            definition = "כּוֹחַ שֶׁדָּם מַפְעִיל עַל דּוֹפְנוֹת כְּלֵי הַדָּם בְּעֵת זְרִימָה.",
            definitionNative = "Сила, с которой кровь давит на стенки сосудов при движении.",
            example = "הָרוֹפֵא מָדַד אֶת לַחַץ הַדָּם שֶׁלִּי.",
            exampleNative = "Врач измерил моё לַחַץ דָּם.",
        ),
        WordEntity(
