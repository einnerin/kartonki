...
object WordDataHebrewSchoolL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "בְּחִינָה אַרְצִית בְּסוֹף הַתִּיכוֹן הַקּוֹבַעַת זְכָאוּת לִתְעוּדַת סִיּוּם.",
            definitionNative = "Государственный экзамен в конце старшей школы, дающий право на аттестат.",
            example = "מִבְחַן בַּגְרוּת בְּמָתֵמָטִיקָה נֶעֱרַךְ בְּשֶׁקֶט מַתָּן בְּכָל הָאָרֶץ.",
        ...
        WordEntity(
            ...
            example = "צִיּוּן בַּגְרוּת גָּבוֹהַ בְּפִיסִיקָה פָּתַח לוֹ דֶּרֶךְ לָאוּנִיבֶרְסִיטָה.",
        ...
        WordEntity(
            ...
            definition = "יוֹם יְצִיאָה מְאֻרְגָּן שֶׁל כִּתָּה עִם מוֹרִים לַאֲתַר חוּצוֹת אוֹ מוּזֵיאוֹן.",
        ...
        WordEntity(
            ...
            definition = "תְּכוּנָה חוּצוֹת שֶׁל שַׁיִט עַל סִירָה אוֹ אֳנִיָּה לְכִתוֹת בְּחוֹף.",
        ...
        WordEntity(
            ...
            example = "הַמּוֹרָה הִכְנִיסָה חִדּוּשׁ פֶּדָגוֹגִי שֶׁל מִשְׂחֲקֵי תַּפְקִידִים.",
        ...
        WordEntity(
            ...
            definition = "מִסְמַךְ סוֹף שָׁנָה עִם הַצִּיּוּנִים שֶׁל הַתַּלְמִיד בְּכָל הַמִּקְצוֹעוֹת.",
        ...
        WordEntity(
            ...
            example = "תְּעוּדַת בַּגְרוּת מְלֵאָה הִיא תְּנַאי לִרְשׁוּת לַתֹּאַר הָרִאשׁוֹן.",
        ...
        WordEntity(
            ...
            example = "בַּתִּיכוֹן הַתַּלְמִידִים בּוֹחֲרִים מִקְצוֹעוֹת מֻגְבָּרִים לַבַּגְרוּת.",
        ...
        WordEntity(
            ...
            definition = "אֲשׁוּל לִמּוּדִים מֻגְבָּר בְּתָחוּם אֶחָד שֶׁתַּלְמִיד בּוֹחֵר בַּתִּיכוֹן.",
