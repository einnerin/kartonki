...
object WordDataHebrewArchitectureStyles {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190804, setId = 1908, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "בְּבְּרַיְיְטוֹן יֵשׁ רְחוֹבוֹת שְׁלֵמִים שֶׁל בָּתֵּי רֵגֶ׳נְסִי בְּצֶבַע שַׁמֶּנֶת.",
        ...
        WordEntity(id = 190807, setId = 1908, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "אַרְמוֹן רוֹמָנוֹ בְּמַנְטוּאָה הוּא דֻּגְמָה שְׁנוּנָה לְמַנְיֶרִיזְם.",
        ...
        WordEntity(id = 190810, setId = 1908, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "סִגְנוֹן אָמֵרִיקָאִי מֻקְדַּם סְבִיב 1800 — עַמּוּדִים דַּקִּים, חַלּוֹנוֹת מְנִיפָה וְסִימֶטְרִיָּה שַׁלְוָה.",
        ...
        WordEntity(id = 190812, setId = 1908, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תְּנוּעָה אִיטַלְקִית מִלִּפְנֵי מִלְחֶמֶת הָעוֹלָם — פֻּלְחַן הַמְּהִירוּת, הַמְּכוֹנוֹת וְהַמִּגְדָּלִים.",
        ...
        WordEntity(id = 190813, setId = 1908, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "סִגְנוֹן שֶׁל שְׁנוֹת הַשְּׁלוֹשִׁים — פִּנּוֹת מְעֻגָּלוֹת, קַוִּים אָפָּקִיִּים אֲרֻכִּים וּמַרְאֶה שֶׁל אֳנִיָּה.",
            definitionNative = "Стиль 1930-х: скруглённые углы, длинные горизонтальные линии и облик океанского лайнера.",
            example = "מִזְנוֹנֵי מָיָאמִי הַיְשָׁנִים מַצִּיגִים פִּתּוּלֵי סְטְרִימְלַיין מוֹדֶרְן וּכְרוֹם.",
        ...
        WordEntity(id = 190814, setId = 1908, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "בֵּית רִיטְוֵלְד שְׁרוֹדֶר הוּא הַבִּנְיָן הַשָּׁלֵם הַיָּחִיד שֶׁל דֶּה סְטֵייל.",
        ...
        WordEntity(id = 190817, setId = 1908, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "סִגְנוֹן אָמֵרִיקָאִי שֶׁל תְּחִלַּת הַמֵּאָה הָעֶשְׂרִים — גַּגּוֹת נְמוּכִים וְקַוִּים אֳפָקִיִּים צְמוּדִים לַקַּרְקַע.",
        ...
        WordEntity(id = 190818, setId = 1908, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "סִגְנוֹן שֶׁל אֶמְצַע הַמֵּאָה הָעֶשְׂרִים — בֵּטוֹן חָשׂוּף, גּוּשִׁים כְּבֵדִים וְקַוִּים גַּסִּים.",
            definitionNative = "Стиль середины XX века: голый бетон, тяжёлые объёмы и грубые линии.",
            example = "הַרְבֵּה מְשָׂרְדֵי מֶמְשָׁלָה בִּירוּשָׁלַיִם הֵם בְּרוּטָלִיזְם טִיפּוּסִי.",
        ...
        WordEntity(id = 190821, setId = 1908, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "גִּישָׁה שֶׁמְּעָרֶבֶת בְּחֹפֶשׁ חֲלָקִים מִסִּגְנוֹנוֹת הִיסְטוֹרִיִּים שׁוֹנִים בְּבִנְיַן אֶחָד.",
        ...
        WordEntity(id = 190822, setId = 1908, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "כִּינּוּי לְלֵב תֵּל אָבִיב, אֵזוֹר שֶׁל יוֹנֶסְקוֹ עִם רִכּוּז גָּדוֹל שֶׁל בָּתֵּי בַּאוּהָאוּס מֻלְבָּנִים.",
        ...
        WordEntity(id = 190823, setId = 1908, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "וַרְיַאצְיָה מְקוֹמִית שֶׁל הַתְּנוּעָה הַגֶּרְמָנִית, מֻתְאֶמֶת לָחֹם: מִרְפְּסוֹת מֻצְלוֹת וְקִירוֹת לְבָנִים.",
        ...
        WordEntity(id = 190824, setId = 1908, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "סִגְנוֹן הַמּוֹשָׁבוֹת שֶׁל הַתֵּמְפְּלָרִים הַגֶּרְמָנִים בְּאֶרֶץ יִשְׂרָאֵל — אֶבֶן יְרוּשַׁלְמִית וְגַגּוֹת אֲדֻמִּים.",
