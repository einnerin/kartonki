...
object WordDataHebrewCyberL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הַצְפָּנָה סִימֶטְרִית מַתְאִימָה לָקֳבָצִים גְּדוֹלִים בְּגַלְלָ מְהִירוּתָהּ.",
        ...
        WordEntity(
            ...
            definition = "מָתֶמָטִיקָה שֶׁמְּמִירָה כָּל קֹבֶץ לְמַחְרֹזֶת קְצָרָה וּקְבוּעָה — וְלֹא חוֹזֶרֶת אַחוֹרָה.",
