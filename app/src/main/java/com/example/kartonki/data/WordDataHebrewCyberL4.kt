...
object WordDataHebrewCyberL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_pentesting",
        ...
        WordEntity(
            ...
            definition = "צֶוֶות תּוֹקֵף שֶׁמְּחַקֶּה הַתְקָפָה אֲמִתִּית כְּדֵי לִבְחֹן אֶת הַהֲגַנָּה שֶׁל הַחֶבְרָה.",
            definitionNative = "Атакующая команда — имитирует настоящую атаку, чтобы проверить защиту фирмы.",
            example = "רֵד טִים הִצְלִיחַ לְהַגִּיעַ לְ|שֵׁרֶת הַשְּׁכֹר תּוֹךְ שָׁלֹשׁ שָׁעוֹת.",
        ...
        WordEntity(
            ...
            definition = "צֶוֶות מֵגֵן שֶׁמְּזַהֶה תְּקִיפוֹת בִּזְמַן אֱמֶת וְעוֹצֵר אוֹתָן בַּסְּבִיבָה הַחַיָּה.",
            ...
            exampleNative = "בְּלוּ טִים фирмы засёк скан за две минуты.",
        ...
        WordEntity(
            ...
            example = "סְרִיקַת חוּלְשׁוֹת שְׁבוּעִית מֲרִיצָה אֶת נֶסוּס עַל כָּל הַסְּבִיבָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_response",
        ...
        WordEntity(
            ...
            example = "פוֹרֶנְזִיקָה דִּיגִיטָלִית גִּלְּתָה שֶׁהַפּוֹרֵץ נִשְׁאַר בָּרֶשֶׁת חֳדָשָׁיִם.",
        ...
        WordEntity(
            ...
            example = "מֶרְכַּז תַּפְעוּל אַבְטָחָה הוּקַם בַּקַּמְפּוּס אַחֲרֵי הַתְקָפַת הַכֹּפֶר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_governance",
        ...
        WordEntity(
            ...
            example = "אַייסוֹ 27001 הִתְקַבֵּל אַחֲרֵי שָׁנָה וָחֵצִי שֶׁל הֲכָנָה רְצוּפָה.",
        ...
        WordEntity(
            ...
            definition = "דְּרִישָׁה שֶׁמֵּידָע שֶׁל אֶזְרָחֵי מְדִינָה יִשָּׁמֵר רַק עַל שֵׁרַתִּים בְּתוֹךְ הַמְּדִינָה הַזּוֹ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_advanced",
        ...
        WordEntity(
            ...
            definition = "סְרִיקָה וְהַקְשָׁחָה שֶׁל דְּמוּיוֹת דּוֹקֵר וְשֶׁל סְבִיבַת הָרִיצָה לִפְנֵי הַעֲלָאָה לַעֲנָן.",
        ...
        WordEntity(
            ...
            definition = "פְּרִיצָה דֶּרֶךְ סְפָק חִיצוֹנִי שֶׁמַּשְׁפִּיעָה עַל מֵאוֹת חֲבָרוֹת שֶׁמְּשַׁתַּמְּשׁוֹת בָּאוֹתוֹ הַכְּלִי.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_cryptography",
            ...
            example = "הַצְפָּנָה סִימֶטְרִית מַתְאִימָה לַקָּבָצִים גְּדוֹלִים בְּגַלְלַ מְהִירוּתָהּ.",
        ...
        WordEntity(
            ...
            example = "מַפְתֵּחַ צִבּוּרִי מְפֻרְסָם בַּשֶּׁרֶת כָּךְ שֶׁכָּל אֶחָד יָכוֹל לִשְׁלֹחַ הוֹדָעָה מֻצְפֶּנֶת.",
        ...
        WordEntity(
            ...
            definition = "מָתֶמָטִיקָה שֶׁמְּמִירָה כָּל קֹבֶץ לְמַחְרֹזֶת קְצָרָה וּקְבוּעָה — וְלֹא חוֹזֶרֶת אָחוֹרָה.",
            definitionNative = "Математика — превращает любой файл в короткую и постоянную строку, без обратного хода.",
            example = "פוּנְקְצִיַּת גִּיבּוּב מְשַׁמֶּשֶׁת לִשְׁמִירַת סִיסְמָאוֹת בְּלִי לְשַׁמְרָן בְּגָלוּי.",
        ...
        WordEntity(
            ...
            definition = "סִימָן מָתֵמָטִי שֶׁמּוֹכִיחַ שֶׁמִּסְמָךְ נִשְׁלַח עַל יָדֵי אִישׁ סְפֵצִיפִי וְלֹא שֻׁנָּה.",
        ...
        WordEntity(
            ...
            definition = "מַחְרֹזֶת אַקְרָאִית שֶׁמּוֹסִיפִים לְסִיסְמָה — כָּךְ שֶׁשְּׁתֵּי סִיסְמָאוֹת זֵהוֹת יִתֵּנוּ פְּלַט שׁוֹנֶה.",
