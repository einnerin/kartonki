...
object WordDataHebrewStartupL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(178901L, 178902L, 178903L, 178904L, 178906L, 178924L)),
        ...
        WordEntity(
            ...
            example = "לָקוֹחַ יַעַד שֶׁלָּנוּ הוּא חֶשְׁבּוֹנָאִי עַצְמָאִי בְּגִיל אַרְבָּעִים.",
        ...
        WordEntity(
            ...
            definition = "מַעֲמָד שֶׁבּוֹ מַרְאִים לְלָקוֹחַ אֵיךְ הַדָּבָר עוֹבֵד וּמָה הוּא נוֹתֵן לוֹ.",
        ...
        WordEntity(
            ...
            definition = "סִימָן צְיוּרִי קָטָן שֶׁמְּזַהֶה אֶת הַחֶבְרָה עַל אֲרִיזוֹת, אֲתָר וְכְרָטִיסֵי בִּקּוּר.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(178911L, 178912L, 178913L, 178914L)),
        ...
        WordEntity(
            ...
            example = "שָׁלַחְתִּי מִכְתָּב קַר לְשִׁבְעִים מְנַהֲלִים וְקִבַּלְתִּי שָׁלוֹשׁ.",
        ...
        WordEntity(
            ...
            definition = "דִּבּוּר חַי בָּרֶשֶׁת — שׁוֹמְעִים זֶה אֶת זֶה אֲבָל לֹא רוֹאִים פָּנִים.",
            definitionNative = "Живой разговор по сети — слышат друг друга, но лиц не видят.",
            example = "סִיכַּמְנוּ אֶת הָעִסְקָה בְּשִׂיחַת טֶלֶפוֹן קְצָרָה שֶׁל שֶׁבַע דַּקּוֹת.",
        ...
        WordEntity(
            ...
            definition = "הָעִסְקָה שֶׁבָּהּ מִישֶׁהוּ לֹא מֻכָּר מַעֲבִיר כֶּסֶף תְּמוּרַת מָה שֶׁבָּנִינוּ.",
            definitionNative = "Сделка, в которой незнакомый человек переводит деньги за то, что мы построили.",
            example = "הַמְּכִירָה רִאשׁוֹנָה הָיְתָה לְלָקוֹחַ מֵרָמַת גַּן בְּמָאתַיִם שֶׁקֶל.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי הַהָשְׁקָה הִתְחִילָה שָׁנָה שֶׁל צְמִיחָה מְהִירָה וְלֹא צְפוּיָה.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(178921L, 178922L, 178923L, 178924L)),
    )
}
