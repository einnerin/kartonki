...
object WordDataHebrewPmL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_strategy",
            original = "וִיזְיוֹן", translation = "vision (видение продукта)",
            definition = "תְּמוּנָה רְחוֹקָה שֶׁל מָה הַמּוּצָר אָמוּר לִהְיוֹת עוֹד חָמֵשׁ אוֹ עֶשֶׂר שָׁנִים.",
        ...
        WordEntity(
            ...
            definition = "מַשֶּׁהוּ קָשֶׁה לְהַעְתָּקָה שֶׁמָּגֵן עַל הַחֶבְרָה מִתַּחֲרוּת לְאֹרֶךְ שָׁנִים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_growth",
            original = "אַקְטִיבַצְיָה", translation = "activation (активация пользователя)",
            definition = "הָרֶגַע שֶׁבּוֹ מִשְׁתַּמֵּשׁ חָדָשׁ הִגִּיעַ לָעָרֶךְ הָרִאשׁוֹן וְקָלַט בַּמָּה הַמּוּצָר עוֹזֵר לוֹ.",
        ...
        WordEntity(
            ...
            definition = "מַסְגֶּרֶת חָמֵשׁ שְׁלַבִּים שֶׁעוֹקֶבֶת אַחֲרֵי הַמִּשְׁתַּמֵּשׁ מֵהַגַּעַת לַמּוּצָר וְעַד הַמְלָצָה לַחֲבֵרִים.",
        ...
        WordEntity(
            ...
            example = "גְּרוֹאוּת' אֶקְסְפֶּרִימֶנְט עַל מָסַךְ הַתַּשְׁלוּם רָץ בְּמֶשֶׁךְ שְׁבוּעַיִם בִּלְבַד.",
        ...
        WordEntity(
            ...
            example = "קֶצֶב הַנִּסּוּיִים הֻכְפַּל אַחֲרֵי הַשְׁקָעַת זְמַן בְּכֵלֵי בְּדִיקָה אוֹטוֹמָטִיִּים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_advanced",
        ...
        WordEntity(
            ...
            definition = "פְּתִיחַת יְכֹלֶת בִּהֲדַרָּגָה לְאָחוּז גָּדֵל וְהוֹלֵךְ שֶׁל הַקָּהָל לְאוֹרֶךְ יָמִים.",
        ...
        WordEntity(
            ...
            definition = "הַכְרָזָה רִשְׁמִית שֶׁיְּכֹלֶת קַיֶּמֶת תַּפְסִיק לִפְעֹל בְּתַאֲרִיךְ עֲתִידִי יָדוּעַ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_business",
        ...
        WordEntity(
            ...
            definition = "הַחְלָטָה שִׁיטָתִית עַל מֲחִירִים לְפִי תַּחֲרוּת, שׁוּלֵי רֶוַח וְעֶרֶךְ נִתְפָּס לַלָּקוֹחַ.",
        ...
        WordEntity(
            ...
            definition = "אִרְגוּן יְכֹלוֹת הַמּוּצָר לִקְבוּצוֹת מֲ|חִיר שׁוֹנוֹת — חִנָּם, פְּרוֹ וְאַרְגּוּנִי.",
        ...
        WordEntity(
            ...
            example = "מוֹנֵטִיזַצְיָה דֶּרֶךְ מָנוּי חַדְּשִׁי הִתְבָּרְרָה כְּטוֹבָה יוֹתֵר מִפִּרְסוּם.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_skills",
            original = "מַנְהִיגוּת בֵּין-תְּחוּמִית", translation = "cross-functional leadership",
            definition = "הוֹבָלָה שֶׁל אֲנָשִׁים מֵהַנְדָּסָה, עִצּוּב, שִׁוּוּק וּמְכִירוֹת בְּלִי סַמְכוּת רִשְׁמִית עֲלֵיהֶם.",
        ...
        WordEntity(
            ...
            example = "יִשּׁוּב קוֹנְפְלִיקְט בֵּין הָאֵנְגִ'ינִירִינְג לְעִצּוּב נָדְרָשׁ עַל סְדַר עֲדִיפוּיוֹת.",
        ...
        WordEntity(
            ...
            example = "רַייס סִיֵּעַ לְהַחְלִיט בֵּין שְׁתֵּי יַזְּמוֹת שֶׁנִּרְאוּ בְּעֶרֶךְ זֵהוֹת בַּהַתְחָלָה.",
        ...
        WordEntity(
            ...
            example = "מוֹסְקוֹאוּ עָזַר לְצֶוֶות הַמּוּצָר לְסַנֵּן אֶת רְשִׁימַת הָרֶכִּיבִים לִפְנֵי הַשִּׁחְרוּר.",
