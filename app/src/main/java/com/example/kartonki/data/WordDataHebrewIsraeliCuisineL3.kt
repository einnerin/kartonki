...
object WordDataHebrewIsraeliCuisineL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הַשֵּׁף הִקְפִּיד לְקַרֵּם אֶת הַבְּצָלִים לְאַט עַל אֵשׁ נְמוּכָה.",
        ...
        WordEntity(
            ...
            example = "הַחַמִּין הָאַשְׁכְּנַזִּי שׁוֹנֶה מֵהַחַמִּין הַמָּרוֹקָאִי בִּתְבָלִין וּבְמִרְכָּב.",
        ...
        WordEntity(
            ...
            example = "הַמִּטְבָּח הַלְּבָנוֹנִי תּוֹרֵם לָאֹכֶל שֶׁלָּנוּ אֶת הַטָּבּוּלֶה וְהַמַּטְבּוּלִים.",
        ...
        WordEntity(
            ...
            definition = "מָסוֹרֶת בִּשּׁוּל מִתֵּימָן עִם תְּבַלִּינִים חֲרִיפִים, מָרָק עוֹף, חִילְבֶּה וְלַחוֹחַ.",
            definitionNative = "Кулинарная традиция Йемена с острыми приправами, куриным супом, хильбе и лахохом.",
            example = "אֲרוּחַת שִׁשִּׁי בַּמִּטְבָּח הַתֵּימָנִי כּוֹלֶלֶת מָרָק חַם וְלַחוֹחַ טָרִי.",
        ...
        WordEntity(
            ...
            definition = "אָדָם מֻסְמָךְ שֶׁמְּפַקֵּחַ עַל מִטְבָּח אוֹ עַל מִפְעַל לְוַדֵּא שֶׁהָאֳכֵל כָּשֵׁר.",
        ...
        WordEntity(
            ...
            example = "הַסּוּמָק הוּא תַּבְלִין חָמוּץ אָדֹם שֶׁמַּשְׁתַּמְּשִׁים בּוֹ בַּסָּלָּטִים.",
        ...
        WordEntity(
            ...
            example = "הַמִּרְקָם שֶׁל הַחוּמּוּס הַזֶּה חָלָק וְקַטִּיפָתִי בְּלִי גַּרְעִינִים.",
        ...
        WordEntity(
            ...
            definition = "עוּגִיּוֹת מָסוֹרְתִיוֹת מְמֻלָּאוֹת בִּתְמָרִים אוֹ בֶּאֱגוֹזִים — אָפְיָנִי לַמִּזְרָח הַתִּיכוֹן.",
            definitionNative = "Традиционное печенье с начинкой из фиников или орехов — характерно для Ближнего Востока.",
            example = "סָבְתָא הֵכִינָה מַעֲמוּל לְכָל הָאוֹרְחִים שֶׁל חַג הֲרָמָדָאן.",
        ...
        WordEntity(
            ...
            definition = "קִנּוּחַ קַר עַל בָּסִיס חָלָב וְקֹרַח עִם רֹטֶב וֶרֶד וֶאֱגוֹזִים — אָפְיָנִי לַמִּזְרָח הַתִּיכוֹן.",
            definitionNative = "Холодный десерт на молоке и крахмале с розовым сиропом и орехами — характерен для Ближнего Востока.",
            example = "אַחֲרֵי הַמָּנָה הָעִקָּרִית הִזְמַנּוּ מָלָאבִּי קַר לַשֻּׁלְחָן.",
