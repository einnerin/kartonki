...
object WordDataHebrewBureauL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "מִשְׂרַד הַפְּנִים אִשֵּׁר לִי לְהַחְלִיף שֵׁם מִשְׁפָּחָה.",
        ...
        WordEntity(
            ...
            example = "מוֹסָד לְבִיטּוּחַ לְאוּמִי הִכִּיר בִּפְגִיעָה שֶׁלִּי בָּעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            example = "מִשְׂרַד הַחוּץ פִּרְסֵם אַזְהָרַת מַסָּע לְכַמָּה מְדִינוֹת בָּאֵיזוֹר.",
            exampleNative = "מִשְׂרָד הַחוּץ выпустил предупреждение о поездках в несколько стран региона.",
         fillInBlankExclusions = listOf(181001L, 181002L, 181003L, 181004L)),
        ...
        WordEntity(
            ...
            example = "הִגַּשְׁנוּ בַּקָּשָׁה לִדְחִיָּה כִּי אִשְׁתִּי בַּחֹדֶשׁ הַתְּשִׁיעִי.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(181006L, 181007L, 181008L, 181009L)),
        ...
        WordEntity(
            ...
            example = "נָתַתִּי לְאָחִי יִיפּוּי כֹּחַ לְמַכּוֹר אֶת הַדִּירָה בְּמַקּוֹמִי.",
        ...
        WordEntity(
            ...
            example = "הִיא נָתְנָה תַּצְהִיר מֻשְׁבָּע עַל הַתְּאוּנָה שֶׁרָאֲתָה.",
        ...
        WordEntity(
            ...
            definition = "סִימָן דִּיגִיטָלִי מֻצְפַּן הַמְּזַהֶה אָדָם בְּמִסְמָכִים מְקֻוָּנִים בְּלִי לִכְתֹּב בַּיָּד.",
         ...
         fillInBlankExclusions = listOf(181011L, 181012L, 181014L)),
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(181016L, 181017L, 181018L)),
        ...
        WordEntity(
            ...
            definition = "הַחְלָטָה כְּתוּבָה וְסוֹפִית שֶׁל שׁוֹפֵט הַסּוֹגֶרֶת הַתִּיק וְקוֹבַעַת אֶת תּוֹצְאָתוֹ.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(181021L, 181023L, 181024L)),
    )
}
