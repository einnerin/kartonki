...
object WordDataHebrewCyberL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_threats",
         ...
         fillInBlankExclusions = listOf(176702L, 176703L, 176704L, 176705L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176701L, 176703L, 176704L, 176705L)),
        WordEntity(
            id = 176703, setId = 1767, languagePair = "he-ru", rarity = "RARE",
            pos = "noun", semanticGroup = "cyber_threats",
            original = "פִישִׁינְג", translation = "фишинг",
            definition = "מִכְתָּב אוֹ אֲתָר מְזֻיָּף שֶׁמַּטְעֶה אֶת הַמִּשְׁתַּמֵּשׁ לִמְסוֹר פְּרָטִים אִישִׁיִּים.",
         ...
         fillInBlankExclusions = listOf(176701L, 176702L, 176704L, 176705L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176701L, 176702L, 176703L, 176705L)),
        WordEntity(
            id = 176705, setId = 1767, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_threats",
            original = "פְּגִיעוּת יוֹם-אֶפֶס", translation = "уязвимость нулевого дня",
            definition = "חוֹר אַבְטָחָה שֶׁעֲדַיִן לֹא יָדוּעַ לַיַּצְרָן וְאֵין עָלָיו טְלַאי לְהַתְקִין.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176707L, 176708L, 176709L, 176710L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176706L, 176708L, 176709L, 176710L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176706L, 176707L, 176709L, 176710L)),
        WordEntity(
            ...
            example = "הַטֶּלֶפוֹן הַחָדָשׁ נִפְתַּח עִם אִימוּת בִּיּוֹמֶטְרִי בְּתוֹךְ חֲצִי שְׁנִיָּה.",
            exampleNative = "Новый телефон открывается через אִימוּת בִּיּוֹמֶטְרִי за полсекунды.",
         fillInBlankExclusions = listOf(176706L, 176707L, 176708L, 176710L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176706L, 176707L, 176708L, 176709L)),

        // ── cyber_network (5) — сетевая защита и периметр ──
        WordEntity(
            id = 176711, setId = 1767, languagePair = "he-ru", rarity = "RARE",
            pos = "noun", semanticGroup = "cyber_network",
            original = "פַייֶרוֹל", translation = "файрвол (брандмауэр)",
            definition = "מִסְנַן רֶשֶׁת שֶׁבּוֹדֵק כָּל בַּקָּשָׁה נִכְנֶסֶת וְיוֹצֵאת וְחוֹסֵם אֶת הַחֲשׁוּדוֹת.",
            definitionNative = "Сетевой фильтр — проверяет каждый входящий и исходящий запрос и блокирует подозрительные.",
            example = "פַייֶרוֹל שֶׁל הַחֶבְרָה חוֹסֵם גִּישָׁה לְאֲתְרֵי שִׁיתּוּף קְבָצִים.",
        ...
        WordEntity(
            ...
            definition = "תְּעָלָה מֻצְפֶּנֶת בֵּין הַמַּחְשֵׁב לַ|שָּׁרָת — מַסְתִּירָה אֶת הַתְּנוּעָה מֵעֵינַיִם זָרוֹת.",
         ...
         fillInBlankExclusions = listOf(176711L, 176713L, 176714L, 176715L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176711L, 176712L, 176714L, 176715L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176711L, 176712L, 176713L, 176715L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176711L, 176712L, 176713L, 176714L)),

        // ── cyber_app (5) — уязвимости приложений и web ──
        WordEntity(
            id = 176716, setId = 1767, languagePair = "he-ru", rarity = "RARE",
            pos = "noun", semanticGroup = "cyber_app",
            original = "אֶס-קְיוּ-אֶל אִינְגֵ'קְשֶׁן", translation = "SQL-инъекция",
            definition = "תְּקִיפָה שֶׁבָּהּ הַתּוֹקֵף שׁוֹתֵל פְּקוּדַת מַסָּד בְּתוֹךְ טֹפֶס וּמַשִּׂיג גִּישָׁה לִנְתוּנִים.",
         ...
         fillInBlankExclusions = listOf(176717L, 176718L, 176719L, 176720L)),
        WordEntity(
            id = 176717, setId = 1767, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_app",
            original = "אֶקְס-אֶס-אֶס", translation = "XSS (cross-site scripting)",
            definition = "הַחְדָּרַת קוֹד זָר לְדַף אֲתָר כַּדִּי שֶׁיֵּרוּץ בַּדַּפְדְּפָן שֶׁל הַמְבַקֵּר וְיִגְנֹב נְתוּנִים.",
         ...
         fillInBlankExclusions = listOf(176716L, 176718L, 176719L, 176720L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176716L, 176717L, 176719L, 176720L)),
        WordEntity(
            id = 176719, setId = 1767, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_app",
            original = "אוֹוַסְפּ טוֹפּ עֲשָׂרָה", translation = "OWASP top 10",
            definition = "רְשִׁימָה רִשְׁמִית שֶׁל עֲשֶׂרֶת חוֹרֵי הָאַבְטָחָה הַנְּפוֹצִים בְּיוֹתֵר בְּאֲתָרִים.",
         ...
         fillInBlankExclusions = listOf(176716L, 176717L, 176718L, 176720L)),
        WordEntity(
            ...
            example = "הַדְרָכַת קוֹד מְאֻבְטָח חוֹסֶכֶת לַחֶבְרָה הַרְבֵּה בָּעָיוֹת בִּכְלַל הָעֵרֶךְ.",
            exampleNative = "Тренинг по קוֹד מְאֻבְטָח экономит фирме много проблем в продакшне.",
         fillInBlankExclusions = listOf(176716L, 176717L, 176718L, 176719L)),

        // ── cyber_basics (5) — основы криптографии ──
        WordEntity(
            id = 176721, setId = 1767, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_basics",
            original = "הִצָפָּנָה לֹא-סִימֶטְרִית", translation = "асимметричное шифрование",
            definition = "שִׁיטָה שֶׁמַּשְׁתֶּמֶשֶׁת בִּזּוּג קוֹדִים — אֶחָד פּוּמְבִּי לְסִגּוֹּר וְאֶחָד פְּרָטִי לִפְתִיחָה.",
         ...
         fillInBlankExclusions = listOf(176722L, 176723L, 176724L, 176725L)),
        WordEntity(
            ...
            example = "הֵשִׁינְג שֶׁל סִיסְמָה לִפְנֵי שְׁמִירָה מוֹנֵעַ דְּלִיפָה גַּם אִם הַמַּסָּד נִגְנַב.",
            exampleNative = "הֵשִׁינְג пароля перед сохранением предотвращает утечку даже если базу украли.",
         fillInBlankExclusions = listOf(176721L, 176723L, 176724L, 176725L)),
        WordEntity(
            id = 176723, setId = 1767, languagePair = "he-ru", rarity = "RARE",
            pos = "noun", semanticGroup = "cyber_basics",
            original = "סֶרְטִיפִיקַט", translation = "сертификат (TLS/SSL)",
            definition = "מִסְמָךְ דִּיגִיטָלִי שֶׁמּוֹכִיחַ שֶׁאֲתַר הוּא בֶּאֱמֶת מִי שֶׁהוּא טוֹעֵן וְלֹא הַעְתָּקָה מְזֻיֶּפֶת.",
            definitionNative = "Цифровой документ — доказывает, что сайт действительно тот, за кого себя выдаёт.",
            example = "הַדַּפְדְּפָן הִתְרִיעַ שֶׁהַסֶּרְטִיפִיקָט שֶׁל הָאֲתָר פָּג לִפְנֵי שְׁבוּעַיִם.",
        ...
        WordEntity(
            ...
            definition = "פְּרוֹטוֹקוֹל שֶׁעוֹטֵף תִּקְשֹׁרֶת בֵּין דַּפְדְּפָן לְ|שָׂרַת וּמוֹנֵעַ הַאֲזָנָה בָּאֶמְצַע.",
         ...
         fillInBlankExclusions = listOf(176721L, 176722L, 176723L, 176725L)),
        WordEntity(
            ...
            example = "חֲתִימָה דִיגִיטָלִית עַל הַחוֹזֶה הִיא תַּחֲלִיף לְגַלִּי לְעֵט וּנְיָר.",
            exampleNative = "חֲתִימָה דִיגִיטָלִית на договоре — юридический эквивалент ручки и бумаги.",
         fillInBlankExclusions = listOf(176721L, 176722L, 176723L, 176724L)),
    )
}
