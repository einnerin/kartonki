...
object WordDataHebrewBureauL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "עוֹתְרִים פָּנוּ לַבָּג\"ץ נֶגֶד הַחְלָטַת הַשַּׂר.",
        ...
        WordEntity(
            ...
            definition = "בֵּית הַדִּין הָאַחֲרוֹן שֶׁאֶפְשָׁר לִפְנוֹת אֵלָיו לִפְנֵי שֶׁהַתַּיָּק נִסְגַּר סוֹפִית.",
        ...
        WordEntity(
            ...
            example = "הַתְּבִיעָה נִדְחֲתָה בִּגְלַל מַעֲשֵׂה בֵּית דִּין מִתַּיָּק קוֹדֵם.",
        ...
        WordEntity(
            ...
            definition = "סְעִיף הַמְּאַפְשֵׁר לִכְּנֶסֶת לְחוֹקֵק חוֹק לַמְרוֹת פְּסִילָתוֹ עַל יְדֵי בֵּית הַמִּשְׁפָּט.",
        ...
        WordEntity(
            ...
            definition = "עָנָף שֶׁל הַמִּשְׁפָּט הָעוֹסֵק בְּמַבְנֶה הַשִּׁלְטוֹן וּבִיחֲסֵי הָרָשׁוּיוֹת זוֹ לָזוֹ.",
        ...
        WordEntity(
            ...
            definition = "צֶוֶת רִשְׁמִי שֶׁמּוֹקַם כְּדֵי לִבְדּוֹק אֵרוּעַ חָמוּר וּלְהַמְלִיץ עַל אַחְרָיוּת.",
        ...
        WordEntity(
            ...
            definition = "הֲגַנָּה מִשְׁפָּטִית מְיֻחֶדֶת לְחֶבְרֵי כְּנֶסֶת מִפְּנֵי תְּבִיעוֹת בִּגְלַל פְּעִילוּתָם הַצִּבּוּרִית.",
