...
object WordDataHebrewAiMlL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "aiml_basic_concepts",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "aiml_basic_tools",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "aiml_basic_tools",
        ...
        WordEntity(
            ...
            example = "הַמְּתַרְגֵּם תִּרְגֵּם לִי תַּפְרִיט שָׁלֵם בַּמִּסְעָדָה הָאִיטַלְקִית.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "aiml_basic_actions",
        ...
        WordEntity(
            ...
            example = "לְקַבֵּל תְּשׁוּבָה מֲהִירָה הוּא הַיִּתְרוֹן הַגָּדוֹל בִּצְ'אטים אֵלֶּה.",
        ...
        WordEntity(
            ...
            example = "נִסִּיתִי לְהָפִיק תְּמוּנָה שֶׁל חָתוּל אַסְטְרוֹנָאוּט עַל הַיָּרֵחַ.",
        ...
        WordEntity(
            ...
            example = "רֶמֶז קָטָן וּמְדֻיַּק נוֹתֵן בְּדֶרֶךְ כְּלָל תּוֹצָאָה טוֹבָה יוֹתֵר.",
        ...
        WordEntity(
            ...
            example = "שַׂמְתִּי לֵב לִשְׁגִיאָה גְּדוֹלָה בִּתְשׁוּבַת הַצַּ'אט הַבֹּקֶר.",
