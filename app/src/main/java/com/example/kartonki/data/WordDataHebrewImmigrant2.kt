...
object WordDataHebrewImmigrant2 {
    ...
    val sets = listOf(
        WordSetEntity(id = 1026, name = "Дом и быт",  description = "Договор, депозит, хозяин", languagePair = "he-ru", orderIndex = 26, topic = "Дом и быт", level = 2),
        WordSetEntity(id = 1027, name = "Дом и быт",  description = "Газ, счётчик, квитанции, мусор",        languagePair = "he-ru", orderIndex = 27, topic = "Дом и быт", level = 2),
                    )
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "הַסְכֵּם שֶׁבּוֹ מִישֶׁהוּ מְשַׁלֵּם לָגוּר בִּנְכַס שֶׁל אַחֵר לִתְּקוּפָה מְסוּיֶּמֶת.",
        ...
        WordEntity(
            ...
            example = "הַבְּנִיַּן שֶׁלָּנוּ יֵשׁ לוֹ שֵׁשׁ קוֹמוֹת.",
        ...
        WordEntity(
            ...
            definition = "הַבְּעָלִים שֶׁל הַדִּירָה הַמַּשְׂכִּירִים אוֹתָהּ לַשּׁוֹכֵר.",
            definitionNative = "Владелец квартиры, сдающий её арендатору.",
            example = "הַמַּשְׂכִּיר אָסַר עַל חַיּוֹת בַּדִּירָה.",
        ...
        WordEntity(
            ...
            example = "הַדַּלָּן לָקַח דְּמֵי תִּיֻּוּוּךְ שֶׁל מֶחֱצִית חוֹדֶשׁ.",
        ...
        WordEntity(
            ...
            definition = "רָמָה אַחַת בְּבִנְיַן שֶׁבָּהּ נִמְצָאוֹת הַדִּירוֹת.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר הַמַּעֲלֶה וּמוֹרִיד אֲנָשִׁים בֵּין קוֹמוֹת הַבְּנִיַּן.",
        ...
        WordEntity(
            ...
            definition = "חֶדֶר קָטָן לְאִחְסוּן חֲפָצִים שֶׁאֵין מֵקוֹם לָהֶם בַּדִּירָה.",
            definitionNative = "Маленькая комната для хранения вещей, которым нет места в квартире.",
            example = "שָׂמָנוּ אֶת הָאוֹפַנַּיִם בַּמַּחְסָן.",
        ...
        WordEntity(
            ...
            definition = "שֶׁטַח פָּתוּחַ לְיַד הַבַּיִת אוֹ הַבְּנִיַּן.",
        ...
        WordEntity(
            ...
            example = "וַעַד הַבַּיִת גּוֹבֶה תַּשְׁלוּם חוֹדְשִׁי לְאֶחְזָקַת הַבְּנִיַּן.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "housing",
            original = "מוֹדָעָה", translation = "объявление",
            ...
            example = "מָצָאנוּ אֶת הַדִּירָה הַזֹּאת דֶּרֶךְ מוֹדָעָה בְּאֲתַּר שְׂכִירוּת.",
            exampleNative = "Мы нашли эту квартиру через מוֹדָעָה на сайте аренды.",
        ),
        ...
        WordEntity(
            ...
            definition = "דֶּלֶק לְבִּישּׁוּל וְחִמּוּם הַמְּסוּפָּק דֶּרֶךְ צִנּוֹרוֹת אוֹ בָּלּוֹנִים.",
            definitionNative = "Топливо для приготовления пищи и обогрева, подаваемое через трубы или баллоны.",
            example = "שִׁלַּמְתִּי אֶת חֶשְׁבּוֹן הַגַּז הַחוֹדְשִׁי הַיּוֹם.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר הַמּוֹדֵד כַּמּוּת צְרִיכַת חַשְׁמַל, גַּז אוֹ מַיִם.",
        ...
        WordEntity(
            ...
            example = "יֵשׁ לִי חוֹב לְחֶבְרַת הַגַּז מֵהַחוֹדֶשׁ הַשַּׁעֲבָר.",
        ...
        WordEntity(
            ...
            definition = "מְעָבָּר מְחֻבַּר לְהַעֲבָרַת מַיִם, גָּז אוֹ נוֹזְלִים אֲחֵרִים.",
        ...
        WordEntity(
            ...
            definition = "תְּהֲלִיךְ עִיבּוּד מֵחָדָשׁ שֶׁל חֲפָצִים לְהַפְחָתַת פְּסֹלֶת.",
            definitionNative = "Процесс повторной обработки предметов для сокращения отходов.",
            example = "יֵשׁ פַּחֵי מִחְזוּר נְפְרָדִים לִנְיָר, זְכוּכִית וּפְּלַסְטִיק.",
        ...
        WordEntity(
            ...
            example = "הִזְמַנְּתִּי חֱבִילָה שֶׁל כֶּבֶל בֵּינְלְאוּמִית.",
        ...
        WordEntity(
            ...
            definition = "תְּהֲלִיךְ הֲשָׁבַת מַכְשִׁיר אוֹ מִבְנֶה לְפַעֲלוּתוֹ הַתְּקִינָה.",
        ...
        WordEntity(
            ...
            definition = "דְּרִישַׁת תַּשְׁלוּם בְּחֶשְׁבּוֹן עַל שֶׁמּוּשׁ בְּשֵׁרוּת.",
            definitionNative = "Запись дебета на счёте за использование сервиса.",
            example = "רָאִיתִי חַיּוּב חָדָשׁ מֵחֶבְרַת הַגַּז בַּחֶשְׁבּוֹן.",
        ...
        WordEntity(
            ...
            example = "הִגְדַּרְתִּי הוֹרָאַת קֶבַע לְחֶשְׁבּוֹן הַגַּז.",
