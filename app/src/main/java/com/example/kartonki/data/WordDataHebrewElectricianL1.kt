...
object WordDataHebrewElectricianL1 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר קָטָן עִם בַּטְּרִיָּה שֶׁמֵּאִיר בַּחֹשֶׁךְ כְּשֶׁאֵין אוֹר בַּחֶדֶר.",
        ...
        WordEntity(
            ...
            example = "תָּא בַּטְּרִיָּה הָיָה רָטוֹב וְהַשָּׁעוֹן הִפְסִיק לַעֲבוֹד.",
        ...
        WordEntity(
            ...
            example = "תֶּקַע מַאֲרִיךְ כָּחוֹל שַׂמְנוּ מֵאֲחוֹרֵי הַסַּפָּה.",
        ...
        WordEntity(
            ...
            example = "מַתַּג קִיר נִשְׁבַּר וְעַכְשָׁו הָאוֹר דּוֹלֵק כָּל הַזְּמַן.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי עִם שְׁלַבֵּי עֲלְיָה לְהַגִּיעַ לִמְקוֹמוֹת גְּבוֹהִים בַּתִּקְרָה אוֹ בַּקִּיר.",
            definitionNative = "Приспособление со ступенями для подъёма к высоким местам в потолке или стене.",
            example = "הַסּוֹלָם הָיָה רָעוּעַ קְצָת וְלָכֵן רָעַד תַּחְתֵּיהֶם.",
        ...
        WordEntity(
            ...
            definition = "אֶפְשָׁרוּת שֶׁאָדָם יִפָּגַע מֵרֶזְרֶם חָזָק כְּשֶׁהוּא נוֹגֵעַ בַּחוּטִים.",
        ...
        WordEntity(
            ...
            definition = "עֲנַן אָפֹר אוֹ שָׁחֹר שֶׁעוֹלֶה כְּשֶׁמַּשֶּׁהוּ נִשְׂרַף אוֹ מִתְחַמֵּם מִדַּי.",
        ...
        WordEntity(
            ...
            example = "רֵיחַ שְׂרִיפָה הִגִּיעַ מֵהַלּוּחַ וְכִבִּינוּ הַכֹּל מִיָּד.",
