...
object WordDataHebrewInterview {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_resume",
        ...
        WordEntity(
            ...
            example = "כָּתַבְתִּי מִכְתַּב מְלַוֶּה אִישִׁי לְכָל מִשְׂרָה בְּנִפְרָד.",
        ...
        WordEntity(
            ...
            definition = "דַּף אִישִׁי בָּרֶשֶׁת הַמִּקְצוֹעִית שֶׁמַּגְיֵיסִים סוֹרְקִים לְאִתּוּר מֻעָמָדִים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_recruiter",
            original = "מְגַיֵּיס", translation = "рекрутер",
            definition = "אִישׁ שֶׁמְּחַפֵּשׂ אֲנָשִׁים מַתְאִימִים לְמִשְׂרוֹת בְּחֶבְרוֹת שׁוֹנוֹת.",
        ...
        WordEntity(
            ...
            definition = "שָׁלָב רִאשׁוֹנִי שֶׁל סִינּוּן מֻעָמָדִים לְפִי קוֹרוֹת חַיִּים וְשִׂיחָה קְצָרָה.",
        ...
        WordEntity(
            ...
            definition = "חֶבְרָה חִיצוֹנִית שֶׁמְּחַבֶּרֶת בֵּין מֻעָמָדִים לְבֵין מַעֲסִיקִים תְּמוּרַת עֲמָלָה.",
        ...
        WordEntity(
            ...
            example = "צַיַּד רָאשִׁים פָּנָה אֵלַי בְּלִינְקְדְאִין עִם הַצָּעָה דִּיסְקְרֵטִית.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_first_call",
        ...
        WordEntity(
            ...
            example = "הַחֶבְרָה הֶעֱדִיפָה פוֹרְמַט הַעֲסָקָה מָלֵא בִּלְבַד, לֹא פְרִילַנְס.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_experience",
        ...
        WordEntity(
            ...
            definition = "הַמִּשְׂרָה שֶׁבָּהּ הַמֻּעָמָד עָבַד לִפְנֵי שֶׁעָזַב לְחַפֵּשׂ מַשֶּׁהוּ חָדָשׁ.",
        ...
        WordEntity(
            ...
            example = "סִיָּמְתִּי תֹּאַר רִאשׁוֹן בְּמַדְעֵי הַמַּחְשֵׁב בָּאוּנִיבֶרְסִיטָה הָעִבְרִית.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_motivation",
        ...
        WordEntity(
            ...
            definition = "הַתְּכוּנוֹת שֶׁבָּהֶן אַתָּה הֲכִי טוֹב — מָה שֶּׁאַתָּה מַצְלִיחַ בּוֹ לְלֹא מַאֲמָץ.",
        ...
        WordEntity(
            ...
            definition = "הַהֶסְבֵּר שֶׁל מֻעָמָד מַדּוּעַ הוּא עוֹזֵב אֶת הַמָּקוֹם שֶׁבּוֹ הוּא עוֹבֵד עַכְשָׁיו.",
            definitionNative = "Объяснение кандидата — почему он уходит с нынешнего места работы.",
            example = "סִבָּה לַעֲזִיבָה הַטֶּבֱעִית הָיְתָה רָצוֹן לִתְחוּם חָדָשׁ.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶׁמֻּעָמָד שׁוֹאֵל בַּסּוֹף עַל הַחֶבְרָה כְּדֵי לְהַרְאוֹת עִנְיָן רְצִינִי.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_tech",
        ...
        WordEntity(
            ...
            example = "הִשְׁקַעְתִּי שִׁישָּׁה לֵילוֹת בָּהֳוָם אַסַיְינְמֶנְט שֶׁל הַסְּטַרְטְאַפּ.",
        ...
        WordEntity(
            ...
            definition = "סוּג רֵאָיוֹן שֶׁבּוֹ דָּנִים אֵיךְ בּוֹנִים מַעֲרֶכֶת גְּדוֹלָה מֵהַתְחָלָה עַל לוּחַ.",
            definitionNative = "Тип интервью: обсуждают, как с нуля построить большую систему — на доске.",
            example = "סִיסְטֶם דִּיזַיְין דָּרַשׁ לְפָרֵט מַאֲגַר מֵידָע, קֶשֶׁ וְתוֹר הוֹדָעוֹת.",
        ...
        WordEntity(
            ...
            definition = "פוֹרְמָט שֶׁל קְצָת זוּג — מְרַאֲיֵין וּמֻעָמָד כּוֹתְבִים בְּיַחַד עַל אוֹתוֹ עוֹרֵךְ.",
            definitionNative = "Формат «в паре»: интервьюер и кандидат пишут вместе в одном редакторе.",
            example = "פֶּר פְּרוֹגְרָמִינְג עָזַר לְהַרְאוֹת אֵיךְ אֲנִי שׁוֹאֵל וּמְקַבֵּל הַצָּעוֹת.",
        ...
        WordEntity(
            ...
            definition = "לוּחַ מָחִיק לָבָן שֶׁעָלָיו הַמֻּעָמָד כּוֹתֵב קוֹד אוֹ דְּיַאגְרָמָה לִפְנֵי הַשּׁוֹאֵל.",
            definitionNative = "Белая маркерная доска — кандидат пишет на ней код или схему перед интервьюером.",
            example = "וַיְיטְבּוֹרְד הָיָה מָלֵא בִּדְיַאגְרָמוֹת בְּסוֹף הַשִּׂיחָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_behavioral",
            original = "רֵאָיוֹן הִתְנַהֲגוּתִי", translation = "поведенческое интервью",
            definition = "רֵאָיוֹן שֶׁל סִיפּוּרִים עַל מַצַּבֵּי עָבָר אֲמִיתִּיִּים בִּמְקוֹם שְׁאֵלוֹת תֵּיאוֹרֶטִיּוֹת.",
            definitionNative = "Интервью на историях из реального прошлого — вместо теоретических вопросов.",
            example = "רֵאָיוֹן הִתְנַהֲגוּתִי שָׁאַל עַל קוֹנְפְלִיקְט עִם עָמִית בְּפְרוֹיֶקְט קָשֶׁה.",
        ...
        WordEntity(
            ...
            definition = "כִּשּׁוּרִים בֵּינְאִישִׁיִּים כְּמוֹ תִּקְשׁוֹרֶת, הַקְשָׁבָה וַעֲבוֹדַת צֶוֶות, לֹא טֶכְנִיּוֹת.",
        ...
        WordEntity(
            ...
            definition = "הַתְאָמָה שֶׁל הָאָדָם לַסְּגָנּוֹן וְלָעֲרָכִים שֶׁל הַחֶבְרָה הַסְּפֵצִיפִית.",
        ...
        WordEntity(
            ...
            definition = "יְכוֹלֶת לְהַנְחוֹת אֲחֵרִים לְעֵבֶר מַטָּרָה מְשֻׁתֶּפֶת בְּלִי לְהַפְעִיל כֹּחַ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_offer",
            ...
            example = "קִבַּלְתִּי אוֹפֶר טוֹב מֵאַרְבָּעָה רְאַיּוֹנוֹת בְּסַךְ הַכֹּל.",
        ...
        WordEntity(
            ...
            definition = "הַתַּאֲרִיךְ הָאַחֲרוֹן שֶׁבּוֹ מֻעָמָד צָרִיךְ לְהַחְלִיט אִם הוּא חוֹתֵם עַל הַהַצָּעָה.",
        ...
        WordEntity(
            ...
            definition = "הַסְּכוּם הַחָדְשִׁי הַקָּבוּעַ שֶׁעוֹבֵד מְקַבֵּל בְּלִי בּוֹנוּסִים אוֹ אוֹפְּצְיוֹת.",
            definitionNative = "Постоянная месячная сумма для сотрудника — без бонусов и опционов.",
            example = "שָׂכָר בָּסִיס הָיָה גָּבוֹהַּ אֲבָל הַמַּסְלוּל הָאָרוּךְ דַּל יוֹתֵר.",
        ...
        WordEntity(
            ...
            example = "חֲבִילָה כּוֹלֶלֶת בְּגוּגָל מִתְקָרֶבֶת לַחֲצִי מִילְיוֹן שֶׁקֶל לַשָּׁנָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_equity",
            ...
            example = "אֶקְוִוִיטִי בִּסְטַרְטְאַפּ מֻקְדַּם שָׁוֶה הַרְבֵּה אוֹ כְּלוּם.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "interview_negotiation",
        ...
        WordEntity(
            ...
            definition = "תְּגוּבָה שֶׁל מֻעָמָד עַל הַהַצָּעָה הָרִאשׁוֹנִית עִם תְּנָאִים אֲחֵרִים אוֹ שׂוֹנִים.",
            definitionNative = "Ответ кандидата на исходное предложение — с другими или изменёнными условиями.",
            example = "הַצָּעָה שֶׁכְּנֶגֶד שֶׁלִּי הִכְנִיסָה עוֹד שָׁבוּעַ חֻפְשָׁה לַהֲסְכֵּם.",
        ...
        WordEntity(
            ...
            definition = "מַאֲמָץ שֶׁל הַחֶבְרָה לִשְׁמֹר עוֹבֵד טוֹב בְּעֵת הַזְמָנָה לְמָקוֹם אַחֵר.",
        ...
        WordEntity(
            ...
            definition = "סְכוּם אוֹ תְּנַאי שֶׁמִתַּחַת לָהֶם הַמֻּעָמָד מַחְלִיט מִכָּתְחִילָה לֹא לַחְתֹּם.",
        ...
        WordEntity(
            ...
            example = "הַבְטָחַת הַעֲבָרָה כִּסְּתָה דִּירָה זְמַנִּית וְטִיסוֹת לַמִּשְׁפָּחָה.",
