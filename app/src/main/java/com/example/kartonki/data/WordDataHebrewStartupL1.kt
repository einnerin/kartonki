...
object WordDataHebrewStartupL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "קְהִילַּת הַיְּזָמִים בְּיִשְׂרָאֵל נֶחְשֶׁבֶת בֵּין הַחֲזָקוֹת בָּעוֹלָם.",
        ...
        WordEntity(
            ...
            example = "מַשְׁקִיעַ מֵאָמֵרִיקָה הִתְעַנְיֵן בָּרַעְיוֹן שֶׁלָּנוּ אַחֲרֵי הַכֶּנֶס.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁשָּׂמִים מֵהַחִסָּכוֹן הָאִישִׁי כְּדֵי לְהַתְחִיל בְּלִי לְבַקֵּשׁ מֵאַף אֶחָד.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁנִּשְׁאַר מֵהַכֶּסֶף שֶׁל הַלָּקוֹחוֹת אַחֲרֵי שֶׁמְּשַׁלְּמִים עַל הַכֹּל.",
            definitionNative = "То, что остаётся от клиентских денег после оплаты всех расходов.",
            example = "רֶוַח קָטָן מִכָּל לָקוֹחַ הוֹפֵךְ לְסָכּוּם רְצִינִי בְּסוֹף הַשָּׁנָה.",
        ...
        WordEntity(
            ...
            definition = "כְּשֶׁהוֹצִיאוּ יוֹתֵר כֶּסֶף מִמָּה שֶּׁהִכְנִיסוּ וְנִשְׁאָרִים בְּמִינוּס.",
        ...
        WordEntity(
            ...
            definition = "כְּשֶׁעֵסֶק לֹא הַצְלִיחַ וְצָרִיךְ לִסְגֹּר אוֹתוֹ אַחֲרֵי שֶׁהַכֶּסֶף נִגְמַר.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁמְּבִינִים אַחֲרֵי דָּבָר שֶׁלֹּא הָלַךְ טוֹב כְּדֵי לֹא לַחְזֹר עָלָיו.",
            definitionNative = "То, что осознают после неудачного дела — чтобы его не повторять.",
            example = "מַסְקָנָה חֲשׁוּבָה מֵהָרִבְעוֹן הַזֶּה הִיא לְדַבֵּר עִם הַשּׁוּק מֻקְדַּם יוֹתֵר.",
