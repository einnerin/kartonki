...
object WordDataHebrewBatch6 {
    ...
    val sets = listOf(
        WordSetEntity(id = 1041, name = "Спорт",         description = "Спорт, фитнес и тренировки",    languagePair = "he-ru", orderIndex = 41,
            topic = "Спорт",
            level = 2),
        WordSetEntity(id = 1042, name = "Еда и кулинария",        description = "Заказ еды, меню и обслуживание",   languagePair = "he-ru", orderIndex = 42,
            topic = "Еда и кулинария",
            level = 2),
        WordSetEntity(id = 1043, name = "Еда и кулинария",      description = "Готовка, рецепты и кухонная утварь", languagePair = "he-ru", orderIndex = 43,
            topic = "Еда и кулинария",
            level = 2),
    )
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "מִשְׂחָק קְבוּצָתִי שֶׁבּוֹ מְנַסִּים לְהַכְנִיס כַּדּוּר לִשְׁעַר הַיְּרִיב.",
        ...
        WordEntity(
            ...
            definition = "תְּנוּעָה שֶׁמַּאֲרִיכָה שְׁרִירִים לִפְנֵי אוֹ אַחֲרֵי אִמּוּן.",
            definitionNative = "Движение, растягивающее мышцы до или после тренировки.",
            example = "חָשׁוּב לַעֲשׂוֹת מְתִיחוֹת לִפְנֵי הָרִיצָה כְּדֵי לְמַנּוֹעַ פְּצִיעוֹת.",
        ...
        WordEntity(
            ...
            example = "הוּא הוֹלֵךְ לְמָכּוֹן כּוֹשֵׁר שָׁלוֹשׁ פְּעָמִים בְּשָׁבוּעַ.",
        ...
        WordEntity(
            ...
            definition = "מִשְׂחָק קְבוּצָתִי שֶׁבּוֹ מְנַסִּים לְהַכְנִיס כַּדּוּר לְסַל הַיְּרִיב.",
            definitionNative = "Командная игра, в которой нужно забросить мяч в корзину соперника.",
            example = "הַנַּעֲרִים מְשַׂחֲקִים כַּדּוּרְסַל בְּמִגְרַשׁ הַשְּׁכוּנָה.",
        ...
        WordEntity(
            ...
            definition = "תַּחֲרוּת מְהִירוּת בֵּין מִשְׁתַּתְּפִים לְהַגִּיעַ לַיַּעַד רִאשׁוֹן.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי אִמּוּן כָּבֵד הַמֻּחְזָק בַּיָּד לְחִיזּוּק שְׁרִירִים.",
            definitionNative = "Тяжёлый спортивный снаряд, удерживаемый в руке для укрепления мышц.",
            example = "הוּא מְרִיָם מַשְׁקֹלֶת כְּדֵי לְחַזֵּק אֶת הַזְּרוֹעוֹת.",
        ...
        WordEntity(
            ...
            definition = "תַּרְגִילֵי הַרְגָּעָה לְאַחַר אִמּוּן לְמֶנִּיעַת כְּאֵבֵי שְׁרִירִים.",
        ...
        WordEntity(
            ...
            original = "שְׁרִירִים", translation = "мышцы",
            ...
            example = "אַחֲרֵי חֹדֶשׁ אִמּוּן הַשְׁרִירִים שֶׁלּוֹ הִתְחַזְּקוּ.",
            exampleNative = "После месяца тренировок его שְׁרִירִים окрепли.",
        ),
        WordEntity(
            ...
            example = "הִיא זָכְתָה בַּמֵּדַלְיָה בַּתַּחֲרוּת הָאֲזּוֹרִית.",
        ...
        WordEntity(
            ...
            definition = "מִשְׂחָק קְבוּצָתִי שֶׁבּוֹ מַעֲבִירִים כַּדּוּר מֵעַל רֶשֶׁת לְצַד הַיְּרִיב.",
        ...
        WordEntity(
            ...
            definition = "מִשְׂחָק שֶׁבּוֹ מַכִּים בְּכַדּוּר בְּמַחְבֵּט מֵעַל רֶשֶׁת.",
            definitionNative = "Игра, в которой ракеткой бьют по мячу через сетку.",
            example = "הֵם מְשַׂחֲקִים טֶנִיס בְּמִגְרַשׁ הַקָּרוֹב לַבַּיִת.",
        ...
        WordEntity(
            ...
            definition = "שֶׁטַח מְיֻעָד לְמִשְׂחֲקֵי כַּדּוּר אוֹ פְּעִילוּת סְפּוֹרְטִיבִית.",
            definitionNative = "Площадь, предназначенная для игр с мячом или спортивной активности.",
            example = "יֵשׁ מִגְרַשׁ כַּדּוּרְסַל בַּפַּארְק.",
        ...
        WordEntity(
            ...
            definition = "מִשְׂחָק קְבוּצָתִי שֶׁבּוֹ מַעֲבִירִים עֵצֶם עָגֹל בִּזְרִיקוֹת בֵּין הַשַּׂחְקָנִים וּמְנַסִּים לְהַכְנִיסוֹ לְשַׁעַר הַיְּרִיב.",
        ...
        WordEntity(
            ...
            definition = "הַגְבָּרַת מְהִירוּת הָרִיצָה לְמֶשֶׁךְ זְמַן קָצָר.",
        ...
        WordEntity(
            ...
            definition = "שַׁלְּבֶּב הַתַּחֲרוּת שֶׁלִּפְנֵי הַגְּמָר, שֶׁבּוֹ מִתְחָרִים הַמְּשַׁתְּפִים הָעוֹלִים לַגְּמָר.",
            definitionNative = "Этап соревнования перед финалом, в котором определяются финалисты.",
            example = "הַקְּבוּצָה שֶׁלָּנוּ הִגִּיעָה לַחֲצִי גְּמַר הַגָּבִיעַ.",
        ...
        WordEntity(
            ...
            definition = "קְבוּצַת שַׂחְקָנִים מְעֻלִּים שֶׁמְּרַכְּזִים מִכַּמָּה מוֹעֲדוֹנִים כְּדֵי לְיַיצֵּג אֶת הַמְּדִינָה אוֹ הָעִיר בְּתַחֲרוּיוֹת.",
        ...
        WordEntity(
            ...
            definition = "תַּרְגִּילִים קַלִּים לִפְנֵי הָאִמּוּן לְהֲכְנַת הַגּוּף לְמַאֲמָץ.",
        ...
        WordEntity(
            ...
            definition = "בְּעִיטַת עָנְשִׁין מִנְּקוּדָה קְבוּעָה כְּלַפֵּי שַׁעַר הַיְּרִיב.",
        ...
        WordEntity(
            ...
            definition = "מַצַּב הַגּוּף מִבְּחִינַת הַיְכֹלֶת הַגּוּפָנִית וְהַבְּרִיאוּת הַכְּלָלִית.",
        ...
        WordEntity(
            ...
            definition = "מִשְׂחָק קְבוּצָתִי שֶׁבּוֹ נוֹשְׂאִים וְזוֹרְקִים כַּדּוּר אֵלִיפְּטִי לִזְכּוֹת בְּנְקוּדוֹת.",
         ...
         fillInBlankExclusions = listOf(104101L, 104102L, 104103L, 104105L, 104106L, 104107L, 104113L, 104114L, 104115L, 104117L, 104118L)),
        ...
        WordEntity(
            ...
            example = "הַמֶּלְצַר הֵבִיא לָנוּ אֶת הַתַּפְרִיט מִיָּד עִם הַכְּנִיסָה.",
        ...
        WordEntity(
            ...
            example = "הִזְמַנּוּ אֶת הַמֶּלְצַר כְּדֵי לְהַזְמִין מָנָה עִיקָרִית.",
        ...
        WordEntity(
            ...
            definition = "נְתַח בָּשָׂר דַּק הַמְּצֻפֶּה פֵּרוּרֵי לֶחֶם וּמְטֻגַּן בְּשֶׁמֶן.",
        ...
        WordEntity(
            ...
            example = "הַמֶּלְצַר הֵנִיחַ צַלַּחַת גְּדוֹלָה לְפָנַי.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל הַמֵּכִיל מוּצְרֵי חָלָב וְאֵינוֹ מְעֹרָב עִם בָּשָׂר לְפִי כַּשְׁרוּת.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל הַמֵּכִיל בָּשָׂר וְאֵינוֹ מְעֹרָב עִם חָלָב לְפִי כַּשְׁרוּת.",
            definitionNative = "Еда, содержащая мясо и не смешанная с молочными продуктами по законам кашрута.",
            example = "הִזְמַנּוּ מִסְעָדָה בְּשָׂרִית לַאֲרוּחַת הַחֲגִּיגָה.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל שֶׁאֵינוֹ מֵכִיל בְּשַׂר אוֹ דָּגִים, אַךְ יָכוֹל לְכַלֵּל מוּצְרֵי חָלָב.",
        ...
        WordEntity(
            ...
            definition = "תַּשְׁלוּם נוֹסָף שֶׁנּוֹתְנִים לְמֶלְצַר בְּהַכָּרַת תּוֹדָה עַל הַשֵּׁרוּת.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל יִשְׂרְאֵלִי עָשׂוּי מִגַּרְגְּרֵי קִטְנִיּוֹת טְחוּנִים עִם שֶׁמֶן זַיִת וּתְחִינָה.",
        ...
        WordEntity(
            ...
            definition = "הַזְמָנָה מֵרֹאשׁ שֶׁל שֻׁלְחָן בְּמִסְעָדָה לִזְמַן מְסֻיָּם.",
            definitionNative = "Заблаговременный заказ столика в ресторане на определённое время.",
            example = "עָשִׂינוּ הַזְמָנַת מָקוֹם לְשַׁבָּת בְּמִסְעָדָה הַחֲדָשָׁה.",
        ...
        WordEntity(
            ...
            example = "הַסָּלָט תֻּבַּל בְּשֶׁמֶן זֵית וְלִימוֹן.",
        ...
        WordEntity(
            ...
            definition = "בָּשָׂר דַּק כָּתוּשׁ הַמְּשַׁמֵּשׁ לְהֲכְנַת קְצִיצוֹת וּבּוּרְגֶּרִים.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל שֶׁבֻּשַּׁל בְּחוּם יָשִׁיר אוֹ בַּתַּנּוּר עַד לְהַשְׁחָמָה.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל שֶׁהוּכַן בַּתַּנּוּר בְּחוּם יַבֵּשׁ.",
        ...
        WordEntity(
            ...
            definition = "מָנָה זְעִירָה לְנִיסָיוֹן אוֹ לְשִׁיתּוּף, לְרֹב מוּגֶשֶׁת בְּמִסְעֲדוֹת סִגְנוֹן טַפָּס.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל מְסוֹרָתִי שֶׁל בֵּיצִים מְבֻשָּׁלוֹת בְּרֹטֶב עַגְבָנִיּוֹת וּפְלָפְלִים.",
        ...
        WordEntity(
            ...
            definition = "כַּדּוּרֵי חֻמּוּס אוֹ פּוּל טְחוּנִים וּמְטֻגָּנִים, מַאֲכָל יִשְׂרְאֵלִי קְלָסִי.",
            definitionNative = "Жареные шарики из молотого нута или фасоли — классическое израильское блюдо.",
            example = "פָּלָאפֶל בְּפִיתָה עִם חוּמּוּס וְסָלָט הוּא אֲרוּחַת צָהֳרַיִם פּוֹפּוּלָרִית.",
        ...
        WordEntity(
            ...
            definition = "מַאֲכָל אֵיכוּתִי וְיָקָר, הַנֶּחֱשָׁב כְּמוֹצָר מֵעוּלֶּה אוֹ נָדִיר.",
            definitionNative = "Качественная и дорогая еда, считающаяся изысканным или редким продуктом.",
            example = "קָנִינוּ מַעֲדָן גְּבִינוֹת לַאֲרוּחַת הַחֲגִּיגָה.",
        ...
        WordEntity(
            ...
            example = "יֵשׁ לָהֶם אֲרוּחַת עֵסֶק בְּמֶחִיר מוּזָל בֵּין שֶׁנִּים עָשָׂר לְשָׁלוֹשׁ.",
        ...
        WordEntity(
            ...
            example = "חִמַּמְתִּי שֶׁמֶן בַּמַּחְבַּת וְטִיגַּנְתִּי בֵּיצָה.",
            exampleNative = "Я разогрел масло в מַחֲבַת и пожарил яйцо."),
        WordEntity(
            id = 104302, setId = 1043, languagePair = "he-ru", rarity = "COMMON",
            pos = "noun", semanticGroup = "kitchen_equipment",
            original = "סִיר", translation = "кастрюля, горшок",
            definition = "כְּלִי בִּישּׁוּל עָמֹק עִם כִּסּוּי הַמְּשַׁמֵּשׁ לְבִשּׁוּל מְרָקִים וּנְזִידִים.",
        ...
        WordEntity(
            ...
            example = "חָתַכְתִּי בָּצָל קָטָן לְתוֹךְ הַמַּחְבַּת.",
        ...
        WordEntity(
            ...
            definition = "תַּבְלִין חָרִיף בַּעַל רֵיחַ חָזָק הַנָּפוֹץ בְּמִטְבָּח יִשְׂרְאֵלִי.",
            definitionNative = "Острая приправа с сильным запахом, распространённая в израильской кухне.",
            example = "הוֹסַפְתִּי שְׁלוֹשָׁה שִׁינֵי שׁוּם לָרֹּטֶב.",
        ...
        WordEntity(
            ...
            original = "לְטַגֵּן", translation = "жарить",
            definition = "לְבַשֵּׁל אֹכֶל בְּשֶׁמֶן חַם עַל הָאֵשׁ.",
            definitionNative = "Готовить еду в горячем масле на огне.",
            example = "הִיא אוֹהֶבֶת לְטַגֵּן שְׁנִיצֶל לַאֲרוּחַת עֶרֶב.",
            exampleNative = "Она любит לְטַגֵּן шницель на ужин.",
        ...
        WordEntity(
            ...
            definition = "הוֹרָאוֹת שֶׁלָּב וּרְשִׁימַת מֵרְכּוּזִים לְהֲכְנַת מַאֲכַל מְסֻיָּם.",
            definitionNative = "Пошаговые инструкции и список ингредиентов для приготовления определённого блюда.",
            example = "חִיפַּשְׁתִּי מַתְכּוֹן לְעוּגַת גַּבִּינָה בָּאִינְטֶרְנֶט.",
            exampleNative = "Я искал מַתְכּוֹן для чизкейка в интернете.",
        ...
        WordEntity(
            ...
            definition = "תַּבְלִין עִם אָרוֹמָה חַמָּה, נָפוֹץ בַּמַּטְבָּח הַמִּזְרָחִי.",
        ...
        WordEntity(
            ...
            example = "הַמִּטְבָּח הַיִּשְׂרְאֵלִי עָשִׁיר בְּתַבְלִינִים אָרוֹמָתִיִּים.",
        ...
        WordEntity(
            ...
            definition = "מוּצָר חֶלְבִּי שׁוּמָנִי הַמּוּפְלָשׁ מֵחָלָב וּמְשַׁמֵּשׁ לְבִישּׁוּל וַאֲפִיָּה.",
            definitionNative = "Жирный молочный продукт, вырабатываемый из молока и используемый для готовки и выпечки.",
            example = "הוֹסַפְתִּי כַּפִּית חֶמְאָה לַמַּחְבַּת לִפְנֵי הַטִּיגּוּן.",
        ...
        WordEntity(
            ...
            definition = "אֲבָקָהּ לְבָנָה הַנַּעֲשֵׂית מִטְּחִינַת חִטָּה, הַמְּשַׁמֶּשֶׁת לַאֲפִיָּה.",
        ...
        WordEntity(
            ...
            definition = "לְהָכִין מָזוֹן בְּחוּם תַּנּוּר.",
        ...
        WordEntity(
            ...
            example = "הַפַּסְטָה הָיְתָה טְעִימָה בִּזְכוּת הָרֳּטֶב הָאִיטַלְקִי.",
        ...
        WordEntity(
            ...
            definition = "תְּהֲלִיךְ הֲכָנַת מָזוֹן בְּחוּם אוֹ אֵשׁ.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר חַשְׁמַלִּי לְחִמּוּם מַיִם מָהִיר לְהֲכְנַת תֵּה אוֹ קָפֶה.",
            definitionNative = "Электрический прибор для быстрого нагрева воды для чая или кофе.",
            example = "הִרְתַּחְתִּי מַיִם בַּמִּיחָם לְהֲכְנַת תֵּה.",
        ...
        WordEntity(
            ...
            example = "שַׂמְתִּי אֶת הַפַּסְטָה בַּמַּסָּנָן לְנִיקּוּז הַמַּיִם.",
        ...
        WordEntity(
            ...
            original = "מִצְחַת", translation = "фартук",
            definition = "בֶּגֶד מְגִנָּן הַנִּלְבָּשׁ עַל הַבְּגָדִים בְּזְמַן בִּישּׁוּל כְּדֵי לְהָגֵּן עֲלֵיהֶם.",
            definitionNative = "Защитная одежда, надеваемая поверх одежды во время готовки для её защиты.",
            example = "לָבַשְׁתִּי מִצְחַת לִפְנֵי שֶׁהִתְחַלְתִּי לְבַשֵּׁל.",
            exampleNative = "Я надел מִצְחַת перед тем, как начать готовить.",
        ),
        WordEntity(
            id = 104321, setId = 1043, languagePair = "he-ru", rarity = "UNCOMMON",
            pos = "noun", semanticGroup = "kitchen_equipment",
            original = "עַרְבֵּל", translation = "скалка",
            ...
            example = "רִידַּדְתִּי אֶת הַבָּצֵק בַּעֲרְבֵּל עַד שֶׁהִתְדַּקֵּק.",
            exampleNative = "Я раскатал тесто עַרְבֵּל до тонкости.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי שְׁתִיָּה לְשָׁמִּירַת וְהַגָּשַׁת תֵּה, מַיִם אוֹ שְׁתִיָּה קָרָה.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי גְּדוֹל עִם יָד אֲרֻכָּה לְחִלּוּק מָרָק וּנְזִידִים.",
        ...
        WordEntity(
            ...
            definition = "כַּף עֲשׂוּיָה עֵץ, מַתְאִימָה לְעִרְבּוּב מַאֲכָלִים בְּלִי לְגָרֵד כֵּלִים.",
            definitionNative = "Ложка из дерева, подходящая для помешивания еды без царапания посуды.",
            example = "עֵרַבְבְּתִּי אֶת הָרֹטֶב בְּכַף עֵץ כְּדֵי לֹא לְשָׁרֵּט אֶת הַסִּיר.",
        ...
        WordEntity(
            ...
            example = "שַׂמְתִּי אֶת הַסִּיר עַל הַכִּירָה לְהַרְתִּיחַ מַיִם.",
            exampleNative = "Я поставил кастрюлю на כִּירָה вскипятить воду.",
         fillInBlankExclusions = listOf(104301L, 104302L, 104305L, 104307L, 104316L, 104317L, 104318L, 104321L, 104322L, 104323L, 104324L)),
