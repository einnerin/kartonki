...
object WordDataHebrewStartupL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "תֵּאוּר מַעֲשִׂי שֶׁל מוּצָר עֲתִידִי — מָה הוּא עוֹשֶׂה, לְמִי וְאֵיךְ נִרְאֶה.",
        ...
        WordEntity(
            ...
            definition = "אֲמִירָה שֶׁל הַמְּיַסֵּד עַל הַשּׁוּק שֶׁיֵּשׁ לִבְדֹּק בְּמַעֲשֶׂה לִפְנֵי הַשְׁקָעַת מַשַּׁאֲבִּים.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ שֶׁבּוֹ בּוֹדְקִים אִם לְקוֹחוֹת בֶּאֱמֶת רוֹצִים לְשַׁלֵּם עַל מָה שֶׁמְּתַכְנְנִים.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטָה שֶׁל רֵאֲיוֹנוֹת עִם מִשְׁתַּמְּשִׁים פּוֹטֶנְצְיָאלִיִּים כְּדֵי לְהָבִין אֶת הַצְּרָכִים שֶׁלָּהֶם.",
            definitionNative = "Метод интервью с потенциальными пользователями — чтобы понять их реальные нужды.",
            example = "קַסְטוֹמֶר דֶּוֶולוֹפְּמֶנְט גִּלָּה לָנוּ שֶׁהַמַּחִיר חָשׁוּב פָּחוֹת מֵהַזְּמַן.",
        ...
        WordEntity(
            ...
            example = "שׁוּתָפוּת הֲקָמָה דּוֹרֶשֶׁת הֶסְכֵּם בָּרוּר עַל אֲחוּזִים וְעַל תַּפְקִידִים.",
        ...
        WordEntity(
            ...
            definition = "דֻּגְמָה עוֹבֶדֶת בְּאֹפֶן חֶלְקִי שֶׁמַּמְחִישָׁה אֵיךְ הֲרַעְיוֹן יִרְאֶה בִּפְעֻלָּה.",
        ...
        WordEntity(
            ...
            definition = "מִשְׁתַּמֵּשׁ מֻקְדַּם שֶׁמְּקַבֵּל גִּישָׁה לִפְנֵי הַשְׁאָר וּמַחֲזִיר מָשְׁוֹב מַעֲשִׂי.",
        ...
        WordEntity(
            ...
            definition = "סִבּוּב אֶחָד שֶׁל שִׁפּוּר עַל בָּסִיס מָשְׁוֹב — שׁוֹלְחִים, בּוֹדְקִים, מְשַׁנִּים, מַחְזִירִים.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁבּוֹ הַשּׁוּק מוֹשֵׁךְ אֶת הַמּוּצָר חָזָק יוֹתֵר מִמָּה שֶׁהַחֶבְרָה מַצְלִיחָה לְסַפֵּק.",
        ...
        WordEntity(
            ...
            definition = "פִּינָה צָרָה בַּשּׁוּק עִם קָהָל מְסֻיָּם שֶׁהַשְּׂחַקָּנִים הַגְּדוֹלִים מְזַלְזְלִים בָּהּ.",
        ...
        WordEntity(
            ...
            definition = "הַשְׁוָאָה שִׁיטָתִית שֶׁל הַמּוּצָר מוּל מָה שֶׁהַשְּׂחַקָּנִים הָאֲחֵרִים בַּשּׁוּק מַצִּיעִים.",
        ...
        WordEntity(
            ...
            example = "מַשְׁקִיעִים בִּשְׁלַב סִיד מְחַפְּשִׂים טְרַאקְשֶׁן עַם מְעַט מְדִידוֹת חִיּוּבִיּוֹת.",
        ...
        WordEntity(
            ...
            definition = "אֶנֶרְגְיָה שֶׁל לִרְדֹּף אַחֲרֵי הַזְדַּמְּנֻיּוֹת בְּלִי לֵאוּת — לִשְׁלֹחַ, לִשְׁאֹל, לְהַתְחִיל.",
            definitionNative = "Энергия гнаться за возможностями без устали — писать, спрашивать, начинать.",
            example = "בְּשָׁלָב הַסִּיד הַסְל חָשׁוּב יוֹתֵר מִתָּכְנִית עָסָקִית מֻשְׁלֶמֶת.",
        ...
        WordEntity(
            ...
            example = "גִּישָׁה מְעֹרַבֶת שֶׁל הַמַּיְיסְּדִים נָתְנָה לַצֶּוֶות תְּחוּשָׁה שֶׁכֻּלָּם בְּאוֹתוֹ הַסִּירָה.",
