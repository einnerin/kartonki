...
object SeedDataHebrew {
    ...
    val sets: List<WordSetEntity> = listOf(
        WordSetEntity(id = 101, name = "Компьютер и интернет", description = "Базовая компьютерная лексика A1/A2", orderIndex = 0, languagePair = "he-ru"),
        WordSetEntity(id = 102, name = "Программирование",     description = "Термины программирования B1",          orderIndex = 1, languagePair = "he-ru"),
        WordSetEntity(id = 103, name = "Информатика",          description = "Продвинутая терминология B2/C1",        orderIndex = 2, languagePair = "he-ru"),
    )
    ...
    private fun set1() = listOf(
        WordEntity(id = 10001, original = "מַחְשֵׁב", transliteration = "makhshev", translation = "компьютер",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(id = 10002, original = "עַכְבָּר", transliteration = "akhbar", translation = "мышь (компьютерная)",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(id = 10003, original = "מַקְלֶדֶת", transliteration = "makledet", translation = "клавиатура",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(id = 10004, original = "מָסָךְ", transliteration = "masakh", translation = "экран, монитор",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(id = 10005, original = "מַדְפֶּסֶת", transliteration = "madpeset", translation = "принтер",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(id = 10006, original = "קוֹבֶץ", transliteration = "kovets", translation = "файл",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(id = 10007, original = "תִּיקִיָּה", transliteration = "tikiya", translation = "папка",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(id = 10008, original = "שְׁמִירָה", transliteration = "shmirah", translation = "сохранение",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(id = 10009, original = "מְחִיקָה", transliteration = "mekhika", translation = "удаление",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(id = 10010, original = "הַעְתָּקָה", transliteration = "ha'ataka", translation = "копирование",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(id = 10011, original = "הַדְבָּקָה", transliteration = "hadbaka", translation = "вставка",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(id = 10012, original = "אַתָּר", transliteration = "atar", translation = "сайт, веб-сайт",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(id = 10013, original = "דַּפְדְּפָן", transliteration = "dafdefan", translation = "браузер",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(id = 10014, original = "דּוֹאַר אֶלֶקְטְרוֹנִי", transliteration = "do'ar elektronit", translation = "электронная почта",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(id = 10015, original = "סִיסְמָה", transliteration = "sismah", translation = "пароль",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(id = 10016, original = "קִישׁוּר", transliteration = "kishur", translation = "ссылка, гиперссылка",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(id = 10017, original = "הוֹרָדָה", transliteration = "horadah", translation = "скачивание, загрузка",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(id = 10018, original = "הַעֲלָאָה", transliteration = "ha'ala'ah", translation = "загрузка на сервер",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(id = 10019, original = "חִיפּוּשׁ", transliteration = "khipush", translation = "поиск",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "actions"),
        WordEntity(id = 10020, original = "עֵדְכּוּן", transliteration = "idkun", translation = "обновление",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "actions"),
        WordEntity(id = 10021, original = "לְחִיצָה", transliteration = "lekhitsa", translation = "клик, нажатие",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "actions"),
        WordEntity(id = 10022, original = "טֶלֶפוֹן", transliteration = "telefon", translation = "телефон, смартфон",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(id = 10023, original = "טַבְלֶט", transliteration = "tablet", translation = "планшет",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(id = 10024, original = "אַפְלִיקַצְיָה", transliteration = "aplikatsya", translation = "приложение",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(id = 10025, original = "וִירוּס", transliteration = "virus", translation = "вирус (компьютерный)",
    ...
    private fun set2() = listOf(
        WordEntity(id = 10026, original = "מִשְׁתַּנֶּה", transliteration = "mishtaneh", translation = "переменная",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(id = 10027, original = "פוּנְקְצְיָה", transliteration = "funktsya", translation = "функция",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(id = 10028, original = "לוּלָאָה", transliteration = "lulaa", translation = "цикл",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "control_flow"),
        WordEntity(id = 10029, original = "מַעֲרָךְ", transliteration = "ma'arakh", translation = "массив",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(id = 10030, original = "תְּנַאי", transliteration = "tnai", translation = "условие",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "control_flow"),
        WordEntity(id = 10031, original = "מַחְלָקָה", transliteration = "makhlaka", translation = "класс",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "oop"),
        WordEntity(id = 10032, original = "אוֹבְּיֶקְט", transliteration = "ob'yekt", translation = "объект",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "oop"),
        WordEntity(id = 10033, original = "מֶתוֹדָה", transliteration = "metoda", translation = "метод",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "oop"),
        WordEntity(id = 10034, original = "פָּרָמֶטֶר", transliteration = "parametr", translation = "параметр",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(id = 10035, original = "סִפְרִיָּה", transliteration = "sifriya", translation = "библиотека",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(id = 10036, original = "מַסַּד נְתוּנִים", transliteration = "masad netunim", translation = "база данных",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(id = 10037, original = "שְׁאֵלָתָה", transliteration = "she'ilta", translation = "запрос",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(id = 10038, original = "שְׁגִיאָה", transliteration = "shgi'a", translation = "ошибка",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "debugging"),
        WordEntity(id = 10039, original = "נִפּוּי שְׁגִיאוֹת", transliteration = "nipuy shgi'ot", translation = "отладка",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "debugging"),
        WordEntity(id = 10040, original = "קוֹד", transliteration = "kod", translation = "код",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(id = 10041, original = "מַחְרוֹזֶת", transliteration = "makhrozet", translation = "строка (тип данных)",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(id = 10042, original = "מִסְפָּר שָׁלֵם", transliteration = "mispar shalem", translation = "целое число",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(id = 10043, original = "בּוּלֵיאָנִי", transliteration = "buli'ani", translation = "булев тип",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(id = 10044, original = "מַמְשָׁק", transliteration = "mimshak", translation = "интерфейс",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "oop"),
        WordEntity(id = 10045, original = "יְרוּשָׁה", transliteration = "yerusha", translation = "наследование",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "oop"),
        WordEntity(id = 10046, original = "חֲרִיגָה", transliteration = "khariga", translation = "исключение",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "debugging"),
        WordEntity(id = 10047, original = "הַחְזָרָה", transliteration = "hakhazara", translation = "возврат значения",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(id = 10048, original = "יִיבּוּא", transliteration = "yivua", translation = "импорт",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(id = 10049, original = "הֶעָרָה", transliteration = "he'ara", translation = "комментарий",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(id = 10050, original = "גִּרְסָה", transliteration = "garsa", translation = "версия",
    ...
    private fun set3() = listOf(
        WordEntity(id = 10051, original = "אַלְגּוֹרִיתְם", transliteration = "algoritm", translation = "алгоритм",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "cs_theory"),
        WordEntity(id = 10052, original = "רְקוּרְסִיָּה", transliteration = "rekursiya", translation = "рекурсия",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "cs_theory"),
        WordEntity(id = 10053, original = "מַהְדֵּר", transliteration = "mahder", translation = "компилятор",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "cs_theory"),
        WordEntity(id = 10054, original = "אַרְכִיטֶקְטוּרָה", transliteration = "arkhitektura", translation = "архитектура ПО",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "architecture"),
        WordEntity(id = 10055, original = "הַצְפָּנָה", transliteration = "hatspana", translation = "шифрование",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "security"),
        WordEntity(id = 10056, original = "אִימּוּת", transliteration = "imut", translation = "аутентификация",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "security"),
        WordEntity(id = 10057, original = "מַסְגֶּרֶת עֲבוֹדָה", transliteration = "masgeret avoda", translation = "фреймворк",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "architecture"),
        WordEntity(id = 10058, original = "מַאֲגָר", transliteration = "ma'agar", translation = "репозиторий",
        ...
        WordEntity(id = 10059, original = "פְּרִיסָה", transliteration = "prisa", translation = "развёртывание",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "architecture"),
        WordEntity(id = 10060, original = "מַכָּל", transliteration = "makal", translation = "контейнер",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(id = 10061, original = "מִיקְרוֹ-שֵׁרוּת", transliteration = "mikro-sherut", translation = "микросервис",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(id = 10062, original = "עָנָן", transliteration = "anan", translation = "облако (вычисления)",
            definition = "מודל למתן משאבי מחשוב דרך האינטרנט לפי דרישה.",
            definitionNative = "Модель предоставления вычислительных ресурсов через интернет по запросу.",
            example = "עָנָן מאפשר גישה לנתונים מכל מקום.",
            exampleNative = "Стартап развернул сервис в עָנָן.",
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(id = 10063, original = "חוּט", transliteration = "khut", translation = "поток (thread)",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "memory"),
        WordEntity(id = 10064, original = "תַּהֲלִיךְ", transliteration = "tahalikh", translation = "процесс",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "memory"),
        WordEntity(id = 10065, original = "זִיכָּרוֹן", transliteration = "zikharon", translation = "память",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "memory"),
        WordEntity(id = 10066, original = "מַטְמוֹן", transliteration = "matmon", translation = "кэш",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "memory"),
        WordEntity(id = 10067, original = "פְּרוֹטוֹקוֹל", transliteration = "protokol", translation = "протокол",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(id = 10068, original = "רֶשֶׁת", transliteration = "reshet", translation = "сеть",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(id = 10069, original = "שֶׁרֶת", transliteration = "sheret", translation = "сервер",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(id = 10070, original = "לָקוֹחַ", transliteration = "lakoakh", translation = "клиент",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(id = 10071, original = "מְכוֹנָה וִירְטוּאָלִית", transliteration = "mekhona virtualit", translation = "виртуальная машина",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(id = 10072, original = "קוֹד פָּתוּחַ", transliteration = "kod patuakh", translation = "открытый исходный код",
            ...
            rarity = "LEGENDARY", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "architecture"),
        WordEntity(id = 10073, original = "אִרְגּוּן מֵחָדָשׁ", transliteration = "irgun mekhadash", translation = "рефакторинг",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "architecture"),
        WordEntity(id = 10074, original = "יְכוֹלֶת הִתְרַחֲבוּת", transliteration = "yekholet hitrakhavut", translation = "масштабируемость",
        ...
        WordEntity(id = 10075, original = "בְּדִיקוֹת", transliteration = "bdikot", translation = "тестирование",
