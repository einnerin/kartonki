...
object SeedDataHebrew {
    ...
    private fun set1() = listOf(
        WordEntity(original = "מַחְשֵׁב", transliteration = "makhshev", translation = "компьютер",
        ...
        WordEntity(original = "עַכְבָּר", transliteration = "akhbar", translation = "мышь (компьютерная)",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(original = "מַקְלֶדֶת", transliteration = "makledet", translation = "клавиатура",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(original = "מָסָךְ", transliteration = "masakh", translation = "экран, монитор",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(original = "מַדְפֶּסֶת", transliteration = "madpeset", translation = "принтер",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(original = "קוֹבֶץ", transliteration = "kovets", translation = "файл",
        ...
        WordEntity(original = "תִּיקִיָּה", transliteration = "tikiya", translation = "папка",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(original = "שְׁמִירָה", transliteration = "shmirah", translation = "сохранение",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(original = "מְחִיקָה", transliteration = "mekhika", translation = "удаление",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(original = "הַעְתָּקָה", transliteration = "ha'ataka", translation = "копирование",
        ...
        WordEntity(original = "הַדְבָּקָה", transliteration = "hadbaka", translation = "вставка",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "files"),
        WordEntity(original = "אַתָּר", transliteration = "atar", translation = "сайт, веб-сайт",
        ...
        WordEntity(original = "דַּפְדְּפָן", transliteration = "dafdefan", translation = "браузер",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(original = "דּוֹאַר אֶלֶקְטְרוֹנִי", transliteration = "do'ar elektronit", translation = "электронная почта",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(original = "סִיסְמָה", transliteration = "sismah", translation = "пароль",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(original = "קִישׁוּר", transliteration = "kishur", translation = "ссылка, гиперссылка",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(original = "הוֹרָדָה", transliteration = "horadah", translation = "скачивание, загрузка",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(original = "הַעֲלָאָה", transliteration = "ha'ala'ah", translation = "загрузка на сервер",
        ...
        WordEntity(original = "חִיפּוּשׁ", transliteration = "khipush", translation = "поиск",
        ...
        WordEntity(original = "עֵדְכּוּן", transliteration = "idkun", translation = "обновление",
        ...
        WordEntity(original = "לְחִיצָה", transliteration = "lekhitsa", translation = "клик, нажатие",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "actions"),
        WordEntity(original = "טֶלֶפוֹן", transliteration = "telefon", translation = "телефон, смартфон",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(original = "טַבְלֶט", transliteration = "tablet", translation = "планшет",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "hardware"),
        WordEntity(original = "אַפְלִיקַצְיָה", transliteration = "aplikatsya", translation = "приложение",
            ...
            rarity = "COMMON", languagePair = "he-ru", setId = 101, pos = "noun", semanticGroup = "internet"),
        WordEntity(original = "וִירוּס", transliteration = "virus", translation = "вирус (компьютерный)",
    ...
    private fun set2() = listOf(
        WordEntity(original = "מִשְׁתַּנֶּה", transliteration = "mishtaneh", translation = "переменная",
        ...
        WordEntity(original = "פוּנְקְצְיָה", transliteration = "funktsya", translation = "функция",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(original = "לוּלָאָה", transliteration = "lulaa", translation = "цикл",
        ...
        WordEntity(original = "מַעֲרָךְ", transliteration = "ma'arakh", translation = "массив",
        ...
        WordEntity(original = "תְּנַאי", transliteration = "tnai", translation = "условие",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "control_flow"),
        WordEntity(original = "מַחְלָקָה", transliteration = "makhlaka", translation = "класс",
        ...
        WordEntity(original = "אוֹבְּיֶקְט", transliteration = "ob'yekt", translation = "объект",
        ...
        WordEntity(original = "מֶתוֹדָה", transliteration = "metoda", translation = "метод",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "oop"),
        WordEntity(original = "פָּרָמֶטֶר", transliteration = "parametr", translation = "параметр",
        ...
        WordEntity(original = "סִפְרִיָּה", transliteration = "sifriya", translation = "библиотека",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(original = "מַסַּד נְתוּנִים", transliteration = "masad netunim", translation = "база данных",
        ...
        WordEntity(original = "שְׁאֵלָתָה", transliteration = "she'ilta", translation = "запрос",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(original = "שְׁגִיאָה", transliteration = "shgi'a", translation = "ошибка",
        ...
        WordEntity(original = "נִפּוּי שְׁגִיאוֹת", transliteration = "nipuy shgi'ot", translation = "отладка",
        ...
        WordEntity(original = "קוֹד", transliteration = "kod", translation = "код",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(original = "מַחְרוֹזֶת", transliteration = "makhrozet", translation = "строка (тип данных)",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(original = "מִסְפָּר שָׁלֵם", transliteration = "mispar shalem", translation = "целое число",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(original = "בּוּלֵיאָנִי", transliteration = "buli'ani", translation = "булев тип",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "data_types"),
        WordEntity(original = "מַמְשָׁק", transliteration = "mimshak", translation = "интерфейс",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "oop"),
        WordEntity(original = "יְרוּשָׁה", transliteration = "yerusha", translation = "наследование",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "oop"),
        WordEntity(original = "חֲרִיגָה", transliteration = "khariga", translation = "исключение",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "debugging"),
        WordEntity(original = "הַחְזָרָה", transliteration = "hakhazara", translation = "возврат значения",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(original = "יִיבּוּא", transliteration = "yivua", translation = "импорт",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(original = "הֶעָרָה", transliteration = "he'ara", translation = "комментарий",
            ...
            rarity = "UNCOMMON", languagePair = "he-ru", setId = 102, pos = "noun", semanticGroup = "basics"),
        WordEntity(original = "גִּרְסָה", transliteration = "garsa", translation = "версия",
    ...
    private fun set3() = listOf(
        WordEntity(original = "אַלְגּוֹרִיתְם", transliteration = "algoritm", translation = "алгоритм",
        ...
        WordEntity(original = "רְקוּרְסִיָּה", transliteration = "rekursiya", translation = "рекурсия",
        ...
        WordEntity(original = "מַהְדֵּר", transliteration = "mahder", translation = "компилятор",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "cs_theory"),
        WordEntity(original = "אַרְכִיטֶקְטוּרָה", transliteration = "arkhitektura", translation = "архитектура ПО",
        ...
        WordEntity(original = "הַצְפָּנָה", transliteration = "hatspana", translation = "шифрование",
        ...
        WordEntity(original = "אִימּוּת", transliteration = "imut", translation = "аутентификация",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "security"),
        WordEntity(original = "מַסְגֶּרֶת עֲבוֹדָה", transliteration = "masgeret avoda", translation = "фреймворк",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "architecture"),
        WordEntity(original = "מַאֲגָר", transliteration = "ma'agar", translation = "репозиторий",
        ...
        WordEntity(original = "פְּרִיסָה", transliteration = "prisa", translation = "развёртывание",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "architecture"),
        WordEntity(original = "מַכָּל", transliteration = "makal", translation = "контейнер",
        ...
        WordEntity(original = "מִיקְרוֹ-שֵׁרוּת", transliteration = "mikro-sherut", translation = "микросервис",
        ...
        WordEntity(original = "עָנָן", transliteration = "anan", translation = "облако (вычисления)",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(original = "חוּט", transliteration = "khut", translation = "поток (thread)",
        ...
        WordEntity(original = "תַּהֲלִיךְ", transliteration = "tahalikh", translation = "процесс",
        ...
        WordEntity(original = "זִיכָּרוֹן", transliteration = "zikharon", translation = "память",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "memory"),
        WordEntity(original = "מַטְמוֹן", transliteration = "matmon", translation = "кэш",
        ...
        WordEntity(original = "פְּרוֹטוֹקוֹל", transliteration = "protokol", translation = "протокол",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(original = "רֶשֶׁת", transliteration = "reshet", translation = "сеть",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(original = "שֶׁרֶת", transliteration = "sheret", translation = "сервер",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(original = "לָקוֹחַ", transliteration = "lakoakh", translation = "клиент",
            ...
            rarity = "RARE", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(original = "מְכוֹנָה וִירְטוּאָלִית", transliteration = "mekhona virtualit", translation = "виртуальная машина",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "infrastructure"),
        WordEntity(original = "קוֹד פָּתוּחַ", transliteration = "kod patuakh", translation = "открытый исходный код",
        ...
        WordEntity(original = "אִרְגּוּן מֵחָדָשׁ", transliteration = "irgun mekhadash", translation = "рефакторинг",
            ...
            rarity = "EPIC", languagePair = "he-ru", setId = 103, pos = "noun", semanticGroup = "architecture"),
        WordEntity(original = "יְכוֹלֶת הִתְרַחֲבוּת", transliteration = "yekholet hitrakhavut", translation = "масштабируемость",
