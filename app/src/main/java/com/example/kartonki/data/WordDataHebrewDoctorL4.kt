...
object WordDataHebrewDoctorL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "שִׁכְבַת הֲגַנָּה בְּסִיסִית שֶׁמְּקַבֵּל כָּל תּוֹשָׁב מֵהַמְּדִינָה לְלֹא תַּשְׁלוּם נוֹסָף.",
        ...
        WordEntity(
            ...
            example = "קֻפָּה צִיבּוּרִית מְחֻיֶּבֶת לְקַבֵּל כָּל פּוֹנֶה בְּלִי קֶשֶׁר לְמַצַּב הַבְּרִיאוּת.",
        ...
        WordEntity(
            ...
            definition = "הַשֵּׁם הָרִשְׁמִי שֶׁל הַמִּסְגֶּרֶת הַשְּׁנִיָּה בְּגֹדֶל בָּאָרֶץ — שִׁמּוּשׁ בְּסֵפֶר הַחֻקִּים.",
            definitionNative = "Официальное название второй по размеру сети в стране, что фигурирует в законах.",
            example = "שֵׁרוּתֵי מַכַּבִּי פָּתְחוּ סֲנִיף חָדָשׁ לְיַד הַתַּחֲנָה הַמֶּרְכָּזִית.",
        ...
        WordEntity(
            ...
            example = "לֵאוּמִית פָּתְחָה סֲנִיף חָדָשׁ בְּעִיר הַפֵּרִיפֶרְיָה הַשָּׁנָה.",
            exampleNative = "לֵאוּמִית открыла новый филиал в периферийном городе в этом году.",
         fillInBlankExclusions = listOf(180503L, 180504L)),
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180506L, 180507L, 180508L, 180509L)),
        ...
        WordEntity(
            ...
            definition = "קְבִיעָה רִשְׁמִית שֶׁל הַגּוּף הַמְבַטֵּחַ אִם לְמַמֵּן טִפּוּל לִמְבֻטָּח אוֹ לִדְחוֹתוֹ.",
        ...
        WordEntity(
            ...
            definition = "טֹפֶס שֶׁמַּתִּיר טִפּוּל בְּלִי תּוֹר רָגִיל — מָסֵר מֻמְחֶה בְּמַצַּב חָרוּם.",
         ...
         fillInBlankExclusions = listOf(180511L, 180512L, 180513L, 180514L)),
        ...
        WordEntity(
            ...
            definition = "חוֹזֶה עִם חֶבְרַת בִּטּוּחַ מִחוּץ לַקֻּפָּה — לְכִסּוּי הַרְחָבָה אִישִׁי וִיקָר.",
        ...
        WordEntity(
            ...
            example = "בִּיטוּחַ סִיעוּדִי מְמַמֵּן עוֹבֶדֶת זָרָה לְסַבָּתָא בַּבַּיִת.",
            exampleNative = "בִּיטוּחַ סִיעוּדִי финансирует иностранную работницу для бабушки дома.",
         fillInBlankExclusions = listOf(180516L, 180517L, 180518L, 180519L)),
        ...
        WordEntity(
            ...
            example = "מִרְפֵּאַת חוּץ אוֹרְתּוֹפֵּדִית בְּהַדֲסָה פְּתוּחָה כָּל בֹּקֶר.",
            exampleNative = "מִרְפֵּאת חוּץ ортопедическая в Хадассе открыта каждое утро.",
         fillInBlankExclusions = listOf(180521L, 180522L, 180523L, 180524L)),
    )
}
