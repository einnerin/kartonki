...
object WordDataHebrewCourierL3 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "פֶּתֶק רַשְּׁמִי שֶׁמְּאַשֵּׁר אֶת סְכוּם הַתַּשְׁלוּם וְאֶת הַתַּאֲרִיךְ.",
            definitionNative = "Официальная бумага, удостоверяющая сумму и дату оплаты.",
            example = "בִּקַּשְׁתִּי קַבָּלָה בִּכְתָב לַחֲשׁוּב לִפְנֵי שֶׁעָזַבְתִּי.",
        ...
        WordEntity(
            ...
            definition = "פְּעֻלָּה שֶׁמְּעַדְכֶּנֶת בַּמַּעֲרֶכֶת שֶׁהַחֲבִילָה הִגִּיעָה לַיַּעַד.",
            definitionNative = "Действие, отмечающее в системе прибытие посылки на точку.",
            example = "סְרִיקַת בַּרְקוֹד נִכְשְׁלָה כִּי הַמַּדְבֵּקָה קְרוּעָה.",
        ...
        WordEntity(
            ...
            example = "מְסִירָה לְשַׁכֵּן דּוֹרֶשֶׁת אִישּׁוּר טֶלֶפוֹנִי מֵהַלָּקוֹחַ.",
        ...
        WordEntity(
            ...
            example = "אִישּׁוּר בִּתְמוּנָה נִשְׁמַר בָּאַפְּלִיקַצְיָה לְשָׁנָה שְׁלֵמָה.",
