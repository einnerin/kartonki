...
object WordDataHebrewDoctorL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מַסָּה שֶׁל תָּאִים שֶׁמִּתְרַבִּים בְּלִי שְׁלִיטָה וַעֲלוּלִים לְהִתְפַּשֵּׁט בַּגּוּף.",
            definitionNative = "Скопление клеток, что бесконтрольно растёт и может расползаться по телу.",
            example = "הַבְּדִיקָה אִשְּׁרָה שֶׁמְּדֻבָּר בְּגִדּוּל מְמָאֵר וְלֹא בְּצִיסְטָה.",
        ...
        WordEntity(
            ...
            example = "הַבִּיוֹפְּסִיָּה גִּלְּתָה קַרְצִינוֹמָה שֶׁל הָעוֹר בְּשָׁלָּב מֻקְדָּם.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180602L, 180603L, 180604L)),
        ...
        WordEntity(
            ...
            definition = "הַעֲבָרָה שֶׁל אֵיבָר בָּרִיא מִתּוֹרֵם אֶל גּוּפוֹ שֶׁל מִי שֶׁחַי בְּלִי תִּפְקוּד תַּקִּין.",
         ...
         fillInBlankExclusions = listOf(180607L, 180608L, 180609L)),
        ...
        WordEntity(
            ...
            definition = "פְּגִישָׁה אֵצֶל אִישׁ מִקְצוֹעַ אַחֵר לְקַבָּלַת זָוִית רְאִיָּה שׁוֹנָה עַל אַבְחָנָה.",
        ...
        WordEntity(
            ...
            definition = "סִבָּה מִקְצוֹעִית מְבֻסֶּסֶת שֶׁמַּצְדִּיקָה מַתַּן טִפּוּל אוֹ נִתּוּחַ לַחוֹלֶה.",
        ...
        WordEntity(
            ...
            definition = "תָּכְנִית שֶׁל שְׁלַבִּים וּפְעֻלּוֹת שֶׁהָרוֹפֵא מְתַכְנֵן עֲבוּר הַחוֹלֶה לְאֹרֶךְ זְמַן.",
            definitionNative = "План этапов и действий, что врач выстраивает для больного на длительный срок.",
            example = "מַסְלוּל הַטִּפּוּל כּוֹלֵל שִׁשָּׁה מַחֲזוֹרִים בְּמֶרְחַק שָׁבוּעַ.",
        ...
        WordEntity(
            ...
            example = "הָרוֹפֵא סֵרֵב לְמַסֹר מֵידָע לַבַּעַל מִשּׁוּם סוֹדִיּוּת רְפוּאִית.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180616L, 180617L, 180618L, 180619L)),
        ...
        WordEntity(
            ...
            definition = "תַּכְשִׁירִים יְקָרִים שֶׁקֻּפַּת הַחוֹלִים מְמַמֶּנֶת רַק אַחֲרֵי אִשּׁוּר מְיֻחָד וּמְיֻעַד.",
            definitionNative = "Дорогие препараты, что больничная касса оплачивает лишь после особого утверждения.",
            example = "הַתַּכְשִׁיר נִכְלַל בִּתְרוּפוֹת בְּהִתְחַיְּבוּת — חַיִּים לְמַלֵּא טֹפֶס מַתְאִים.",
        ...
        WordEntity(
            ...
            definition = "מוֹצָר עִם וִיטָמִינִים אוֹ חָמְרֵי תְּזוּנָה שֶׁמַּשְׁלִים מַחְסוֹר אֵצֶל הַחוֹלֶה.",
            definitionNative = "Продукт с витаминами или питательными веществами — восполняет нехватку у больного.",
            example = "אַחֲרֵי הַנִּיתּוּחַ הִיא קִבְּלָה תּוֹסַף תְּזוּנָה רְפוּאִי לְהַחְלָמָה מְהִירָה.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180621L, 180622L, 180623L, 180624L)),
    )
}
