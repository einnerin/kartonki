...
object WordDataHebrewDoctorL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "doctor_basic_people",
        ...
        WordEntity(
            ...
            definition = "תְּחוּשָׁה לֹא נְעִימָה בַּגּוּף — חַד אוֹ עָמּוּם, קָצָר אוֹ אָרֹךְ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "doctor_basic_meds",
        ...
        WordEntity(
            ...
            example = "נָתַתִּי לַיֶּלֶד סִירוֹפּ לְשִׁעוּל לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "doctor_basic_actions",
        ...
        WordEntity(
            ...
            pos = "verb", semanticGroup = "doctor_basic_actions",
        ...
        WordEntity(
            ...
            definition = "לָקַחַת אֶת מָה שֶּׁהָרוֹפֵא רָשַׁם בִּזְמַן הַנָּכוֹן וּבַמִּינוּן הַנָּכוֹן.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "doctor_basic_visit",
            original = "תּוֹר", translation = "очередь / запись",
            definition = "מָקוֹם וְשָׁעָה שֶׁמְּחַכִּים בָּהֶם לְפֵגִישָׁה עִם הָרוֹפֵא.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "doctor_basic_visit",
            ...
            example = "נִכְנַסְתִּי לְחֶדֶר רוֹפֵא וְהַרְגַּשְׁתִּי מִיָּד יוֹתֵר רָגוּעַ.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶׁהָרוֹפֵא מְבַקֵּשׁ לַעֲשׂוֹת אַחֲרֵי הַבִּיקוּר — לִשְׁתּוֹת, לָנוּחַ, לַחֲזֹר.",
