...
object WordDataHebrewEmotionsL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מַצָּב נַפְשִׁי שֶׁל שְׁתֵּי תְּחוּשׁוֹת הֲפוּכוֹת כְּלַפֵּי אוֹתוֹ אָדָם אוֹ נוֹשֵׂא בְּאוֹתוֹ זְמַן.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי הַתְּאוּנָה הוּא חַוָּה דִּיסוֹצְיָאצְיָה קַלָּה לִשְׁעָתַיִם.",
        ...
        WordEntity(
            ...
            example = "הַכַּעַס שֶׁלּוֹ עַל הַחֲבֵר הָיָה בְּעֶצֶם הַטָּלַת רֶגֶשׁ מִתּוֹךְ עַצְמוֹ.",
        ...
        WordEntity(
            ...
            definition = "עַצְבוּת חֲרִישִׁית וַעֲמֻקָּה שֶׁמְּלַוָּה אָדָם זְמַן רַב בְּלִי סִבָּה בְּרוּרָה.",
            definitionNative = "Тихая глубокая печаль, что сопровождает человека долгое время без явной причины.",
            example = "הַסְּתָו עוֹרֵר בּוֹ מֵלַנְכּוֹלְיָה שֶׁל יָמִים שֶׁעָבְרוּ.",
        ...
        WordEntity(
            ...
            example = "מַרְאֶה הַבַּיִת הַיָּשָׁן הִצִּיף אוֹתוֹ בְּנוֹסְטַלְגְּיָה מְתוּקָה.",
        ...
        WordEntity(
            ...
            definition = "לְהַבִּיעַ שִׂמְחָה גְּבוֹהָה וְגַדּוֹלָה בְּקוֹל וּבִתְנוּעָה — בְּלָשׁוֹן סִפְרוּתִית.",
        ...
        WordEntity(
            ...
            definition = "לִרְצוֹת מַשֶּׁהוּ בְּעַצְמָהּ רַבָּה וּלְהַרְגִּישׁ אוֹתוֹ חָסֵר עַד כְּדֵי כְּאֵב פְּנִימִי.",
        ...
        WordEntity(
            ...
            definition = "לְהַרְגִּישׁ כָּבוֹד עָמֹק וַחֲרָדָה קַלָּה כְּלַפֵּי דָּבָר נִשְׂגָּב אוֹ קָדוֹשׁ.",
            ...
            exampleNative = "Посетители לִרְעֹד מִיִרְאָה внутри древнего храма.", isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            definition = "נוֹטֶה לִבְחֹן אֶת מָחָשְׁבוֹתָיו וּמַעֲשָׂיו בְּעוֹמֶק וּבְזַהִירוּת.",
        ...
        WordEntity(
            ...
            definition = "מַחֲזִיק שְׁתֵּי גִּישׁוֹת רִגְשִׁיּוֹת הֲפוּכוֹת כְּלַפֵּי אוֹתוֹ נוֹשֵׂא בְּעֵת וּבְעוֹנָה אַחַת.",
        ...
        WordEntity(
            ...
            definition = "רֶגֶשׁ עָמֹק שֶׁל הִשְׁתַּתְּפוּת בְּסֵבֶל הַזּוּלָת וְרָצוֹן לְהָקֵל עָלָיו.",
            definitionNative = "Глубокое чувство участия в чужом страдании и желания облегчить его.",
            example = "אֲחָיוֹת בַּטִּפּוּל הַפַּלִיאָטִיבִי מְבַטְּאוֹת חֶמְלָה רַבָּה כָּל יוֹם.",
        ...
        WordEntity(
            ...
            example = "אַנְטִיפַּתְיָה הֲדָּדִית שָׂרְרָה בֵּינֵיהֶם מֵהַיּוֹם הָרִאשׁוֹן.",
        ...
        WordEntity(
            ...
            definition = "מְסִירָה מְלֵאָה שֶׁל עַצְמוֹ וּזְמַנּוֹ לְאָדָם, מַטָּרָה אוֹ אָמָּנוּת בְּלִי שִׁיּוּר.",
