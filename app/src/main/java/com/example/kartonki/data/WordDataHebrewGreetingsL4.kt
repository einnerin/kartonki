...
object WordDataHebrewGreetingsL4 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            example = "הַגָּשַׁת כְּתַב הָאֲמָנָה נֶעֶרְכָה בָּאַרְמוֹן.",
        ...
        WordEntity(
            ...
            definition = "דִּבְרֵי בְּרָכָה רִשְׁמִיִּים שֶׁפּוֹתְחִים כֶּנֶס אוֹ טֶקֶס אָקָדֵמִי.",
        ...
        WordEntity(
            ...
            definition = "דִּבְרֵי שָׁלוֹם רִשְׁמִיִּים לְאוֹרְחִים בְּפֶתַח אֵרוּעַ אָקָדֵמִי אוֹ צִבּוּרִי.",
        ...
        WordEntity(
            ...
            example = "הַחוֹקֵר נָעַל אֶת הַהַרְצָאָה בְּדִבְרֵי תּוֹדָה אָקָדֵמִיִּים.",
        ...
        WordEntity(
            ...
            definition = "מִפְגָּשׁ הַתַּחֲלָתִי בּוֹ מַשְׁתַּתְּפֵי כֶּנֶס מַצִּיגִים אֶת עַצְמָם זֶה לָזֶה.",
            definitionNative = "Начальный сбор, на котором участники симпозиума представляются друг другу.",
            example = "טֶקֶס הַכָּרַת פָּנִים נִפְתָּח בִּצְלִילֵי כִּנּוֹר.",
        ...
        WordEntity(
            ...
            definition = "נֻסָּח חֲתִימָה רִשְׁמִית בְּמִכְתָּב לִפְנֵי שֵׁם הַשּׁוֹלֵחַ.",
        ...
        WordEntity(
            ...
            example = "לִכְבוֹד אֲדוֹנִי הַנִּכְבָּד, הִנֵּנִי לְהוֹדִיעַ.",
        ...
        WordEntity(
            ...
            definition = "פְּתִיחָה רִשְׁמִית מְקֻבֶּלֶת בְּמִכְתָּב הוֹדָעָה רֶשֱׁמִית מִמּוֹסֶד.",
            definitionNative = "Принятая формальная фраза в начале служебного уведомления от учреждения.",
            example = "הִנֵּנִי לְהוֹדִיעַ עַל קַבָּלָתְךָ לַתַּפְקִיד.",
        ...
        WordEntity(
            ...
            definition = "בְּרָכָה תָּנָּכִית מִתְּהִלִּים, מְשַׁמֶּשֶׁת כִּפְתִיחָה גְּבוֹהָה.",
        ...
        WordEntity(
            ...
            definition = "פְּתִיחַת בִּרְכַּת כֹּהֲנִים, מְשַׁמֶּשֶׁת בְּטֶקֱסִים גְּבוֹהִים.",
        ...
        WordEntity(
            ...
            definition = "נֻסָּח רִשְׁמִי לְהַזְכָּרַת נִפְטַר בְּטֶקֶס אוֹ בְּהוֹדָעָה רֶשֱׁמִית.",
        ...
        WordEntity(
            ...
            definition = "נֻסָּח בְּרָכָה מְכֻבָּד הַמְלַוֶּה הוֹדָעָה רֶשֱׁמִית עַל הִישֵּׂג אוֹ אֵרוּעַ שִׂמְחָה.",
