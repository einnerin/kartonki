...
object WordDataHebrewBatch15 {
    ...
    val sets = listOf(
        WordSetEntity(id = 1067, name = "Армия: основы",      description = "Базовая военная лексика",                    languagePair = "he-ru", orderIndex = 67,
            topic = "Армия",
            level = 1),
        WordSetEntity(id = 1068, name = "Армия: продвинутый",  description = "Профессиональная военная лексика",            languagePair = "he-ru", orderIndex = 68,
            topic = "Армия",
            level = 2),
        WordSetEntity(id = 1069, name = "Политика: основы",           description = "Кнессет, правительство и выборы",            languagePair = "he-ru", orderIndex = 69,
            topic = "Политика",
            level = 1),
    )
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "army_basics", transliteration = "imdá",
            original = "עִמְדָּה", translation = "позиция; боевой пост",
            definition = "מָקוֹם מְבֻצָּר שֶׁמִּמֶּנּוּ חַיָּל מַגֵּן אוֹ צוֹפֶה.",
            definitionNative = "Укреплённое место, с которого солдат обороняется или ведёт наблюдение.",
            example = "הַחַיָּלִים אָחֲזוּ בָּעִמְדָּה לְמֶשֶׁךְ כָּל הַלַּיְלָה.",
            exampleNative = "Солдаты удерживали позицию всю ночь.",
        ),
        WordEntity(
