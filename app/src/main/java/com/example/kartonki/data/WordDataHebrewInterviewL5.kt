...
object WordDataHebrewInterviewL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ שֶׁהַחֶבְרָה בּוֹדֶקֶת אֶת הֶעָבָר שֶׁל מֻעָמָד לִפְנֵי שֶׁמְּגַיֶּסֶת אוֹתוֹ.",
        ...
        WordEntity(
            ...
            definition = "שִׂיחָה שֶׁל הַמַּעֲסִיק עִם בּוֹסִים קוֹדְמִים שֶׁל הַמֻּעָמָד לְבֵרוּר אֲמִינוּת.",
        ...
        WordEntity(
            ...
            definition = "הַסְכָּמָה רִשְׁמִית שֶׁל הַמְּדִינָה לָתֵת לָאָדָם גִּישָׁה לְמֵידָע סוֹדִי שֶׁל צָבָא אוֹ מֲדִּינָה.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175401L, 175402L, 175403L, 175404L)),
        ...
        WordEntity(
            ...
            definition = "הַסְכָּמָה בִּכְתָב לֹא לְסַפֵּר לְאַף אֶחָד עַל מָה שֶּׁעוֹבֵד יוֹדֵעַ עַל הַחֶבְרָה.",
        ...
        WordEntity(
            ...
            example = "הַחֶבְרָה הוֹסִיפָה קְנָס יְצִיאָה לָעוֹבְדִים שֶׁמְּקַבְּלִים בּוֹנוּס חֲתִימָה.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175406L, 175407L, 175408L, 175409L)),
        ...
        WordEntity(
            ...
            definition = "סְכוּמִים חָדְשִׁיִּים שֶׁמַּעֲבִיד וְעוֹבֵד מַעֲבִירִים לְקֶרֶן לְעֵת זִקְנָה.",
        ...
        WordEntity(
            ...
            example = "קֶרֶן הִשְׁתַּלְמוּת נֶחְשֶׁבֶת לַהֲטָבָה הֲכִי מְבֻקֶּשֶׁת בָּאוֹפֵּר.",
            exampleNative = "קֶרֶן הִשְׁתַּלְמוּת — самая желанная льгота в офере.",
         fillInBlankExclusions = listOf(175411L, 175412L, 175413L, 175414L)),
        ...
        WordEntity(
            ...
            definition = "הוֹדָעָה קְצָרָה בַּמֵּייל שֶׁמֻּעָמָד שׁוֹלֵחַ אַחֲרֵי שִׂיחָה כְּדֵי לִשְׁמֹר עַל קֶשֶׁר חִיוּבִי.",
        ...
        WordEntity(
            ...
            definition = "פְּנִיָּה שֶׁל הַמֻּעָמָד אַחֲרֵי שֶׁעָבַר זְמַן בְּלִי שׁוּם תְּשׁוּבָה מֵהַחֶבְרָה.",
        ...
        WordEntity(
            ...
            definition = "הוֹדָעָה מֵהַחֶבְרָה שֶׁהַמֻּעָמָד עוֹבֵר הָלְאָה לִקְרַאת רֵאָיוֹן בָּא בַּתַּהֲלִיךְ.",
        ...
        WordEntity(
            ...
            definition = "תְּקוּפָה אַחֲרֵי הָרֵאָיוֹן הָאַחֲרוֹן שֶׁבָּהּ הַמֻּעָמָד לֹא יוֹדֵעַ אִם קִבְּלוּ אוֹתוֹ.",
        ...
        WordEntity(
            ...
            definition = "סְגָנּוֹן דִּבּוּר שֶׁבּוֹ אוֹמְרִים בְּדִיּוּק מָה שֶׁחוֹשְׁבִים בְּלִי כְּסוּת מְנֻמֶּסֶת.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175421L, 175422L, 175423L, 175424L)),
    )
}
