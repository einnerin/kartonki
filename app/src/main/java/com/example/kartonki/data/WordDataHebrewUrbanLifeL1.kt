...
object WordDataHebrewUrbanLifeL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "קָנִיתִי בְּבֵית מִרְקַחַת תְּרוּפָה לְכָאֵב גָּרוֹן.",
        ...
        WordEntity(
            ...
            definition = "קֻפְסָה אוֹ חֲפָצִים אֲרוּזִים שֶׁשּׁוֹלְחִים דֶּרֶךְ הַדֹּאַר לְכַתֹּבֶת אַחֶרֶת.",
            definitionNative = "Коробка с упакованными вещами, что пересылают почтой на другой адрес.",
            example = "הִגִּיעָה לִי חֲבִילָה גְּדוֹלָה מֵהוֹרַי בָּרוּסְיָה.",
        ...
        WordEntity(
            ...
            example = "אֲנִי הוֹלֵךְ בַּכִּוּוּן הַשְּׁגוּי, צָרִיךְ לַחֲזֹר אָחוֹרָה.",
        ...
        WordEntity(
            ...
            definition = "לִפְנוֹת לְמִישֶׁהוּ בְּשֶׁאֵלָה כְּדֵי לְקַבֵּל מֵידָע אוֹ הַסְבָּרָה.",
        ...
        WordEntity(
            ...
            definition = "כְּתִיבַת הַשֵּׁם שֶׁלָּךְ בִּכְתַב יָד בְּסוֹף הַמִּסְמָךְ לְאִשּׁוּר.",
        ...
        WordEntity(
            ...
            definition = "אִשָּׁה שֶׁעוֹבֶדֶת בְּמִשְׂרַד וְקוֹבַעַת תּוֹרִים וּפְגִישׁוֹת לַפָּקִידִים.",
