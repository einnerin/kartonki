...
object WordDataHebrewDoctorL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180301L, 180302L, 180303L, 180304L)),
        ...
        WordEntity(
            ...
            definition = "הַמֶּרְחָק מֵהָרַגְלַיִם עַד הָרֹאשׁ — נִמְדָּד בְּסַנְטִימֶטְרִים בַּמִּרְפָּאָה.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180306L)),
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי הַקְשָׁבָה לַלֵּב הָרוֹפֵא אָמַר שֶׁהַכֹּל תַּקִּין.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי בְּדִיקַת גָּרוֹן הִתְבָּרֵר שֶׁיֵּשׁ דַּלֶּקֶת חֲזָּקָה.",
        ...
        WordEntity(
            ...
            example = "הַיֶּלֶד בָּכָה בְּמַהֲלַךְ בְּדִיקַת אֹזֶן בְּאֶצְלוֹ דַּלֶּקֶת.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180311L, 180312L, 180313L, 180314L)),
        ...
        WordEntity(
            ...
            definition = "סִפּוּר הַמַּחֲלוֹת שֶׁל הָאָדָם בֶּעָבָר — מָה שֶּׁעוֹזֵר לְהַחֲלִיט עַל טִיפּוּל.",
        ...
        WordEntity(
            ...
            definition = "כָּל הַפְּעֻלּוֹת הַכִּירוּרְגִיּוֹת בֶּעָבָר — חָשׁוּב לְהַחֲלָטָה עַל טִיפּוּל.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180316L, 180318L, 180319L)),
        ...
        WordEntity(
            ...
            definition = "מִכְתָּב מֵהָרוֹפֵא הַמִּשְׁפַּחְתִּי — מַתִּיר פְּגִישָׁה אֵצֶל רוֹפֵא צַר תְּחוּם.",
        ...
        WordEntity(
            ...
            example = "הָבֵא מִכְתַּב הַחְלָמָה לָרוֹפֵא הַמִּשְׁפַּחְתִּי אַחֲרֵי הַשִּׁחְרוּר.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(180321L, 180322L, 180323L, 180324L)),
    )
}
