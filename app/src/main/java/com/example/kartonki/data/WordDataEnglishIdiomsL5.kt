...
object WordDataEnglishIdiomsL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 40902, setId = 409, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "То, без чего что-то совсем невозможно — суть и основа. Латынь — «без чего нет».",
        ...
        WordEntity(id = 40903, setId = 409, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Повторяемое так часто, что вызывает раздражение и отвращение. Латынь крылатая.",
        ...
        WordEntity(id = 40904, setId = 409, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Когда человек открыто берёт на себя ответственность за допущенную ошибку. Латынь.",
        ...
        WordEntity(id = 40922, setId = 409, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Вопрос «кто получает пользу?» — помогает найти возможного виновника. Латынь.",
        ...
        WordEntity(id = 40924, setId = 409, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Когда суд или церемония проходят без самого человека. Латынь крылатая.",
