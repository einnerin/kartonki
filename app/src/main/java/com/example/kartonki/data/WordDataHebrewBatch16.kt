...
object WordDataHebrewBatch16 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "music", transliteration = "melodiya",
            original = "מֶלוֹדְיָה", translation = "мелодия",
            definition = "רֶצֶף תָּוִים הַיּוֹצְרִים קַו מוּסִיקָלִי נִכָּר.",
            definitionNative = "Последовательность нот, образующих узнаваемую музыкальную линию.",
            example = "הַמֶּלוֹדְיָה הַזֹּאת נִשְׁמָעָה לִי מוּכֶּרֶת מְאֹד.",
            exampleNative = "Эта מֶלוֹדְיָה кажется мне очень знакомой.",
        ),
        WordEntity(
            id = 107219, setId = 1072, languagePair = "he-ru", rarity = "UNCOMMON",
            pos = "noun", semanticGroup = "music", transliteration = "khalil",
            original = "חֲלִיל", translation = "флейта",
            definition = "כְּלִי נְגִינָה מַתָּכְתִּי אוֹ עֵצִי הַמּוּנָּע בִּנְשִׁיפָה.",
            definitionNative = "Металлический или деревянный духовой инструмент.",
            example = "הִיא לָמְדָה לְנַגֵּן עַל חֲלִיל בָּאוּלְפַּן מוּסִיקָה.",
            exampleNative = "Она научилась играть на חֲלִיל в музыкальной студии.",
        ),
        WordEntity(
