...
object WordDataHebrewBatch16 {
    ...
    val sets: List<WordSetEntity> = listOf(
        ...
        WordSetEntity(
            ...
            description = "Инструменты, жанры, исполнение",
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הָאָב עָשָׂה קִדּוּשׁ לִפְנֵי הַסְּעוּדָה בְּשַׁבָּת.",
        ...
        WordEntity(
            ...
            example = "הַיְּהוּדִים מַאֲמִינִים בֶּאֱלֹהִים אֶחָד.",
        ...
        WordEntity(
            ...
            definition = "אֵמוּן עָמֹק בֶּאֱלֹהִים וּבְעִקְּרוֹת הַדָּת.",
        ...
        WordEntity(
            ...
            example = "חֲגִיגַת הַבַּר מִצְוָה שֶׁלּוֹ הָיְתָה גְּדוֹלָה מְאֹד.",
        ...
        WordEntity(
            ...
            definition = "טֶקֶס הַמְסַמֵּן שֶׁנַּעֲרָה יְהוּדִיָּה בַּת 12 הוֹפֶכֶת לְאַחְרָאִיִת לְקִיּוּם מִצְוֹת.",
        ...
        WordEntity(
            ...
            definition = "עֲשָׂרָה יְהוּדִים בְּגִיל מִצְוָה — הַמִּסְפָּר הַמִּינִימָלִי לִתְּפִלָּה בְּצִבּוּר.",
        ...
        WordEntity(
            ...
            definition = "מִדָּה מוּסָרִית יְסוֹדִית בְּיַהֲדוּת — גְּמִילוּת חֲסָדִים, עֶזְרָה לַזּוּלָת בְּלִי תְּמוּרָה.",
            definitionNative = "Основное нравственное качество в иудаизме — помощь ближнему без вознаграждения.",
            example = "גְּמִילוּת חֲסָדִים הִיא אֶחָד מֵהַמִּצְוֹת הַחֲשׁוּבוֹת בְּיַהֲדוּת.",
        ...
        WordEntity(
            ...
            definition = "הָעוֹלָם שֶׁלְּאַחַר הַמָּוֶת לְפִי הָאֱמוּנָה הַיְּהוּדִית.",
        ...
        WordEntity(
            ...
            definition = "תְּפִלַּת קִדּוּשׁ הַשֵּׁם, הַנֶּאֱמֶרֶת בְּמֶשֶׁךְ תְּקוּפַת הָאֵבֶל וּבְיִזְכּוֹר.",
        ...
        WordEntity(
            ...
            definition = "הַשִּׁחְרוּר הַשָּׁלֵם וְהַסּוֹפִי שֶׁל עַם יִשְׂרָאֵל וְהָעוֹלָם, לְפִי הַתִּקְוָה הַיְּהוּדִית.",
        ...
        WordEntity(
            ...
            definition = "הַבִּטָּחוֹן הַעֲמֹק בֶּאֱלֹהִים וּבָעִקָּרִים הַדָּתִיִּים כְּבָסִיס לַחַיִּים.",
            definitionNative = "Глубокая преданность Богу и духовным заветам, лежащая в основе всей жизни.",
            example = "הָאֱמוּנָה שֶׁלּוֹ חִזְּקָה אוֹתוֹ בְּתְקוּפַת הַמַּשְׁבֵּר.",
        ...
        WordEntity(
            ...
            example = "הַשְּׁכוּנוֹת הַחֲרֵדִיּוֹת בְּבְּנֵי בְּרָק גְּדֵלוֹת בִּמְהִירוּת.",
            exampleNative = "Кварталы харедим в Бней-Браке быстро растут.",
         isFillInBlankSafe = false),
        WordEntity(
            id = 107104, setId = 1071, languagePair = "he-ru", rarity = "UNCOMMON",
            pos = "noun", semanticGroup = "religion_advanced",
            original = "כֹּהֵן", translation = "коэн (священник / потомок Аарона)",
            definition = "צֶאֱצָא שֶׁל אַהֲרֹן, שֶׁשִּׁמֵּשׁ בַּמִּקְדָּשׁ וְקִבֵּל הַטָּבוֹת הַלֲכָתִיּוֹת.",
            definitionNative = "Потомок Аарона, служивший в Храме и получающий определённые галахические привилегии.",
            example = "כֹּהֵן הוּא צֶאֱצָא שֶׁל אַהֲרֹן וּמְשָׁרֵת בַּמִּקְדָּשׁ.",
            exampleNative = "Коэн — потомок Аарона, служащий в Храме."),
        WordEntity(
        ...
        WordEntity(
            ...
            example = "הַחַזָּן עָמַד עַל הַבִּימָה וּפָתַח אֶת הַתְּפִלָּה.",
            exampleNative = "Хазан встал на בִּימָה и открыл молитву.",
        ),
        ...
        WordEntity(
            ...
            definition = "תְּפִלַּת שְׁמוֹנֶה עֶשְׂרֵה — תְּפִלַּת הַשַּׁחַר, מִנְחָה וְעַרְבִית, הַנֶּאֱמֶרֶת עַל הָרַגְלַיִם.",
            definitionNative = "Молитва восемнадцати благословений — читается стоя на утренней, послеполуденной и вечерней молитве.",
            example = "בִּזְמַן הָעֲמִידָה נִדְרַשׁ לַעֲמֹד בְּשֶׁקֶט וּלְהִתְרַכֵּז.",
        ...
        WordEntity(
            ...
            example = "פָּרָשַׁת הַשָּׁבוּעַ הִיא בְּרֵאשִׁית — פּוֹתַחַת אֶת הַמַּחְזוֹר.",
        ...
        WordEntity(
            ...
            definition = "יְהוּדִים שֶׁמּוֹצָאָם מֵאַרְצוֹת הַמִּזְרָח — כְּגוֹן מָרוֹקוֹ, עִרַק, תֵּימָן וּפָרַס.",
        ...
        WordEntity(
            ...
            definition = "חַג הַנִּחְגָּג בְּסֶיּוּם סֻכּוֹת — יוֹם הַתְּפִלָּה לְגֶשֶׁם וְשִׂמְחַת תּוֹרָה.",
            definitionNative = "Праздник в конце Суккота — день молитвы о дожде и Симхат Тора.",
            example = "בְּשֶׁמִּינִי עֲצֶרֶת מַקִּיפִים בְּשִׂמְחָה עִם סִפְרֵי הַתּוֹרָה.",
        ...
        WordEntity(
            ...
            example = "הַמוּסִיקָה הַסְּפָרַדִּית מְשַׁלֶּבֶת עֲרָבִית, טוּרְקִית וּסְפָרַדִּית.",
        ...
        WordEntity(
            ...
            definition = "קּוֹד הַהֲלָכָה הַחֲשׁוּב בְּיוֹתֵר שֶׁחִבֵּר רַבִּי יוֹסֵף קָארוֹ בְּמֵאָה הַ-16.",
            ...
            exampleNative = "Шулхан Арух до сих пор остаётся столпом галахических решений.",
        ),
        WordEntity(
            id = 107118, setId = 1071, languagePair = "he-ru", rarity = "RARE",
            pos = "noun", semanticGroup = "religion_advanced",
            original = "מוּסָר", translation = "мусар (этика / нравственное учение)",
            definition = "תְּנוּעָה לְשִׁכְלוּל הַמִּדּוֹת וְהָאֵתִיקָה בַּחַיִּים הַדָּתִיִּים, שֶׁיָּסַד רַבִּי יִשְׂרָאֵל סָלַנְטֶר.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטַת הַפַּרְשָׁנוּת הַיְּהוּדִית הַמְּפָרֶשֶׁת סִיפּוּרֵי הַמִּקְרָא בְּדֶרֶךְ מִסְפָּרִית וּמוּסָרִית.",
            definitionNative = "Метод еврейской экзегезы, интерпретирующий библейские нарративы нарративно и этически.",
            example = "הַמִּדְרָשׁ מֵבִיא פַּרֲשָׁנוּת יְצִירָתִית לְסִיפּוּרֵי בְּרֵאשִׁית.",
        ...
        WordEntity(
            ...
            definition = "מִי שֶׁכּוֹפֵר בְּעִקָּרֵי הַדָּת הַיְּהוּדִית אוֹ מְזַלְזֵּל בְּחַכָּמִים.",
        ...
        WordEntity(
            ...
            example = "הָאַגָּדוֹת שֶׁל חֲזַ\"ל מְלַמְּדוֹת מִדּוֹת בְּדֶרֶךְ סִפּוּרִית.",
            exampleNative = "Раввинская агада учит нравственности через нарративы.",
         isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            example = "הִיא נַגְּנָהּ עַל הַפִּסְנְתֵּר בְּהַצָּגַת הַסִּיּוּם.",
        ...
        WordEntity(
            ...
            example = "הַלַּהֲקָה הַזֹּאת מְפֻרְסֶמֶת בְּכָל הַאֶרֶץ.",
        ...
        WordEntity(
            ...
            definition = "שִׁיר מְסוֹרָתִי הַמְּיַצֵּג תַּרְבּוּת וְזֶהוּת עֲמָּמִית.",
        ...
        WordEntity(
            ...
            example = "מוּסִיקַת פּוֹפּ דּוֹמִינַנְטִית בְּרַדִּיּוֹ.",
        ...
        WordEntity(
            ...
            example = "הֵם הִצִּיגוּ מָחוֹל מָסָרְתִּי בְּאֵצַע הָאוּלְפַּן.",
        ...
        WordEntity(
            ...
            definition = "סוּג הוֹפָעָה הַמְּשַׁלֵּב רִקּוּד קְלָאסִי, מוּסִיקָה וּסְצֵינוֹגְרַפְיָה.",
        ...
        WordEntity(
            ...
            definition = "אָדָם שֶׁמְּחַבֵּר וּמְעַצֵּב מַעֲשֵׂי אָמָּנוּת — מוּסִיקָה, שִׁירָה, צִיּוּר וְכַדּוֹמֶה.",
            definitionNative = "Человек, создающий произведения искусства — музыку, поэзию, живопись и тому подобное.",
            example = "הוּא יוֹצֵר מְחוֹנָן שֶׁמְּשַׁלֵּב מוּסִיקָה וְשִׁיר.",
        ...
        WordEntity(
            ...
            definition = "חָמְרֵי צֶבַע הַמְּשֻׁמָּשִׁים לְצִיּוּר וִיצִירָה אָמָּנוּתִית.",
