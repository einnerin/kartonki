...
object WordDataHebrewEntertainmentL1L2L3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "אֵרוּעַ עַלִּיז שֶׁל אֲנָשִׁים בְּבַיִת אוֹ בְּגַן עִם אֹכֶל וּמוּסִיקָה.",
        ...
        WordEntity(
            ...
            definition = "אֲרוּחָה עַל שֶׁמִּיכָה בַּטֶּבַע, בְּגַן אוֹ עַל הַחוֹף.",
        ...
        WordEntity(
            ...
            example = "חֲגִיגָה גְּדוֹלָה הָיְתָה לִכְבוֹד יוֹם הַהֻלֶּדֶת שֶׁל סַבָּא.",
        ...
        WordEntity(
            ...
            example = "סַבָּא סִפֵּר בְּדִיחָה יְשָׁנָה וְכֻלָּם צָחֲקוּ.",
        ...
        WordEntity(
            ...
            definition = "מִתְקַן עֵץ אוֹ מַתֶּכֶת שֶׁבּוֹ הַיֶּלֶד נָע קָדִימָה וְאָחוֹרָה לִהֲנָאָה.",
        ...
        WordEntity(
            ...
            definition = "מִתְקַן מִנְּיָר וְעֵץ הַמּוּטָס בָּאֲוִיר בְּעֶזְרַת חוּט אָרֹךְ.",
        ...
        WordEntity(
            ...
            example = "כָּל בֹּקֶר הוּא בּוֹחֵר צַעֲצוּעַ אַחֵר מֵהָאָרוֹן.",
        ...
        WordEntity(
            ...
            example = "הַסָּבְתָּא שָׁאֲלָה אוֹתָנוּ חִידָה יְשָׁנָה עַל אָרוּז.",
        ...
        WordEntity(
            ...
            example = "סַבָּא לִמֵּד אוֹתִי לְשַׂחֵק שַׁחְמָט בְּגִיל שֶׁבַע.",
        ...
        WordEntity(
            ...
            definition = "מִשְׂחַק לוּחַ פָּשׁוּט יוֹתֵר שֶׁבּוֹ אוֹכְלִים אֶת הַחַיָּלִים שֶׁל הַיָּרִיב.",
            definitionNative = "Простая настольная игра, где едят фишки соперника по диагонали.",
            example = "הוּא הִפְסִיד בְּדַמְקָה לָסַּבְתָּא שָׁלוֹשׁ פְּעָמִים בָּרֶצַף.",
        ...
        WordEntity(
            ...
            example = "הַבֵּן שֶׁלִּי מְשׂוּגָע עַל אָנִימֶה כְּבָר חָמֵשׁ שָׁנִים.",
        ...
        WordEntity(
            ...
            definition = "סוּג שֶׁל סֶרֶט מוֹתֵחַ הַשּׁוֹמֵר עַל הַצּוֹפֶה בְּמַתַּח עַד הַסּוֹף.",
            definitionNative = "Жанр напряжённого фильма, держащего зрителя в саспенсе до развязки.",
            example = "הַמּוֹתְחָן הָאַחֲרוֹן שֶׁלּוֹ זָכָה בְּפְרָסִים רַבִּים בְּקָאן.",
        ...
        WordEntity(
            ...
            definition = "סֶרֶט אוֹ סִפֵּר הַמְּמַשֵּׁךְ אֶת הָעֲלִילָה שֶׁל יְצִירָה קוֹדֶמֶת.",
        ...
        WordEntity(
            ...
            example = "הִזְמַנּוּ חֲדַר בְּרִיחָה עִם נוֹשֵׂא שֶׁל מַעֲבַּדַּת מַדָּעָן.",
        ...
        WordEntity(
            ...
            definition = "סִימָן דִּיגִיטָלִי שֶׁמַּעֲנִיק הַמִּשְׂחָק עַל מֲשִּׂימָה קָשָׁה שֶׁהֻשְׁלְמָה.",
            definitionNative = "Цифровая отметка, что игра выдаёт за выполненное трудное задание.",
            example = "הוּא הִתְפָּאֵר בַּהֶשֵּׂג הַנָּדִיר שֶׁבּוֹ זָכָה רַק אֱחוּז קָטָן.",
        ...
        WordEntity(
            ...
            example = "הִכְנַתִּי פְּלֵייְלִיסְט מְיֻחָד לַטִּיּוּל בָּרֶכֶב הַחָדָשׁ.",
        ...
        WordEntity(
            ...
            example = "הַטְּרֵיילֶר זָרַע סְקַרֲנוּת אֲבָל הִסְתִּיר אֶת הַסּוֹף.",
        ...
        WordEntity(
            ...
            definition = "גִּלּוּי שֶׁל פְּרָט חָשׁוּב מֵהָעֲלִילָה לְמִי שֶׁעוֹד לֹא רָאָה.",
        ...
        WordEntity(
            ...
            definition = "פְּעֻלָּה מְהַנָּה בִּזְמַן פָּנוּי כְּמוֹ בַּר, סֶרֶט אוֹ קוֹנְצֶרְט.",
            definitionNative = "Приятное времяпрепровождение в свободные часы — бар, кино, концерт.",
            example = "לְבִלּוּי בָּעֶרֶב בָּחַרְנוּ בַּר חָדָשׁ עַל הַחוֹף.",
        ...
        WordEntity(
            ...
            example = "הַפֶּנְדּוֹם שֶׁל הַסִּדְרָה הִקִּים אֲתָר עִם תְּמוּנוֹת וּסְקִירוֹת.",
        ...
        WordEntity(
            ...
            example = "גְּלִיטְשׁ נָדִיר שֶׁל הַתְּמוּנָה הָפַךְ לִצְחוֹק כְּלָלִי בָּרֶשֶׁת.",
        ...
        WordEntity(
            ...
            definition = "סִפֵּר שֶׁל מַעֲרִיץ עַל גִּבּוֹרִים מִיְצִירָה קְיָמֶת וְלֹא מִשֶּׁלּוֹ.",
        ...
        WordEntity(
            ...
            definition = "סִימָן עָדִין מֻקְדַּם שֶׁמַּכְשִׁיר אֶת הַקָּהָל לִקְרֹאת תַּפְנִית עֲתִידִית.",
        ...
        WordEntity(
            ...
            example = "הַסֶּרֶט הָפַךְ לְלָהִיט קוּפָּתִי בְּסוֹף שָׁבוּעַ הַפְּתִיחָה.",
        ...
        WordEntity(
            ...
            example = "רוֹגָלַייק קָשֶׁה עָלוּל לְהָסִּיר עֲשָׂרוֹת שָׁעוֹת בְּלִי הִתְקַדְּמוּת.",
        ...
        WordEntity(
            ...
            definition = "נִסָּיוֹן לִגְמוֹר מִשְׂחָק בִּזְמַן הַקָּצָר בְּיוֹתֵר אֶפְשָׁרִי תּוֹךְ נִצּוּל בַּגִּים.",
        ...
        WordEntity(
            ...
            definition = "הַמְּפַקֵּחַ הָרָאשִׁי עַל סִדְרָה שֶׁאַחְרָאִי לָעֲלִילָה וְלַצֶּוֶת כֻּלּוֹ.",
            definitionNative = "Главный руководитель сериала, ведущий и сюжет, и всю съёмочную команду.",
            example = "הַשּׁוֹרַנֶּר הִתְעַקֵּשׁ עַל סוֹף עָצוּב לָעֲלִילָה לַמְרוֹת הַלְּחָצִים.",
        ...
        WordEntity(
            ...
            definition = "מַעֲרֶכֶת הָעֻבְדּוֹת הָרִשְׁמִיּוֹת מִתּוֹךְ הַיְצִירָה שֶׁאָסוּר לִסְתוֹר.",
        ...
        WordEntity(
            ...
            definition = "כָּל הַשְּׁלַבִּים שֶׁל הֲכָנַת סֶרֶט מֵהַתַּסְרִיט וְעַד יְצִיאָתוֹ לְקוֹלְנוֹעַ.",
        ...
        WordEntity(
            ...
            definition = "הַפֶּרֶק הָאַחֲרוֹן בָּעוֹנָה שֶׁמַּשְׁאִיר שְׁאֵלוֹת לָעוֹנָה הַבָּאָה.",
            definitionNative = "Последний эпизод сезона, оставляющий вопросы для следующего цикла.",
            example = "הַגְּמָר עוֹנָה הִתְקִיף אֶת הַצּוֹפִים בְּקְלִיפְהֵנְגֶר חַד.",
        ...
        WordEntity(
            ...
            definition = "סִגְנוֹן חָזוּתִי מְגוּבָּשׁ שֶׁל סֶרֶט אוֹ סִדְרָה הַיּוֹצֵר רֹשֶׁם אֶחָד.",
