...
object WordDataHebrewFoodSpices {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 189401, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            original = "סוּמָק",
            translation = "сумак",
            definition = "תַּבְלִין אָדֹם וְחָמוּץ עָשׂוּי מִגַּרְגִּירִים שֶׁל שִׂיחַ הַסּוּמָק, נָפוֹץ בַּמִּטְבָּח הַלְּבַנְטִינִי.",
        ...
        WordEntity(id = 189404, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "גַּרְגִּירִים חוּמִּים שֶׁל עֵץ פִּימֶנְטָה, בַּעֲלֵי טַעַם הַמַּזְכִּיר קִינָּמוֹן, צִיפּוֹרֶן וְאֱגוֹז מוּסְקָט.",
        ...
        WordEntity(id = 189407, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תַּרְמִילִים יְרֻקִּים אֲרוֹמָטִיִּים עִם זַרְעֵי שָׁחוֹר, מְשַׁמְּשִׁים לְקָפֶה תֵּימָנִי וּלְעוּגוֹת.",
        ...
        WordEntity(id = 189424, setId = 1894, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מוּצָרֵי תַּבְלִין יְבֵשִׁים כְּמוֹ כַּמּוֹן, פִּלְפֵּל אוֹ פַּפְּרִיקָה שֶׁמּוֹסִיפִים לְמַאֲכָלִים לְטַעַם וְלְרֵיחַ.",
        ...
        WordEntity(id = 189425, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "כַּמָּה תַּבְלִינִים מְעוּרְבָּבִים יַחַד בְּפַרוֹפּוֹרְצְיוֹת מְסוּיָּמוֹת, כְּמוֹ בַּהָרָאת אוֹ חַוָאיֵג׳.",
