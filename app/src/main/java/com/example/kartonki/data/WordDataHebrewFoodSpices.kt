...
object WordDataHebrewFoodSpices {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 189402, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הוּא תִּבֵּל אֶת הַתַּבְשִׁיל בְּכַף בַּהֲרָאַת לִפְנֵי הָאֲפִיָּה.",
        ...
        WordEntity(id = 189407, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תַּרְמִילִים יְרֻקִּים אָרוֹמָטִיִּים עִם זְרָעִים שְׁחוֹרִים, מְשַׁמְּשִׁים לְקָפֶה תֵּימָנִי וּלְעוּגוֹת.",
            definitionNative = "Ароматные зелёные стручки с чёрными зёрнышками; кладут в йеменский кофе и в выпечку.",
            example = "סַבָּא תָּמִיד מוֹסִיף הֵל לְקָפֶה הַטּוּרְקִי שֶׁלּוֹ.",
        ...
        WordEntity(id = 189411, setId = 1894, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "רֵיחָן",
            translation = "базилик",
            definition = "צֶמַח תַּבְלִין יָרוֹק בַּעַל אָרוֹמָה מְתוּקָה וַעֲדִינָה, מוֹסִיפִים אוֹתוֹ לְפַסְטָה וּפֶּסְטוֹ.",
            definitionNative = "Зелёная пряная трава со сладким мягким ароматом; идёт в пасту и в соус песто.",
            example = "כָּתַשְׁתִּי עֲלֵי רֵיחָן טְרִיִּים עִם שׁוּם וְשֶׁמֶן זַיִת.",
        ...
        WordEntity(id = 189413, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "צֶמַח תַּבְלִין עִם מַחֲטִים יְרֻקּוֹת וְרֵיחַ אָרוֹמָטִי חָזָק, מַתְאִים לְעוֹף וְלִתְפּוּחֵי אֲדָמָה.",
            definitionNative = "Куст со жёсткой хвоей и сильным ароматом; отлично подходит к курице и к запечённой картошке.",
            example = "הִנַּחְתִּי עַנְפֵי רוֹזְמָרִין מִתַּחַת לָעוֹף לִפְנֵי הַצְּלִיָּה.",
        ...
        WordEntity(id = 189414, setId = 1894, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "שָׁמִיר",
            translation = "укроп",
            definition = "צֶמַח תַּבְלִין דַּק עִם עָלִים נוֹצָתִיִּים וְרֵיחַ קַל, מוֹסִיפִים אוֹתוֹ לְסָלָטִים וּלְמְלַפְפוֹנֵי כְּבוּשִׁים.",
        ...
        WordEntity(id = 189415, setId = 1894, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "עֵשֶׂב תַּבְלִין יָרוֹק עִם עָלִים מְסוּלָּסִים אוֹ שְׁטוּחִים, נֶחְשָׁב יְסוֹדִי בְּסָלַט תַּבּוּלֶה.",
        ...
        WordEntity(id = 189417, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "גָּרַדְתִּי מְעַט אֱגוֹז מוּסְקָט עַל רוֹטֶב הַבֶּשָׁמֶל.",
        ...
        WordEntity(id = 189418, setId = 1894, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "וָנִיל",
            translation = "ваниль",
            definition = "תַּרְמִילִים שְׁחוֹרִים שֶׁל סַחְלָב טְרוֹפִּי עִם זְרָעִים אָרוֹמָטִיִּים, מְשַׁמְּשִׁים לְעוּגוֹת וְלִקְצֶפֶת.",
        ...
        WordEntity(id = 189419, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            original = "שׁוּמָר",
            translation = "фенхель",
            definition = "צֶמַח עִם בָּצָל לָבָן וְעָלִים נוֹצָתִיִּים, בַּעַל טַעַם מָתוֹק שֶׁל אַנִיס.",
        ...
        WordEntity(id = 189423, setId = 1894, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "מָרַחְתִּי חַרְדַּל דִּיז'וֹן עַל הַכָּרִיךְ לִפְנֵי שֶׁהוֹסַפְתִּי גְּבִינָה.",
        ...
        WordEntity(id = 189425, setId = 1894, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "צֵרוּף שֶׁל כַּמָּה אֲבָקוֹת אָרוֹמַטִיּוֹת בְּיַחַס קָבוּעַ, כְּמוֹ בַּהֲרָאַת אוֹ חַוָאיֵג׳.",
