...
object WordDataHebrewHightechL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "צוּרָה שֶׁבָּהּ מְסֻדָּרוֹת הַמַּחְלָקוֹת וְכַפִיפוּיוֹת בֵּין הָאֲנָשִׁים בַּחֶבְרָה.",
            definitionNative = "То, как устроены отделы и кому кто подчиняется внутри фирмы.",
            example = "מִבְנֶה אִרְגּוּנִי שָׁטוּחַ הִתְאִים לִשְׁלֹשִׁים אִישׁ אֲבָל לֹא לְמֶאֱתַיִם.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ קָצָר וְלֹא מְחַיֵּב שֶׁמְסַכֵּם אֶת הַתְּנָאִים הָעִקָּרִיִּים שֶׁל הָעִסְקָה.",
            definitionNative = "Короткая необязывающая бумага — резюмирует ключевые условия будущей сделки.",
            example = "הַמַּשְׁקִיעַ הָרָאשִׁי שָׁלַח טֶרֶם שִׁיט עִם הַעֲרָכָה גְּבוֹהָה מֵהַצָּפוּי.",
        ...
        WordEntity(
            ...
            definition = "טַבְלָה מְפֹרֶטֶת שֶׁמַּרְאָה מִי מַחֲזִיק כָּל אָחוּז וְכָל סוּג שֶׁל נְיַר עֵרֶךְ בַּחֶבְרָה.",
        ...
        WordEntity(
            ...
            definition = "הַחְלָטָה אֵיךְ הַמּוּצָר נִתְפַּס בַּשּׁוּק וּמוּל מִי הוּא מַתְמוֹדֵד.",
        ...
        WordEntity(
            ...
            example = "אֶפֶקְט הָרֶשֶׁת יָצַר לְוָוטְסְאַפּ מוֹאַט שֶׁאַף אֶחָד לֹא הִצְלִיחַ לִשְׁבֹּר.",
        ...
        WordEntity(
            ...
            definition = "מַשֶּׁהוּ שֶׁחֶבְרָה עוֹשָׂה טוֹב יוֹתֵר מֵאֲחֵרִים וְקָשֶׁה לָהֶם לְהַדְבִּיק אוֹתָהּ.",
            definitionNative = "То, что фирма делает лучше прочих, — и им сложно её догнать.",
            example = "הַיִּתְרוֹן הַתַּחֲרוּתִי שֶׁלָּנוּ הוּא מַאֲגַר נְתוּנִים שֶׁאָסַּפְנוּ עֶשֶׂר שָׁנִים.",
        ...
        WordEntity(
            ...
            definition = "הַשָּׁלָב שֶׁבּוֹ הַשּׁוּק קוֹנֶה בְּתֵיאָבוֹן אֶת מָה שֶּׁהַסְּטַרְטְאַפּ מַצִּיעַ.",
        ...
        WordEntity(
            ...
            definition = "אֲחוּז הָעוֹבְדִים שֶׁעוֹזְבִים אֶת הַחֶבְרָה בְּמֶשֶׁךְ שָׁנָה אַחַת לִכְלַל הַסֶּגֶל.",
        ...
        WordEntity(
            ...
            definition = "מַעֲרֶכֶת אֶמְצָעִים שֶׁל הַחֶבְרָה כְּדֵי שֶׁאֲנָשִׁים טוֹבִים יִשָּׁאֲרוּ זְמַן רַב.",
        ...
        WordEntity(
            ...
            example = "אוֹנָאוּת חֲזָקָה אֵצֶל מְהַנְדְּסִים גּוֹרֶמֶת לָהֶם לִפְתֹּחַ בַּגִּים בְּלִי בַּקָּשָׁה.",
        ...
        WordEntity(
            ...
            definition = "נְכוֹנוּת לָתֵת דִּין וְחֶשְׁבּוֹן עַל מַעֲשִׂים וְתְוֹצָאוֹת בְּלִי לְהַאֲשִׁים אֶת הַסְּבִיבָה.",
        ...
        WordEntity(
            ...
            definition = "הַתַּדְמִית שֶׁל הַחֶבְרָה בְּעֵינֵי הַמֻּעָמָדִים שֶׁעוֹד לֹא הִגִּיעוּ אֵלֶיהָ.",
            definitionNative = "Образ фирмы в глазах кандидатов, которые ещё в неё не пришли.",
            example = "מוֹתָג מַעֲסִיק חָזָק חוֹסֵךְ מְלֵא כֶּסֶף עַל מוֹדָעוֹת דְּרוּשִׁים.",
