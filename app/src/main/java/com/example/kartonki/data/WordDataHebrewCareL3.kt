...
object WordDataHebrewCareL3 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "care_age_specifics",
        ...
        WordEntity(
            ...
            example = "יְרִידָה בִּרְאִיָּה מַקְשָׁה עָלֶיהָ לִקְרֹא תָּוֵּי הַתְּרוּפוֹת.",
        ...
        WordEntity(
            ...
            example = "רֵיחַ זִקְנָה נֶחְלַשׁ אַחֲרֵי מִקְלַחַת חַמָּה וּבְגָדִים נְקִיִּים.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "care_medical_basics",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "care_medical_basics",
            ...
            example = "פּוּלְסוֹמֶטֶר נִצְמָד לָאֶצְבַּע וְנוֹתֵן תּוֹצָאָה תּוֹךְ דַּקָּה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "care_mobility",
        ...
        WordEntity(
            ...
            definition = "סִבּוּב הַגּוּף מִצַּד אֶחָד לַשֵּׁנִי לִמְנִיעַת פְּצָעִים בָּעוֹר.",
        ...
        WordEntity(
            ...
            example = "אַבְטָחָה בְּמַעֲבָר חוֹסֶכֶת חַבָּלוֹת קְשׁוּחוֹת בַּמָּתְנַיִם.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "care_family_communication",
        ...
        WordEntity(
            ...
            definition = "הוֹדָעָה דְּחוּפָה לַמִּשְׁפָּחָה כְּשֶׁמַּצַּב הַזָּקֵן יוֹרֵד פִּתְאוֹם.",
            definitionNative = "Срочное сообщение родне, когда состояние старика резко ухудшается.",
            example = "דִּוּוּחַ עַל הַחְמָרָה נִשְׁלַח לַבַּת תּוֹךְ עֶשֶׂר דַּקּוֹת.",
        ...
        WordEntity(
            ...
            definition = "טֵלֵפוֹן קָבוּעַ בַּשָּׁעָה הָאַחַת אַחֲרֵי הַצָּהֳרַיִם עַל מַהֲלַךְ הַיּוֹם.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "care_documentation",
            original = "יוֹמָן טִיפּוּל", translation = "журнал ухода",
            definition = "מַחְבֶּרֶת שֶׁבָּהּ נִרְשָׁמוֹת כָּל הַפְּעֻלּוֹת לְלָקוּחַ בְּמַהֲלַךְ הַיּוֹם.",
            definitionNative = "Тетрадь, в которой фиксируются все действия с подопечным за сутки.",
            example = "יוֹמַן טִיפּוּל נִשְׁאַר עַל שֻׁלְחַן הַסָּלוֹן לְבוֹדְקֵי הָאֲגַף.",
        ...
        WordEntity(
            ...
            definition = "דַּף שֶׁבּוֹ הַסִּיעֶדֶת מְסַכֶּמֶת מָה קָּרָה לִפְנֵי שֶׁעוֹזֶבֶת.",
        ...
        WordEntity(
            ...
            definition = "רְשִׁימָה שֶׁל הִתְבַּטְּאוּיוֹת לֹא רְגִילוֹת בַּגּוּף וּבַמַּצָּב הָרוּחַ.",
        ...
        WordEntity(
            ...
            definition = "טַבְלָה שֶׁמּוֹנָה כָּל כַּדּוּר וְזָרְקָה שֶׁמְּקַבֵּל הַמְּטוּפָּל בַּיּוֹם.",
