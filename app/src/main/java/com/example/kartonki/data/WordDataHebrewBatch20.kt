...
object WordDataHebrewBatch20 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "סִידּוּר מֻקְפָּד שֶׁל כָּל הַמַּרְכִּיבִים בִּכְלֵי קְטַנִּים לִפְנֵי הַדְלָקַת הָאֵשׁ.",
            definitionNative = "Упорядоченная раскладка всех составляющих до начала приготовления.",
            example = "הַשֶּׁף דּוֹרֵשׁ מִיז אָן פְּלַס מוּשְׁלָם לִפְנֵי פְּתִיחַת הַמִּסְעָדָה.",
        ...
        WordEntity(
            ...
            definition = "רוֹטֵב חוּם סָמִיךְ הַמִּתְקַבֵּל מֵצִמְצוּם אָרֹךְ שֶׁל מָרָק עַצְמוֹת בָּקָר.",
            definitionNative = "Густой коричневый соус из выпаренного мясного бульона для блюд из говядины.",
            example = "הַשֶּׁף הִכִין דֵּמִי גְּלָס בְּמֶשֶׁךְ שְׁמוֹנֶה שָׁעוֹת.",
        ...
        WordEntity(
            ...
            definition = "רוֹטֵב לָבָן צָרְפָתִי קְלָאסִי שֶׁמָּכִינִים מֵחָלָב, חֶמְאָה וְקֶמַח לָבָן.",
        ...
        WordEntity(
            ...
            example = "בְּמִטְבָּח צָרְפַת קַיָּמִים חֲמִישָּׁה רוֹטֵב אֵם קְלָאסִיִּים.",
        ...
        WordEntity(
            ...
            example = "הַשֶּׁף הוֹסִיף שׁוּמְשׁוּם לַפָּנִירָה לִקְרִיסְפִּיּוּת.",
        ...
        WordEntity(
            ...
            definition = "מַאֲפֶה מֵאוֹת שִׁכְבוֹת דַּקִּיקוֹת שֶׁל קֶמַח עִם חֶמְאָה הַמּוּפְרָדוֹת בַּאֲפִיָּה.",
        ...
        WordEntity(
            ...
            example = "הוּא מָזִין מַחְמַצָּהּ בְּקֶמַח שֶׁבַע שָׁנִים.",
        ...
        WordEntity(
            ...
            definition = "בָּצָל קָטָן וּמֻאָרָךְ בְּטַעַם עָדִין וּמָתוֹק, מַתְאִים לִרְטָבִים צָרְפָתִיִּים.",
        ...
        WordEntity(
            ...
            definition = "תַּעֲרֹבֶת יַצִּיבָה שֶׁל שְׁנֵי נוֹזְלִים שֶׁלֹּא מִתְעָרְבִים, כְּמוֹ שֶׁמֶן וּמַיִם בְּמָיוֹנֵז.",
        ...
        WordEntity(
            ...
            definition = "תִּבְשׁוּל אִטִּי שֶׁל רֶגֶל בַּרְוָז אוֹ אַוָּז טַבּוּלָה כֻּלָּהּ בְּשׁוּמַן עַצְמָהּ.",
        ...
        WordEntity(
            ...
            definition = "אָמָּנוּת סִידּוּר הָאֳכֵל עַל הַצַּלַּחַת בְּצוּרָה יָפָה לְפִי כְּלָלֵי עִיצּוּב מִקְצוֹעִיִּים.",
            definitionNative = "Искусство эстетичного расположения еды на тарелке в дорогом ресторане.",
            example = "הַשֶּׁף לוֹמֵד פְּלֵיטִינְג מִינִימָלִיסְטִי יַפָּנִי.",
        ...
        WordEntity(
            ...
            definition = "אָמָּנוּת וּמַדָּע שֶׁל אֳכָלִים מְשׁוּבָּחִים, מֵהַהֲכָנָה וְעַד הַהֲנָאָה בַּפֶּה.",
        ...
        WordEntity(
            ...
            definition = "תְּגוּבָה כִּימִית בֵּין חֶלְבּוֹנִים וְסְכָּרִים בְּחוֹם גָּבוֹהַּ שֶׁיּוֹצֶרֶת קְרוּם זָהֹב וְטָעִים.",
            definitionNative = "Химическое потемнение белков и сахаров при сильном нагреве.",
            example = "הַסְּטֵיְק מְקַבֵּל גָּוֶן זָהֹב בִּזְכוּת מֵיאָרְ.",
        ...
        WordEntity(
            ...
            definition = "חִיתּוּךְ צָרְפָתִי שֶׁל יְרָקוֹת לְקוּבִיּוֹת זְעִירוֹת בְּגֹדֶל שְׁנֵי מ\"מ בִּלְבַד.",
        ...
        WordEntity(
            ...
            definition = "צֵירוּף יִחוּדִי שֶׁל אַקְלִים, אֲדָמָה וּמָסוֹרֶת מְקוֹמִית שֶׁמְּעַצֵּב טַעַם יַיִן אוֹ גְּבִינָה.",
