...
object WordDataHebrewReligionL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מָקוֹר אוֹר קָטָן הַמֻּצָּת לִכְבוֹד שַׁבָּת אוֹ חַג.",
        ...
        WordEntity(
            ...
            example = "בַּמִּסְעָדָה הַזֹּאת כָּל הָאֳכֵל כָּשֵׁר.",
        ...
        WordEntity(
            ...
            definition = "חַג שִׂמְחָה הַמְצַיֵּן אֶת הַצָּלַת הַיְּהוּדִים מִיְּדֵי הָמָן.",
            definitionNative = "Весёлый праздник в память спасения евреев Персии от планов Амана.",
            example = "יְלָדִים מִתְחַפְּשִׂים בְּפּוּרִים וְאוֹכְלִים אָזְנֵי הַמָּן.",
        ...
        WordEntity(
            ...
            definition = "חַג סְתָו יְהוּדִי בּוֹ גָּרִים שִׁבְעָה יָמִים בִּצְרִיף זְמַנִּי מְקֻשָּׁט, זֵכֶר לַנְּדוּדִים בַּמִּדְבָּר.",
            definitionNative = "Семидневный осенний праздник, во время которого живут во временных шалашах.",
            example = "בְּסוּכּוֹת אוֹכְלִים וְיַשְּׁנִים בַּסֻּכָּה.",
        ...
        WordEntity(
            ...
            definition = "מַעֲשֶׂה אָסוּר עַל פִּי הַתּוֹרָה אוֹ נֶגֶד רְצוֹן הָאֵל.",
        ...
        WordEntity(
            ...
            definition = "הַחֵלֶק הָרוּחָנִי בָּאָדָם שֶׁנִּתַּן עַל יְדֵי הָאֵל.",
        ...
        WordEntity(
            ...
            example = "סַבָּא שֶׁלִּי בְּגַן עֵדֶן עַכְשָׁו.",
        ...
        WordEntity(
            ...
            definition = "הַמֶּלֶךְ הָרוּחָנִי שֶׁיָּבוֹא לִגְאֹל אֶת עַם יִשְׂרָאֵל בְּעָתִיד.",
