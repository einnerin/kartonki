...
object WordDataHebrewQaL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "qa_platforms",
            ...
            example = "פְּלַטְפוֹרְמַת בְּדִיקוֹת מֶרְכָּזִית הִחְלִיפָה לָנוּ שִׁבְעָה כְּלִים נְפְרָדִים.",
        ...
        WordEntity(
            ...
            definition = "שֵׁרוּת עָנָן שֶׁמַּרְשֶׁה לְהָרִיץ בְּדִיקוֹת עַל מֵאוֹת דַּפְדְּפָנִים אֲמִתִּיִּים מֵרָחוֹק.",
        ...
        WordEntity(
            ...
            definition = "סְפָּק עָנָן וָתִיק לִבְדִיקוֹת מַקְבִּילוֹת שֶׁל אֲתְרֵי וֵוב וְאַפְּלִיקַצְיוֹת מוֹבַיְיל.",
        ...
        WordEntity(
            ...
            definition = "אֶשְׁכּוֹל שֵׁרַתִּים שֶׁל הַחֶבְרָה עַצְמָהּ — מְקַבֵּל מְשִׂימוֹת בְּדִיקָה וּמְחַלֵּק בֵּינֵיהֶן.",
        ...
        WordEntity(
            ...
            definition = "מַאֲגַר מְכוֹנוֹת גָּדוֹל שֶׁמְּקַצֵּר סָבַב שֶׁל אֲלָפִים בְּדִיקוֹת לְדַקּוֹת בּוֹדְדוֹת.",
            definitionNative = "Большой пул машин — сокращает прогон тысяч проверок до считанных минут.",
            example = "חַוַּת רִיצוֹת מַקְבִּילוֹת חֲדָשָׁה הוֹרִידָה אֶת הַסַּבָּב מִשָּׁעָתַיִם לְשָׁלוֹשׁ דַּקּוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "qa_observability",
            ...
            example = "אָנָלִיטִיקַת בְּדִיקוֹת חָשְׂפָה שֶׁשְּׁלוֹשִׁים אָחוּז מֵהַסַּבָּב מְבֻזְבָּז עַל זְלִיגוֹת.",
        ...
        WordEntity(
            ...
            definition = "מוֹדֶל שֶׁמְּזַהֶה מֵרֹאשׁ בְּאֵיזוֹ קְבָצִים סָבִיר שֶׁתִּפֹּל בְּעָיָה לִפְנֵי שֶׁהַסַּבָּב יָרוּץ.",
        ...
        WordEntity(
            ...
            example = "נִתּוּחַ הַשְׁפָּעָה צִמְצֵם אֶת סָבַב הַפּוּל רִיקְוֵוסְט בִּשְׁמוֹנִים אָחוּז.",
        ...
        WordEntity(
            ...
            definition = "אִסּוּף נְקֻדּוֹת מְדִידָה מִכָּל שְׁלַב בָּרָצָה כְּדֵי לַחֲקֹר אַחַר כָּךְ אִטִּיּוּת אוֹ נְפִילָה.",
        ...
        WordEntity(
            ...
            definition = "מָסַךְ מְרֻכָּז שֶׁמַּצִּיג בִּזְמַן אֱמֶת אֵילוּ סַבָּבִים הִצְלִיחוּ וְכַמָּה בָּאגִים פְּתוּחִים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "qa_mobile",
        ...
        WordEntity(
            ...
            definition = "מַעְבָּדָה עִם עֲשָׂרוֹת טֵלֵפוֹנִים פִיזִיִּים מְחֻבָּרִים לְ|שֵׁרֶת לִבְדִיקָה מֵרָחוֹק.",
        ...
        WordEntity(
            ...
            definition = "סִפְרִיָּה רִשְׁמִית שֶׁל גוּגֶל לִבְדִיקַת מָסַכִּים בְּאַנְדְרוֹאִיד עִם הַמְתָּנוֹת חֲכָמוֹת.",
        ...
        WordEntity(
            ...
            definition = "הַכְּלִי הָרִשְׁמִי שֶׁל אֶפֶּל לִבְדִיקוֹת מַמְשָׁק עַל אַיְיפוֹן וְאַיְיפַּד מִתּוֹךְ הַסְּבִיבָה שֶׁלָּהֶם.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "qa_security",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "qa_quality_engineering",
        ...
        WordEntity(
            ...
            definition = "עִקָּרוֹן שֶׁמַּקְדִּים בְּדִיקוֹת לִשְׁלַבִּים מֻקְדָּמִים שֶׁל הַתִּכְנוּן בִּמְקוֹם רַק לִפְנֵי שִׁחְרוּר.",
        ...
        WordEntity(
            ...
            example = "פִּירָמִידַת בְּדִיקוֹת אִידֵאָלִית מְשַׁמֶּרֶת אֶת הַסַּבָּב מִתַּחַת לְעֶשֶׂר דַּקּוֹת.",
        ...
        WordEntity(
            ...
            definition = "סָפִּים אוֹטוֹמָטִיִּים בַּקּוֹ שֶׁלֹּא נוֹתְנִים לְקוֹד לְהִתְקַדֵּם אִם מַדַּד מְסֻיָּם נָפַל.",
