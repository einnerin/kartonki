...
object WordDataHebrewQaL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "סְפַּק עֲנָן וָתִיק לִבְדִיקוֹת מַקְבִּילוֹת שֶׁל אַתְרֵי וֵוב וְאַפְּלִיקַצְיוֹת מוֹבַיְיל.",
        ...
        WordEntity(
            ...
            definition = "מָסַךְ מְרֻכָּז שֶׁמַּצִּיג בִּזְמַן אֱמֶת אֵילוּ סָבָבִים הִצְלִיחוּ וְכַמָּה בָּאגִים פְּתוּחִים.",
        ...
        WordEntity(
            ...
            definition = "הַכְּלִי הָרִשְׁמִי שֶׁל אֶפֶּל לִבְדִיקוֹת מָמְשָׁק עַל אַיְיפוֹן וְאַיְיפַּד מִתּוֹךְ הַסְּבִיבָה שֶׁלָּהֶם.",
