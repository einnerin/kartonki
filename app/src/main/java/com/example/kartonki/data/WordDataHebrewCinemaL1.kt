...
object WordDataHebrewCinemaL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 185701, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            ...
            definition = "יְצִירָה אֲרֻכָּה שֶׁמַּקְרִינִים בְּקוֹלְנוֹעַ אוֹ צוֹפִים בָּהּ בַּטֵּלֵוִיזְיָה.",
            definitionNative = "Длинная история на экране — её смотрят в зале или дома.",
            example = "אֶתְמוֹל רָאִינוּ סֶרֶט מַצְחִיק שֶׁל אָדָם סַנְדְּלֶר.",
        ...
        WordEntity(id = 185704, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "הַצָּגָה", translation = "показ / спектакль",
        ...
        WordEntity(id = 185706, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "בַּמַּאי", translation = "режиссёр",
        ...
        WordEntity(id = 185707, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "כּוֹכָב", translation = "звезда (известный актёр)",
        ...
        WordEntity(id = 185708, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            ...
            definition = "מִישֶׁהוּ שֶׁיּוֹשֵׁב מוּל הַמָּסָךְ אוֹ הַבָּמָה וּמִסְתַּכֵּל עַל מָה שֶׁקּוֹרֶה.",
        ...
        WordEntity(id = 185709, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "גִּבּוֹר", translation = "герой (главный персонаж)",
        ...
        WordEntity(id = 185710, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "אוֹיֵב", translation = "враг (антагонист в сюжете)",
        ...
        WordEntity(id = 185711, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "תַּפְקִיד", translation = "роль (актёрская)",
        ...
        WordEntity(id = 185712, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "צִילּוּם", translation = "съёмка",
            definition = "תַּהֲלִיךְ שֶׁבּוֹ מַצְלֵמָה קוֹלֶטֶת אֶת מָה שֶׁקּוֹרֶה לְפָנֶיהָ — לְסֶרֶט אוֹ לִתְמוּנָה.",
        ...
        WordEntity(id = 185713, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "עֲרִיכָה", translation = "монтаж (фильма)",
        ...
        WordEntity(id = 185714, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "הַפָּקָה", translation = "продюсирование",
        ...
        WordEntity(id = 185715, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "סְצֵנָה", translation = "сцена (кинокадр)",
        ...
        WordEntity(id = 185716, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "עֲלִילָה", translation = "сюжет",
            definition = "הַסִּפּוּר שֶׁל הַסֶּרֶט — מָה קוֹרֶה לַגִּבּוֹרִים וְאֵיךְ זֶה נִגְמַר בַּסּוֹף.",
        ...
        WordEntity(id = 185717, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "דִּיאַלוֹג", translation = "диалог",
            ...
            example = "הַדִּיאָלוֹג בֵּין הָאַבָּא וְהַבֵּן בַּסּוֹף הִבְכָּה אוֹתִי.",
        ...
        WordEntity(id = 185718, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "מוּזִיקַת רֶקַע", translation = "фоновая музыка (в кино)",
            definition = "הַמּוּזִיקָה הַשְּׁקֵטָה שֶׁמְּנַגֶּנֶת מֵאָחוֹר בִּזְמַן שֶׁהַשַּׂחְקָנִים מְדַבְּרִים.",
            definitionNative = "Тихая музыка, что играет на фоне, пока актёры разговаривают.",
            example = "מוּזִיקַת הָרֶקַע בַּסְּצֵנָה הַזֹּאת מַעֲצִימָה אֶת הָרֶגֶשׁ.",
        ...
        WordEntity(id = 185719, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "כְּתוּבִיּוֹת", translation = "субтитры",
            definition = "מִלִּים שֶׁמּוֹפִיעוֹת לְמַטָּה בַּמָּסָךְ וּמְתַרְגְּמוֹת אֶת מָה שֶׁאוֹמְרִים.",
            definitionNative = "Текст внизу экрана, который переводит то, что говорят на чужом языке.",
            example = "אֲנִי תָּמִיד צוֹפָה בִּסְרָטִים אַנְגְּלִיִּים עִם כְּתוּבִיּוֹת בְּעִבְרִית.",
        ...
        WordEntity(id = 185720, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "דּוּבּוּב", translation = "дубляж",
        ...
        WordEntity(id = 185721, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "בֵּית קוֹלְנוֹעַ", translation = "кинотеатр",
            ...
            example = "בֵּית הַקּוֹלְנוֹעַ בְּדִיזֶנְגוֹף סֶנְטֶר נִסְגַּר לִפְנֵי שְׁנָתַיִם.",
        ...
        WordEntity(id = 185722, setId = 1857, languagePair = "he-ru", rarity = "COMMON",
            original = "כַּרְטִיס", translation = "билет (в кино)",
        ...
        WordEntity(id = 185723, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "פֶסְטִיבָל", translation = "кинофестиваль",
        ...
        WordEntity(id = 185724, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "קְדִימוֹן", translation = "трейлер (анонс фильма)",
            definition = "סֶרְטוֹן קָצָר שֶׁמַּרְאֶה רְגָעִים מִסֶּרֶט עֲתִידִי כְּדֵי לִמְשׁוֹךְ צוֹפִים.",
        ...
        WordEntity(id = 185725, setId = 1857, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "בִּקֹּרֶת", translation = "рецензия / критика",
