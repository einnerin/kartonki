...
object WordDataHebrewIsraeliTransportL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "מְהִירוּת הָרַכֶּבֶת הַמְּהִירָה לִירוּשָׁלַיִם מַגִּיעָה לְמֵאָה וְשִׁשִּׁים.",
        ...
        WordEntity(
            ...
            definition = "הוֹרָדַת מְחִיר אוֹ הֲטָבָה בַּתַּחְבּוּרָה לִגְמַלָּאִים, חַיָּלִים וּסְטוּדֶנְטִים.",
        ...
        WordEntity(
            ...
            definition = "תַּשְׁלוּם שֲׁנָתִי שֶׁמְּכַסֶּה נֶזֶק לָרֶכֶב אוֹ פְּגִיעָה בַּתְּאוּנָה.",
            definitionNative = "Годовой платёж, что покрывает ущерб транспорту или травму при аварии.",
            example = "בִּטּוּחַ הָרֶכֶב הַשָּׁנָה עָלָה בְּמֵאָה שְׁקָלִים בְּגִלַל הָאִינְפְלַצְיָה.",
        ...
        WordEntity(
            ...
            definition = "בְּדִיקָה שֲׁנָתִית שֶׁל מַצַּב הָרֶכֶב לְפִי דְּרִישַׁת מִשְׂרַד הַתַּחְבּוּרָה.",
            definitionNative = "Годовая проверка состояния автомобиля по требованию министерства транспорта.",
            example = "עָבַרְתִּי טֶסְט שֲׁנָתִי וְקִבַּלְתִּי תָּו יָרֹק בְּלִי הֶעָרוֹת.",
        ...
        WordEntity(
            ...
            example = "הִשְׁאַרְתִּי אֶת הָרֶכֶב בַּמּוֹסָךְ עַד מָחָר אַחַר הַצָּהֳרַיִם.",
        ...
        WordEntity(
            ...
            example = "אֶגֶד מַפְעִיל אֶת קַו חֲמֵשׁ-מֵאוֹת מִתֵּל אָבִיב לִירוּשָׁלַיִם.",
        ...
        WordEntity(
            ...
            example = "אֲנִי נוֹסֵעַ לַצָּפוֹן לְסוֹף שָׁבוּעַ אָרֹךְ עִם הַחֲבֵרִים שֶׁלִּי.",
