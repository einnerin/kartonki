...
object WordDataHebrewIsraeliTransportL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definitionNative = "Снижение цены или льгота в транспорте для пенсионеров, солдат и студентов.",
        ...
        WordEntity(
            ...
            example = "פִּסְפַּסְתִּי אֶת הָרַכֶּבֶת הָאַחֲרוֹנָה וְלָקַחְתִּי מוֹנִית הַבַּיְתָה.",
            exampleNative = "Я לְפַסְפֵּס последний поезд и взял такси домой.",
        ),
        WordEntity(
