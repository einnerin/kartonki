...
object WordDataHebrewBaristaL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הַטֵּרוּאָר שֶׁל הַזַּן הַזֶּה מַזְכִּיר אַדַּמַת הָרֵי גְּוָאטֶמָלָה.",
        ...
        WordEntity(
            ...
            definition = "זַן יָקָר בַּעַל אָרוֹמָה פִּרְחוֹנִית מְעוּדֶנֶת מִכָּפְרֵי הָרֵי פָּנָמָה.",
        ...
        WordEntity(
            ...
            definition = "מָנָה זְעִירָה מֵחֶלְקָה אַחַת בְּחַוָּה אַחַת בְּעוֹנָה אַחַת בִּלְבַד.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_latte_art",
            original = "בַּרְבּוּר", translation = "лебедь (узор)",
            definition = "צִיּוּר עָדִין בְּצוּרַת עוֹף מַיִם עִם צַוַּאר וְכָנָף עַל הַכּוֹס.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_latte_art",
            original = "קֶצֶף מִיקְרוֹ", translation = "микропенка",
            definition = "בּוּעוֹת זְעִירוֹת אֲחִידוֹת שֶׁנּוֹתְנוֹת מִרְקָם חָלָק כְּמוֹ צֶבַע.",
        ...
        WordEntity(
            ...
            definition = "צִיּוּר שֶׁל דְּגָם בְּלִי תּוֹסֶפֶת — רַק תְּנוּעַת הַיָּד וְהַזֶּרֶם הַלָּבָן.",
            definitionNative = "Узор без добавок — только движение руки и струя белой массы.",
            example = "יְצִיקָה חוֹפְשִׁית מַרְאָה אֶת אֵיכוּת הָעֲבוֹדָה שֶׁל הַמֵּכִין.",
        ...
        WordEntity(
            ...
            definition = "תּוֹסֶפֶת קַוִּים דַּקִּים בְּקֵיסַם דַּק עַל הַקֶּצֶף לְפֵרוּט שֶׁל הַתְּמוּנָה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_roasting",
        ...
        WordEntity(
            ...
            definition = "הַשֶּׁבַע אַחֲרֵי הַנָּקִּישָׁה הָרִאשׁוֹנָה שֶׁבּוֹ נִבְנֶה הַטַּעַם הַסּוֹפִי.",
        ...
        WordEntity(
            ...
            example = "תְּגוּבַת מַיַאר שׁוֹלֶטֶת בָּאָרוֹמוֹת שֶׁל קָלוּי וְקָרָמֵל.",
        ...
        WordEntity(
            ...
            definition = "יְצִיאַת אֲוִּיר מֵהַזֶּרַע בְּשָׁבוּעַ הָרִאשׁוֹן לִפְנֵי הַשִּׁמּוּשׁ הַטּוֹב.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_brewing_advanced",
            original = "וִי שִׁשִּׁים", translation = "V60 (воронка)",
            definition = "מַסְנֵן יָדַנִי בְּצוּרַת חֵרוּט עִם חֲרִיצִים שֶׁמְּכַוְּנִים אֶת זְרִימַת הַמַּיִם.",
            definitionNative = "Ручная воронка-конус с рёбрами, направляющими ход воды через слой засыпки.",
            example = "אֲנִי מֵכִין וִי שִׁשִּׁים בְּכָל בֹּקֶר לִפְנֵי הָעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר נִשְׁלַף שֶׁל לַחַץ אֲוִיר יְדָנִי לְמָנָה אַחַת חֲזָקָה וּמְהִירָה.",
            definitionNative = "Ручной поршневой прибор с нажимом воздуха на одну быструю крепкую порцию.",
            example = "אֶרוֹפְּרֶס נוֹחַ מְאוֹד לְטִיסָה אוֹ לְטִיוּל בַּהֲרִים.",
        ...
        WordEntity(
            ...
            definition = "בַּקְבּוּק זְכוּכִית עִם צַוַּאר וְעוֹר מֻדְבָּק לְכוֹס סִינוּן אִיטִית וּצְלוּלָה.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטָה אִיטִית שֶׁל שְׁפִיכַת מַיִם בְּיַד עַל אָבָק בְּמַסְנֵן נְיָר.",
        ...
        WordEntity(
            ...
            definition = "שֶׁפֶךְ קָטָן רִאשׁוֹן שֶׁמַּפְרִישׁ אֲוִּיר מֵהַטַּחֲנָה לִפְנֵי הַשֶּׁפֶךְ הָעִקָּרִי.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "barista_competition",
            ...
            example = "אַלִּיפוּת בָּרִיסְטָה הַשְּׁנָתִית תִּתְקַיֵּם בְּתֵל אָבִיב הַשָּׁנָה.",
        ...
        WordEntity(
            ...
            definition = "שֻׁלְחַן עֲבוֹדָה רִשְׁמִי שֶׁבּוֹ הַמִּתְמוֹדֵד מָכִּין מָנוֹת לִפְנֵי הַקָּהָל.",
        ...
        WordEntity(
            ...
            definition = "דַּף רִשְׁמִי שֶׁבּוֹ הַשּׁוֹפֵט מְצַיֵּן צִיּוּן לְכָל פָּרַט שֶׁל הַמָּנָה.",
        ...
        WordEntity(
            ...
            example = "גְּבִיעַ הַטּוֹעֵם דּוֹרֵשׁ אַף עָדִין וְזִכָּרוֹן חַד מְאוֹד.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_competition",
            ...
            example = "הַסִּיגְנָטוּרָה שֶׁלִּי כּוֹלֶלֶת בַּזִּיל קַר וְטְלוֹאַת לִימוֹן.",
