...
object WordDataEnglishBusiness {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 42301, setId = 423, languagePair = "en-ru", rarity = "EPIC",
            ...
            definitionNative = "Когда две компании вместе зарабатывают больше, чем порознь.",
        ...
        WordEntity(id = 42302, setId = 423, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Огромная корпорация — у неё много не связанных направлений бизнеса в одной группе.",
        ...
        WordEntity(id = 42303, setId = 423, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Когда корпорация избавляется от части активов, чтобы лучше сосредоточиться на главном.",
        ...
        WordEntity(id = 42304, setId = 423, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Захват контроля над фирмой наперекор воле её руководителей.",
        ...
        WordEntity(id = 42305, setId = 423, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Официальный конец фирмы — её юридическое лицо закрывают навсегда.",
        ...
        WordEntity(id = 42307, setId = 423, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Ведущий себя так, будто один продавец полностью владеет всем рынком.",
        ...
        WordEntity(id = 42321, setId = 423, languagePair = "en-ru", rarity = "EPIC",
            ...
            exampleNative = "Юристы заменили старый boilerplate на более простой современный язык.",
        ...
        WordEntity(id = 42324, setId = 423, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Уловка совета — чтобы фирма стала менее привлекательной для враждебного покупателя.",
