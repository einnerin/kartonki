...
object WordDataHebrewAiMlL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "אִישׁ צֶוֶות שֶׁמְּפַתֵּחַ אַלְגוֹרִיתְמִים חֲדָשִׁים וּמְפַרְסֵם מַאֲמָרִים בִּכְנָסִים מַדָּעִיִּים.",
            definitionNative = "Человек в команде, который придумывает новые алгоритмы и публикует научные статьи.",
            example = "אֶם-אֶל רִיסֵרְצֶ'ר חָדָשׁ הִצְטָרֵף לַצֶּוֶות יָשַׁר מִדּוֹקְטוֹרָט בִּסְטָנְפוֹרְד.",
        ...
        WordEntity(
            ...
            definition = "אִישׁ מֶחְקָר שֶׁמּוֹרִיד רַעֲיוֹנוֹת אָקָדֵמִיִּים לְפִתְרוֹנוֹת שֶׁבָּאֱמֶת רָצִים אֵצֶל לָקוֹחוֹת.",
        ...
        WordEntity(
            ...
            definition = "מְהַנְדֵּס שֶׁבּוֹנֶה צִנּוֹרוֹת אִימּוּן וְיִישּׂוּם שֶׁל בִּינָה מְלָאכוּתִית בִּסְבִיבָה אֲמִיתִית.",
        ...
        WordEntity(
            ...
            definition = "מְהַנְדֵּס שֶׁאַחְרָאִי עַל הַתַּשְׁתִּית, פְּרִיסָה וּמַעֲקָב אַחַר מוֹדֵלִים בִּפְרוֹדַקְשֶׁן.",
        ...
        WordEntity(
            ...
            definition = "אֲסֵפָה שֶׁל מָאוֹת כַּרְטִיסִים גְּרָפִיִּים מְחֻבָּרִים יַחַד לְהַפְעָלָה שֶׁל אִימּוּנִים כְּבֵדִים.",
        ...
        WordEntity(
            ...
            example = "מִבְחָן A/B הוֹכִיחַ שֶׁכַּפְתּוֹר יָרֹק מַעֲלֶה הַמְרוֹת בְּשִׁבְעָה אָחוּז.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ שֶׁמּוֹצֵא אֵיפֹה הַמּוֹדֵל מַפְלֶה קְבוּצוֹת אוּכְלוּסִיָּה לְפִי מִין, גֶּזַע אוֹ גִּיל.",
        ...
        WordEntity(
            ...
            example = "וַעֲדַת הוֹגְנוּת בָּדְקָה כָּל אַלְגוֹרִיתְם לִפְנֵי שֶׁעָלָה לִפְרוֹדַקְשֶׁן.",
        ...
        WordEntity(
            ...
            definition = "מֶחְקָר שֶׁמְּוַדֵּא שֶׁמַּעֲרָכוֹת חֲכָמוֹת מְמַלְּאוֹת אַחַר כַּוָּונוֹת אֱנוֹשִׁיּוֹת וְלֹא סוֹטוֹת מֵהֶן.",
            ...
            exampleNative = "Команда אֵיי-אַיי אַלַיינְמֶנְט в Anthropic — лишь десятки исследователей.",
        ...
        WordEntity(
            ...
            definition = "עֲמִידָה שִׁיטָתִית בִּדְרִישׁוֹת חוֹק וְתַקָּנוֹת רִשְׁמִיּוֹת בְּכָל פְּעֻלָּה עִסְקִית.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ קָצָר שֶׁמְּתָאֵר עַל מָה הַמּוֹדֵל אֻמָּן, לְמָה הוּא מַתְאִים וְאֵיפֹה הוּא נִכְשַׁל.",
            definitionNative = "Короткий документ — на чём модель тренировалась, для чего годится и где плохо работает.",
            example = "מוֹדֵל קַארְד עַל גִ'יטְהָאבּ הוּא תְּנַאי לְשִׁתּוּף מוֹדֵל בְּקוֹד פָּתוּחַ.",
        ...
        WordEntity(
            ...
            definition = "רֶצֶף רְשׁוּמוֹת בְּלִתִּי נִיתָּן לְשִׁינּוּי שֶׁמְּתַעֵד מִי עָשָׂה מָה וּמָתַי בַּמַּעֲרֶכֶת.",
            definitionNative = "Неизменяемая последовательность записей — кто, что и когда делал в системе.",
            example = "אוֹדִיט טְרֵייל מְלָאֶהָ הוּא תְּנַאי בְּסִיסִי בְּכָל מַעֲרֶכֶת רְפוּאִית.",
        ...
        WordEntity(
            ...
            definition = "מָבְנֶה עֲנָק עִם אַלְפֵי מַחְשְׁבִים מְקֻרֲרִים שֶׁמַּפְעִילִים אֶת הָאִימּוּן יוֹמָם וָלַיְלָה.",
        ...
        WordEntity(
            ...
            definition = "דִּילֶמָה אִסְטְרָטֵגִית: לְפַתֵּחַ פִּתְרוֹן בְּעַצְמְךָ אוֹ לְהִשְׁתַּמֵּשׁ בְּכֵלִים מוּכָנִים.",
            definitionNative = "Стратегическая дилемма — сделать решение самому или взять готовый инструмент.",
            example = "הַחְלָטַת בְּנֵה אוֹ קְנֵה בִּמְשִׁיכַת מוֹדֵלִים נַחְתְּכָהּ לְטוֹבַת אַנְתְ'רוֹפִּיק.",
