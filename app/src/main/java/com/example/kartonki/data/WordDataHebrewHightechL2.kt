...
object WordDataHebrewHightechL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מַחֲזוֹר עֲבוֹדָה קָצָר שֶׁל שָׁבוּעַיִם, שֶׁבְּסוֹפוֹ הַצֶּוֶות מַסְפִּיק לְמַסֵּר תּוֹצָר.",
        ...
        WordEntity(
            ...
            definition = "פְּגִישָׁה בְּסוֹף מַחֲזוֹר שֶׁל דִּיוּן עַל מָה עָבַד טוֹב וּמָה צָרִיךְ לְשַׁפֵּר.",
            definitionNative = "Встреча в конце цикла — обсуждают, что прошло хорошо и что нужно улучшить.",
            example = "בָּרֶטְרוֹסְפֶּקְטִיב הֶחְלַטְנוּ לְקַצֵּר אֶת אֹרֶךְ הַפְּגִישׁוֹת בַּעֲתִיד.",
        ...
        WordEntity(
            ...
            definition = "פְּגִישָׁה שֶׁבָּהּ בּוֹחֲרִים אֵילוּ מְשִׂימוֹת יִכָּנְסוּ לַמַּחֲזוֹר הַקָּרוֹב.",
        ...
        WordEntity(
            ...
            definition = "בַּקָּשָׁה לְמַזְּגוּ שִׁנּוּיֵי קוֹד מֵעָנָף צֲדָדִי אֶל הַעֲנַף הָרָאשִׁי שֶׁל הַפּרוֹיֶקְט.",
        ...
        WordEntity(
            ...
            definition = "סִימַן יָרֹק שֶׁל בּוֹדֵק הַקּוֹד שֶׁכָּל הַשִּׁנּוּיִים מוּכָנִים לְהִתְמַזֵּג.",
        ...
        WordEntity(
            ...
            definition = "תְּצוּגָה צַבְעוֹנִית שֶׁל הַשּׁוּרוֹת שֶׁנּוֹסְפוּ אוֹ נִמְחֲקוּ בֵּין שְׁתֵּי גִּרְסָאוֹת.",
            definitionNative = "Цветной показ строк, которые добавились или удалились между двумя версиями.",
            example = "הִסְתַּכַּלְתִּי עַל הַדִּיף וְהֵבַנְתִּי שֶׁשָּׁכַחְתִּי לְמַחֹק קוֹד דִּיבּוּג.",
        ...
        WordEntity(
            ...
            example = "בְּלִי שִׁחְזוּר בָּאג אָמִין הַמְּפַתֵּחַ אֵינוֹ יָכוֹל לְתַקֵּן כְּלוּם.",
        ...
        WordEntity(
            ...
            example = "הַסְּטָטוּס הִשְׁתַּנָּה לְ-«בִּבְדִיקָה» אַחֲרֵי שֶׁהַטֶּסְטֶר קִבֵּל אֶת הַמְּשִׂימָה.",
        ...
        WordEntity(
            ...
            definition = "מַצַּב גְּבוּל לֹא רָגִיל שֶׁבּוֹ הַתּוֹכְנָה מַתְנַהֶגֶת אַחֶרֶת מֵהַצָּפוּי.",
        ...
        WordEntity(
            ...
            definition = "תִּקּוּן דָּחוּף וּקְצַר טְוָח שֶׁיּוֹצֵא לַמִּשְׁתַּמְּשִׁים בְּלִי לְחַכּוֹת לַמַּחֲזוֹר הָרָגִיל.",
        ...
        WordEntity(
            ...
            definition = "אַחְרַאי עַל אֲנָשִׁים — שָׂכָר, קִדּוּם, מָשּׁוֹב וּמְעוֹדֵד הִתְפַּתְּחוּת אִישִׁית.",
        ...
        WordEntity(
            ...
            definition = "תְּגוּבָה כֵּנָה לַעֲבוֹדַת אָדָם שֶׁעוֹזֶרֶת לוֹ לְהָבִין מָה לְהַמְשִׁיךְ אוֹ לְשַׁנּוֹת.",
            definitionNative = "Честный отклик о работе человека — помогает ему понять, что продолжать или менять.",
            example = "פִידְבֵּק יָשִׁיר מֵעֲמִיתִים שִׁפֵּר אֶת הָעֲבוֹדָה שֶׁלִּי מֵרַבָּעוֹן לְרָבָעוֹן.",
