...
object WordDataEnglishEverydayL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 32808, setId = 328, languagePair = "en-ru", rarity = "EPIC",
            ...
            definitionNative = "Одновременно встревоженный и недовольный — выбит из равновесия неприятной проблемой.",
        ...
        WordEntity(id = 32814, setId = 328, languagePair = "en-ru", rarity = "EPIC",
            ...
            definitionNative = "Грустный и брошенный — оставленный друзьями или даже самой надеждой.",
