...
object WordDataHebrewHealthKupatHolim {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 191701, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "מַעֲבַר קֻפָּה מִתְבַּצֵּעַ דֶּרֶךְ הָאֲתָר שֶׁל הַבִּטּוּחַ הַלְּאֻמִּי.",
        ...
        WordEntity(id = 191702, setId = 1917, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "בְּלִי כַּרְטִיס מְבֻטַּח הָאָחוֹת לֹא יְכוֹלָה לִפְתֹּחַ אֶת הַתִּיק.",
        ...
        WordEntity(id = 191703, setId = 1917, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מִשְׂרַד שָׁכוּן בַּשְּׁכוּנָה שֶׁמַּעֲנִיק שֵׁרוּתֵי הַרְשָׁמָה וּבְדִיקוֹת בְּסִיסִיּוֹת.",
            definitionNative = "Офис в районе, где оформляют записи и сдают базовые анализы рядом с домом.",
            example = "סֲנִיף קֻפַּת חוֹלִים נִפְתָּח בְּשֶׁבַע בַּבֹּקֶר וְעוֹמֵד עַד הָעֶרֶב.",
        ...
        WordEntity(id = 191708, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "רְפוּאָה מְקַדֶּמֶת מַצִּילָה כֶּסֶף וּזְמַן בַּטְּוָוח הָאָרֹךְ.",
        ...
        WordEntity(id = 191709, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "הַגָּעַת רוֹפֵא לְבֵית הַחוֹלֶה — שֵׁרוּת לִקְשִׁישִׁים וּלְמִי שֶׁאֵינוֹ נַיָּד.",
            definitionNative = "Приход врача на дом к пациенту — услуга для пожилых и для тех, кто не может ходить.",
            example = "הִזְמַנְתִּי בִּקּוּר בַּיִת רְפוּאִי לְסַבָּתָא כִּי הִיא לֹא יְכוֹלָה לָצֵאת.",
        ...
        WordEntity(id = 191710, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פְּגִישָׁה עִם רוֹפֵא בְּוִידֵאוֹ אוֹ בְּצַ'ט — בְּלִי לְהַגִּיעַ פִיזִית לַסַּנִּיף.",
            definitionNative = "Встреча с врачом в видео или в чате — без необходимости физически приходить в филиал.",
            example = "רְפוּאָה מֵרָחוֹק מַתְאִימָה לְמַחֲלוֹת קַלּוֹת וּלְמַעֲקָב כְּרוֹנִי.",
        ...
        WordEntity(id = 191712, setId = 1917, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "פֶּתֶק נְיָר שֶׁמְּעִיד עַל תַּשְׁלוּם בְּדָלְפֵּק הַקֻּפָּה — נִשְׁמַר לְהַחְזֵר אוֹ לְמַס.",
        ...
        WordEntity(id = 191713, setId = 1917, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "תַּשְׁלוּם חַדְּשִׁי קָבוּעַ עַל הַתָּכְנִית הַמַּשְׁלִימָה שֶׁל הַקֻּפָּה.",
            definitionNative = "Фиксированная ежемесячная оплата за дополнительную программу кассы, поверх базовой страховки.",
            example = "דְּמֵי חָבֵר בַּעֲלוּ הַשָּׁנָה בְּכַעֲשָׂרָה אֲחוּזִים.",
        ...
        WordEntity(id = 191714, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִסְמָךְ רִשְׁמִי שֶׁמְּזַכֶּה בְּהַנָּחָה עַל תְּרוּפוֹת וְעַל בִּקּוּרֵי מֻמְחֶה.",
        ...
        WordEntity(id = 191715, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הִגַּעְתִּי לְתִקְרַת תַּשְׁלוּם בְּחֹדֶשׁ מָרְץ וְלֹא שִׁלַּמְתִּי יוֹתֵר.",
        ...
        WordEntity(id = 191718, setId = 1917, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "תַּצְלוּם פְּנִימִי שֶׁל הַגּוּף בִּקְרִינַת אֶקְס — מַרְאֶה עֲצָמוֹת וְשִׁבְרֵי כַּפְּלִים.",
        ...
        WordEntity(id = 191719, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הָרוֹפֵא רָשַׁם טִיפּוּל פִיזְיוֹתֵרַפִּי לִשְׁמוֹנֶה מִפְגָּשִׁים.",
        ...
        WordEntity(id = 191720, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "זוֹגוֹת צְעִירִים עוֹשִׂים בְּדִיקָה גֵּנֵטִית לִפְנֵי הֵרָיוֹן.",
        ...
        WordEntity(id = 191725, setId = 1917, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "מָנוּי בְּנַטֳּלִי הִצִּיל לָנוּ לַיְלָה שָׁלֵם בְּלִי חֲדַר מִיּוּן.",
