...
object WordDataHebrewIsraeliTransportL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הָרַכֶּבֶת לִיְרוּשָׁלַיִם יוֹצֵאת מֵרָצִיף שָׁלֹשׁ בְּעוֹד שָׁלֹשׁ דַּקּוֹת.",
        ...
        WordEntity(
            ...
            transliteration = "таханат ракевет",
        ...
        WordEntity(
            ...
            transliteration = "маса",
            definition = "נְסִיעָה אֲרֻכָּה אוֹ מְעַנְיֶנֶת מִנְּקֻדָּה אַחַת לִנְקֻדָּה אַחֶרֶת בְּכְלִי תַּחְבּוּרָה.",
            definitionNative = "Длинная или интересная поездка из одной точки в другую на транспорте.",
        ...
        WordEntity(
            ...
            transliteration = "лехакот",
            definition = "לַעֲמֹד בְּמָקוֹם וּלְהַמְתִּין עַד שֶׁמַּשֶּׁהוּ אוֹ מִישֶׁהוּ יַגִּיעַ.",
            definitionNative = "Стоять на месте и ждать, пока что-то или кто-то не подойдёт или прибудет.",
        ...
        WordEntity(
            ...
            transliteration = "ларедет",
            definition = "לָצֵאת מִכְּלִי תַּחְבּוּרָה דֶּרֶךְ הַדֶּלֶת בְּסוֹף הַנְּסִיעָה אוֹ בַּתַּחֲנָה.",
            definitionNative = "Выходить из транспорта через дверь в конце поездки или на остановке.",
