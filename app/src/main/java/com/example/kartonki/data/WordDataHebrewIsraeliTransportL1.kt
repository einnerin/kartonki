...
object WordDataHebrewIsraeliTransportL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "אוֹטוֹבּוּס מִסְפַּר חֲמִשִּׁים וְחָמֵשׁ נוֹסֵעַ לָעֲבוֹדָה שֶׁלִּי בַּבֹּקֶר.",
        ...
        WordEntity(
            ...
            definition = "נְסִיעָה אֲרֻכָּה אוֹ מְעַנְיֶנֶת מִנְּקֻדָּה אַחַת לִנְקֻדָּה אַחֶרֶת בְּכֶלִי תַּחְבּוּרָה.",
            definitionNative = "Долгое путешествие из одной точки в другую на машине или автобусе.",
            example = "הַמַּסָּע מֵהַצָּפוֹן לְאֵילַת אָרַךְ שֵׁשׁ שָׁעוֹת בְּלִי הַפְסָקוֹת.",
        ...
        WordEntity(
            ...
            definition = "הַמָּקוֹם הַסּוֹפִי שֶׁאֵלָיו רוֹצִים לְהַגִּיעַ בִּנְסִיעָה אוֹ בְּמַסַּע.",
