...
object WordDataHebrewEmotionsL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "emotions_l3_psychology",
            original = "אֲטִימוּת", translation = "бесчувственность, эмоциональная нечуткость",
            definition = "מַצָּב שֶׁבּוֹ אָדָם אֵינוֹ מָגִּיב לִכְאֵב אוֹ לְרִגְשׁוֹת שֶׁל הַזּוּלָת וְנִשְׁאָר קַר וְסָגוּר.",
            definitionNative = "Состояние, при котором человек не откликается на чужую боль или чувства и остаётся холодным и закрытым.",
            example = "הָאֲטִימוּת שֶׁלּוֹ כְּלַפֵּי סִבְלָם שֶׁל אֲחֵרִים הִדְהִימָה אֶת כָּל הַצֶּוֶת.",
            exampleNative = "Его אֲטִימוּת к страданиям окружающих поразила всю команду.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "emotions_l3_psychology",
            original = "דִּכְדּוּךְ", translation = "подавленность",
            definition = "מַצַּב רוּחַ נָמוּךְ שֶׁמִּתְאַפְיֵן בַּעֲצָבּוּת וַחֻסֵּר אֵנֶרְגִיָּה.",
            definitionNative = "Сниженное настроение, что отличается грустью и нехваткой энергии.",
            example = "דִּכְדּוּךְ סְתָוִי תָּפַס אוֹתוֹ עִם הַגְּשָׁמִים הָרִאשׁוֹנִים.",
            exampleNative = "Осенний דִּכְדּוּךְ накрыл его с первыми дождями.",
        ),
        ...
        WordEntity(
            ...
            definition = "לְבַטֵּא הִזְדַּהוּת עִם הַכְּאֵב שֶׁל אַחֵר וּלְחַלֵּק אִתּוֹ אֶת מַעֲמַסַּת הָעֶצֶב.",
        ...
        WordEntity(
            ...
            example = "הַשֶּׁכֵּן הַזָּעוּף לֹא הֵשִׁיב אַף פַּעַם לִשְׁלוֹם.",
        ...
        WordEntity(
            ...
            definition = "מִי שֶׁמָּגִּיב בִּרְגָשׁוֹת חֲזָקִים וּבְלַהַט, לִפְעָמִים יוֹתֵר מִדַּי.",
            definitionNative = "Тот, кто реагирует сильными эмоциями и страстью, иногда даже чрезмерно.",
            example = "הוּא נוֹאֵם חֲמוּם שֶׁמְּשַׁכְנֵעַ אֶת הַקָּהָל בִּמְהֵרָה.",
        ...
        WordEntity(
            ...
            definition = "מִי שֶׁנִּפְגַּע בְּקַלּוּת מִמִּלִּים אוֹ מִמַּעֲשִׂים שֶׁל אֲחֵרִים.",
            definitionNative = "Тот, кто легко обижается от слов или поступков других людей.",
            example = "יְלָדִים פָּגִיעִים זְקוּקִים לְהֲגַנָּה מְיֻחֶדֶת מֵהַסְּבִיבָה.",
            exampleNative = "פָּגִיעַ детям нужна особая защита со стороны окружения.", isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            definition = "יַחַס שֶׁל כָּבוֹד עָמֹק וְהוֹקָרָה גְּדוֹלָה כְּלַפֵּי אָדָם נֶעֱרַץ.",
        ...
        WordEntity(
            ...
            example = "הוּא לֹא הִצְלִיחַ לְהַסְתִּיר אֶת צָרוּת הָעַיִן בַּמָּכּוֹנִית הַחֲדָשָׁה שֶׁל הַשָּׁכֵן.",
