...
object WordDataHebrewDataEngL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "de_architecture_advanced",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177601L, 177603L, 177604L, 177605L)),
        WordEntity(
            id = 177603, setId = 1776, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "de_architecture_advanced",
            original = "לֵייקְהָאוּס", translation = "lakehouse",
            definition = "אַרְכִיטֶקְטוּרָה שֶׁמְּשַׁלֶּבֶת אָחְסוּן זוֹל שֶׁל לֵייק עִם שְׁאֵלוֹת מְבֻנּוֹת שֶׁל מַחְסָן.",
         ...
         fillInBlankExclusions = listOf(177601L, 177602L, 177604L, 177605L)),
        WordEntity(
            ...
            definition = "תַּבְנִית בִּשְׁלוֹשׁ שִׁכְבוֹת — בְּרוֹנְזֶה לְגַלְמִי, כֶּסֶף לִמְעוּבָּד, זָהָב לִמְזֻכָּךְ.",
            definitionNative = "Шаблон в три слоя — бронза для сырого, серебро для обработанного, золото для очищенного.",
            example = "אַרְכִיטֶקְטוּרַת מֵדַלְיוֹן הֵקֵלָּה עַל הַסְּדֶר וְהַמַּעֲקָב אַחַר אֵיכוּת הַמֵּידָע.",
            exampleNative = "אַרְכִיטֶקְטוּרַת מֵדַלְיוֹן облегчила порядок и слежение за качеством данных.",
         fillInBlankExclusions = listOf(177601L, 177602L, 177603L, 177605L)),
        WordEntity(
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177607L, 177608L, 177609L, 177610L)),
        WordEntity(
            ...
            example = "אִיחוּד מְקוֹרוֹת בְּטְרִינוֹ פָּתַח לָאָנָלִיסְטִים גִּישָׁה לְכָל שֶׁבַע הַחֲטִיבוֹת.",
            exampleNative = "אִיחוּד מְקוֹרוֹת в Trino открыл аналитикам доступ ко всем семи дивизионам.",
         fillInBlankExclusions = listOf(177606L, 177608L, 177609L, 177610L)),
        WordEntity(
            id = 177608, setId = 1776, languagePair = "he-ru", rarity = "LEGENDARY",
            pos = "noun", semanticGroup = "de_query_advanced",
            original = "דְּחִיפַת תְּנַאי", translation = "push-down predicate",
            definition = "אוֹפְּטִימִיזַצְיָה שֶׁבָּהּ הַסִּנּוּן מַתַּחֲלִיף לְצַד הַמָּקוֹר — קוֹרְאִים פָּחוֹת שׁוּרוֹת.",
         ...
         fillInBlankExclusions = listOf(177606L, 177607L, 177609L, 177610L)),
        WordEntity(
        ...
        WordEntity(
            ...
            definition = "תּוֹכְנָה שֶׁקּוֹרֵאת קָבְצֵי עַמּוּדוֹת מָהִיר וּמָרִיצָה שְׁאֵלוֹת אָנָלִיטִיוֹת בִּדְחִיסָה גְּבוֹהָה.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177612L, 177613L, 177614L, 177615L)),
        WordEntity(
            ...
            example = "רִישׁוּם מֻכְשָׁר שֶׁל לָקוֹחַ מָכִּיל אֶת הַכְּתֹבֶת הָעַדְכָּנִית בְּיוֹתֵר מִכָּל מַעֲרֶכֶת.",
            exampleNative = "רִישׁוּם מֻכְשָׁר клиента содержит самый свежий адрес из всех систем.",
         fillInBlankExclusions = listOf(177611L, 177613L, 177614L, 177615L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177611L, 177612L, 177614L, 177615L)),
        WordEntity(
            ...
            example = "אַלְגוֹרִיתְם זִיהוּי יֵשׁוּיוֹת חִבֵּר רְשׁוּמוֹת מֵהַסִינִיף וּמֵהָאֲתָר.",
            exampleNative = "Алгоритм זִיהוּי יֵשׁוּיוֹת связал записи из филиала и с сайта.",
         fillInBlankExclusions = listOf(177611L, 177612L, 177613L, 177615L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177611L, 177612L, 177613L, 177614L)),

        // ── de_strategy (5) — стратегия данных и руководство ──
        WordEntity(
            id = 177616, setId = 1776, languagePair = "he-ru", rarity = "LEGENDARY",
            pos = "noun", semanticGroup = "de_strategy",
            original = "סִי-דִּי-אוֹ", translation = "CDO (директор по данным)",
            definition = "מְנַהֵל בָּכִיר בִּדְרָג הַהַנְהָלָה שֶׁאַחְרַאי עַל הַנֶּכֶס הָאִסְטְרָטֶגִי שֶׁל הַמֵּידָע בָּעֵסֶק.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177616L, 177618L, 177619L, 177620L)),
        WordEntity(
            id = 177618, setId = 1776, languagePair = "he-ru", rarity = "LEGENDARY",
            pos = "noun", semanticGroup = "de_strategy",
            original = "דֵּמוֹקְרָטִיזַצְיָה", translation = "data democratization",
            definition = "מְגַמָּה שֶׁבָּהּ גִּישָׁה לַמֵּידָע נִפְתַּחַת לְכָל הָעוֹבְדִים, לֹא רַק לַמְּהַנְדְסִים אוֹ לָאָנָלִיסְטִים.",
         ...
         fillInBlankExclusions = listOf(177616L, 177617L, 177619L, 177620L)),
        WordEntity(
            ...
            example = "סַדְנַת אוֹרְיָנוּת דָּאטָה לִשְׁלוֹשׁ מֵאוֹת עוֹבְדִים נִפְתְּחָה בְּתוֹם הָרֹבַע.",
            exampleNative = "Воркшоп אוֹרְיָנוּת דָּאטָה на триста сотрудников открыли в конце квартала.",
         fillInBlankExclusions = listOf(177616L, 177617L, 177618L, 177620L)),
        WordEntity(
            ...
            definition = "מַדָּד שֶׁמּוֹדֵד כַּמָּה כֶּסֶף הָעֵסֶק רוֹוֵחַ מֵהַהַשְׁקָעָה בַּתַּשְׁתִּית וּבַצֶּוֶות שֶׁלַּמֵּידָע.",
            definitionNative = "Метрика — сколько денег бизнес зарабатывает с вложений в инфраструктуру и команду данных.",
            example = "תְּשׁוּאַת דָּאטָה מַעֲרִיכָה אֶת הַחִסָּכוֹן בִּמְלַאי בִּשְׁמוֹנָה מִילְיוֹן שֶׁקֶל בַּשָּׁנָה.",
            exampleNative = "תְּשׁוּאַת דָּאטָה оценивает экономию на складе в восемь миллионов шекелей в год.",
         fillInBlankExclusions = listOf(177616L, 177617L, 177618L, 177619L)),

        // ── de_advanced_governance (5) — продвинутая регуляция и этика данных ──
        WordEntity(
            id = 177621, setId = 1776, languagePair = "he-ru", rarity = "LEGENDARY",
            pos = "noun", semanticGroup = "de_advanced_governance",
         ...
         fillInBlankExclusions = listOf(177622L, 177623L, 177624L, 177625L)),
        WordEntity(
            id = 177622, setId = 1776, languagePair = "he-ru", rarity = "LEGENDARY",
            pos = "noun", semanticGroup = "de_advanced_governance",
            original = "רִיבּוֹנוּת דָּאטָה", translation = "data sovereignty",
            definition = "עֶקְרוֹן שֶׁלְּפִיו הַמֵּידָע כָּפוּף לְחֻקֵּי הַמְּדִינָה שֶׁבָּהּ הוּא נֶאֱסַף אוֹ נִשְׁמַר.",
         ...
         fillInBlankExclusions = listOf(177621L, 177623L, 177624L, 177625L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177621L, 177622L, 177624L, 177625L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177621L, 177622L, 177623L, 177625L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(177621L, 177622L, 177623L, 177624L)),
    )
}
