...
object WordDataHebrewImmigrant5 {
    ...
    val sets = listOf(
                WordSetEntity(id = 1143, name = "Еда и кулинария",     description = "Покупки на шуке, торговля и продукты",       languagePair = "he-ru", orderIndex = 143,
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            example = "הַיּוֹם יֵשׁ מְכִירָה בְּחָנוּת הַבְּגָדִים.",
        ...
        WordEntity(
            ...
            definition = "חֵלֶק הַצֶּמַח הַמֵּכִיל זְרָעִים וְנֶאֱכָל טָרִי.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "shuk",
            original = "עֶשְׂבֵּי תִּיבּוּל", translation = "пряные травы / зелень",
            definition = "צְמָחִים אָרוֹמָטִיִּים כְּגוֹן נַעֲנַע, פֶּטְרוֹזִילְיָה וְכוּסְבָּרָה.",
        ...
        WordEntity(
            ...
            definition = "מָחִיתָ מַטְעֶמֶת מֵחֻמְּצִיוֹת עִם טְחִינָה וְלִימוֹן.",
        ...
        WordEntity(
            ...
            definition = "מָנַּת בָּשָׂר צָלוּי הַמּוֹגֶשֶׁת בְּפִיתָה עִם תּוֹסָפוֹת.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי אֲרִיזָה מִנְיָלוֹן אוֹ נְיָר לְהַכָּנָסַת מֻצָרִים.",
        ...
        WordEntity(
            ...
            definition = "חֲנוּת קְטַנָּה הַמּוֹכֶרֶת מָזּוֹן וּמוּצָרֵי יוֹמְיוֹם.",
        ...
        WordEntity(
            ...
            definition = "פְּרִי הַזַּיִת, נֶאֱכַל כָּבוּשׁ אוֹ מְשַׁמֵּשׁ לְהַפָּקַת שֶׁמֶן.",
        ...
        WordEntity(
            ...
            example = "קָנִיתִי חֲמִישָּׁה אַגָּסִים בַּשּׁוּק.",
        ...
        WordEntity(
            ...
            example = "שָׂמָנוּ מַיּוֹנֵז בַּשָּׁלִישׁ.",
