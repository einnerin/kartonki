...
object WordDataHebrewTimeL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "בַּעֲשׂוֹר הָאַחֲרוֹן הָעִיר הִשְׁתַּנְּתָה כִּמְעַט לְלֹא הַכָּרָה.",
        ...
        WordEntity(
            ...
            example = "בְּצָהֳרֵי הַיּוֹם הָעוֹבְדִים יוֹצְאִים לָאֲרוּחָה וְהַמִּשְׂרָדִים מִתְרוֹקְנִים.",
        ...
        WordEntity(
            ...
            example = "מָחֳרָתַיִם נָטּוּס לְלוֹנְדּוֹן לְבִקּוּר שֶׁל שָׁבוּעַ שָׁלֵם.",
        ...
        WordEntity(
            ...
            example = "יֵשׁ עִתִּים שֶׁבָּהֶן הַכֹּל קָשֶׁה וּלְעֻמָּתָן הַכֹּל זוֹרֵם בְּקַלּוּת.",
            exampleNative = "Бывают עִתִּים, когда всё трудно, а в противоположность им всё течёт легко.",
        ...
        WordEntity(
            ...
            example = "פַּעַם בִּזְמַן שֶׁעָבַר גַּרְנוּ בִּכְפָר קָטָן בַּגָּלִיל.",
