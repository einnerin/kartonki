...
object WordDataHebrewStartupL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_rounds",
            original = "סִיד", translation = "seed-раунд",
            definition = "הַשְׁקָעָה רִאשׁוֹנָה בִּסְכוּם קָטָן שֶׁמְּאַפְשֶׁרֶת לְהוֹכִיחַ אֶת הֲרַעְיוֹן וְלִבְנוֹת אַבַּטִיפּוּס.",
        ...
        WordEntity(
            ...
            example = "סֶיְרִיס אֵיי הָיָה עֲשָׂרָה מִילְיוֹן דּוֹלָר בְּהוֹבָלַת קֶרֶן אָמֵרִיקָאִית.",
        ...
        WordEntity(
            ...
            definition = "הַזְרָמַת כֶּסֶף קְצָרָה בֵּין שְׁנֵי שְׁלַבִּים גְּדוֹלִים כְּדֵי לְהַחְזִיק אֶת הַחֶבְרָה בַּחַיִּים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_investors",
            original = "אֶנְגֵ'ל", translation = "ангел-инвестор",
            definition = "אִישׁ פְּרָטִי עָשִׁיר שֶׁמַּשְׁקִיעַ כֶּסֶף שֶׁלּוֹ בִּשְׁלַבִּים מַקְדִּימִים שֶׁל יַזְמוּת.",
        ...
        WordEntity(
            ...
            definition = "זְרוֹעַ הַשְׁקָעָה שֶׁל תַּאֲגִיד גָּדוֹל שֶׁמְּחַפֵּשׂ סִינֶרְגְיָה אִסְטְרָטֵגִית עִם הַחֶבְרָה הַצְּעִירָה.",
        ...
        WordEntity(
            ...
            example = "פֵּמִילִי אוֹפִיס מִלּוֹנְדּוֹן הִשְׁתַּתֵּף בַּסִּבּוּב כְּמַשְׁקִיעַ אִסְטְרָטֶגִי שָׁקֵט.",
        ...
        WordEntity(
            ...
            definition = "מַשְׁקִיעַ פָּסִיבִי שֶׁשָּׂם כֶּסֶף בַּקֶּרֶן אֲבָל לֹא מַחְלִיט בָּעֲסָקוֹת הַסּוֹפִיּוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_programs",
            ...
            example = "הִתְקַבַּלְנוּ לְאַקְסֶלֵרָטוֹר יוּקְרָתִי בְּסַן פְרַנְצִיסְקוֹ אַחֲרֵי שִׁבְעָה רַאֲיוֹנוֹת.",
        ...
        WordEntity(
            ...
            definition = "מִזְנוֹן שֶׁל יְזָמִים שֶׁמַּקְמִים מִסְפַּר חֲבָרוֹת בְּמַקְבִּיל וּמְלַוֶּה אוֹתָן הַחָל מִיוֹם רִאשׁוֹן.",
        ...
        WordEntity(
            ...
            example = "בַּדֵּמוֹ דֵּיי הָיוּ מָאתַיִם מַשְׁקִיעִים וְהוֹתִירָה אוֹתָנוּ בְּלִי קוֹל מֵרֹב הַתְלַהֲבוּת.",
        ...
        WordEntity(
            ...
            definition = "מַעֲמָד תְּחָרוּתִי שֶׁבּוֹ מִסְפַּר חֶבְרוֹת צְעִירוֹת מִתְמוֹדְדוֹת עַל פְּרָס כַּסְפִּי וַחֲשִׂיפָה.",
        ...
        WordEntity(
            ...
            definition = "סְכוּם כַּסְפִּי מִגּוּף מֶמְשַׁלְתִּי שֶׁנִּתַּן לְלֹא דְּרִישָׁה לְהַחְזִיר וּלְלֹא וִיתּוּר עַל מְנָיוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_deal",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "startup_deal",
        ...
        WordEntity(
            ...
            example = "שְׁטַר הֲמָרָה אִפְשֵׁר לָנוּ לִדְחוֹת אֶת וִיכּוּחַ הַהַעֲרָכָה לְעוֹד שָׁנָה.",
        ...
        WordEntity(
            ...
            definition = "מַקְסִימוּם שֶׁנִּקְבַּע מֵרֹאשׁ שֶׁמַּגֵּן עַל הַמַּשְׁקִיעַ הַמַּקְדִּים מִפְּנֵי הַעֲרָכָה גְּבוֹהָה מִדַּי.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ שֶׁבּוֹ אֲחוּז הַבְּעָלִים הַוָּתִיקִים יוֹרֵד כִּי מַנְפִּיקִים נְיָרוֹת חֲדָשִׁים לְמַשְׁקִיעַ נוֹסָף.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_pitch",
            original = "פִּיטְץ' דֶּק", translation = "pitch deck",
            definition = "מַצַּגַּת קְצָרָה שֶׁל כְּעֶשֶׂר שְׁקוּפִיּוֹת שֶׁמְּסַפֶּרֶת אֶת סִיפּוּר הַסְּטַרְטְאַפּ לְמַשְׁקִיעַ פּוֹטֶנְצְיָאלִי.",
            definitionNative = "Короткая презентация в десяток слайдов — рассказывает историю стартапа потенциальному инвестору.",
            example = "עָבַדְנוּ עַל פִּיטְץ' דֶּקָ שָׁבוּעַ שָׁלֵם וְהֶחֱלַפְנוּ אוֹתוֹ אַרְבַּע פְּעָמִים.",
        ...
        WordEntity(
            ...
            definition = "תֵּאוּר תַּמְצִיתִי בֶּן שְׁלוֹשִׁים שְׁנִיּוֹת שֶׁמְּסַבֵּר מָה הַחֶבְרָה עוֹשָׂה בְּלִי מַסְפָּרִים.",
