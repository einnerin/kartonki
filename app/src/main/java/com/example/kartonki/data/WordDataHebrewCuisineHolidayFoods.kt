...
object WordDataHebrewCuisineHolidayFoods {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 191601, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "כַּדּוּר בָּצֵק מְטֻגָּן בְּשֶׁמֶן עָמֹק, מְמֻלָּא רִבָּה אוֹ קְרֶם וּמְפֻזָּר אַבְקַת סֻכָּר.",
        ...
        WordEntity(id = 191602, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "סַבְתָּא מִתֶּימָן הֵכִינָה בִּמּוּאֵלוֹס לַנְּכָדִים בְּחַג הָאוּרִים.",
        ...
        WordEntity(id = 191606, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הָאוֹפָה הוֹצִיא מֵהַתַּנּוּר מַגָּשׁ שֶׁל כְּרֵיכִית רֵיחָנִית לְכָבוֹד הַחַג.",
        ...
        WordEntity(id = 191607, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "סַבְתָּא הָאַשְׁכְּנַזִּית בִּשְּׁלָה קְרֶפְּלָךְ בְּמָרָק הַתַּרְנְגוֹלֶת.",
        ...
        WordEntity(id = 191611, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "אַבָּא טִגֵּן מַצָּה בְּרָיָיָה לַיְלָדִים בַּבֹּקֶר שֶׁל חֹל הַמּוֹעֵד.",
        ...
        WordEntity(id = 191612, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "יָרָק מַר — חַסָּה אוֹ חַזֶּרֶת — שֶׁאוֹכְלִים בְּלֵיל הַסֵּדֶר לְזֵכֶר מֲרִירוּת הַשִּׁעְבּוּד.",
        ...
        WordEntity(id = 191614, setId = 1916, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "בְּחַג הַשָּׁבוּעוֹת עוֹרְכִים שֻׁלְחָן מָלֵא מַאַכֲלֵי חָלָב.",
        ...
        WordEntity(id = 191615, setId = 1916, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "עוּגָה עֲשִׁירָה מִגְּבִינַת שַׁמֶּנֶת עַל בְּסִיס בִּיסְקְוִיט — דֶּגֶל הַקּוֹנְדִיטוֹרְיָה שֶׁל שָׁבוּעוֹת.",
            definitionNative = "Густой торт из сливочного сыра на бисквитной основе — флагман кондитерской Шавуот.",
            example = "הַשֵּׁף אַפָּהּ עוּגַת גְּבִינָה גְּבוֹהָה עִם תּוּתִים טְרִיִּים לְמַעְלָה.",
        ...
        WordEntity(id = 191616, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פַּנְקֵיְק דַּק מְמֻלָּא בִּגְבִינָה לְבָנָה מְתוּקָה, מְקֻפָּל לְמַעֲטֶפֶת וּמְטֻגַּן עַד זָהֹב.",
        ...
        WordEntity(id = 191617, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פַּנְקֵיְק צָרְפָתִי דַּקִּיק עִם גְּבִינָה מְלוּחָה אוֹ מְתוּקָה — וַרְיַאצְיָה מוֹדֶרְנִית לְחַג הֶחָלָב.",
            definitionNative = "Тонкий французский блин с солёным или сладким сыром — современная вариация для молочного праздника.",
            example = "בַּמִּסְעָדָה הִגִּישׁוּ קְרֶפּ גְּבִינָה עִם דְּבַשׁ וֶאֱגוֹזִים.",
        ...
        WordEntity(id = 191618, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "אַחֲרֵי הַתְּפִלָּה הִתְכַּנֵּסְנוּ לֶאֱכֹל חוֹלְנְט חַם בְּבֵית הַסַּבָּא.",
        ...
        WordEntity(id = 191619, setId = 1916, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "אִיטְרִיּוֹת אֲפוּיוֹת בְּסֻכָּר חוּם מְקֻרְמַל וּפִלְפֵּל שָׁחוֹר — מַאֲכָל שַׁבָּת מַסֹּרְתִּי שֶׁל יְרוּשָׁלַיִם.",
        ...
        WordEntity(id = 191621, setId = 1916, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "כִּכָּר חַלָּה בְּצוּרַת סְלִיל מְעֻגָּל — סֶמֶל לְמַעְגַּל הַשָּׁנָה וְלַאֲרֻכַּת יָמִים.",
        ...
        WordEntity(id = 191622, setId = 1916, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "עַל הַשֻּׁלְחָן הִנִּיחוּ צַלַּחַת שֶׁל פֵּירוֹת יְבֵשִׁים וָאֱגוֹזִים.",
        ...
        WordEntity(id = 191624, setId = 1916, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "בֵּיצָה שֶׁבֻּשְּׁלָה בָּקְלִיפָּה — סֶמֶל הָאֵבֶל בִּסְעוּדַת הַבְרָאָה וְעַל קְעַרַת הַסֵּדֶר.",
            definitionNative = "Яйцо, сваренное в скорлупе — символ траура в трапезе скорбящих и часть пасхального кеара.",
            example = "אַחֲרֵי הַלְוָיָה הִגִּישׁוּ לֶחֶם וּבֵיצָה קָשָׁה לַאֲבֵלִים.",
