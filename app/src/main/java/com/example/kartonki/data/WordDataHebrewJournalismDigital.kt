...
object WordDataHebrewJournalismDigital {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190402, setId = 1904, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "אָדָם אוֹ מִסְמָךְ שֶׁהָיָה נוֹכַח בָּאֵירוּעַ אוֹ יָצַר אוֹתוֹ — בְּלִי תִּוּוּךְ.",
        ...
        WordEntity(id = 190407, setId = 1904, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "פִּרְסוּם שֶׁנִּכְתַּב בְּכַוָּנָה לְהַטְעוֹת אֶת הַקּוֹרֵא לְמַטָּרָה פּוֹלִיטִית אוֹ מִסְחָרִית.",
        ...
        WordEntity(id = 190408, setId = 1904, languagePair = "he-ru", rarity = "RARE",
            ...
            translation = "дипфейк",
            definition = "סִרְטוֹן מְזֻיָּף שֶׁנּוֹצַר עַל יְדֵי בִּינָה מְלָאכוּתִית וּמַרְאֶה אָדָם אוֹמֵר דְּבָרִים שֶׁלֹּא אָמַר.",
            definitionNative = "Поддельное видео, созданное ИИ: человек говорит на нём то, чего на самом деле не произносил.",
            example = "זִיּוּף עָמוֹק שֶׁל רֹאשׁ הַמֶּמְשָׁלָה הִטְעָה מִלְיוֹן צוֹפִים.",
        ...
        WordEntity(id = 190409, setId = 1904, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "תְּמוּנָה אוֹ סִרְטוֹן שֶׁעָבַר עֲרִיכָה עַרְמוּמִית כְּדֵי לְשַׁנּוֹת אֶת הַמַּשְׁמָעוּת הַמְּקוֹרִית.",
        ...
        WordEntity(id = 190412, setId = 1904, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִכְתָּב קָבוּעַ שֶׁמַּגִּיעַ לַתֵּבָה שֶׁל הַמִּנּוּי וּמֵכִיל סְקִירָה אוֹ טוּר אִישִׁי.",
            definitionNative = "Регулярное письмо, приходящее подписчику в ящик, с обзором или авторской колонкой.",
            example = "הוּא מַפְעִיל עָלּוֹן דִּיגִיטָלִי שָׁבוּעִי עִם שְׁלוֹשִׁים אֶלֶף מֲנּוּיִים.",
        ...
        WordEntity(id = 190414, setId = 1904, languagePair = "he-ru", rarity = "EPIC",
            ...
            translation = "пэйвол",
            definition = "מַחְסוֹם בַּאֲתָר שֶׁחוֹסֵם אֶת הַתֹּכֶן עַד שֶׁהַקּוֹרֵא נִרְשַׁם וּמְשַׁלֵּם.",
        ...
        WordEntity(id = 190420, setId = 1904, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "סוּג עֲבוֹדָה שֶׁדּוֹרֵשׁ חֳדָשִׁים שֶׁל אִסּוּף מִסְמָכִים וְעֵדִים כְּדֵי לַחֲשֹׂף עַוָּלָהּ.",
        ...
        WordEntity(id = 190422, setId = 1904, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הוּא כְּתַב נֶגֶד לְבִּטָּחוֹן וּמַגִּיעַ לְכָל מְסִיבַּת עִתּוֹנָאִים.",
        ...
        WordEntity(id = 190423, setId = 1904, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "כּוֹתֵב שֶׁעוֹבֵד בְּסוֹכְנוּת חֲדָשׁוֹת בֵּינְלְאוּמִית וּמַסְפִּיק חַמְּרִים לְמֵאוֹת עִתּוֹנִים.",
        ...
        WordEntity(id = 190425, setId = 1904, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "כִּוּוּן עֲבוֹדָה שֶׁמְּחַלֵּץ סִפּוּרִים מִטַּבְלָאוֹת, מַאַגֲרֵי מֵידָע וּגְרָפִים סְטָטִיסְטִיִּים.",
