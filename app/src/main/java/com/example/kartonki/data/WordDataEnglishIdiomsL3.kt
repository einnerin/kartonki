...
object WordDataEnglishIdiomsL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 40715, setId = 407, languagePair = "en-ru", rarity = "UNCOMMON",
            ...
            definitionNative = "Намёки, что трудная ситуация скоро завершится хорошо. Образ из тёмного прохода.",
        ...
        WordEntity(id = 40719, setId = 407, languagePair = "en-ru", rarity = "UNCOMMON",
            ...
            definitionNative = "Часто пугать выдуманной угрозой — и потом настоящим словам уже не верят. Басня Эзопа.",
        ...
        WordEntity(id = 40722, setId = 407, languagePair = "en-ru", rarity = "UNCOMMON",
            ...
            definitionNative = "Приложить усилия сверх ожидаемого — ради отличного итога. Образ лишней мили.",
        ...
        WordEntity(id = 40724, setId = 407, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "Твёрдо отказаться менять мнение или подчиниться желаниям других. Образ — каблуки в землю.",
