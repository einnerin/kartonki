...
object WordDataHebrewPlumberL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "כֹּחַ שֶׁמַּפְעִיל נוֹזֵל בְּמַצַּב מְנוּחָה עַל דָּפְנוֹת הַמֵּיכָל אוֹ הַצִּנּוֹר.",
            definitionNative = "Сила, с которой жидкость в покое давит на стенки сосуда или трубы.",
            example = "לַחַץ הִידְרוֹסְטָטִי גָּדֵל עִם הָעֳמֵק שֶׁל הַמֵּיכָל.",
        ...
        WordEntity(
            ...
            example = "אִתּוּר דֶּלֶף עִם גַּז מְכֻוָּן לוֹקֵחַ פָּחוֹת מִשָּׁעָה.",
        ...
        WordEntity(
            ...
            example = "בְּדִיקָה אָקוּסְטִית אִתְּרָה דֶּלֶף תַּחַת הָרִצְפָּה.",
        ...
        WordEntity(
            ...
            definition = "טַבַּעַת רַכָּה הַחוֹסֶמֶת מַעֲבַר מַיִם בֵּין שְׁנֵי חֲלָקִים מְחֻבָּרִים.",
        ...
        WordEntity(
            ...
            example = "נוֹזֵל הַעֲבָרַת חֹם בְּגִילְיקוֹל מוֹנֵעַ הִקָּפְאוּת בַּחֹרֶף.",
        ...
        WordEntity(
            ...
            example = "דּוּד עָקִיף עוֹבֵד עִם מַעֲרֶכֶת הַשֶּׁמֶשׁ וְעִם הַגָּז.",
        ...
        WordEntity(
            ...
            example = "רַדְיָאטוֹר אָלוּמִינְיוּם מִתְחַמֵּם בְּעֶשֶׂר דַּקּוֹת בִּלְבַד.",
