...
object WordDataHebrewSportsBasketball {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 191501, setId = 1915, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הַפּוֹעֵל יְרוּשָׁלַיִם נִצְּחָה אֶת מַכַּבִּי בַּדֶּרְבִּי הַחַשּׁוּב.",
        ...
        WordEntity(id = 191502, setId = 1915, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הַקְּבוּצָה עָלְתָה לְלִיגַת הָעָל בְּכַדּוּרְסַל לְאַחַר עוֹנָה מַרְשִׁימָה.",
        ...
        WordEntity(id = 191503, setId = 1915, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "טוּרְנִיר הַבַּסְקֶטְבּוֹל הַחֲשׁוּב בְּיוֹתֵר בְּאֵירוֹפָּה — מַכַּבִּי תֵּל אָבִיב זָכְתָה בּוֹ שֵׁשׁ פְּעָמִים.",
        ...
        WordEntity(id = 191504, setId = 1915, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "הַלִּיגָה הַמִּקְצוֹעָנִית הַחֲשׁוּבָה בְּיוֹתֵר בַּאַרְצוֹת הַבְּרִית — חֲלוֹם שֶׁל כָּל שַׂחְקָן בַּסְקֶטְבּוֹל בָּעוֹלָם.",
            definitionNative = "Главная профессиональная лига США — мечта любого баскетболиста в мире.",
            example = "הַשַּׂחְקָן הַיִּשְׂרְאֵלִי חָתַם חוֹזֶה בָּNBA בְּגִיל עֶשְׂרִים וּשְׁתַּיִם.",
        ...
        WordEntity(id = 191507, setId = 1915, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "שַׂחְקַן הַסִּעוּף הָאֲחוֹרִי הַמִּתְמַחֶה בִּקְלִיעוֹת מֵרָחוֹק וּבְקֻדּוֹת לַסַּל.",
        ...
        WordEntity(id = 191510, setId = 1915, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "חֲמֵשֶׁת הַשַּׂחְקָנִים שֶׁפּוֹתְחִים אֶת הַמִּשְׂחָק עַל הַמִּגְרָשׁ — הַהֶרְכֵּב הַחֲזַק בְּיוֹתֵר שֶׁל הַקְּבוּצָה.",
        ...
        WordEntity(id = 191513, setId = 1915, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "הוּא הֶחְמִיץ אֶת שְׁתֵּי זְרִיקוֹת הָעוֹנְשִׁין בְּסוֹף הָרֶבַע.",
        ...
        WordEntity(id = 191514, setId = 1915, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "קְלִיעָה מֵעַל הַחִישּׁוּק כְּשֶׁהַשַּׂחְקָן קוֹפֵץ וְשׂוֹם אֶת הַכַּדּוּר יָשָׁר לְתוֹךְ הַסַּל.",
            definitionNative = "Бросок сверху, когда игрок выпрыгивает и закладывает мяч прямо в кольцо.",
            example = "הוּא סָגַר אֶת הָרֶבַע בְּהַטְבָּעָה מְרַשֶּׁמֶת מֵעַל הַיָּרִיב.",
        ...
        WordEntity(id = 191517, setId = 1915, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "לְקִיחַת הַכַּדּוּר מִיְּדֵי הַיָּרִיב תּוֹךְ כְּדֵי מֲסִירָה אוֹ כַּדְרוּר — בְּלִי לַעֲשׂוֹת עֲבֵרָה.",
            definitionNative = "Отбор мяча у соперника во время передачи или ведения — без нарушения правил.",
            example = "הַחֲטָפָה שֶׁל הַשַּׂחְקָן הַמַּסְמִיךְ הָפְכָה לְהַטְבָּעָה מֲהִירָה.",
        ...
        WordEntity(id = 191518, setId = 1915, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מַגָּע אָסוּר שֶׁל מֵגֵן בְּשַׂחְקָן הַיָּרִיב — חָמֵשׁ עֲבֵרוֹת אִישִׁיוֹת מוֹצִיאוֹת מֵהַמִּשְׂחָק.",
        ...
        WordEntity(id = 191523, setId = 1915, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "חָמֵשׁ דַּקּוֹת נוֹסָפוֹת לְמִשְׂחָק שֶׁהִסְתַּיֵּם בְּתֵיקוּ — מְשַׂחֲקִים עַד שֶׁמִּישֶׁהוּ מְנַצֵּחַ.",
