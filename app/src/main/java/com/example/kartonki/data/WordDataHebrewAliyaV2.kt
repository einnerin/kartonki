...
object WordDataHebrewAliyaV2 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "פֹּעַל בֶּסִיס שֶׁל הַמּוּשָׂג אֲלִיָּה — מַעֲבָר לָאָרֶץ.",
            definitionNative = "Глагол, означающий переезд на историческую родину.",
            example = "סָבִי וְסַבְתִּי הֶחְלִיטוּ לַעֲלוֹת מֵרוּסְיָה.",
        ...
        WordEntity(
            ...
            example = "אָנוּ רוֹצִים לָגוּר בְּשַׁכּוּנָה שְׁקֵטָה.",
        ...
        WordEntity(
            ...
            example = "תּוֹדָה רַבָּה עַל הַקַּבָּלַת הַפָּנִים הַחַמָּה.",
        ...
        WordEntity(
            ...
            definition = "מִלַּת הַסְכָּמָה חִיּוּבִית לִשְׁאֵלָה כְּלָלִית.",
        ...
        WordEntity(
            ...
            definition = "בְּיוֹם שֶׁאָנוּ נִמְצָאִים בּוֹ כָּעֵת.",
        ...
        WordEntity(
            ...
            example = "מָצָאנוּ בַּיִת נַחְמָד בְּחֵיפָה.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ זְמַנִּי שֶׁמַּעֲנִיק זְכֻיּוֹת הַקְּלִיטָה לָעוֹלֶה.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ רִשְׁמִי לְזֵהוּי הַנּוֹסֵעַ לְחוּץ לָאָרֶץ.",
        ...
        WordEntity(
            ...
            definition = "סִימָן רִשְׁמִי עַל מִסְמָךְ לְאִישׁוּר תָּקְפוּת.",
        ...
        WordEntity(
            ...
            definition = "הַתַּאֲרִיךְ שֶׁבּוֹ מִסְמָךְ מַפְסִיק לִהְיוֹת תַּקֵּף.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ רִשְׁמִי שֶׁמְּתַעֵד אֶת הַהוֹלִיד שֶׁל אָדָם.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ שֶׁמְּאַשֵּׁר שֶׁזּוּג נָשׂוּי כַּחֹק.",
        ...
        WordEntity(
            ...
            example = "עָשִׂיתִי תִּרְגּוּם נוֹטַרִיּוֹנִי לְכָל הַמִּסְמָכִים.",
        ...
        WordEntity(
            ...
            definition = "לִמְסוֹר מִסְמָכִים לִרְשׁוּת רִשְׁמִית לְטִפּוּל.",
        ...
        WordEntity(
            ...
            definition = "לָקַחַת דָּבָר שֶׁנִּמְסַר אוֹ נִשְׁלַח לָאָדָם.",
        ...
        WordEntity(
            ...
            definition = "שָׁעוֹת שֶׁבָּהֶן פָּקִיד פָּתוּחַ לְקָהָל הַקּוֹנִים.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ מִשְׁפָּטִי בֵּין הַשּׂוֹכֵר לְבַעַל הַבַּיִת.",
        ...
        WordEntity(
            ...
            definition = "אַחַת מֵאַרְבַּע קוּפּוֹת הַחוֹלִים הַגְּדוֹלוֹת בָּאָרֶץ.",
        ...
        WordEntity(
            ...
            example = "מַסְפֵּן נוֹסֵעַ מֵחֵיפָה לְאֵילַת כָּל יוֹם.",
        ...
        WordEntity(
            ...
            definition = "יִישׁוּב כַּפְרִי מְשֻׁתַּף שֶׁעָרֵי תַּעֲסוּקָה וְשִׁוּוּי חֲלוּצִי.",
        ...
        WordEntity(
            ...
            definition = "חֵלֶק מִקְהִילַת הַקִּבּוּץ בְּעַלַּת זְכֻיּוֹת וַחֲבָרוּת מְלֵאָה.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ חוֹדְשִׁי שֶׁמְּפָרֵט שָׂכָר, נִכּוּיִים וּבִטּוּחִים.",
        ...
        WordEntity(
            ...
            definition = "יְהוּדִי שֶׁמַּקּוֹרוֹ בְּקְהִילּוֹת מֶרְכַּז וּמִזְרַח אֵירוֹפָּה.",
        ...
        WordEntity(
            ...
            definition = "יְהוּדִי שֶׁמַּקּוֹרוֹ בִּקְהִילּוֹת סְפָרַד וְצָפוֹן אַפְרִיקָה.",
            definitionNative = "Еврей, выходец из общин Испании и Северной Африки.",
            example = "הֲסַבְתָּא שֶׁלָּנוּ סְפָרַדִּי מִמָּרוֹקוֹ.",
        ...
        WordEntity(
            ...
            definition = "יְהוּדִי שֶׁמַּקּוֹרוֹ בִּקְהִילּוֹת מִזְרַח וּצְפוֹן אַפְרִיקָה.",
        ...
        WordEntity(
            ...
            definition = "יְהוּדִי שֶׁמַּקּוֹרוֹ בְּבֵית יִשְׂרָאֵל בְּאֶתְיוֹפְּיָה.",
        ...
        WordEntity(
            ...
            definition = "לֶחֶם מָתוֹק וּמוּקְפָץ לִסְעוּדַת שַׁבָּת וַחַגִּים.",
        ...
        WordEntity(
            ...
            definition = "מָזוֹן הַעֲשׂוּי מֵחָלָב וּמוּצְרֵי חָלָב.",
        ...
        WordEntity(
            ...
            example = "הַחַג הַבַּעַל הֲכִי אָהוּב שֶׁלִּי הוּא סֻכּוֹת.",
        ...
        WordEntity(
            ...
            example = "הִדְלַקְנוּ נֵרוֹת בְּחַנֻּכָּה בַּחַלּוֹן.",
        ...
        WordEntity(
            ...
            definition = "מָקוֹם לִתְפִלָּה וְלְקְרִיאַת תּוֹרָה בַּיַּהֲדוּת.",
        ...
        WordEntity(
            ...
            example = "סָבִי דִּבֵּר יִידִישׁ בַּבַּיִת עַל הַסָּבְתָּא.",
        ...
        WordEntity(
            ...
            example = "קָרָאתִי שִׁיר יָשָׁן בְּלָדִינוֹ מֵהַסַּבְתָּא.",
        ...
        WordEntity(
            ...
            definition = "שָׂפָה שֵׁמִית רָחֲבָה בַּמִּזְרָח הַתִּיכוֹן וּבְיִשְׂרָאֵל.",
        ...
        WordEntity(
            ...
            definition = "מִמְרַח גַּרְגְּרֵי קִטְנִיּוֹת עִם טְחִינָה וְלִימוֹן.",
        ...
        WordEntity(
            ...
            example = "אַהֲבָה שֶׁלִּי לַזֶּמֶר עִבְרִי מִן הַיַּלְדּוּת.",
        ...
        WordEntity(
            ...
            example = "וַעֲדָה זוֹ דָּנָה בְּחוֹק הַחִנּוּךְ הֶחָדָשׁ.",
            exampleNative = "וַעֲדָה рассматривает новый закон об образовании.",
         fillInBlankExclusions = listOf(161401L, 161402L)),
        ...
        WordEntity(
            ...
            example = "רֹאשׁ הַמֶּמְשָׁלָה נָסַע לְוַשִּׁינְגְטוֹן לְפִסְגָּה.",
        ...
        WordEntity(
            ...
            definition = "חֲבֵר מֶמְשָׁלָה הָאַחַרַאִי עַל תֵּיק מִשְׂרָדִי.",
            definitionNative = "Член правительства, возглавляющий конкретное ведомство.",
            example = "הַשַּׂר הֶחָדָשׁ שָׁמַר עַל תִּקְצִיב עָרוֹךְ.",
        ...
        WordEntity(
            ...
            definition = "רֹאשׁ הַמְּדִינָה הַטִּקְסִי, בְּעַלַּת סַמְכוּיוֹת מוּגְבָּלוֹת.",
        ...
        WordEntity(
            ...
            definition = "הָעַרֲכָאָה הַגְּבוֹהָה בְּיוֹתֵר בַּמַּעֲרֶכֶת הַמִּשְׁפָּטִית.",
            definitionNative = "Высшая судебная инстанция в государстве.",
            example = "בֵּית הַמִּשְׁפָּט הָעֶלְיוֹן פָּסַק לְטוֹבַת הָעוֹתְרִים.",
        ...
        WordEntity(
            ...
            definition = "מִפְלָגָה שְׁמַרָנִית יָמִין הֲוַּתֵרֶת בְּיִשְׂרָאֵל.",
        ...
        WordEntity(
            ...
            definition = "מִפְלָגָה דָּתִית סְפָרַדִּית הַמְצִיגָה אִינְטֶרֶסִים חֲרָדִיִּים.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ דֵּמוֹקְרָטִי לִבְחִירַת נְצִיגֵי הָעָם.",
            definitionNative = "Демократический процесс избрания представителей народа.",
            example = "הַבְּחִירוֹת תַּעַרֲכְנָה בְּנוֹבֶמְבֶּר הַקָּרוֹב.",
        ...
        WordEntity(
            ...
            definition = "מִפְלָגוֹת שֶׁנֶּגֶד הָרֹב הַשַּׁלִּיט בַּכְּנֶסֶת.",
        ...
        WordEntity(
            ...
            definition = "זְכֻיּוֹת בֵּסִיס הַמַּגִּיעוֹת לְכָל אָדָם מֵרוֹאַת לֵדָה.",
            definitionNative = "Базовые права каждого человека с момента рождения.",
            example = "עֲמוּתָה לִזְכֻיּוֹת אָדָם פַּרְסְמָהּ דּוּחַ חָדָשׁ.",
        ...
        WordEntity(
            ...
            example = "יִשְׂרָאֵל נֶחְשֶׁבֶת לְדֵּמוֹקְרַטְיָה פַּרְלָמֶנְטָרִית.",
        ...
        WordEntity(
            ...
            definition = "חוֹק מַעֲמָד עֶלְיוֹן בַּאֲרוֹךְ בְּסִיס הַמִּשְׁטָר הַיִּשְׂרְאֵלִי.",
        ...
        WordEntity(
            ...
            definition = "תְּנוּעַת שִׁיבַת הָעָם הַיְּהוּדִי לְאַרְצוֹ הַהִיסְטוֹרִית.",
        ...
        WordEntity(
            ...
            definition = "אָדָם בַּעַל דֵּעוֹת שֶׁל חֵרוּת הַפְּרָט וּזְכֻיּוֹת.",
            definitionNative = "Человек, отстаивающий свободу личности и её права.",
            example = "הוּא מְזָהֵ אֶת עַצְמוֹ לִיבֵּרָלִי בַּעֵינְיָנִים חֶבְרָתִיִּים.",
        ...
        WordEntity(
            ...
            definition = "הִתְכַנְסוּת צִבּוּרִית לְהַבָּעַת מְחָאָה אוֹ עָמְדָה.",
            definitionNative = "Публичное собрание для выражения протеста или позиции.",
            example = "הָיְתָה הַפְגָּנָה גְּדוֹלָה בְּכִכַּר רַבִּין.",
        ...
        WordEntity(
            ...
            definition = "מְרַקֵּם שֶׁל אִרְגּוּנִים וְיוֹזְמוֹת מִחוּץ לַמֶּמְשָׁלָה.",
        ...
        WordEntity(
            ...
            definition = "עֲלִיָּה כּוֹלֶלֶת בְּמְחִירִים וִירִידַת כֹּחַ הַקְּנִיָּה.",
        ...
        WordEntity(
            ...
            definition = "הַמִּסְמָךְ שֶׁהִכְרִיז עַל הֲקָמַת הַמְּדִינָה בְּחַמִּישָׁה בְּאִיָּר 1948.",
        ...
        WordEntity(
            ...
            example = "מְגִלַּת הָעַצְמָאוּת מוּצֶגֶת בַּגְנַזַּךְ הַמְּדִינָה.",
        ...
        WordEntity(
            ...
            example = "הַסַּבָּא שֶׁלִּי לָחַם בְּמִלְחֶמֶת שֵׁשֶׁת הַיָּמִים.",
        ...
        WordEntity(
            ...
            example = "הָאִינְתִיפַאדַה הַשְּׁנִיָּה פָּרְצָה בִּשְׁנַת אַלְפַּיִים.",
        ...
        WordEntity(
            ...
            definition = "רֹאשׁ הַמֶּמְשָׁלָה הָרִאשׁוֹן, הַמַּכְרִיז עַל הַמְּדִינָה.",
        ...
        WordEntity(
            ...
            definition = "רָאשַׁת הַמֶּמְשָׁלָה הָרִאשׁוֹנָה, מַנְהִיגָה בִּתְקוּפַת יוֹם הַכִּפּוּרִים.",
        ...
        WordEntity(
            ...
            definition = "חוֹזֶה הַמְּדִינָה, מְיַסֵּד הַתְּנוּעָה הַצִּיּוֹנִית בְּסוֹף הָעֶשְׂרִים.",
        ...
        WordEntity(
            ...
            example = "חַיִּים וַיְצְמָן הָיָה נָשִׂיא שֶׁל הַהִסְתַּדְּרוּת הַצִּיּוֹנִית.",
        ...
        WordEntity(
            ...
            example = "רֶצַח יִצְחָק רַבִּין הֵכָה אֶת הָעָם כּוּלוֹ.",
        ...
        WordEntity(
            ...
            example = "מְנַחֵם בֶּגִין קִבֵּל פְּרַס נוֹבֵּל לְשָׁלוֹם.",
        ...
        WordEntity(
            ...
            definition = "אֵזוֹרִים שֶׁמֵעֵבֶר לַקַּו הַיָּרֹק וּמְעוֹרֲרִים וִכּוּחַ מִשְׁפָּטִי.",
        ...
        WordEntity(
            ...
            definition = "מִסְמַךְ הַכָּרָה הֲדָּדִי עִם הָרָשׁוּת הַפָּלֶסְטִינִית מ-1993.",
        ...
        WordEntity(
            ...
            definition = "הַסֵּמֶל הַלְאוּמִי, מָגֵן דָּוִד כָּחוֹל עַל רֶקַע לָבָן.",
        ...
        WordEntity(
            ...
            definition = "הַסֵּמֶל הַמְּדִינָתִי — שִׁבְעַת הַקָּנִים עִם זֵרֵי זַיִת.",
            definitionNative = "Эмблема государства — семисвечник с оливковыми ветвями.",
            example = "מְנוֹרָה מוּצֶבֶת מוּל הַכְּנֶסֶת בְּכִכַּר.",
        ...
        WordEntity(
            ...
            definition = "זְרוֹעַ הַלּוֹחֵם שֶׁל הַהֲגַנָּה לִפְנֵי הֲקָמַת הַמְּדִינָה.",
            definitionNative = "Ударные отряды еврейской самообороны до создания государства.",
            example = "סַבָּא שֶׁלִּי שֵׁרֵת בַּפַּלְמָ״ח בַּגָּלִיל.",
        ...
        WordEntity(
            ...
            definition = "אִרְגּוּן רֶוִיזְיוֹנִיסְטִי חֲשָׁאִי בִּתְקוּפַת הַמַּנְדָּט הַבְּרִיטִי.",
        ...
        WordEntity(
            ...
            definition = "מַצַּב הַחַיִּים הַיְּהוּדִים מִחוּץ לְאֶרֶץ יִשְׂרָאֵל.",
        ...
        WordEntity(
            ...
            definition = "הַקֹּדֶם שֶׁל הַתַּלְמוּד, אוֹסֶף הַלַּכּוֹת שֶׁל תַּנָּאִים.",
        ...
        WordEntity(
            ...
            definition = "הַחֵלֶק הַמִּשְׁפָּטִי שֶׁל הַמָּסֹרֶת הַיְּהוּדִית, כְּלָלֵי הִתְנַהֲגוּת.",
        ...
        WordEntity(
            ...
            example = "עֶשֶׂר סְפִירוֹת מְצוּיָּרוֹת בָּאִילָן קַבָּלִי.",
        ...
        WordEntity(
            ...
            definition = "כּוֹבַע פַּרְוָה חֲסִידִי שֶׁלּוֹבְשִׁים בַּחַגִּים וּבַחֲתוּנּוֹת.",
        ...
        WordEntity(
            ...
            example = "הוּא לוֹמֵד בְּכּוֹלֵל בִּבְנֵי בְּרָק.",
        ...
        WordEntity(
            ...
            example = "אָנוּ מְחַכִּים לְבוֹאוֹ שֶׁל מָשִׁיחַ.",
        ...
        WordEntity(
            ...
            definition = "הַשִּׁחְרוּר הָעֲתִידִי שֶׁל עַם יִשְׂרָאֵל וְהָעוֹלָם כּוּלוֹ.",
        ...
        WordEntity(
            ...
            definition = "סֵפֶר הַתְּפִלּוֹת הַיּוֹמִיּוֹת וְהַחַגִּים.",
            definitionNative = "Книга ежедневных молитв и праздничных текстов.",
            example = "הַסִּדּוּר שֶׁלִּי מִוָּרַּשׁ אֵצֶל סַבָּא.",
        ...
        WordEntity(
            ...
            definition = "שִׁירָה דָּתִית עִבְרִית שֶׁנֶּאֱמֶרֶת בַּתְּפִלּוֹת הַחַגִּים.",
