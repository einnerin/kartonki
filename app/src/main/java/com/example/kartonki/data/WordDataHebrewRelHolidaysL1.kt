...
object WordDataHebrewRelHolidaysL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "holidays_table",
            ...
            example = "סַבָּא הִגְבִּיהַּ אֶת הַכּוֹסִית וְאָמַר לְחַיִּים.",
            exampleNative = "Дедушка поднял כּוֹסִית и сказал «лехаим».",
        ),
        WordEntity(
            id = 171002, setId = 1710, languagePair = "he-ru", rarity = "COMMON",
            pos = "phrase", semanticGroup = "holidays_table",
            original = "מֵיץ עֲנָבִים", translation = "виноградный сок",
            definition = "מַשְׁקֶה מָתוֹק מִפֵּרוֹת אֲדֻמִּים שֶׁשּׁוֹתִים יְלָדִים בַּקִּדּוּשׁ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "holidays_food",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "holidays_food",
            original = "עֻגַת דְּבַשׁ", translation = "медовик",
            definition = "מַאֲפֶה רַךְ וְחוּם מָתוֹק שֶׁמָּכִּינִים בְּרֹאשׁ הַשָּׁנָה לְשָׁנָה מְתוּקָה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "holidays_celebration",
        ...
        WordEntity(
            ...
            example = "הַסָּלּוֹן הָיָה מָלֵא שִׂמְחָה כְּשֶׁהִגִּיעוּ אוֹרְחֵי הַחַג.",
        ...
        WordEntity(
            ...
            example = "כָּל הָאוֹרְחִים אָמְרוּ מַזָּל טוֹב לֶחָתָן הַצָּעִיר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "holidays_purim",
        ...
        WordEntity(
            ...
            example = "הָאֲחָיוֹת תָּפְרוּ מַלְבּוּשִׁים מַרְהִיבִים לִקְרַאת הַמְּסִבָּה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "holidays_song",
