...
object WordDataHebrewInterviewL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "שָׁעוֹת גְּמִישׁוֹת חֲשׁוּבוֹת לִי בִּגְלַל הַיְּלָדִים בַּגַּן.",
        ...
        WordEntity(
            ...
            definition = "פוֹרְמָט שֶׁל חֵצִי מִשֶּׁרָד וְחֵצִי מֵרָחוֹק — כַּמָּה יָמִים בְּשָׁבוּעַ פֹּה וְשָׁם.",
            definitionNative = "Формат: половина в офисе, половина из дома — несколько дней в неделю там и там.",
            example = "מִשְׂרָה הִיבְּרִידִית מַאַפְשֶׁרֶת לִי לָגוּר רָחוֹק יוֹתֵר מִתֵּל אָבִיב.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175301L, 175302L, 175303L, 175304L)),
        ...
        WordEntity(
            ...
            definition = "פְּעֻלַּת הַעֲבָרַת קוֹרוֹת חַיִּים וּתְעוּדוֹת לַחֶבְרָה כְּחֵלֶק מִדְּחִיפַת מֻעָמָּדוּת.",
        ...
        WordEntity(
            ...
            definition = "תְּשׁוּבָה שְׁלִילִית מֵחֶבְרָה עִם הֶסְבֵּר קָצָר לָמָּה הַמֻּעָמָד לֹא הִתְקַבֵּל.",
        ...
        WordEntity(
            ...
            example = "שָׁלַחְתִּי בַּקָּשַׁת מָשׁוֹב מְנֻמֶּסֶת אַחֲרֵי הָרֵאָיוֹן הַשֵּׁנִי.",
        ...
        WordEntity(
            ...
            example = "מַעֲקָב הִתְקַדְּמוּת מְסֻדָּר חָסַךְ לִי שָׁעוֹת בַּשָּׁבוּעַ הַשֵּׁנִי.",
            exampleNative = "Упорядоченный מַעֲקַב הִתְקַדְּמוּת сэкономил мне часы на второй неделе.",
         fillInBlankExclusions = listOf(175306L, 175307L, 175308L, 175309L)),
        ...
        WordEntity(
            ...
            definition = "מִפְגָּשׁ קָטָן וְלֹא רִשְׁמִי שֶׁל אַנְשֵׁי הַתְּחוּם אַחֲרֵי הָעֲבוֹדָה בְּפָאבּ אוֹ בְּמִשְׂרַד.",
        ...
        WordEntity(
            ...
            definition = "מִכְתָּב אוֹ דְּבָרִים טוֹבִים שֶׁמִּישֶׁהוּ אוֹמֵר עָלֶיךָ לְחֶבְרָה שֶׁמְּחַפֶּשֶׂת עוֹבֵד.",
        ...
        WordEntity(
            ...
            definition = "הִכָּרוּת דֶּרֶךְ חָבֵר מְשֻׁתָּף, לֹא מֵאֶפֶס — מָה שֶּׁמַעֲלֶה אֶת סִכּוּי הַתְּשׁוּבָה.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175311L, 175312L, 175313L, 175314L)),
        ...
        WordEntity(
            ...
            definition = "עֵסֶק חִיצוֹנִי שֶׁמְּחַבֵּר בֵּין מְחַפְּשֵׂי עֲבוֹדָה לְבֵין מַעֲסִיקִים — וְלוֹקֵחַ אָחוּז.",
            definitionNative = "Внешний бизнес-посредник между ищущими работу и работодателями — берёт процент.",
            example = "חֶבְרַת הַשָּׂמָה הִצִּיעָה לִי שָׁלוֹשׁ מִשְׂרוֹת בִּתְעָשִּׂיַּת הַסַּיְבֶּר.",
        ...
        WordEntity(
            ...
            definition = "אֹסֶף גָּדוֹל שֶׁל קוֹרוֹת חַיִּים שֶׁל אֲנָשִׁים מוּכָנִים, שֶׁמְּגַיְּיסִים שׁוֹלְפִים מִמֶּנּוּ.",
        ...
        WordEntity(
            ...
            example = "עַמֲלַת אִתּוּר נֵעֶנֶית בְּשָׁלִישׁ הַמַּשְׂכֹּרֶת הַשְּׁנָתִית בַּחֲבִילָה.",
        ...
        WordEntity(
            ...
            example = "סָרַבְתִּי לַחְתֹּם עַל הֶסְכֵּם בִּלְעָדִיּוּת לִשְׁנָתַיִם.",
            exampleNative = "Я отказался подписывать הֶסְכֵּם בִּלְעַדִיּוּת на два года.",
         fillInBlankExclusions = listOf(175316L, 175317L, 175318L, 175319L)),
        ...
        WordEntity(
            ...
            definition = "תַּפְקִיד לִתְקוּפָה קְצָרָה עִם תַּאֲרִיךְ סִיּוּם יָדוּעַ — לְכַמָּה חֳדָשִׁים אוֹ לִפְּרוֹיֶקְט.",
        ...
        WordEntity(
            ...
            definition = "מַתְכֹּנֶת עַצְמָאִית: לוֹקְחִים פְּרוֹיֶקְטִים מִכַּמָּה לָקוֹחוֹת בְּלִי מַעֲסִיק קָבוּעַ.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175321L, 175322L, 175323L, 175324L)),
    )
}
