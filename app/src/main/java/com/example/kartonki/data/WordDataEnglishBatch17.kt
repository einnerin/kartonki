...
object WordDataEnglishBatch17 {
    ...
    val words = listOf(
        ...
        WordEntity(id = 29902, original = "plaza", transliteration = "[ˈplɑːzə]", translation = "городская площадь",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "public_space"),
        ...
        WordEntity(id = 29903, original = "footpath", transliteration = "[ˈfʊtpæθ]", translation = "пешеходная дорожка",
            ...
            definitionNative = "Узкая дорожка в парке или между улицами — только для людей.",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_element"),
        ...
        WordEntity(id = 29904, original = "rooftop", transliteration = "[ˈruːftɒp]", translation = "крыша здания",
            ...
            definitionNative = "Верхняя плоскость здания — порой превращённая в сад, бар или террасу.",
            example = "The hotel's rooftop bar has the best view in town.",
            exampleNative = "Rooftop-бар отеля — лучший вид в городе.",
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "building_part"),

        WordEntity(id = 29905, original = "quarter", transliteration = "[ˈkwɔːrtər]", translation = "квартал (городской)",
            definition = "A district in a city with its own style, often named by history or trade.",
        ...
        WordEntity(id = 29907, original = "lawn", transliteration = "[lɔːn]", translation = "газон",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "urban_nature"),
        ...
        WordEntity(id = 29908, original = "tenement", transliteration = "[ˈtenəmənt]", translation = "доходный дом",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "housing_type"),
        ...
        WordEntity(id = 29910, original = "duplex", transliteration = "[ˈduːpleks]", translation = "дуплекс, двухквартирный дом",
            ...
            definitionNative = "Здание из двух независимых квартир — друг над другом или рядом.",
        ...
        WordEntity(id = 29912, original = "arcade", transliteration = "[ɑːrˈkeɪd]", translation = "пассаж, крытая галерея",
            ...
            definitionNative = "Крытый проход с магазинами по сторонам, опирающийся на ряд арок.",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "public_space"),
        ...
        WordEntity(id = 29913, original = "cobblestone", transliteration = "[ˈkɒbəlstoʊn]", translation = "брусчатка, булыжник",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_surface"),
        ...
        WordEntity(id = 29914, original = "awning", transliteration = "[ˈɔːnɪŋ]", translation = "навес, тент (над входом)",
            ...
            definitionNative = "Косой козырёк над окном или входом — защищает от солнца и дождя.",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "facade_element"),
        ...
        WordEntity(id = 29915, original = "bollard", transliteration = "[ˈbɒlərd]", translation = "защитный столбик",
            ...
            definitionNative = "Низкий толстый столбик на пути машин, охраняющий пешеходную зону.",
            example = "Cars can't cross here — there are bollards on the path.",
            exampleNative = "Машины не проедут — тут bollard прямо на пути.",
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_element"),
        ...
        WordEntity(id = 29918, original = "stoop", transliteration = "[stuːp]", translation = "крыльцо (NYC-стиля)",
            definition = "A short set of steps leading up to the front door of a city home.",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "building_part"),
        ...
        WordEntity(id = 29919, original = "quay", transliteration = "[kiː]", translation = "набережная, причал",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "waterfront"),
        ...
        WordEntity(id = 29920, original = "lamppost", transliteration = "[ˈlæmppoʊst]", translation = "фонарный столб",
            ...
            definitionNative = "Высокий металлический столб с уличным фонарём сверху.",
        ...
        WordEntity(id = 29921, original = "mews", transliteration = "[mjuːz]", translation = "мьюс (быв. конюшенный ряд)",
            ...
            definitionNative = "Тихий ряд маленьких жилищ в Лондоне на месте бывших конюшен.",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "urban_area"),
        ...
        WordEntity(id = 29922, original = "pergola", transliteration = "[ˈpɜːrɡələ]", translation = "пергола",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "urban_nature"),
        ...
        WordEntity(id = 29923, original = "eaves", transliteration = "[iːvz]", translation = "свесы крыши",
            ...
            definitionNative = "Нижний край крыши, выступающий за внешнюю стену дома.",
        ...
        WordEntity(id = 29924, original = "cul-de-sac", transliteration = "[ˈkʌl də sæk]", translation = "тупик (улица)",
            ...
            definitionNative = "Улица с глухим концом — машины разворачиваются и едут обратно.",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_layout"),
        ...
        WordEntity(id = 29925, original = "alleyway", transliteration = "[ˈæliweɪ]", translation = "узкий переулок",
            ...
            definitionNative = "Узкий проход между двумя рядами зданий — часто сырой и тёмный.",
