...
object WordDataEnglishBatch17 {
    ...
    val sets = listOf(
        WordSetEntity(id = 299, name = "Город",
    ...
    val words = listOf(
        ...
        WordEntity(id = 29901, original = "neighborhood", transliteration = "[ˈneɪbərhʊd]", translation = "район, окрестности",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "urban_area", fillInBlankExclusions = listOf(29905L, 29908L, 29921L, 29924L)),
        ...
        WordEntity(id = 29902, original = "plaza", transliteration = "[ˈplɑːzə]", translation = "городская площадь",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "public_space", fillInBlankExclusions = listOf(29901L, 29905L, 29912L, 29919L, 29925L)),
        ...
        WordEntity(id = 29903, original = "footpath", transliteration = "[ˈfʊtpæθ]", translation = "пешеходная дорожка",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_type", fillInBlankExclusions = listOf(29924L, 29925L)),
        ...
        WordEntity(id = 29904, original = "rooftop", transliteration = "[ˈruːftɒp]", translation = "крыша здания",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "building_exterior", fillInBlankExclusions = listOf(29914L, 29918L, 29923L)),
        ...
        WordEntity(id = 29905, original = "quarter", transliteration = "[ˈkwɔːrtər]", translation = "квартал (городской)",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "urban_area", fillInBlankExclusions = listOf(29901L, 29912L, 29921L, 29925L)),
        ...
        WordEntity(id = 29906, original = "signpost", transliteration = "[ˈsaɪnpoʊst]", translation = "указатель",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_fixture", fillInBlankExclusions = listOf(29913L, 29915L, 29916L, 29917L, 29920L)),
        ...
        WordEntity(id = 29907, original = "lawn", transliteration = "[lɔːn]", translation = "газон",
            ...
            rarity = "UNCOMMON", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "urban_greenery", fillInBlankExclusions = listOf(29922L)),
        ...
        WordEntity(id = 29908, original = "tenement", transliteration = "[ˈtenəmənt]", translation = "доходный дом",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "housing_type", fillInBlankExclusions = listOf(29909L, 29910L, 29911L)),
        ...
        WordEntity(id = 29909, original = "townhouse", transliteration = "[ˈtaʊnhaʊs]", translation = "таунхаус",
            ...
            example = "They bought a narrow brick townhouse in the old part of London.",
            exampleNative = "Они купили узкий кирпичный townhouse в старом районе Лондона.",
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "housing_type", isFillInBlankSafe = false, fillInBlankExclusions = listOf(29908L, 29910L, 29911L)),
        ...
        WordEntity(id = 29910, original = "duplex", transliteration = "[ˈduːpleks]", translation = "дуплекс, двухквартирный дом",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "housing_type", fillInBlankExclusions = listOf(29908L, 29909L, 29911L)),
        ...
        WordEntity(id = 29911, original = "bungalow", transliteration = "[ˈbʌŋɡəloʊ]", translation = "бунгало",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "housing_type", fillInBlankExclusions = listOf(29908L, 29909L, 29910L)),
        ...
        WordEntity(id = 29912, original = "arcade", transliteration = "[ɑːrˈkeɪd]", translation = "пассаж, крытая галерея",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "public_space", fillInBlankExclusions = listOf(29902L, 29903L, 29919L)),
        ...
        WordEntity(id = 29913, original = "cobblestone", transliteration = "[ˈkɒbəlstoʊn]", translation = "брусчатка, булыжник",
            ...
            example = "Every cobblestone in this old square was laid by hand.",
            exampleNative = "Каждый cobblestone на этой старой площади уложен вручную.",
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_fixture", isFillInBlankSafe = false, fillInBlankExclusions = listOf(29906L, 29915L, 29916L, 29917L, 29920L)),
        ...
        WordEntity(id = 29914, original = "awning", transliteration = "[ˈɔːnɪŋ]", translation = "навес, тент (над входом)",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "building_exterior", fillInBlankExclusions = listOf(29904L, 29918L, 29923L)),
        ...
        WordEntity(id = 29915, original = "bollard", transliteration = "[ˈbɒlərd]", translation = "защитный столбик",
            ...
            example = "A thick steel bollard blocks cars from entering the pedestrian zone.",
            exampleNative = "Толстый стальной bollard не пускает машины на пешеходную зону.",
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_fixture", isFillInBlankSafe = false, fillInBlankExclusions = listOf(29906L, 29913L, 29916L, 29917L, 29920L)),
        ...
        WordEntity(id = 29916, original = "curb", transliteration = "[kɜːrb]", translation = "бордюр (амер.)",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_fixture", fillInBlankExclusions = listOf(29906L, 29913L, 29915L, 29917L, 29918L, 29920L)),
        ...
        WordEntity(id = 29917, original = "manhole", transliteration = "[ˈmænhoʊl]", translation = "канализационный люк",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_fixture", fillInBlankExclusions = listOf(29906L, 29913L, 29915L, 29916L, 29920L)),
        ...
        WordEntity(id = 29918, original = "stoop", transliteration = "[stuːp]", translation = "крыльцо (NYC-стиля)",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "building_exterior", fillInBlankExclusions = listOf(29902L, 29903L, 29904L, 29907L, 29914L, 29916L, 29919L, 29923L)),
        ...
        WordEntity(id = 29919, original = "quay", transliteration = "[kiː]", translation = "набережная, причал",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "public_space", fillInBlankExclusions = listOf(29902L, 29912L)),
        ...
        WordEntity(id = 29920, original = "lamppost", transliteration = "[ˈlæmppoʊst]", translation = "фонарный столб",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_fixture", fillInBlankExclusions = listOf(29906L, 29913L, 29915L, 29916L, 29917L, 29922L)),
        ...
        WordEntity(id = 29921, original = "mews", transliteration = "[mjuːz]", translation = "мьюс (быв. конюшенный ряд)",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "urban_area", fillInBlankExclusions = listOf(29901L, 29905L, 29908L, 29909L, 29910L, 29924L)),
        ...
        WordEntity(id = 29922, original = "pergola", transliteration = "[ˈpɜːrɡələ]", translation = "пергола",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "urban_greenery", fillInBlankExclusions = listOf(29907L, 29912L, 29914L, 29923L)),
        ...
        WordEntity(id = 29923, original = "eaves", transliteration = "[iːvz]", translation = "свесы крыши",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "building_exterior", fillInBlankExclusions = listOf(29904L, 29912L, 29914L, 29918L, 29922L)),
        ...
        WordEntity(id = 29924, original = "cul-de-sac", transliteration = "[ˈkʌl də sæk]", translation = "тупик (улица)",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_type", fillInBlankExclusions = listOf(29901L, 29903L, 29921L, 29925L)),
        ...
        WordEntity(id = 29925, original = "alleyway", transliteration = "[ˈæliweɪ]", translation = "узкий переулок",
            ...
            rarity = "RARE", setId = 299, languagePair = "en-ru", pos = "noun", semanticGroup = "street_type", fillInBlankExclusions = listOf(29903L, 29921L, 29924L)),
    )
}
