...
object WordDataHebrewPmL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "אָדָם אוֹ חֶבְרָה שֶׁמְּשַׁלֵּם כֶּסֶף עַל הַשֵּׁרוּת אוֹ הַסָּחוֹרָה.",
            definitionNative = "Человек или фирма, что платит деньги за услугу или товар.",
            example = "כָּל לָקוֹחַ חָשׁוּב לָנוּ — בִּמְיֻחָד בַּחֹדֶשׁ הָרִאשׁוֹן אַחֲרֵי הַהָשְׁקָה.",
        ...
        WordEntity(
            ...
            definition = "מִי שֶׁנִּכְנַס לַדַּף אוֹ לָאֲתָר רַק לִזְמַן קָצָר וְלֹא בְּהֶכְרֵחַ נִרְשַׁם.",
            definitionNative = "Тот, кто заходит на страницу или сайт ненадолго и не обязательно регистрируется.",
            example = "כָּל מְבַקֵּר בַּדַּף שֶׁלָּנוּ נִשְׁאַר בַּמֻּצָע פָּחוֹת מִדַּקָּה.",
        ...
        WordEntity(
            ...
            definition = "קְבוּצָה גְּדוֹלָה שֶׁל אֲנָשִׁים שֶׁהַמּוּצָר מְכַוֵּן אֲלֵיהֶם בְּסוֹף.",
            definitionNative = "Большая группа людей, на которую продукт в итоге нацелен.",
            example = "קָהָל שֶׁלָּנוּ מֵכִיל הוֹרִים צְעִירִים בְּגִיל שְׁלוֹשִׁים עַד אַרְבָּעִים.",
        ...
        WordEntity(
            ...
            definition = "מַשֶּׁהוּ שֶׁחֶבְרָה מֲכִּינָה כְּדֵי לִמְכֹּר אוֹ לָתֵת לְאֲנָשִׁים בַּחַיִּים שֶׁלָּהֶם.",
        ...
        WordEntity(
            ...
            definition = "פְּעֻלָּה שֶׁחֶבְרָה עוֹשָׂה עֲבוּר אֲנָשִׁים תְּמוּרַת תַּשְׁלוּם — לֹא חֵפֶץ פִיזִי.",
            definitionNative = "Действие, что фирма делает за плату — не физическая вещь, а помощь или работа.",
            example = "אֲנַחְנוּ נוֹתְנִים שֵׁרוּת שֶׁל אִחְסוּן קְבָצִים בַּעֲנַן לִמְפַתְּחִים.",
        ...
        WordEntity(
            ...
            example = "הָאֲתָר שֶׁל הַחֶבְרָה נִבְנָה מֵחָדָשׁ בְּעִצּוּב מוֹדֶרְנִי.",
        ...
        WordEntity(
            ...
            example = "הַדֵּרוּג שֶׁלָּנוּ בַּחֲנוּת יָרַד בִּגְלַל בָּאג בַּגִּרְסָה הָאַחֲרוֹנָה.",
        ...
        WordEntity(
            ...
            definition = "מַחֲשָׁבָה חֲדָשָׁה עַל מָה שֶׁשָּׁוֶה לִבְנוֹת אוֹ לְשַׁפֵּר בַּמּוּצָר.",
        ...
        WordEntity(
            ...
            example = "מָצָאנוּ בְּעָיָה גְּדוֹלָה בַּמָּסָךְ הַתַּשְׁלוּם — מִשְׁתַּמְּשִׁים נוֹטְשִׁים שָׁם.",
        ...
        WordEntity(
            ...
            definition = "דֶּרֶךְ לְהוֹצִיא אֶת הָאָדָם מִמַּצָּב קָשֶׁה אוֹ לַעֲנוֹת עַל מָה שֶׁחָסֵר לוֹ.",
        ...
        WordEntity(
            ...
            example = "כָּל מְשִׂימָה בַּסְּפְּרִינְט מְקַבֶּלֶת בַּעַל אַחְרָיוּת בָּהִיר וּזְמַן צָפוּי.",
        ...
        WordEntity(
            ...
            definition = "תּוֹצָאָה טוֹבָה שֶׁבָּהּ הַמַּטָּרָה שֶׁתָּכְנַנּוּ הַגִּיעָהּ לְמָקוֹם בָּהִיר וְנִמְדָּד.",
            definitionNative = "Хороший результат — когда задуманная цель пришла к ясному и измеримому исходу.",
            example = "הַהַצְלָחָה שֶׁל הַהָשְׁקָה הַפְתִּיעָהּ אֲפִילוּ אֶת הַמַּשְׁקִיעִים הַוָּתִיקִים.",
