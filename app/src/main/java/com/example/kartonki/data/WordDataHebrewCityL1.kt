...
object WordDataHebrewCityL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "חִכִּינוּ בְּסַבְלָנוּת לְפָנָיו וְעָבַרְנוּ בַּמַּעֲבָר חֲצִיָּה.",
        ...
        WordEntity(
            ...
            example = "אֲנִי נוֹסֵעַ בָּאוֹטוֹבּוּס לַעֲבוֹדָה כָּל בֹּקֶר.",
        ...
        WordEntity(
            ...
            example = "הִזְמַנּוּ מוֹנִית לִתְחַנַּת הָרַכֶּבֶת בַּלַּיְלָה.",
        ...
        WordEntity(
            ...
            definition = "מָקוֹם בָּרְחוֹב שֶׁבּוֹ עוֹצֵר אוֹטוֹבּוּס וַאֲנָשִׁים עוֹלִים אוֹ יוֹרְדִים.",
        ...
        WordEntity(
            ...
            definition = "מָקוֹם בָּעִיר שֶׁבּוֹ קוֹנִים תְּרוּפוֹת לְפִי מִרְשַׁם הָרוֹפֵא.",
            definitionNative = "Заведение в городе, где покупают лекарства по рецепту врача.",
            example = "הָלַכְתִּי לַבֵּית מִרְקַחַת לְקַבֵּל אֶת הַתְּרוּפָה שֶׁל סָבָתִי.",
        ...
        WordEntity(
            ...
            definition = "מִתְקָן שֶׁבּוֹ מַיִם קוֹפְצִים לָאֲוִיר לְקִשּׁוּט הַכִּכָּר.",
            definitionNative = "Сооружение, где вода взлетает струями вверх — украшает площадь.",
            example = "יְלָדִים שִׂחֲקוּ לְיַד הַמָּזְרָקָה בַּכִּכָּר הַמֶּרְכָּזִית.",
