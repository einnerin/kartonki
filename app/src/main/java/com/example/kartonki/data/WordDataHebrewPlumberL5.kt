...
object WordDataHebrewPlumberL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "plumber_design",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "plumber_standards",
            original = "תֶּקֶן יִשְׂרְאֵלִי 1205", translation = "израильский стандарт 1205",
            definition = "מִסְמַךְ הַחוֹבָה שֶׁקּוֹבֵעַ דְּרִישׁוֹת לַעֲבוֹדוֹת מַיִם בִּבְנִיָּה בִּמְדִינָה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "plumber_business",
        ...
        WordEntity(
            ...
            definition = "פֵּרוּט מָה יַעֲשׂוּ וְכַמָּה זֶה יַעֲלֶה — לִפְנֵי שֶׁהַלָּקוֹחַ מֵסְכִּים.",
            definitionNative = "Расшифровка, что сделают и сколько стоит — до того как клиент согласится.",
            example = "הַצָּעַת מְחִירִים שָׁלַחְתִּי בְּמֵיְל בּוֹ בַּיּוֹם.",
        ...
        WordEntity(
            ...
            definition = "מִסְמַךְ מְפֹרָט שֶׁמְּפָרֵט כָּל פְּעֻלָּה וְכָל חֹמֶר עִם מְחִירִים בִּמְכַרָּז.",
        ...
        WordEntity(
            ...
            example = "חוֹזֵה קַבְּלָנוּת חָתוּם נוֹתֵן הֲגַנָּה לִשְׁנֵי הַצְּדָדִים.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "plumber_specialty",
            ...
            example = "חִבּוּר גַּז לְכִירָה חֲדָשָׁה בִּצַּעְתִּי בְּהַשְׁגָּחַת מְפַקֵּחַ.",
        ...
        WordEntity(
            ...
            example = "מַחֲלִיף חוֹם מְבוֹדֵד אֶת מַיִם הַשְּׁתִיָּה מִמַּעֲרֶכֶת הֲחִמּוּם.",
        ...
        WordEntity(
            ...
            definition = "הַחְלָפָה כּוֹלֶלֶת שֶׁל קַוִּים יְשָׁנִים בְּשָׁכוּנָה אוֹ בְּבִנְיַן וָתִיק.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "plumber_safety",
            ...
            example = "כְּלָלֵי בְּטִיחוּת אֲנִי תּוֹלֶה עַל הַקִּיר בְּכָל אֲתָר חָדָשׁ.",
        ...
        WordEntity(
            ...
            definition = "מַחְשָׁבָה שִׁיטָתִית לִפְנֵי הַתְחָלָה — מָה יָכוֹל לְהִשְׁתַּבֵּשׁ וּמָה נַעֲשֶׂה אָז.",
        ...
        WordEntity(
            ...
            example = "נֹהַל חֵרוּם כָּתוּב בְּקֹבֶץ נָגִישׁ לְכָל חַבֵּרֵי הַצֶּוֶת.",
