...
object WordDataHebrewQaL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "qa_automation",
            original = "סֵלֵנְיוּם", translation = "Selenium",
            definition = "כְּלִי וָתִיק שֶׁמְּדַמֶּה לְחִיצוֹת וַהַקְלָדוֹת בְּדַפְדְּפָן לִבְדִיקוֹת אוֹטוֹמָטִיּוֹת.",
         ...
         fillInBlankExclusions = listOf(176202L, 176203L, 176204L, 176205L)),
        WordEntity(
            ...
            example = "עָבַרְנוּ לִפְּלֵייוֵוייט וְהַבְּדִיקוֹת הִפְסִיקוּ לִתְקֹעַ עַל אָנִימַצְיוֹת.",
            exampleNative = "Перешли на פְּלֵייוֵוייט — и тесты перестали зависать на анимациях.",
         fillInBlankExclusions = listOf(176201L, 176203L, 176204L, 176205L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176201L, 176202L, 176204L, 176205L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176201L, 176202L, 176203L, 176205L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176201L, 176202L, 176203L, 176204L)),

        // ── qa_perf (5) — нагрузочное тестирование ──
        WordEntity(
            id = 176206, setId = 1762, languagePair = "he-ru", rarity = "RARE",
            pos = "noun", semanticGroup = "qa_perf",
            ...
            example = "הַלוֹאד טֶסְט הִרְאָה שֶׁהָאֲתָר מַחֲזִיק חָמֵשׁ אֲלָפִים מִשְׁתַּמְּשִׁים בְּמַקְבִּיל.",
            exampleNative = "לוֹאד טֶסְט показал, что сайт держит пять тысяч пользователей одновременно.",
         fillInBlankExclusions = listOf(176207L, 176208L, 176209L, 176210L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176206L, 176208L, 176209L, 176210L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176206L, 176207L, 176209L, 176210L)),
        WordEntity(
            ...
            example = "סְפַּייק טֶסְט הוֹכִיחַ שֶׁהַסְּקֵיילִינְג הָאוֹטוֹמָטִי לֹא מַסְפִּיק מַהֵר.",
            exampleNative = "סְפַּייק טֶסְט доказал, что автоскейлинг недостаточно быстр.",
         fillInBlankExclusions = listOf(176206L, 176207L, 176208L, 176210L)),
        WordEntity(
            ...
            example = "הַבֶּנְצ׳מַארְק הִרְאָה שֶׁהַגִּרְסָה הַחֲדָשָׁה מֲהִירָה פִּי שְׁתַּיִם מֵהַיְּשָׁנָה.",
            exampleNative = "בֶּנְצ׳מַארְק показал, что новая версия в два раза быстрее старой.",
         fillInBlankExclusions = listOf(176206L, 176207L, 176208L, 176209L)),

        // ── qa_api (5) — API-тесты ──
        WordEntity(
            id = 176211, setId = 1762, languagePair = "he-ru", rarity = "RARE",
            pos = "noun", semanticGroup = "qa_api",
            original = "טֶסְטֵי רֶסְט", translation = "REST testing (тестирование REST)",
            definition = "סִדְרָה שֶׁשּׁוֹלַחַת בַּקָּשׁוֹת לְ|שָׂרַת וּמוֹדֶדֶת אִם הַתְּשׁוּבָה תּוֹאֶמֶת לַצָּפוּי.",
         ...
         fillInBlankExclusions = listOf(176212L, 176213L, 176214L, 176215L)),
        WordEntity(
            ...
            example = "אוֹסֵף פּוֹסְטְמַן מְשֻׁתָּף מַעֲבִיר מַהֵר יְדִיעוֹת בֵּין מְפַתְּחִים לְבוֹחֲנִים.",
            exampleNative = "Общая коллекция פּוֹסְטְמַן быстро передаёт знания между разработчиками и тестировщиками.",
         fillInBlankExclusions = listOf(176211L, 176213L, 176214L, 176215L)),
        WordEntity(
            id = 176213, setId = 1762, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "qa_api",
            original = "קוֹנְטְרַקְט טֶסְט", translation = "contract test (контрактный)",
            definition = "בְּדִיקָה שֶׁמְּוַדֵּאת שֶׁשְּׁנֵי שֵׁרוּתִים מַסְכִּימִים עַל פוֹרְמַט הַהוֹדָעוֹת בֵּינֵיהֶם.",
         ...
         fillInBlankExclusions = listOf(176211L, 176212L, 176214L, 176215L)),
        WordEntity(
            ...
            example = "הֲרַמְנוּ מוֹק סֶרְוֶור כְּשֶׁשִּׁירוּת הַחִיוּב הָיָה לְמַטָּה לְתַחֲזוּקָה.",
            exampleNative = "Мы подняли מוֹק סֶרְוֶור, пока биллинг был на профилактике.",
         fillInBlankExclusions = listOf(176211L, 176212L, 176213L, 176215L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176211L, 176212L, 176213L, 176214L)),

        // ── qa_ci (5) — CI / интеграция ──
        WordEntity(
            id = 176216, setId = 1762, languagePair = "he-ru", rarity = "RARE",
            pos = "noun", semanticGroup = "qa_ci",
         ...
         fillInBlankExclusions = listOf(176217L, 176218L, 176219L, 176220L)),
        WordEntity(
            ...
            definition = "חֲלוּקַת חֲבִילוֹת בְּדִיקוֹת בֵּין מְכוֹנוֹת רַבּוֹת כְּדֵי לְקַצֵּר אֶת זְמַן הַסַּבָּב.",
            definitionNative = "Деление пакетов тестов между многими машинами — чтобы сократить общее время прогона.",
            example = "רִיצָה מַקְבִּילָה קִצְּרָה אֶת הַסַּבָּב מִשָּׁעָה לְשֶׁבַע דַּקּוֹת.",
            exampleNative = "רִיצָה מַקְבִּילָה сократила прогон с часа до семи минут.",
         fillInBlankExclusions = listOf(176216L, 176218L, 176219L, 176220L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176216L, 176217L, 176219L, 176220L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176216L, 176217L, 176218L, 176220L)),
        WordEntity(
            id = 176220, setId = 1762, languagePair = "he-ru", rarity = "RARE",
            pos = "phrase", semanticGroup = "qa_ci",
            original = "כִּסּוּי בְּדִיקוֹת", translation = "test coverage (покрытие тестами)",
            definition = "אֲחוּז שׁוּרוֹת הַתָּכְנָה שֶׁעָבְרוּ דֶּרֶךְ בְּדִיקוֹת אוֹטוֹמָטִיּוֹת בָּרָצָה אַחַת.",
            definitionNative = "Доля строк программы, которые прошли через автотесты за один прогон.",
            example = "כִּסּוּי בְּדִיקוֹת נָפַל לְשִׁבְעִים אָחוּז וְהַחֲסִימָה הִתְנַשְּׁפָה אוֹטוֹמָטִית.",
            exampleNative = "כִּסּוּי בְּדִיקוֹת упал до семидесяти процентов — и блокировка сработала автоматически.",
        ),

        // ── qa_advanced (5) — продвинутые виды тестирования ──
        WordEntity(
            id = 176221, setId = 1762, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "qa_advanced",
            original = "הַנְדָּסַת כָאוֹס", translation = "chaos engineering",
            definition = "גִּישָׁה שֶׁמְּפִילָה רְכִיבִים בִּכְוָנָה בִּסְבִיבַת יְצוּר כְּדֵי לִבְדֹּק חֹסֶן.",
         ...
         fillInBlankExclusions = listOf(176222L, 176223L, 176224L, 176225L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176221L, 176223L, 176224L, 176225L)),
        WordEntity(
         ...
         fillInBlankExclusions = listOf(176221L, 176222L, 176224L, 176225L)),
        WordEntity(
            ...
            definition = "סְרִיקָה שֶׁבּוֹדֶקֶת שֶׁאֲנָשִׁים עִם מֻגְבָּלוּת יְכוֹלִים לְהִשְׁתַּמֵּשׁ בָּאֲתָר אוֹ בָּאַפְּלִיקַצְיָה.",
            definitionNative = "Проверка — могут ли люди с ограничениями пользоваться сайтом или приложением.",
            example = "בִּקֹּרֶת נְגִישׁוּת חָשַׂף שֶׁמְּקַרְאֵי מָסָךְ לֹא קָרְאוּ אֶת תַּפְרִיט הָרָאשִׁי.",
            exampleNative = "בִּקֹּרֶת נְגִישׁוּת вскрыл, что скринридеры не читали главное меню.",
         fillInBlankExclusions = listOf(176221L, 176222L, 176223L, 176225L)),
        WordEntity(
            ...
            example = "רֶגְרֶסְיָה חָזוּתִית הַתְרִיעָה עַל כַּפְתּוֹר שֶׁזָּז שְׁתֵּי פִּיקְסֵלִים יָמִינָה.",
            exampleNative = "רֶגְרֶסְיָה חֲזוּתִית предупредила о кнопке, которая сдвинулась на два пикселя вправо.",
         fillInBlankExclusions = listOf(176221L, 176222L, 176223L, 176224L)),
    )
}
