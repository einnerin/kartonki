...
object WordDataHebrewSportsFootball {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 189207, setId = 1892, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "שַׂחְקָן בְּאֶמְצַע הַמִּגְרָשׁ הַמְּחַבֵּר בֵּין הֲגָנָה לְהַתְקָפָה.",
        ...
        WordEntity(id = 189215, setId = 1892, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "בְּעִיטָה מִפִּינַּת הַמִּגְרָשׁ אַחֲרֵי שֶׁהֲגָנָה הוֹצִיאָה אֶת הַכַּדּוּר.",
        ...
        WordEntity(id = 189216, setId = 1892, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִפְגָּשׁ סְפּוֹרְט הַנֶּעֱרָךְ בַּמִּגְרָשׁ שֶׁל הַיָּרִיב.",
        ...
        WordEntity(id = 189217, setId = 1892, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִפְגָּשׁ סְפּוֹרְט הַנֶּעֱרָךְ בַּמִּגְרָשׁ שֶׁל הַקְּבוּצָה הַמְּאַרַחַת.",
        ...
        WordEntity(id = 189221, setId = 1892, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מִפְגָּשׁ סְפּוֹרְט בֵּין שְׁתֵּי קְבוּצוֹת מֵאוֹתָהּ עִיר אוֹ אֵזוֹר.",
        ...
        WordEntity(id = 189223, setId = 1892, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "סִדְרַת מִשְׂחָקִים מְאוּרְגֶּנֶת שֶׁבְּסוֹפָהּ נִקְבָּע מְנַצֵּחַ.",
        ...
        WordEntity(id = 189225, setId = 1892, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "בְּעִיטָה חוֹפְשִׁית הַנִּיתֶּנֶת אַחֲרֵי עֲבֵרָה מִחוּץ לָרַחֲבָה.",
