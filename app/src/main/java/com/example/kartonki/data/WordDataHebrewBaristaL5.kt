...
object WordDataHebrewBaristaL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_management",
            original = "מְנַהֵל בֵּית קָפֶה", translation = "директор кофейни",
            definition = "אָדָם שֶׁאַחְרָאִי עַל כָּל מָה שֶּׁקּוֹרֶה בַּמָּקוֹם — צֶוֶת, כֶּסֶף וְלָקוֹחוֹת.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ שֶׁל חִפּוּשׁ אֲנָשִׁים חֲדָשִׁים, רֵאָיוֹן וּבְחִירָה לְעָבְדָהּ בַּמָּקוֹם.",
            definitionNative = "Поиск новых людей, собеседование и выбор сотрудника на работу.",
            example = "גִּיּוּס מֻעָמָדִים אָרַךְ חֹדֶשׁ עַד שֶׁמָּצָאנוּ אֶת הַמַּתְאִים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_economics",
            original = "עֲלוּת הַכּוֹס", translation = "себестоимость чашки",
            definition = "כַּמָּה כֶּסֶף יוֹצֵא לַבָּעְלִים לְהָכִין מָנָה אַחַת — חָּוָּמְרֵי גֶּלֶם וַעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            definition = "כַּמָּה כֶּסֶף נִשְׁאַר לַבָּעְלִים מִכָּל מְכִירָה אַחֲרֵי הַהוֹצָאוֹת.",
            definitionNative = "Сколько денег остаётся хозяину с каждой продажи после расходов.",
            example = "רִוְוחִיּוּת הָעֳסַק עָלְתָה אַחֲרֵי שֶׁהוֹרַדְנוּ עוֹבְדִים מְיֻתָּרִים.",
        ...
        WordEntity(
            ...
            definition = "אֲבֵדָה כַּסְפִּית מִתּוֹצַר שֶׁהִתְקַלְקֵל, נִשְׁפַּךְ אוֹ עָבַר תַּאֲרִיךְ אַחֲרוֹן.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_quality",
        ...
        WordEntity(
            ...
            definition = "כְּשֶׁמַּגִּישִׁים יַחַד כַּמָּה דְּגָמִים סְמוּיִים כְּדֵי לְהַחְלִיט אֵיזֶה הֲכִי טוֹב.",
        ...
        WordEntity(
            ...
            definition = "טֹפֶס עִם נְקֻדּוֹת לְצִיּוּן רֵיחַ, מִרְקָם וּתְכוּנוֹת שֶׁל כָּל דֶּגֶם נִבְדַּק.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_training",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "barista_culture",
        ...
        WordEntity(
            ...
            definition = "אֹסֶף שֶׁל מִנְהָגִים וּכְלָלִים אֵיךְ אֲנָשִׁים מַגִּישִׁים וּמְבַלִּים בְּזְמַן הַמַּשְׁקֶה.",
        ...
        WordEntity(
            ...
            example = "אָמָּנוּת הָאֵירוּחַ הַיַּפָּנִית מְלַמֶּדֶת שֶׁכָּל פְּרָט קָטָן חָשׁוּב.",
        ...
        WordEntity(
            ...
            definition = "בְּחִירָה לִקְנוֹת רַק מִסַּפָּקִים שֶׁמְּשַׁלְּמִים נָכוֹן לַחַוָּאִים וְשׁוֹמְרִים עַל הַטֶּבַע.",
