...
object WordDataHebrewBureauL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "שַׂמְתִּי אֶת הַטֹּפֶס בְּתוֹךְ הַמְּעֲטָּפָה.",
        ...
        WordEntity(
            ...
            example = "נִגַּשְׁתִּי לַדֶּלְפֵּק לְמַסֹּר אֶת הַמְּעֲטָּפָה.",
        ...
        WordEntity(
            ...
            example = "הָרִשּׁוּם לְקֻרְסֵי עִבְרִית נִסְגַּר מָחָר.",
        ...
        WordEntity(
            ...
            definition = "לִכְתֹּב אֶת הַשֵּׁם שֶׁלָּךְ בִּכְתַב יָד בְּסוֹף הַמִּסְמָךְ לְאִשּׁוּר.",
