...
object WordDataHebrewTimeL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            exampleNative = "קַדְמוֹנָה мудрость отцов сохранилась в сокрытых писаниях.", isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            exampleNative = "חוֹלֶפֶת слава не заменит истинной любви.", isFillInBlankSafe = false),
