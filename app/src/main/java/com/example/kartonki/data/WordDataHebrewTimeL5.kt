...
object WordDataHebrewTimeL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "בִּטּוּי תָּנַּ\"כִי לִתְקוּפָה הָאַחֲרוֹנָה שֶׁל הַהִיסְטוֹרְיָה — זְמַן הַגְּאֻלָּה הַשְּׁלֵמָה.",
        ...
        WordEntity(
            ...
            example = "הַמִּזְמוֹר הִשְׁוָוָה אֶת חֶסֶד הָאֵל לַנֵּצַח.",
        ...
        WordEntity(
            ...
            definition = "בִּטּוּי מִקְרָאִי הַמּוֹסֵר רַעֲיוֹן שֶׁל הֶמְשֵׁכִיּוּת בֵּין דּוֹרוֹת — זִכְרוֹן עַם וַחֲסָדָיו.",
        ...
        WordEntity(
            ...
            definition = "כִּנּוּי תָּנַּ\"כִי לְתוֹלְדוֹת עוֹלָם הַקְּדוּמוֹת — מִבְּרֵאשִׁית עַד לִתְקוּפַת הַנְּבִיאִים.",
        ...
        WordEntity(
            ...
            example = "הַחֲזוֹן עוֹסֵק בְּמָה שֶּׁיִּקְרֶה בְּאַחֲרִית הָעוֹלָם.",
        ...
        WordEntity(
            ...
            definition = "מֵטָפוֹרָה שִׁירִית לְמִרְקַם הָאֵרוּעִים שֶׁמִּשְׁתַּזְּרִים זֶה בָּזֶה לְאֹרֶךְ הַשָּׁנִים.",
        ...
        WordEntity(
            ...
            definition = "מִשֵּׁךְ הַזְּמַן הַמְצֻפֶּה שֶׁבּוֹ אָדָם חַי — מוּשָׂג סְטָטִיסְטִי וּפִילוֹסוֹפִי כְּאַחַד.",
            definitionNative = "Срок, который человеку, как ожидается, отведено прожить — категория и статистическая, и философская.",
            example = "תּוֹחֶלֶת הַחַיִּים בְּעוֹלַם הַמַּעֲרָב גְּדֵלָה לְאַט.",
        ...
        WordEntity(
            ...
            example = "הַנֵּר תָּמִיד שֶׁבְּאֻלָּם הַיִּזְכֹּר דָּלַק לִכְבוֹד הַחֲלָלִים.",
        ...
        WordEntity(
            ...
            example = "הַסְּפָרְדִּי הִסְבִּיר אֶת הָאֱלוֹהוּת בְּמֻשַּׂג הַהַוֶּה הַמַּתְמִיד.",
        ...
        WordEntity(
            ...
            definition = "תַּפִיסָה שֶׁל גְּמַר הַמְּצִיאוּת הַמֻּכֶּרֶת — נוֹשֵׂא מֶרְכָּזִי בְּפִילוֹסוֹפְיָה, בְּדַת וּבַסִּפְרוּת.",
        ...
        WordEntity(
            ...
            definition = "תַּפִיסָה פִילוֹסוֹפִית שֶׁכָּל מָה שֶּׁקַּיָּם בָּעוֹלָם הַזֶּה הוּא זְמַנִּי וְלֹא קָבוּעַ.",
        ...
        WordEntity(
            ...
            definition = "בִּטּוּי סִפְרוּתִי לִתְקוּפָה אֲרֻכָּה שֶׁעָבְרָה — נֶחְשַׁב גָּבוֹהַּ יוֹתֵר מֵ«הַרְבֵּה זְמַן».",
        ...
        WordEntity(
            ...
            definition = "תְּקוּפָה שֶׁהִתְרַחֲשָׁה הַרְבֵּה זְמַן לִפְנֵי הַהוֹוֶה — מָתָּאֵם לְזִכְרוֹנוֹת קְמוּטֵי שָׁנִים.",
            definitionNative = "Эпоха, что миновала задолго до нынешнего часа — соответствует выцветшим от лет воспоминаниям.",
            example = "כָּל מָה שֶּׁקָּרָה אָז שַׁיָּךְ כְּבָר לְעֶבֶר רָחוֹק.",
        ...
        WordEntity(
            ...
            example = "הַמְּשׁוֹרֵר הִבְטִיחַ לִידִידָיו עֲתִיד נֶצַח שֶׁל אַחֲוָה.",
        ...
        WordEntity(
            ...
            definition = "שֶׁאֵינוֹ מִתְקַיֵּם זְמַן רַב וְעוֹבֵר חִישׁ — תֹּאַר סִפְרוּתִי לְכָל מָה שֶּׁאֵינוֹ נִצְחִי.",
            definitionNative = "Тот, что недолго длится и быстро минует — литературный эпитет для всего, что невечно.",
            example = "תְּהִלָּה חוֹלֶפֶת אֵינָהּ מַחְלִיפָה אַהֲבַת אַמֵּת.",
        ...
        WordEntity(
            ...
            definition = "תְּכוּנָה שֶׁל מָה שֶּׁמִּתְקַיֵּם בְּלִי גְּבוּל זְמַן — שֵׁם עֶצֶם מֻפְשָׁט בִּלְשׁוֹן גְּבוֹהָה.",
