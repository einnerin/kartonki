...
object WordDataHebrewTimeL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            exampleNative = "Древняя мудрость отцов сохранилась в сокрытых писаниях.", isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            exampleNative = "Преходящая слава не заменит истинной любви.", isFillInBlankSafe = false),
