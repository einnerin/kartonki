...
object WordDataHebrewEducationEdTech {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190201, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "קוּרְסֵרָה הִשִּׁיקָה קוּרְס מֲקֻוָּוָן הֲמוֹנִי בִּלְמִידַת מְכוֹנָה.",
        ...
        WordEntity(id = 190203, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פוֹרְמָט שֶׁבּוֹ הַמּוֹרֶה וְהַתַּלְמִידִים נִפְגָּשִׁים בִּזְמַן אֱמֶת בְּוִידֵאוֹ אוֹ בְּכִתָּה.",
        ...
        WordEntity(id = 190204, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "קוּרְס שֶׁמְּשַׁלֵּב מִפְגָּשִׁים פְּרוֹנְטָלִיִּים עִם מְשִׂימוֹת אוֹנְלַיְן בְּאוֹתָהּ תְּקוּפָה.",
        ...
        WordEntity(id = 190205, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "מַצְלֵמָה רְחַבַּת זָוִית הִכְרִיחָה אֶת לְמִידָה הִיבְּרִידִית לִפְעֹל חָלָק.",
        ...
        WordEntity(id = 190206, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פְּלַטְפוֹרְמָה שֶׁבָּהּ מוֹרִים מַעֲלִים מְשִׂימוֹת, צִיּוּנִים וְחוֹמְרִים שֶׁל הַקּוּרְס כֻּלּוֹ.",
        ...
        WordEntity(id = 190208, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הִיא שָׁלְחָה כָּל קְבוּצָה לַחֲדַר מִפְגָּשׁ לְעֶשֶׂר דַּקּוֹת.",
            exampleNative = "Она отправила каждую группу в חֲדַר מִפְגָּשׁ на десять минут.",
        ...
        WordEntity(id = 190209, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פִיצֵ'ר בִּכְלִי וִידֵאוֹ שֶׁמַּרְאֶה לְכָל הַמִּשְׁתַּתְּפִים אֶת מְסָךְ הַמַּצִּיג בִּזְמַן אֱמֶת.",
            definitionNative = "Функция в видеосвязи: показывает всем участникам экран докладчика в реальном времени.",
            example = "שִׁתּוּף מָסָךְ עָזַר לְהַצִּיג אֶת הַקּוֹד שׁוּרָה אַחַר שׁוּרָה.",
        ...
        WordEntity(id = 190210, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "טֶקְסְט חַי מִתַּחַת לַוִּידֵאוֹ הַמַּרְאֶה מָה שֶּׁהַמַּרְצֶה אָמַר, נוֹצַר מִזִּהוּי דִּבּוּר.",
            definitionNative = "Бегущий текст под видео, показывающий слова лектора, создаётся распознаванием речи.",
            example = "כְּתוּבִיוֹת אוֹטוֹמָטִיוֹת עָזְרוּ לִסְטוּדֶנְט חֵרֵשׁ לַעֲקֹב אַחַר הַהַרְצָאָה.",
        ...
        WordEntity(id = 190211, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "בְּכִתָּה הֲפוּכָה הַיְּלָדִים צוֹפִים בִּשְׁבָרִים לִפְנֵי שִׁעוּר.",
        ...
        WordEntity(id = 190213, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "לְמִידָה אַדַּפְּטִיבִית הֶחְזִירָה אוֹתוֹ לִשְׁבָרִים כְּשֶׁאַלְגֶּבְּרָה נֶחְלְשָׁה.",
        ...
        WordEntity(id = 190214, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            original = "לְמִידָה מְבֻסֶּסֶת חֲקִירָה",
            ...
            example = "לְמִידָה מְבֻסֶּסֶת חֲקִירָה הָפְכָה אֶת הַשִּׁעוּר לְדִיּוּן עַל בְּטִיחוּת.",
            exampleNative = "לְמִידָה מְבֻסֶּסֶת חֲקִירָה превратила урок в дискуссию о безопасности.",
        ...
        WordEntity(id = 190215, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "שִׁיטַת סוֹקְרָטֶס שִׁמְּשָׁה בְּפָקוּלְטוֹת הַמִּשְׁפָּטִים בְּהַרְוַארְד.",
        ...
        WordEntity(id = 190216, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פוֹרְמַט קוּרְס שֶׁבּוֹ כָּל לוֹמֵד מַחְלִיט מָתַי לְהַתְחִיל, בְּאֵיזֶה קֶצֶב לִלְמֹד וּמָתַי לְסַיֵּם.",
        ...
        WordEntity(id = 190217, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "קוּרְס אוֹנְלַיְן שֶׁבּוֹ הַסְּטוּדֶנְטִים מַתְחִילִים וּמְסַיְּמִים יַחַד עִם דֶּדְלַיְן שְׁבוּעִי וּקְבוּצַת שִׂיחָה.",
        ...
        WordEntity(id = 190219, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מָסָךְ דִּיגִיטָלִי מְשֻׁתָּף שֶׁעָלָיו מוֹרֶה וְתַלְמִידִים מְצַיְּרִים, כּוֹתְבִים וּמַדְבִּיקִים פֶּתֶק יַחַד.",
        ...
        WordEntity(id = 190220, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "כְּלִי בִּפְלַטְפוֹרְמַת לְמִידָה שֶׁמַּצִּיג שְׁאֵלָה וּמְקַבֵּל תְּשׁוּבוֹת מִכָּל הַתַּלְמִידִים בִּשְׁנִיּוֹת.",
        ...
        WordEntity(id = 190222, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הִיא הִדְבִּיקָה תָּג דִּיגִיטָלִי שֶׁל גּוּגֶל לַפְּרוֹפִיל בְּלִינְקְדְאִין.",
        ...
        WordEntity(id = 190223, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "לִינְקְדְאִין הִצִּיעַ נְתִיב לְמִידָה שֶׁל שִׁשָּׁה קוּרְסִים לִמְנַהֵל מוּצָר.",
        ...
        WordEntity(id = 190224, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            exampleNative = "הַסְמָכַת מִיקְרוֹ по SQL принесла ей три звонка от рекрутёров.",
        ...
        WordEntity(id = 190225, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מְיוּמָנוּת לִמְצֹא, לְהַעֲרִיךְ וְלִיצֹר תּוֹכֶן בָּרֶשֶׁת בְּצוּרָה בְּטוּחָה וּבִיקּוּרְתִּית.",
