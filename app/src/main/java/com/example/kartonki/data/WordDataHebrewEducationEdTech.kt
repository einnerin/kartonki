...
object WordDataHebrewEducationEdTech {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190209, setId = 1902, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פִיצֵ'ר בִּכְלִי וִידֵאוֹ שֶׁמַּרְאֶה לְכָל הַמִּשְׁתַּתְּפִים אֶת מְסַךְ הַמַּצִּיג בִּזְמַן אֱמֶת.",
        ...
        WordEntity(id = 190220, setId = 1902, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "כְּלִי בִּפְלָטְפוֹרְמַת לְמִידָה שֶׁמַּצִּיג שְׁאֵלָה וּמְקַבֵּל תְּשׁוּבוֹת מִכָּל הַתַּלְמִידִים בִּשְׁנִיּוֹת.",
