...
object WordDataHebrewArmyL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 170203, setId = 1702, languagePair = "he-ru", rarity = "COMMON",
            ...
            example = "הַחַיָּלִים יָצְאוּ לִקְרָב לִפְנֵי שֶׁעָלָה הַבֹּקֶר עַל הַגְּבָעָה.",
        ...
        WordEntity(id = 170205, setId = 1702, languagePair = "he-ru", rarity = "COMMON",
            ...
            example = "הַפְּלוּגָה הִתְכַּנְּסָה בַּמִּסְדָּר לִפְנֵי הַיְצִיאָה לַשֶּׁטַח.",
        ...
        WordEntity(id = 170208, setId = 1702, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            pos = "phrase", semanticGroup = "army_units",
            definition = "זְרוֹעַ הַצָּבָא הַמַּפְעִילָה מְטוֹסִים וּמַסּוֹקִים לַהֲגַנָּה וְלַהַתְקָפָה.",
        ...
        WordEntity(id = 170211, setId = 1702, languagePair = "he-ru", rarity = "COMMON",
            ...
            example = "הַקַּצִּינָה שָׂמָה אֶקְדָּח בִּנְרְתִּיק הַחֲגוֹרָה לִפְנֵי הַיְצִיאָה.",
        ...
        WordEntity(id = 170214, setId = 1702, languagePair = "he-ru", rarity = "COMMON",
            ...
            pos = "noun", semanticGroup = "army_gear",
            definition = "נַעַל גְּבוֹהָה וְקָשָׁה הַמּוּדְבֶּקֶת לָרֶגֶל לַהֲלִיכָה בַּשֶּׁטַח הַקָּשֶׁה.",
        ...
        WordEntity(id = 170215, setId = 1702, languagePair = "he-ru", rarity = "COMMON",
            ...
            translation = "носилки",
            pos = "noun", semanticGroup = "army_gear",
            definition = "מִתְקַן בַּד עִם שְׁתֵּי מוֹטוֹת לְסוּחַבָּת פָּצוּעַ אוֹ חוֹלֶה.",
        ...
        WordEntity(id = 170218, setId = 1702, languagePair = "he-ru", rarity = "COMMON",
            ...
            pos = "noun", semanticGroup = "army_base_life",
            definition = "חֲנוּת קְטַנָּה בַּבָּסִיס שֶׁמּוֹכֶרֶת חֲטִּיפִים, שְׁתִיָּה וּצְרָכִים יוֹמְיוֹמִיִּים.",
        ...
        WordEntity(id = 170223, setId = 1702, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "הַמַּחְלָקָה יָצְאָה לַמָּטֳּוַחַ לִשְׁעָתַיִם שֶׁל אִמּוּן בֹּקֶר.",
        ...
        WordEntity(id = 170224, setId = 1702, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "הוּא קִבֵּל צִיּוּן מַעֲלֵה עַל קְלִיעָה בְּתֹם שָׁבוּעַ הָאִמּוּן.",
