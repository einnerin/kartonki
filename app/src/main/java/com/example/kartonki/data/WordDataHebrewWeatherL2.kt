...
object WordDataHebrewWeatherL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "אוֹר עָמוּם נָפַל עַל הַגַּגּוֹת בְּשָׁעַת בֵּין הָעַרְבַּיִם.",
        ...
        WordEntity(
            ...
            example = "אֲוִיר חַמִּים וְקַל שָׁטַף אוֹתָנוּ בְּצֵאתֵנוּ מֵהַבַּיִת.",
        ...
        WordEntity(
            ...
            definitionNative = "Когда воздух бодрит и тянет накинуть свитер — но это ещё не холод.",
        ...
        WordEntity(
            ...
            definitionNative = "Когда холод острый и его чувствуешь на щеках и кончиках пальцев.",
        ...
        WordEntity(
            ...
            definitionNative = "Сильное жгучее пекло — как у печи или в полдень в разгар лета.",
        ...
        WordEntity(
            ...
            definition = "עַמּוּד אֲוִיר מִסְתּוֹבֵב חָזָק שֶׁיּוֹרֵד מִן הָעֲנָנִים וּמַחֲרִיב כָּל מָה שֶׁבְּדַרְכּוֹ.",
        ...
        WordEntity(
            ...
            definition = "אִישׁ הַמְּקָצּוֹעַ שֶׁמּוֹסֵר בַּטֶּלֶוִיזְיָה אוֹ בָּרַדְיוֹ אֵיךְ תִּהְיֶה הַמֶּזֶג אֲוִיר.",
        ...
        WordEntity(
            ...
            definition = "תֵּאוּר קָצָר שֶׁל מָה שֶּׁצָּפוּי לִקְרוֹת בַּמֶּזֶג אֲוִיר בַּיָּמִים הַקְּרוֹבִים.",
        ...
        WordEntity(
            ...
            definition = "אוֹפְיָנִי לָאָבִיב — חַמִּים, פּוֹרֵחַ וְצִבְעוֹנִי, גְּשָׁמִים קַלִּים מִדֵּי פַּעַם.",
