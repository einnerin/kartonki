...
object WordDataHebrewNatureGeology {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 189601, setId = 1896, languagePair = "he-ru", rarity = "RARE",
            original = "גְּרָנִיט",
            translation = "гранит",
            definition = "סֶלַע מֲגְמָתִי קָשֶׁה וְגַרְעִינִי מִקְוַרְץ וּפֶלְדְּשַׁפַּט, נָפוֹץ בַּהֲרִים וּבְמִשְׁטְחֵי מִטְבָּח.",
        ...
        WordEntity(id = 189602, setId = 1896, languagePair = "he-ru", rarity = "RARE",
            original = "בַּזֶלֶת",
            translation = "базальт",
            definition = "סֶלַע וֻלְקָנִי כֵּהֶה הַנּוֹצָר כַּאֲשֶׁר לַבָּה דַּקָּה מִתְקָרֶרֶת בִּמְהִירוּת עַל פְּנֵי הָאֲדָמָה.",
        ...
        WordEntity(id = 189603, setId = 1896, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הָרֵי יְהוּדָה בְּנוּיִים בְּעִקָּר מִגִּיר שֶׁנּוֹצַר עַל קַרְקָעִית יָם קַדְמוֹן.",
        ...
        WordEntity(id = 189606, setId = 1896, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "זְכוּכִית טִבְעִית שְׁחוֹרָה הַנּוֹצֶרֶת כַּאֲשֶׁר לַבָּה צְמִיגָה מִתְקָרֶרֶת מַהֵר וְלֹא מַסְפִּיקָה לְהִתְגַּבֵּשׁ.",
        ...
        WordEntity(id = 189607, setId = 1896, languagePair = "he-ru", rarity = "EPIC",
            original = "כַּלְקָר",
            translation = "мергель",
            definition = "סֶלֶע רַךְ הַמָּעֳרָב מִגִּיר וְחַרְסִית, נֶחְשָׂף לְעִתִּים קְרוֹבוֹת בְּמִדְרוֹנֵי הָרֵי הַנֶּגֶב.",
            definitionNative = "Мягкая порода — смесь известковых частиц и глины; часто обнажается на склонах гор Негева.",
            example = "הַשְּׁכָבוֹת הָאֲפֹרוֹת שֶׁל כַּלְקָר מִתְפּוֹרְרוֹת מְהֵרָה תַּחַת גִּשְׁמֵי הָחֳרֵף.",
        ...
        WordEntity(id = 189610, setId = 1896, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מִשְׁפַּחַת מִינֶרָלִים הָאוֹרֶזֶת אֶת רֹב סִלְעֵי כַּדּוּר הָאָרֶץ, מַזְהִירָה בַּגְּרָנִיט הַחֲתוּךְ.",
        ...
        WordEntity(id = 189611, setId = 1896, languagePair = "he-ru", rarity = "EPIC",
            original = "קָלְצִיט",
            translation = "кальцит",
            definition = "מִינֶרָל לָבָן אוֹ צָלוּל, רָכִיב עִקָּרִי שֶׁל גִּיר וְשַׁיִשׁ, מָגִּיב לְחֻמְצָה בִּרְתִיחָה.",
        ...
        WordEntity(id = 189612, setId = 1896, languagePair = "he-ru", rarity = "RARE",
            original = "אַמֶתִיסְט",
            translation = "аметист",
            definition = "גָּרְסָה סְגֻלָּה שֶׁל קְוַרְץ, מְשַׁמֶּשֶׁת אֶבֶן חֵן מְחֻבֶּבֶת לְתַכְשִׁיטִים וּלְקִשּׁוּטֵי מִזְבֵּחַ.",
        ...
        WordEntity(id = 189616, setId = 1896, languagePair = "he-ru", rarity = "RARE",
            original = "מַגְמָה",
            translation = "магма",
            definition = "סֶלַע מֻתַּךְ וְלוֹהֵט הַזּוֹרֵם לְאַט עָמוֹק מִתַּחַת לִקְלִפַּת כַּדּוּר הָאָרֶץ.",
        ...
        WordEntity(id = 189617, setId = 1896, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "בְּהָוָואִי הַתַּיָּרִים צוֹפִים מֵרָחוֹק בְּלַבָּה כְּתֻמָּה שֶׁמַּגִּיעָה אֶל הַיָּם.",
        ...
        WordEntity(id = 189620, setId = 1896, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "מַכְתֵּשׁ רָמוֹן הוּא הַשֶּׁקַע הָאֵרוֹזְיוֹנִי הַגָּדוֹל בְּיוֹתֵר בָּעוֹלָם.",
            exampleNative = "מַכְתֵּשׁ Рамон — крупнейшая в мире эрозионная впадина.",
            pos = "noun", semanticGroup = "nature_geology_processes"),
        ...
        WordEntity(id = 189622, setId = 1896, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "הַשִּׁכְבָה הַעֲבָהּ שֶׁמִּתַּחַת לַקֵּרוּם וּמֵעַל לַגַּרְעִין, בָּהּ זוֹרֵם סֶלַע חַם וּצְמִיגִי.",
        ...
        WordEntity(id = 189623, setId = 1896, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "כּוֹרֵי הַתִּימְנָע גִּלּוּ עוֹרֵק עָפְרָה עָשִׁיר בְּנְחֹשֶׁת לִפְנֵי שָׁלֹשֶׁת אֲלָפִים שָׁנָה.",
        ...
        WordEntity(id = 189624, setId = 1896, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "לֹא רָחוֹק מִמּוֹדִיעִין יֵשׁ מַחְצַב גָּדוֹל שֶׁמְּסַפֵּק חָצָץ לְכָל הָאֵזוֹר.",
