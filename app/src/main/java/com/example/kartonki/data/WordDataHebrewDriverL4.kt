...
object WordDataHebrewDriverL4 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "חֶדֶר עִם מָסַכִּים שֶׁבּוֹ עוֹקְבִים אַחַר כָּל הַמַּשָּׂאִיּוֹת.",
            definitionNative = "Помещение с экранами, откуда следят за всеми машинами на рейсе.",
            example = "בַּחֲדַר בַּקָּרָה מָסַּכִּים מַרְאִים מִקּוּם רֶכֶב בִּזְמַן אֲמִיתִּי.",
        ...
        WordEntity(
            ...
            definition = "חַלּוּקַת מַסְלוּלִים בֵּין נְהָגִים לְפִי כִּשּׁוּרִים וּזְמִינוּת.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ הַמְפָרֵט מָה הוּבַל, מִמִּי וּלְמִי, וְכַמָּה זֶה שׁוֹקֵל.",
            definitionNative = "Бумага с описанием груза: что везут, от кого, кому и сколько весит.",
            example = "הַנֶּהָג חָתַם עַל שְׁטַר מִטְעָן בַּמַּחְסָן.",
        ...
        WordEntity(
            ...
            example = "בְּלִי אִישׁוּר מַעֲבַר גְּבוּל לֹא יְאֻפְשַׁר מַעֲבַר.",
        ...
        WordEntity(
            ...
            example = "רִשּׁוּם שְׁעוֹת נְהִיגָה נִשְׁמַר בַּמַּחְשֵׁב עֶשְׂרִים וּשְׁמוֹנֶה יָמִים.",
        ...
        WordEntity(
            ...
            example = "מַשְּׂאִית מְקֻרֶּרֶת הֵבִיאָה גְּלִידָה לַחֲנוּת.",
        ...
        WordEntity(
            ...
            definition = "בְּדִיקָה בַּדֶּרֶךְ שֶׁל מִשְׁקַל הַמַּשָּׂא לִמְנֹעַ עֲמִיסַת יֶתֶר.",
        ...
        WordEntity(
            ...
            example = "מַשָּׂא יְקַר עֵרֶךְ נוֹסַעַ תָּמִיד עִם שְׁנֵי נְהָגִים.",
        ...
        WordEntity(
            ...
            definition = "מִטְעָן שֶׁאֵינוֹ נִכְנַס בִּגְדָלִים רְגִילִים — אָרֹךְ, גָּבוֹהַּ אוֹ כָּבֵד מְאוֹד.",
            definitionNative = "Груз, не вписывающийся в типовые габариты по длине, высоте или весу.",
            example = "מַטְעָן בִּלְתִּי שִׁגְרָתִי נוֹסַעַ רַק בַּלַּיְלָה עִם לִוּוּי.",
        ...
        WordEntity(
            ...
            definition = "מַשְּׂאִית עִם נִגְרֶרֶת אֲרֻכָּה הַמְחַבֶּרֶת אֵלֶיהָ בְּצַוָּאר.",
        ...
        WordEntity(
            ...
            definition = "מַשְּׂאִית עִם תֹּף סוֹבֵב שֶׁמַּחֲזִיק אֶת הַתַּעֲרֹבֶת נוֹזְלִית עַד לָאֲתָר.",
        ...
        WordEntity(
            ...
            example = "מַשְּׂאִית טֶנְדֶּר פִּזְּרָה חָצָץ עַל הַכְּבִישׁ הֶחָדָשׁ.",
        ...
        WordEntity(
            ...
            definition = "מַעֲרֶכֶת הָרָמָה הַפּוֹעֶלֶת בְּלַחַץ שֶׁמֶן וּמְרִימָה מַשָּׂא כָּבֵד.",
        ...
        WordEntity(
            ...
            definition = "חוֹבָה לְפַצּוֹת לָקוֹחַ עַל נֶזֶק שֶׁנִּגְרַם בִּמְהַלַּךְ הָעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            definition = "פָּקִיד מֻסְמָךְ הַמַּעֲרִיךְ אֶת הַנֶּהָג בְּמִבְחַן הַמַּעֲשִׂי בַּכְּבִישׁ.",
        ...
        WordEntity(
            ...
            example = "כֶּפֶל בִּטּוּחַ מַסְבִּיךְ אֶת הַתְּבִיעָה אַחֲרֵי הַתְּאוּנָה.",
        ...
        WordEntity(
            ...
            example = "חוֹזֶה הַעֲסָקָה נֶחְתַּם רַק אַחֲרֵי שְׁלֹשָׁה חָדֳשֵׁי נִסָּיוֹן.",
