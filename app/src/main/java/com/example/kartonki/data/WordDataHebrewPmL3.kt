...
object WordDataHebrewPmL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "אֲחוּז הָאַנָשִׁים שֶׁעָבְרוּ אֶת הַשָּׁלָב הַמְּבֻקָּשׁ — לְמָשָׁל נִרְשְׁמוּ אַחֲרֵי כְּנִיסָה לַדַּף.",
        ...
        WordEntity(
            ...
            example = "עֲלִיָּה לַאֲוִיר נִדְחֲתָה בְּשָׁבוּעַ בִּגְלַל בָּאג חָמוּר בָּאוֹנְבּוֹרְדִּינְג.",
