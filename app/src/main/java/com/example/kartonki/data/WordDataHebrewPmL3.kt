...
object WordDataHebrewPmL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_research",
            ...
            example = "רֵאָיוֹן מִשְׁתַּמְּשִׁים אֶחָד גִּלָּה לָנוּ בָּעָיָה שֶׁלֹּא הִכַּרְנוּ.",
        ...
        WordEntity(
            ...
            definition = "שְׁאֵלוֹת זֵהוּת לְהַרְבֵּה אֲנָשִׁים בְּבַת אַחַת — לִקְבֹּל מַסְפָּרִים וְלֹא רַק סִפּוּר.",
        ...
        WordEntity(
            ...
            example = "ג׳וֹבְּס טוּ בִּי דָּאָן עָזַר לָנוּ לְהָבִין שֶׁמַּתְחֲרִים שֶׁלָּנוּ הֵם וֵוייז וּסְפּוֹטִיפַי.",
        ...
        WordEntity(
            ...
            definition = "הֶעָרוֹת וּתְלוּנוֹת שֶׁמַּגִּיעוֹת אַחֲרֵי שִׁמּוּשׁ בַּמּוּצָר — בְּצַ׳אט, בְּדֹאַר אוֹ בִּסְקָרִים.",
            definitionNative = "Замечания и жалобы после использования продукта — в чате, почте или опросах.",
            example = "מִשּׁוּב לָקוֹחוֹת מֵהַחֹדֶשׁ הָאַחֲרוֹן הִצְבִּיעַ עַל בָּעָיוֹת בָּאוֹנְבּוֹרְדִּינְג.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_planning",
        ...
        WordEntity(
            ...
            definition = "רְשִׁימָה מְסֻדֶּרֶת שֶׁל כָּל הָעֲבוֹדוֹת הֶעֲתִידִיּוֹת עַל הַמּוּצָר — מִן הַחֲשׁוּב לַפָּחוֹת.",
        ...
        WordEntity(
            ...
            definition = "הַחְלָטָה מָה לַעֲשׂוֹת רִאשׁוֹן וּמָה לִדְחוֹת — לְפִי עֵרֶךְ לַלָּקוֹחַ וַעֲלוּת לְצֶוֶות.",
        ...
        WordEntity(
            ...
            definition = "מִשְׁפָּט קָצָר בִּפוֹרְמַט «כְּמִישֶׁהוּ אֲנִי רוֹצֶה X כְּדֵי לְהַשִּׂיג Y» — כָּכָה כּוֹתְבִים דְּרִישׁוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_metrics",
        ...
        WordEntity(
            ...
            definition = "אֲחוּז הָאֲנָשִׁים שֶׁעָבְרוּ אֶת הַשָּׁלָב הַמְּבֻקָּשׁ — לְמָשָׁל נִרְשְׁמוּ אַחֲרֵי כְּנִיסָה לַדַּף.",
            definitionNative = "Доля людей, прошедших нужный шаг — например, зарегистрировались после захода на страницу.",
            example = "שִׁעוּר הַהֲמָּרָה שֶׁל דַּף הַנְּחִיתָה עָלָה מִשְּׁנֵי אֲחוּזִים לַחֲמִשָּׁה.",
        ...
        WordEntity(
            ...
            definition = "מַסְפַּר הָאֲנָשִׁים הַשּׁוֹנִים שֶׁנִּכְנְסוּ לַמּוּצָר בְּמֶשֶׁךְ יוֹם אֶחָד שֶׁלָּם.",
        ...
        WordEntity(
            ...
            definition = "הַמִּדָּה שֶׁבָּהּ אֲנָשִׁים פּוֹעֲלִים בַּמּוּצָר — לוֹחֲצִים, גּוֹלְלִים, מַשְׁאִירִים תְּגוּבוֹת.",
            definitionNative = "Насколько люди действуют в продукте — кликают, скроллят, оставляют комментарии.",
            example = "מְעֻרֲבוּת בַּפִיד יָרְדָה אַחֲרֵי שֶׁשִּׁנִּינוּ אֶת הָאַלְגוֹרִיתְם.",
        ...
        WordEntity(
            ...
            example = "מִפָּרֵנוּ אֶת מַסַּע הַלָּקוֹחַ עַל הַלּוּחַ וְגִלִּינוּ שִׁשָּׁה נְקֻדּוֹת חִכּוּךְ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_collaboration",
        ...
        WordEntity(
            ...
            definition = "מִפְגָּשׁ קָצָר שֶׁבּוֹ מְעַצֵּב מַצִּיג הַצָּעוֹת לְמָסָךְ וְהַצֶּוֶות נוֹתֵן הֶעָרוֹת לְפִי קוֹמְפּוֹנֶנְטִים.",
        ...
        WordEntity(
            ...
            definition = "תָּכְנִית כּוֹלֶלֶת אֵיךְ מַגִּיעִים לְלָקוֹחוֹת רִאשׁוֹנִים — שִׁוּוּק, מְחִירוֹן וְעֲרוּצֵי מְכִירָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_lifecycle",
        ...
        WordEntity(
            ...
            definition = "נִסּוּי קָטָן וְזָרִיז שֶׁמַּרְאֶה אִם אֲמִירָה עַל הַשּׁוּק נְכוֹנָה לִפְנֵי הַשְׁקָעַת קוֹד.",
        ...
        WordEntity(
            ...
            example = "שְׁלַב פִּתּוּחַ נִמְשָׁךְ שְׁמוֹנָה שָׁבוּעוֹת בִּגְלַל אִינְטֶגְרַצְיוֹת רְחָבוֹת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "pm_lifecycle",
            original = "עֲלִיָּה לַאֲוִיר", translation = "выпуск (запуск в эфир)",
            definition = "הָרֶגַע שֶׁבּוֹ הַפִיצֶ׳ר נִפְתַּח לְכָל הַלָּקוֹחוֹת אַחֲרֵי בְּדִיקוֹת וְאִישּׁוּרִים סוֹפִיִּים.",
            definitionNative = "Момент, когда фичу открывают всем клиентам после финальных проверок и согласований.",
            example = "עֲלִיָּה לָאֲוִיר נִדְחֲתָה בְּשָׁבוּעַ בִּגְלַל בָּאג חָמוּר בָּאוֹנְבּוֹרְדִּינְג.",
        ...
        WordEntity(
            ...
            definition = "סִבּוּב נוֹסָף שֶׁל שִׁפּוּר אַחֲרֵי שֶׁמַּמְצִיאִים מָה לֹא עָבַד וְלוֹמְדִים מִמֶּנּוּ לֵעָבוֹדָה הַבָּאָה.",
