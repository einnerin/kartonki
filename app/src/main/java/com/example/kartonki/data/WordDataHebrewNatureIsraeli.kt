...
object WordDataHebrewNatureIsraeli {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 191301, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "אַנְטִילוֹפָּה לְבָנָה גְּדוֹלָה שֶׁל הַנֶּגֶב — מֻזְכֶּרֶת בַּתַּנַ״ךְ, הֻחְזְרָה לַטֶּבַע אַחֲרֵי הַכְחָדָה.",
        ...
        WordEntity(id = 191304, setId = 1913, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "יוֹנֵק חָזָק וּמְסֻכָּן הַחַי בַּחֻרְשׁוֹת וּבְעֵמֶק הַחוּלָה — נִכְנָס לְחַצְרוֹת הַיִּשּׁוּבִים בַּצָּפוֹן.",
        ...
        WordEntity(id = 191308, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "בַּשְּׁמוּרָה מַאֲכִילִים אֶת הָרַחַם כְּדֵי לְשַׁמֵּר אֶת הַמִּין.",
        ...
        WordEntity(id = 191310, setId = 1913, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "עוֹף מַיִם בַּעַל רַגְלַיִם אֲרֻכּוֹת וְצַוַּאר מָתוּחַ — צָדָה דָּגִים בַּבִּצּוֹת וּבַבְּרֵכוֹת.",
        ...
        WordEntity(id = 191311, setId = 1913, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "עֵץ מְקוֹמִי בַּעַל גֶּזַע אָדֹם וְעָלִים קְטַנִּים — נִזְכַּר בַּתַּנַ״ךְ כְּסֵמֶל לַחֹסֶן.",
        ...
        WordEntity(id = 191313, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִין מְקוֹמִי שֶׁל מַחַט בַּעַל מַחֲטִים אֲרֻכּוֹת — נָטוּעַ בִּיעָרוֹת קֶרֶן קַיֶּמֶת בְּכֹל הָאָרֶץ.",
        ...
        WordEntity(id = 191314, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "עֵץ יְרוֹק תָּמִיד עִם תַּרְמִילִים חוּמִים מְתוּקִים — נִקְשַׁר לְאַגָּדַת חוֹנִי הַמְעַגֵּל וְהַתַּלְמוּד.",
            definitionNative = "Вечнозелёное дерево с коричневыми сладкими стручками — связано с легендой о Хони а-Меагеле и Талмудом.",
            example = "מִתַּרְמִילֵי הַחֲרוּב מְכִינִים סִילָאן וְקֶמַח בָּרִיא.",
        ...
        WordEntity(id = 191315, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "סַבָּא קָטַף תְּאֵנָה בְּשֵׁלָה מֵהֶעָנָף וְהוֹשִׁיט לִי.",
        ...
        WordEntity(id = 191316, setId = 1913, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "פֶּרַח בַּר וָרוֹד שֶׁל הָחֳרֵף — צוֹמֵחַ בֵּין סְלָעִים בַּכַּרְמֶל וּבַגָּלִיל, מֻגַּן בְּחֹק.",
        ...
        WordEntity(id = 191318, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "פֶּרַח בַּר צָהֹב קָטָן עִם עָלִים חֲרוּצִים — פּוֹרֵחַ בְּחֻרְשׁוֹת הָאָרֶץ בָּאָבִיב.",
        ...
        WordEntity(id = 191319, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "צֶמַח בַּר עִם שִׁבֳּלִים לְבָנוֹת וְעָלִים אֲרֻכִּים — נִשְׁמַר בְּכֹל שִׂדוֹת הָאָרֶץ בְּחֹדֶשׁ אֲדָר.",
        ...
        WordEntity(id = 191320, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "צֶמַח בַּר בַּעַל שִׁבֹּלֶת לְבָנָה גְּבוֹהָה — פּוֹרֵחַ בַּסְּתָו לִפְנֵי בּוֹא הַגְּשָׁמִים בָּאָרֶץ.",
            definitionNative = "Дикое растение с высоким белым колосом — цветёт осенью до прихода дождей в стране.",
            example = "מֵעֵבֶר לַגָּדֵר רָאִינוּ חַטַּב הָאֱלֹהִים פּוֹרֵחַ בַּשָּׂדֶה הַיָּבֵשׁ.",
        ...
        WordEntity(id = 191322, setId = 1913, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "בְּלֵב הַנֶּגֶב צָמְחָה שִׁיטָּה בּוֹדֶדֶת לְיַד הַוָּאדִי.",
        ...
        WordEntity(id = 191324, setId = 1913, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "צָלַּלְנוּ לִרְאוֹת אַלְמוֹג אָדֹם בְּחוֹף הַשֻּׁמַּרֵת.",
