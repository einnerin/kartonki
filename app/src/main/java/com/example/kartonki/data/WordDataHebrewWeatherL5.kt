...
object WordDataHebrewWeatherL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הַשִּׁירָה הָעַתִּיקָה דִּבְּרָה עַל גֶּשֶׁם הַיּוֹרֵד מִן הַרְקִיעַ.",
        ...
        WordEntity(
            ...
            example = "הַמְּשׁוֹרֵר בִּקֵּשׁ שֶׁיֵּרֵד טַל שָׁמַיִם עַל אַדַּמַּת אֲבוֹתָיו.",
        ...
        WordEntity(
            ...
            definition = "כִּנּוּי תָּנַּ\"כִי לְכִוּוּנֵי הָעוֹלָם — מִזְרָח, מַעֲרָב, צָפוֹן וְדָרוֹם יַחַד.",
        ...
        WordEntity(
            ...
            exampleNative = "В вечерних דִּמְדּוּמִים ручьи казались серебряными лентами.", isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            definition = "חֹשֶׁךְ עָבֶה וּמַעֲבִיר תְּחוּשַׁת אֵימָה — בְּעִקָּר לִפְנֵי סוּפָה אוֹ בְּלַיְלָה חֲסַר יָרֵחַ.",
            definitionNative = "Густая жуткая тьма — особенно перед бурей или в безлунную ночь.",
            example = "אֹפֶל יָרַד עַל הָעֵמֶק לִפְנֵי הָרַעַם הָרִאשׁוֹן.",
        ...
        WordEntity(
            ...
            example = "מְטוֹסֵי סִיּוּר טָסִים בַּסְטְרָטוֹסְפֵרָה רָחוֹק מֵעַל הָעֲנָנִים.",
        ...
        WordEntity(
            ...
            definition = "מַיִם בְּמַצָּב גַּזִּי הַמְּפֻזָּרִים בָּאֲוִיר וְקוֹבְעִים אֶת רָמַת הַלַּחוּת.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁבּוֹ מִסְפַּר חֶלְקִיקֵי הָאֲוִיר בִּיחִידַת נֶפַח קָטָן — בְּעִקָּר בְּגָבְהֵי הָרִים.",
        ...
        WordEntity(
            ...
            definition = "אֵזוֹר רָחָב בְּכַדּוּר הָאָרֶץ עִם אַקְלִים וְצִמְחִיָּה אָפְיָנִית — כְּמוֹ סָוָּנָּה אוֹ טַיְגָה.",
        ...
        WordEntity(
            ...
            definition = "שִׁכְבָה שֶׁל מַיִם בָּאוֹקְיָנוֹס שֶׁבָּהּ הַטֶּמְפֶּרָטוּרָה צוֹנַחַת בִּמְהִירוּת עִם הָעֳמֵק.",
            definitionNative = "Слой океанической воды, в котором температура резко падает с увеличением глубины.",
            example = "הַתֶּרְמוֹקְלִין מַשְׁפִּיעַ עַל זְרָמִים יַמִּיִּים וְעַל אַקְלִים מֲקוֹמִי.",
        ...
        WordEntity(
            ...
            definition = "כְּשֶׁכֹּחַ הַטֶּבַע נִדְלַק לְעֵרָנוּת קִיצוֹנִית — רוּחוֹת מְיַלְּלוֹת וְגַלִּים שׁוֹבְרִים כֹּל.",
            ...
            exampleNative = "Исступлённая буря обрушилась на побережье и оставила руины.", isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            definition = "שֶׁמַּחֲרִיב כָּל לַחוּת וְכָל חַיִּים בְּמַגָּע אַחַד — עַל חֹם מִדְבָּרִי קִיצוֹנִי.",
        ...
        WordEntity(
            ...
            exampleNative = "Леденящий ветер с моря заморозил пальцы в один миг.", isFillInBlankSafe = false),
    )
}
