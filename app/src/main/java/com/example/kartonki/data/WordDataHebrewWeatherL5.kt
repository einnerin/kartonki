...
object WordDataHebrewWeatherL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            exampleNative = "מְשֻׁלְהֶבֶת буря обрушилась на побережье и оставила руины.", isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            exampleNative = "מְצַמְרֶרֶת ветер с моря заморозил пальцы в один миг.", isFillInBlankSafe = false),
    )
}
