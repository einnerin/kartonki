...
object WordDataHebrewShoppingL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "אֲחוּז הַגּוֹלְשִׁים שֶׁמְּסַיְּמִים אֶת הַתַּהֲלִיךְ עַד הַסּוֹף בְּלִי לִנְטֹשׁ.",
        ...
        WordEntity(
            ...
            definition = "קֶצֶב הַחְלָפַת הַסְּחוֹרוֹת בַּמַּחְסָן בִּפְרַק זְמַן קָבוּעַ.",
        ...
        WordEntity(
            ...
            example = "אַסְפָּקָה רְצוּפָה חוֹסֶכֶת לַמִּפְעָל אֶת הַצֹּרֶךְ בְּמַחְסָן עֲנָק.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(179206L, 179208L, 179209L)),
        ...
        WordEntity(
            ...
            definition = "אִסּוּף וּמֵעַקָּב שֶׁל נְתוּנֵי הָאֲתָר כְּדֵי לְהָבִין הִתְנַהֲגוּת גּוֹלְשִׁים.",
        ...
        WordEntity(
            ...
            definition = "פֶּרֶק הַזְּמַן שֶׁבּוֹ הַגּוֹלֵשׁ נִשְׁאַר בְּדַף אֶחָד לִפְנֵי שֶׁהוּא עוֹבֵר הָלְאָה.",
         ...
         fillInBlankExclusions = listOf(179211L, 179212L, 179213L)),
        ...
        WordEntity(
            ...
            definition = "קֶשֶׁר עָמֹק בֵּין הַצַּרְכָן לִשְׁמוֹ שֶׁל יַצְרַן מְסֻיָּם הַחוֹרֵג מֵרַצְיוֹנָל.",
        ...
        WordEntity(
            ...
            example = "אָסִימֶטְרִיַּת מֵידָע מַגְדִּילָה אֶת כֹּחַ הַמּוֹכֵר בִּשְׁוָקִים מְקֻצָּעִים.",
        ...
        WordEntity(
            ...
            example = "אֶפֶקְט פִּתָּיוֹן הוּא הַסּוֹד שֶׁל הַמַּחֲיָרוֹן בְּחֶבְרוֹת מָנוּי.",
            exampleNative = "אֶפֶקְט פִּתָּיוֹן — секрет прайс-листа подписочных компаний.",
         fillInBlankExclusions = listOf(179216L, 179217L, 179218L, 179219L)),
        ...
        WordEntity(
            ...
            definition = "פָּרִיט יָקָר בְּמְיֻחָד שֶׁפּוֹנֶה לְשִׁכְבָה הָעֲשִּׁירָה בְּיוֹתֵר שֶׁל הַשּׁוּק.",
            definitionNative = "Особенно дорогой предмет, нацеленный на самую состоятельную аудиторию.",
            example = "מוּצַר עִלִּית מִכַּמָּה גְרָמִים שֶׁל זָהָב טָהוֹר נָמְכַּר בְּתוֹר זָקוּף.",
        ...
        WordEntity(
            ...
            example = "לֵייבֶּל מְעַצֵּב יְשָׂא תָּמִיד מִסְפָּר סִדּוּרִי וְחֲתִימָה.",
        ...
        WordEntity(
            ...
            definition = "עֲבוֹדַת חַיָּט שֶׁמַּתְאִימָה אֶת הַבֶּגֶד בְּדִיּוּק לְצוּרַת הַגּוּף.",
        ...
        WordEntity(
            ...
            definition = "לִוּוּי בְּלַעָדִי שֶׁל גּוֹרֵם פְּרָטִי הַמְּסַדֵּר כָּל בַּקָּשָׁה שֶׁל הַלָּקוֹחַ הָעָשִּׁיר.",
         ...
         fillInBlankExclusions = listOf(179221L, 179222L, 179223L, 179224L)),
    )
}
