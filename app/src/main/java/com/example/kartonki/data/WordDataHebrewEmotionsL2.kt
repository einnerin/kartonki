...
object WordDataHebrewEmotionsL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "אִמָּא שֶׁלִּי הִבִּיטָה בִּי בְּגַאֲוָה כְּשֶׁעָלִיתִי לַבָּמָּה.",
        ...
        WordEntity(
            ...
            definition = "תְּחוּשָׁה לֹא נְעִימָה כְּשֶׁרוֹצִים מָה שֶּׁיֵּשׁ לְמִישֶׁהוּ אַחֵר אוֹ פּוֹחֲדִים לְאַבֵּד אָהוּב.",
        ...
        WordEntity(
            ...
            definition = "תְּחוּשָׁה חַמָּה כְּלַפֵּי מִישֶׁהוּ שֶׁעָזַר אוֹ עָשָׂה דָּבָר טוֹב לְמַעַנְךָ.",
            definitionNative = "Тёплое чувство к тому, кто помог тебе или сделал что-то хорошее.",
            example = "כָּתַבְתִּי לָהּ מִכְתָּב שֶׁל הַכָּרַת תּוֹדָה אַחֲרֵי כָּל מָה שֶּׁעָשְׂתָה.",
        ...
        WordEntity(
            ...
            definition = "תְּכוּנָה שֶׁל אָדָם שֶׁבֶּאֱמֶת חוֹשֵׁב עַל אֲחֵרִים וְלֹא נִשְׁאַר אָדִישׁ לַסֵּבֶל שֶׁלָּהֶם.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁבּוֹ לְאָדָם לֹא אִכְפַּת מִמָּה שֶּׁקּוֹרֶה לַסְּבִיבָה אוֹ לַאֲנָשִׁים סְבִיבוֹ.",
        ...
        WordEntity(
            ...
            example = "עָקָה כְּבֵדָה הִקִּיפָה אוֹתוֹ לִפְנֵי כָּל יְצִיאָה לְבָמָּה.",
        ...
        WordEntity(
            ...
            definition = "מִלָּה שֶׁאוֹמֶרֶת שֶׁדָּבָר קָרָה רַק עִם מַאֲמָץ רַב אוֹ כִּמְעַט לֹא קָרָה.",
