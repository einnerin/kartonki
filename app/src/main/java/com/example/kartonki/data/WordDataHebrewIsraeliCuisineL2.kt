...
object WordDataHebrewIsraeliCuisineL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "אִמָּא נוֹהֶגֶת לְהַקְפִּיא מָנוֹת חַמִּין לִשְׁבָתוֹת הַבָּאוֹת.",
        ...
        WordEntity(
            ...
            example = "כְּדַאי לְקַלּוֹת אֶת הַשֻּׁמְשׁוּם לִפְנֵי שֶׁמּוֹסִיפִים אוֹתוֹ לַזַּעְתָּר.",
        ...
        WordEntity(
            ...
            example = "מָרָק קוּבֶּה סֶלֶק אָדֹם הוּא הַמָּנָה הָעִירָאקִית הַחַמָּה הָאֲהוּבָה בָּאָרֶץ.",
        ...
        WordEntity(
            ...
            example = "בַּמִּטְבָּח בְּשָׂרִי מַחֲזִיקִים סִירִים נִפְרָדִים מֵהַמִּטְבָּח הֶחֲלָבִי.",
        ...
        WordEntity(
            ...
            example = "לִפְנֵי הַסְּעוּדָה הַשַּׁבַּתִּית עוֹשִׂים נֱטִילַת יָדַיִם בַּכִּיּוֹר עִם נָטְלָה.",
        ...
        WordEntity(
            ...
            definition = "קָפֶה טָחוּן עָבֶה שֶׁמָּכִּינִים בְּכוֹס בְּלִי סִנּוּן — שׁוֹתִים מִלְמַעְלָה זָהִיר.",
        ...
        WordEntity(
            ...
            example = "בְּבֵית הַסֵּפֶר חִלְּקוּ אָזְנֵי הַמָּן בְּמִשְׁלוֹחַ מָנוֹת לְכָל יֶלֶד וַיֶּלֶד.",
        ...
        WordEntity(
            ...
            example = "בְּלֵיל הַסֵּדֶר טוֹבְלִים מָרוֹר בְּהָרוּסַת לִפְנֵי שֶׁאוֹכְלִים אוֹתוֹ.",
        ...
        WordEntity(
            ...
            definition = "תַּבְשִׁיל אָפוּי מֵאִטְרִיּוֹת אוֹ מִתַּפּוּחֵי אֲדָמָה — מָנָה אַשְׁכְּנַזִּית לְשַׁבָּת.",
        ...
        WordEntity(
            ...
            definition = "מַמְתָּק מִזְרָחִי קָשֶׁה מִשַּׁמְשׁוּם טָחוּן וְסֻכָּר — חוֹתְכִים לִפְרוּסוֹת בַּשּׁוּק.",
