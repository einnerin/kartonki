...
object WordDataHebrewCyberL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "הִתְקָן קָטָן שֶׁמִּתְחַבֵּר לַמַּחְשֵׁב וּמְאַשֵּׁר אֶת הַזֶּהוּת בִּלְחִיצָה אַחַת.",
        ...
        WordEntity(
            ...
            definition = "קֶשֶׁר מֻצְפַּן בֵּין הַדַּפְדְּפָן לָאֲתָר — אַף אֶחָד בָּאֶמְצַע לֹא יָכוֹל לִקְרֹא אוֹתוֹ.",
            definitionNative = "Шифрованная связь между браузером и сайтом — никто посередине не прочтёт.",
            example = "הָאֲתָר עָבַר לְחִבּוּר מֻגַּן רַק אַחֲרֵי שֶׁהִתְלוֹנַנּוּ.",
        ...
        WordEntity(
            ...
            definition = "קְרִיאָה שֶׁל הַשּׁוּרָה הָעֶלְיוֹנָה כְּדֵי לְוַדֵּא שֶׁאַתָּה לֹא בְּאָתָר מְזֻיָּף שֶׁמְּחַקֶּה אֶת הָאֲמִתִּי.",
            definitionNative = "Чтение верхней строки — убедиться, что ты не на поддельном сайте, что копирует настоящий.",
            example = "בְּדִיקַת כְּתֹבֶת זְהִירָה הִצִּילָה אוֹתִי מֵאֲתַר מְזֻיָּף שֶׁל הַבַּנְק.",
        ...
        WordEntity(
            ...
            definition = "קֹבֶץ שֶׁמְּצָרְפִים לְהוֹדָעַת דֹּאַר — קוֹרֵא מַחְשֵׁב פּוֹתֵחַ אוֹתוֹ בִּלְחִיצָה.",
        ...
        WordEntity(
            ...
            definition = "תִּקְיָהּ שֶׁבָּהּ שׁוֹמְרִים מַיְלִים יְשָׁנִים לְלֹא לִמְחֹק אוֹתָם — לְשִׁמּוּשׁ עֲתִידִי.",
