...
object WordDataHebrewAppearanceL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "מַכָּה חֲזָקָה בַּשּׁוֹק פּוֹגַעַת קֹדֶם בִּקְרוּם הָעֶצֶם.",
        ...
        WordEntity(
            ...
            definition = "קַו עָמֹק שֶׁנִּמְתַּח מִכְּנַף הָאַף עַד זָוִית הַפֶּה — מִתְעַמֵּק עִם הַגִּיל.",
        ...
        WordEntity(
            ...
            definition = "קַפֵּל הָעוֹר מִתַּחַת לָעַיִן — עָדִין מְאוֹד וְנוֹטֶה לַנְפִיחוּת.",
        ...
        WordEntity(
            ...
            example = "עִם הַגִּיל הָאֵזוֹר הֲרַקָּתִי מַתְחִיל לְהִשְׁתַּקֵּעַ פְּנִימָה.",
        ...
        WordEntity(
            ...
            definition = "טִיפּוּס מִבְנֶה רָזֶה וְגָבוֹהַּ מִטֶּבַע — מִתְקַשֶּׁה לִצְבּוֹר מַסַּת שְׁרִירִים.",
        ...
        WordEntity(
            ...
            definition = "טִיפּוּס מִבְנֶה שְׁרִירִי וְאַתְלֵטִי מִטֶּבַע — מַסָּה גְּדוֹלָה וְשֻׁמָּן נָמוּךְ.",
            definitionNative = "Тип сложения мускулистый и атлетический от природы — большая масса и мало жира.",
            example = "מַאֲמֵּן אָמַר שֶׁאֲנִי מֵזוֹמוֹרְף וְאֶבְנֶה שְׁרִירִים מַהֵר.",
        ...
        WordEntity(
            ...
            definition = "מִדַּת אֹרֶךְ סְבִיב הַחֵלֶק הַצַּר בְּיוֹתֵר שֶׁל הַגֵּו — מַדַּד מַפְתֵּחַ לִבְרִיאוּת.",
            definitionNative = "Длина по самой узкой части туловища — ключевой показатель здоровья.",
            example = "הָרוֹפֵא מַדַּד אֶת הֶיקֵּף הַמָּתְנַיִם וְהוּא תַּקִּין.",
        ...
        WordEntity(
            ...
            definition = "עוֹר שֶׁמָּגִּיב בְּגֵרוּי לְקוֹסְמֶטִיקָה, חוֹם וְלַחַץ.",
        ...
        WordEntity(
            ...
            example = "הִיפֶּרְפִּיגְמֶנְטַצְיָה אַחֲרֵי הַקַּיִץ דּוֹרֶשֶׁת טִפּוּלֵי לֶיְזֶר.",
        ...
        WordEntity(
            ...
            example = "לָרֵאָיוֹן הַחֲשׁוּב הִיא בָּחֲרָה אִיפּוּר טִבְעִי וּמַטַּעֶם.",
        ...
        WordEntity(
            ...
            definition = "טִפּוּל מְקָצּוֹעִי שֶׁל צִפָּרְנֵי הַיָּדַיִם — הַחְלָקָה, צֶבַע, צוּרָה.",
        ...
        WordEntity(
            ...
            definition = "טִפּוּל מְקָצּוֹעִי שֶׁל הַגַּבּוֹת — מְרִיטָה, צְבִיעָה וְעִצּוּב צוּרָה.",
        ...
        WordEntity(
            ...
            example = "הַסֵּלֶבְּ עָבְרָה מְתִיחַת פָּנִים לִפְנֵי הָאֵרוּעַ הַגָּדוֹל.",
