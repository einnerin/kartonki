...
object WordDataHebrewLinguisticsBinyanim {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 191103, setId = 1911, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מוֹסָף שֶׁנֶּצְמָד לְסוֹף הַמִּילָּה וּמְסַמֵּן גּוּף, מִין, מִסְפָּר אוֹ קִנְיָן.",
        ...
        WordEntity(id = 191106, setId = 1911, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "בִּנְיָן בָּסִיסִי שֶׁמַּבִּיעַ פְּעֻלָּה פְּשׁוּטָה: כָּתַב, אָמַר, רָץ.",
        ...
        WordEntity(id = 191109, setId = 1911, languagePair = "he-ru", rarity = "EPIC",
            ...
            definitionNative = "Страдательная порода-пара к פִּעֵל: דֻּבַּר, לֻמַּד, סֻפַּר — преимущественно в литературном языке.",
        ...
        WordEntity(id = 191118, setId = 1911, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "גִּזְרָה שֶׁבָּהּ הָאוֹת הָרִאשׁוֹנָה שֶׁל הַשֹּׁרֶשׁ נוֹחָה — נ, י אוֹ א — וְנֶעֱלֶמֶת בִּנְטִיָּה.",
