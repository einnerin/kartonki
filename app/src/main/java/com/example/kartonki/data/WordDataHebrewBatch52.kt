...
object WordDataHebrewBatch52 {
    ...
    val words: List<WordEntity> get() = listOf(
        ...
        WordEntity(id = 129601, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            exampleNative = "Мы написали простой אַלְגּוֹרִיתְם для сортировки списков.",
        ...
        WordEntity(id = 129602, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "קֶטַע קוֹד עִם שֵׁם, שֶׁמְּקַבֵּל קְלַט וּמַחֲזִיר תּוֹצָאָה.",
            ...
            exampleNative = "Он написал короткую פוּנְקְצִיָּה для расчёта НДС.",
            pos = "noun", semanticGroup = "hightech_code_basics"),
        ...
        WordEntity(id = 129603, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            exampleNative = "Забыл инициализировать מִשְׁתַּנֶּה — и получил ошибку.",
            pos = "noun", semanticGroup = "hightech_code_basics"),
        ...
        WordEntity(id = 129604, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            exampleNative = "Я склонировал свежий מַאֲגַר גִּיט себе на ноут.",
        ...
        WordEntity(id = 129605, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "פָּתַחְתִּי עָנָף נִפְרָד לְתִיקּוּן הַבָּג הַזֶּה.",
        ...
        WordEntity(id = 129606, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            exampleNative = "Приложение ходит за погодой в שֵׁרוּת API погодного провайдера.",
            pos = "noun", semanticGroup = "hightech_code_basics"),
        ...
        WordEntity(id = 129607, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            exampleNative = "У нас один מִחְזוֹר פִּיתּוּחַ длится две недели.",
        ...
        WordEntity(id = 129608, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "סִיַּמְנוּ אֶת הַסְּפְּרִינְט עִם כָּל הַמְּשִׂימוֹת בַּקְּלָף.",
            exampleNative = "Мы закрыли ספְּרִינְט со всеми задачами на доске.",
            pos = "noun", semanticGroup = "hightech_process"),
        ...
        WordEntity(id = 129609, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "כָּל קוֹמִיט אֵצֶל הַמְּפַתֵּחַ מָרִיץ בְּדִיקוֹת יְחִידָה.",
            exampleNative = "На каждый коммит у разработчика гоняются בְּדִיקוֹת יְחִידָה.",
        ...
        WordEntity(id = 129610, setId = 1296, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            exampleNative = "Я написал короткий מַדְרִיךְ טֶכְנִי для новичков в команде.",
            pos = "noun", semanticGroup = "hightech_process"),
        ...
        WordEntity(id = 129611, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "אֲנִי מְחַכֶּה לִבְּחִינַת קוֹד מֵהַטֶּק-לִיד שֶׁלִּי.",
            exampleNative = "Жду בְּחִינַת קוֹד от своего тимлида.",
            pos = "noun", semanticGroup = "hightech_git"),
        ...
        WordEntity(id = 129612, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            exampleNative = "Мы делали פְּרִיסַת קוֹד на прод в два часа ночи.",
        ...
        WordEntity(id = 129613, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            exampleNative = "Под новый проект мы выбрали популярный מַסְגֶּרֶת פִּיתּוּחַ.",
        ...
        WordEntity(id = 129614, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            exampleNative = "מְהַדֵּר ругнулся ошибкой уже на третьей строчке.",
            pos = "noun", semanticGroup = "hightech_tools"),

        WordEntity(id = 129615, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            original = "מְנַפֵּה שְׁגִיאוֹת", translation = "отладчик, дебаггер",
            definition = "כְּלִי שֶׁמַּאַפִּשֵׁר לְעַצֵּב הָרָצָה וְלִרְאוֹת מָה קוֹרֵה בְּכָל שׁוּרָה.",
            ...
            exampleNative = "Я открыл מְנַפֵּה שְׁגִיאוֹת — понять, почему цикл зависает.",
            pos = "noun", semanticGroup = "hightech_tools"),
        ...
        WordEntity(id = 129616, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            exampleNative = "После лёгкого רִיפַקְטוֹרִינְג код читается куда приятнее.",
            pos = "noun", semanticGroup = "hightech_git"),
        ...
        WordEntity(id = 129617, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            exampleNative = "Команда подняла אִינְטֶגְרַצְיָה רְצִיפָה на GitHub Actions.",
            pos = "noun", semanticGroup = "hightech_testing"),
        ...
        WordEntity(id = 129618, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "כְּתִיבַת סְקְרִיפְּטִים שֶׁמָּרִיצִים בְּדִיקוֹת בְּלִי הִתְעָרְבוּת אֱנוֹשִׁית.",
            ...
            exampleNative = "В пайплайн деплоя мы добавили אוֹטוֹמַצְיַת בְּדִיקוֹת.",
            pos = "noun", semanticGroup = "hightech_testing"),

        WordEntity(id = 129619, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            original = "רוֹלְבֶּק", translation = "роллбэк (откат версии)",
            definition = "חֲזָרָה מֲהִירָה לַגִּרְסָה הַקּוֹדֶמֶת אַחֲרֵי שֶׁמַּשֶּׁהוּ הִתְפּוֹצֵץ בַּפְּרוֹדַקְשֶׁן.",
            ...
            exampleNative = "После падения мы за пять минут сделали רוֹלְבֶּק.",
            pos = "noun", semanticGroup = "hightech_release"),
        ...
        WordEntity(id = 129620, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "עֵרֶךְ קְלַט שֶׁמַּעֲבִירִים פְּנִימָה כְּדֵי לְהַשְׁפִּיעַ עַל הַתּוֹצָאָה.",
            definitionNative = "Входное значение — его передают внутрь, чтобы повлиять на результат.",
            example = "הַבָּג הִתְגַּלָּה בְּפְּרָמֶטֶר פוּנְקְצִיָּה שֶׁלֹּא נִבְדַּק כָּרָאוּי.",
            exampleNative = "Баг сидел в פְּרָמֶטֶר פוּנְקְצִיָּה, который никто толком не проверил.",
            pos = "noun", semanticGroup = "hightech_code_basics"),

        WordEntity(id = 129621, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            original = "רֶגְרֵסִיָּה", translation = "регрессия (тестирование)",
            definition = "מַצָּב שֶׁבּוֹ פִּיצָ'ר יָשָׁן וְעוֹבֵד נִשְׁבַּר אַחֲרֵי שִׁנּוּי בַּקּוֹד.",
            ...
            exampleNative = "Мы поймали רֶגְרֵסִיָּה ещё до выхода версии в прод.",
            pos = "noun", semanticGroup = "hightech_testing"),
        ...
        WordEntity(id = 129622, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "כַּרְטִיס בִּמְעָרֶכֶת הַצֶּוֶת עִם תֵּאוּר עֲבוֹדָה לְמִישֶׁהוּ מֵהַמְּפַתְּחִים.",
            ...
            exampleNative = "Я взял на себя маленькую מְשִׁימַת פִּיתּוּחַ перед праздниками.",
            pos = "noun", semanticGroup = "hightech_process"),
        ...
        WordEntity(id = 129623, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            exampleNative = "После ревью тимлид одобрил מִזוּג קוֹד в master.",
            pos = "noun", semanticGroup = "hightech_git"),
        ...
        WordEntity(id = 129624, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            ...
            exampleNative = "Прямо в סְבִיבַת הַפְעָלָה экспериментировать строго нельзя.",
            pos = "noun", semanticGroup = "hightech_release"),

        WordEntity(id = 129625, setId = 1296, languagePair = "he-ru", rarity = "RARE",
            original = "תַּשְׁתִּית הַקוֹד", translation = "кодовая база",
            definition = "כְּלַל הַקְּבָצִים וְהַמּוֹדוּלִים שֶׁמְּרַכִּיבִים אֶת הַמּוּצָר הַתָּכְנַתִּי כֻּלּוֹ.",
            ...
            exampleNative = "תַּשְׁתִּית הַקוֹד у стартапа разрослась до сотен тысяч строк.",
            pos = "noun", semanticGroup = "hightech_code_basics"),
