...
object WordDataHebrewBatch21 {
    ...
    val sets: List<WordSetEntity> = listOf(
        WordSetEntity(
            ...
            name = "Спорт: углублённо",
            description = "Соревнования, тактика и спортивная психология A2/C1",
        ),
        WordSetEntity(
            id = 1086, languagePair = "he-ru", orderIndex = 1086,
            name = "Архитектура",
            description = "Стили, конструкции и городская среда B1/C1",
        ),
        WordSetEntity(
            id = 1087, languagePair = "he-ru", orderIndex = 1087,
            name = "Психология: углублённо",
            description = "Психоанализ, когниция и защитные механизмы B2/C2",
        ),
    )
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 108504, setId = 1085, languagePair = "he-ru", rarity = "COMMON",
            original = "מֵאַמֵּן", translation = "тренер"),
        ...
        WordEntity(id = 108509, setId = 1085, languagePair = "he-ru", rarity = "UNCOMMON",
            original = "שְׁחִיָּה", translation = "плавание"),
        ...
        WordEntity(id = 108612, setId = 1086, languagePair = "he-ru", rarity = "UNCOMMON",
