...
object WordDataHebrewTimeL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "בָּא מִיָּד אַחֲרֵי שַׁבָּת וּפוֹתֵחַ אֶת שְׁבוּעַ הָעֲבוֹדָה בְּיִשְׂרָאֵל.",
        ...
        WordEntity(
            ...
            definition = "בָּא מִיָּד אַחֲרֵי תְּחִילַת הַשָּׁבוּעַ וְלִפְנֵי אֶמְצָעוֹ.",
        ...
        WordEntity(
            ...
            definition = "בָּא מִיָּד לִפְנֵי שַׁבָּת — זְמַן קָצָר שֶׁל הֲכָנוֹת לִקְרַאת הַמְּנוּחָה.",
        ...
        WordEntity(
            ...
            example = "אֶתְמוֹל הָיִיתִי בַּשּׁוּק וּקְנִיָּתִי יְרָקוֹת טְרִיִּים.",
        ...
        WordEntity(
            ...
            example = "עַכְשָׁו אֲנִי לֹא יָכוֹל לְדַבֵּר, אֲנִי בָּעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            definition = "בְּשׁוּם זְמַן וּבְשׁוּם מַצָּב — לֹא בֶּעָבָר, לֹא בַּהֹוֶה וְלֹא בֶּעָתִיד.",
