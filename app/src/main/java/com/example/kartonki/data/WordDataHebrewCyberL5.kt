...
object WordDataHebrewCyberL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_leadership",
            original = "סִי-אַייסוֹ", translation = "CISO (директор по информационной безопасности)",
            definition = "מְנַהֵל בָּכִיר שֶׁאַחְרָאִי עַל כָּל הָאַסְטְרָטֶגְיָה וְעַל הַתַּקְצִיב שֶׁל הֲגַנָּה דִיגִיטָלִית בָּאִרְגּוּן.",
        ...
        WordEntity(
            ...
            definition = "מְעַצֵּב מַעֲרָכוֹת שֶׁבּוֹחֵר אֵיךְ לְשַׁלֵּב הֲגַנָּה לְתוֹךְ כָּל שִׁכְבָה שֶׁל הַמּוּצָר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_threat_intelligence",
            original = "מוֹדִיעִין אִיּוּמִים", translation = "threat intelligence (разведка угроз)",
            definition = "אִסּוּף וְעִבּוּד שֶׁל מֵידָע עַל תּוֹקְפִים וְשְׁיָטוֹתֵיהֶם כְּדֵי לְהָכִין אֶת הַהֲגָנָה מֵרֹאשׁ.",
        ...
        WordEntity(
            ...
            definition = "זֶרֶם רָצוּף שֶׁל סִימָנִים חֲשׁוּדִים מִקְּהִילָה בֵּינְלְאֻמִּית — נִכְנַס אוֹטוֹמָטִית לְמַעַרְכוֹת הַסִּינּוּן.",
        ...
        WordEntity(
            ...
            example = "צַיַּד אִיּוּמִים שְׁבוּעִי מָצָא דְּלָתוֹת אֲחוֹרִיּוֹת שֶׁכְּלִי הָאַנְטִיוִוירוּס פִּסְפֵּס.",
        ...
        WordEntity(
            ...
            definition = "הַחְלָטָה מְבֻסֶּסֶת רְאָיוֹת מִי הַקְּבוּצָה שֶׁעוֹמֶדֶת מֵאֲחוֹרֵי הַתְקָפָה — לְפִי כְּלִים, שָׂפָה וּזְמַנֵּי פְּעִילוּת.",
            definitionNative = "Доказательное решение, какая группа стоит за нападением — по инструментам, языку и часам активности.",
            example = "יִיחוּס תְּקִיפָה לְקַבוּצַת לָאזָרוּס לָקַח חֳדָשָׁיִם שֶׁל אֲנָלִיזָה מַעֲמִיקָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_defense_in_depth",
        ...
        WordEntity(
            ...
            definition = "פְּלַטְפוֹרְמָה שֶׁמְּחַבֶּרֶת בֵּין כְּלֵי אַבְטָחָה וְמָרִיצָה תְּגוּבָה אוֹטוֹמָטִית עַל אֵרוּעִים שִׁגְרָתִיִּים.",
            definitionNative = "Платформа — связывает security-инструменты и катит автоматический ответ на рутинные события.",
            example = "סוֹאָר סָגַר חֶשְׁבּוֹן חָשׁוּד תּוֹךְ שָׁלוֹשׁ שְׁנִיּוֹת בְּלִי שֶׁאָנָלִיסְט נָגַע.",
        ...
        WordEntity(
            ...
            example = "אוֹטוֹמַצְיַת הֲגַנָּה צִמְצְמָה בִּשְׁלִישׁ אֶת זְמַן הַטִּפּוּל בְּפִישִׁינְג.",
        ...
        WordEntity(
            ...
            definition = "מַסְמָךְ קָצָר וּמְפֹרָט שֶׁאוֹמֵר לַתּוֹרָן מָה לַעֲשׂוֹת צַעַד אַחַר צַעַד בִּמְקָרֶה מֻגְדָּר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_governance_advanced",
        ...
        WordEntity(
            ...
            example = "הַדְרָכַת מוּדָעוּת שְׁנָתִית הוֹרִידָה אֶת אֲחוּז הַלְּחִיצוֹת עַל קִישּׁוּרִים מְזֻיָּפִים.",
        ...
        WordEntity(
            ...
            definition = "טַבְלָה מְרֻכֶּזֶת שֶׁבָּהּ כָּל סִכּוּן יָדוּעַ נִרְשַׁם עִם הִסְתַּבְּרוּת, הַשְׁלָכָה וְאַחַרַאִי לְטִפּוּל.",
        ...
        WordEntity(
            ...
            definition = "תֶּקֶן בֵּינְלְאֻמִּי שֶׁמַּרְחִיב אֶת כְּלָלֵי אַבְטָחַת הַמֵּידָע בִּסְפֵצִיפִי לִסְבִיבַת עָנָן וְשֵׁרוּתִים מְשֻׁתָּפִים.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "cyber_business_continuity",
        ...
        WordEntity(
            ...
            definition = "אֹסֶף שֶׁל פְּרוֹצֶדוּרוֹת טֶכְנִיּוֹת לְהַחְזָרַת שֵׁרַתִּים וּמָסָדִּים אַחֲרֵי כִּשָּׁלוֹן רְחַב.",
            definitionNative = "Сборник технических процедур для возврата серверов и баз после крупного сбоя.",
            example = "שִׁיקּוּם מֵאָסוֹן נִמְשָׁךְ שָׁעָה וָחֵצִי בַּמַּעֲבָר לְמֶרְכַּז הַגִּבּוּי.",
        ...
        WordEntity(
            ...
            definition = "מֶשֶׁךְ הַזְּמַן הַמַּקְסִימָלִי שֶׁמַּעֲרֶכֶת יְכוֹלָה לִהְיוֹת מֻשְׁבֶּתֶת לִפְנֵי שֶׁהָעֵסֶק נִפְגַּע מַמָּשׁ.",
