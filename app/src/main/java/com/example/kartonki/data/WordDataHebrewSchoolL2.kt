...
object WordDataHebrewSchoolL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מקום שבו שוהים ילדים קטנים בבוקר עם מְטַפֶּלֶת ומשחקים.",
        ...
        WordEntity(
            ...
            example = "הכיתה יוצאת ל מַסַּע סִיוּם בצפון בשבוע הבא.",
        ...
        WordEntity(
            ...
            definition = "כַּמָּה ימים תלמיד היה בבית הספר במשך תקופה ולא נעדר.",
