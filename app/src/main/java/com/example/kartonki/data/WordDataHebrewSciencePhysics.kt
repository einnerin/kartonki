...
object WordDataHebrewSciencePhysics {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 189702, setId = 1897, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מַאֲגָר הַתְּנוּעָה שֶׁל גּוּף, שָׁוֶה לְמַסָּתוֹ כְּפוּלָה בִּמְהִירוּתוֹ.",
        ...
        WordEntity(id = 189706, setId = 1897, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מַאֲגָר הַתְּנוּעָה שֶׁל גּוּף; כָּל שֶׁהוּא מָהִיר אוֹ כָּבֵד יוֹתֵר, הַמַּאֲגָר גָּדוֹל יוֹתֵר.",
        ...
        WordEntity(id = 189709, setId = 1897, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "כַּמּוּת הַחֹמֶר שֶׁדְּחוּסָה בְּתוֹךְ יְחִידַת נְפַח אֶחָד שֶׁל גּוּף.",
        ...
        WordEntity(id = 189711, setId = 1897, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "חֹמֶר שֶׁמַּעֲבִיר זֶרֶם חַשְׁמַלִּי בְּקַלּוּת, כְּמוֹ נְחֹשֶׁת אוֹ אֲלוּמִינְיוּם.",
        ...
        WordEntity(id = 189714, setId = 1897, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "תְּכוּנָה בְּסִיסִית שֶׁל חֲלָקִיקִים גּוֹרֶמֶת לָהֶם לִמְשֹׁךְ אוֹ לִדְחוֹת זֶה אֶת זֶה דֶּרֶךְ שְׂדוֹת חַשְׁמַל.",
        ...
        WordEntity(id = 189722, setId = 1897, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "הַעֲבָרָה שֶׁל חֹם אוֹ זֶרֶם דֶּרֶךְ גּוּף בְּעֶזְרַת מַגָּע יָשִׁיר בֵּין הַחֲלָקִיקִים שֶׁלּוֹ.",
        ...
        WordEntity(id = 189724, setId = 1897, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִדַּת הָעֳבִיוּת שֶׁל נוֹזֵל — עַד כַּמָּה הַשְּׁכָבוֹת הַפְּנִימִיּוֹת שֶׁלּוֹ מַפְרִיעוֹת זוֹ לְזוֹ בִּזְרִימָה.",
