...
object WordDataHebrewPhilosophySchools {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190101, setId = 1901, languagePair = "he-ru", rarity = "RARE",
            original = "צִינִיזְם",
            translation = "кинизм",
            definition = "אַסְכּוֹלָה עַתִּיקָה שֶׁל דִּיוֹגֶנֶס שֶׁדָּחֲתָה עוֹשֶׁר וּמוֹסְכָּמוֹת לְטוֹבַת חַיִּים פְּשׁוּטִים לְפִי הַטֶּבַע.",
        ...
        WordEntity(id = 190102, setId = 1901, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מָסֹרֶת אֲפְלָטוֹן שֶׁמַּחְזִיקָה כִּי הַצּוּרוֹת הַמֻּפְשָׁטוֹת מַמָּשִׁיּוֹת יוֹתֵר מֵהָעוֹלָם הַחָמְרִי הַמִּשְׁתַּנֶּה.",
        ...
        WordEntity(id = 190104, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "שִׁיטָה יְמֵי־בֵּינֵימִית שֶׁל תּוֹמָאס אַקְוִינַס: לְשַׁלֵּב אֱמוּנָה דָּתִית עִם הִגָּיוֹן אֲרִיסְטוֹטֵלִי.",
        ...
        WordEntity(id = 190105, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "אַסְכּוֹלָה שֶׁל אֲרִיסְטוֹ שֶׁלִּמְּדָה תַּצְפִּית עַל הַטֶּבַע, לוֹגִיקָה וּמִיוּן הַמַּדָּעִים.",
        ...
        WordEntity(id = 190107, setId = 1901, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "אֱמוּנָה שֶׁכָּל מַה שֶּׁקּוֹרֶה נִקְבַּע מֵרֹאשׁ וּמַאֲמָצֵי הָאָדָם אֵינָם יְכוֹלִים לְשַׁנּוֹת זֹאת.",
        ...
        WordEntity(id = 190108, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "תְּנוּעָה אֲמֶרִיקָאִית שֶׁל אֶמֶרְסוֹן וְתוֹרוֹ: חִפּוּשׂ אֱמֶת בַּטֶּבַע וּבָאִינְטוּאִיצְיָה.",
        ...
        WordEntity(id = 190109, setId = 1901, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תּוֹרָה שֶׁל מַרְקְס: הִסְטוֹרְיָה מֻסְבֶּרֶת בְּמַאֲבָק מַעֲמָדוֹת עַל אֶמְצָעֵי הַיִּצּוּר וְהַתְּנָאִים הַחָמְרִיִּים.",
        ...
        WordEntity(id = 190110, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "גִּישָׁה שֶׁל פְרוֹיְד: הִתְנַהֲגוּת בּוֹגְרִים מֻנְעֶת בְּעִיקָּר מִדְּחָפִים לֹא־מוּדָעִים וּמִתְּסַבְּכֵי יַלְדוּת.",
        ...
        WordEntity(id = 190113, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "גִּישַׁת דְּיוּאִי: רַעְיוֹנוֹת הֵם כְּלִי לְפִתְרוֹן בְּעָיוֹת, וְשׁוֹוֵיהֶם נִמְדָּד בְּתוֹעֲלָתָם הַמַּעֲשִׂית.",
        ...
        WordEntity(id = 190114, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "עֶמְדַּת פּוּאַנְקָרֶה: אֲקְסְיוֹמוֹת מַדָּעִיּוֹת הֵן הֶסְכֵּמִים נוֹחִים שֶׁל הַקְּהִילָה, וְלֹא הִתְגַּלּוּת שֶׁל אֱמֶת.",
        ...
        WordEntity(id = 190116, setId = 1901, languagePair = "he-ru", rarity = "RARE",
            original = "מוֹנִיזְם",
            translation = "монизм",
            definition = "עֶמְדָּה שֶׁהָעוֹלָם בָּנוּי מֵיֵסוֹד אֶחָד בִּלְבָד — בֵּין אִם רוּחַ, חֹמֶר אוֹ דְּבַר־מָה אַחֵר.",
        ...
        WordEntity(id = 190120, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "תְּפִיסָה שֶׁאֲרִיסְטוֹ פִּתֵּחַ: כָּל יֵשׁוּת בַּטֶּבַע פּוֹעֶלֶת לְקַרַאת מַטָּרָה פְּנִימִית.",
        ...
        WordEntity(id = 190122, setId = 1901, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "גִּישַׁת אֲרִיסְטוֹ: לֹא לְאֵיזֶה כְּלָל לְצַיֵּת, אֶלָּא אֵיזֶה טִיפּוּס שֶׁל אִישׁ לִהְיוֹת בִּדְרָכָה הַשְּׁלֵמָה.",
        ...
        WordEntity(id = 190125, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "זֶרֶם שֶׁל סַנְדֵּל וּמָקְאִינְטַייר: הָאָדָם מְעֻצָּב בִּקְהִילָה, וְעֶרְכֵי הַקְּהִילָה קוֹדְמִים לְזְכוּת הַפְּרָט.",
