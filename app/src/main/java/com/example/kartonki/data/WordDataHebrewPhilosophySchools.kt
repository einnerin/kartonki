...
object WordDataHebrewPhilosophySchools {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190101, setId = 1901, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "דִּיוֹגֶנֶס גִּלֵּם צִינִיזְם — חַי בְּחָבִית וְלָעַג לְאָלֶכְּסַנְדֶּר.",
        ...
        WordEntity(id = 190120, setId = 1901, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "תְּפִיסָה שֶׁאֲרִיסְטוֹ פִּתֵּחַ: כָּל יֵשׁוּת בַּטֶּבַע פּוֹעֶלֶת לִקְרַאת מַטָּרָה פְּנִימִית.",
        ...
        WordEntity(id = 190122, setId = 1901, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "גִּישַׁת אֲרִיסְטוֹ: הַשְּׁאֵלָה אֵינָהּ לְאֵיזֶה כְּלָל לְצַיֵּת, אֶלָּא אֵיזֶה טִיפּוּס שֶׁל אָדָם לִהְיוֹת.",
