...
object WordDataHebrewDoctorL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            exampleNative = "פְּסִיכִיאָטֶר выписал ему таблетки от депрессии после долгой беседы.",
        ...
        WordEntity(
            ...
            exampleNative = "אַלֶרְגוֹלוֹג нашёл у меня чувствительность к арахису по кожной пробе.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "גָסְטְרוֹאֶנְטֶרוֹלוֹג отправил меня на проверку язвы желудка.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "אוֹנְקוֹלוֹג подобрал ей протокол лечения после результатов биопсии.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "נוֹירוֹכִירוּרְג оперировал его десять часов, удаляя опухоль мозга.",
            isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            exampleNative = "בְּדִיקַת שֶׁתֶן нужно было сдать утром натощак.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "אֶלֶקְטְרוֹקַרְדְּיוֹגְרַם показала лёгкие нарушения ритма сердца.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "בְּדִיקַת תִּפְקוּדֵי כָּבֵד назначили после года приёма постоянного лекарства.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "תַּרְבִּית גָּרוֹן подтвердил бактериальную, а не вирусную инфекцию.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "הוֹרְמוֹנֵי תִּרְאוֹיד оказались низкими и объяснили постоянную усталость.",
            isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            exampleNative = "בְּדִיקַת רְאִיָּה показала, что для чтения нужны очки.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "בְּדִיקַת שְׁמִיעָה показала снижение в левом ухе.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "אֶכוֹקַרְדְּיוֹגְרַפְיָה показала лёгкое расширение левого желудочка.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "מִיפּוּי עֲצָמוֹת не нашёл метастазов в рёбрах или тазу.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "דֶּרְמָטוֹסְקוֹפְּיָה на регулярной основе ловит подозрительные родинки рано.",
            isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            exampleNative = "חִסּוּן שַׁפַּעַת бесплатна в кассе для всех застрахованных пенсионеров.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "חִסּוּן יְלָדִים делают по возрасту: в три, в полгода, в год.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "מָנָה דּוֹחֶפֶת от ковида рекомендована через полгода после первой.",
            isFillInBlankSafe = false),
        WordEntity(
        ...
        WordEntity(
            ...
            exampleNative = "טִפַּת חָלָב приглашает младенца на взвешивание и укол.",
            isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            exampleNative = "מַגֵּן דָּוִד אָדוֹם приехал к месту аварии за семь минут.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "חֲדַר מִיּוּן был забит, и врача мы ждали три часа.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "Спасательный реанимобиль приехал за минуты к упавшему на улице старику.",
            isFillInBlankSafe = false),
        WordEntity(
            ...
            exampleNative = "Мы обратились в пункт неотложной помощи в два часа ночи с высокой температурой.",
            isFillInBlankSafe = false),
        WordEntity(
