...
object WordDataHebrewDoctorL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "doctor_specialists",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "doctor_tests",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "doctor_tests",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "doctor_examinations",
            original = "בְּדִיקַת רְאִיָּה", translation = "проверка зрения",
            definition = "מַעֲרֶכֶת מִבְחָנִים אֵצֶל אוֹפְּטוֹמֶטְרִיסְט לְמַעַן חֵדּוּת הָעַיִן.",
            definitionNative = "Серия тестов у оптометриста на остроту глаза.",
            example = "בְּדִיקַת רְאִיָּה גִּלְּתָה צֹרֶךְ בְּמִשְׁקְפַיִם רֲ|אִיָּה לִקְרִיאָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "doctor_examinations",
            original = "אֶכוֹקַרְדְּיוֹגְרַפְיָה", translation = "эхокардиография",
            definition = "צִילוּם הַלֵּב בְּעֶזְרַת גַּלֵּי קוֹל גְּבוֹהִים מִתּוֹךְ הַחֲזֵה.",
        ...
        WordEntity(
            ...
            example = "מִיפּוּי עֲצָמוֹת לֹא מָצָא גְּרוּרוֹת בִּצְלָעוֹת אוֹ בָּאַגָּן.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "doctor_immunization",
            original = "חִסּוּן שַׁפַּעַת", translation = "прививка от гриппа",
            definition = "זְרִיקָה שְׁנָתִית שֶׁמְּגִינָה מִפְּנֵי וִירוּס הָחֳרֵף הַנָּפוֹץ.",
        ...
        WordEntity(
            ...
            definition = "זְרִיקָה נוֹסֶפֶת אַחֲרֵי הַסְּדָרָה הָעִקָּרִית לְהַחְזָקַת הַהֲגַנָּה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "doctor_immunization",
        ...
        WordEntity(
            ...
            example = "טִפַּת חָלָב מַזְמִינָה אֶת הַתִּינוֹק לִבְדִיקַת מִשְׁקָל וּזְרִיקָה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "doctor_emergency",
        ...
        WordEntity(
            ...
            example = "פָּנִינוּ לְמוּקַד חֵרוּם רְפוּאִי בִּשְׁתַּיִם לִפְנוֹת בֹּקֶר עִם חֹם גָּבוֹהַּ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "doctor_emergency",
