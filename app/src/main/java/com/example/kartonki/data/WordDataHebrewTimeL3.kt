...
object WordDataHebrewTimeL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "מֶשֶׁךְ זְמַן הַטִּיסָה הָיָה אַרְבַּע שָׁעוֹת וָעָשֶׂר דַּקּוֹת.",
        ...
        WordEntity(
            ...
            definition = "נְקֻדַּת זְמַן קַצָּרָהּ שֶׁבָּהּ נִקְבַּעַת תּוֹצָאָה חֲשׁוּבָה לְמֶשֶׁךְ אָרֹךְ.",
        ...
        WordEntity(
            ...
            example = "יוֹם הַשִּׁוְיוֹן שֶׁל הָאָבִיב חָל בְּעֶשְׂרִים וְאֶחָד בְּמָרְץ.",
        ...
        WordEntity(
            ...
            example = "צוֹפִים בַּמִּדְבָּר שָׂמוּ לֵב לְמוּטַת הַכּוֹכָבִים שֶׁמּוֹרָה עַל זְמַן הַלַּיְלָה.",
        ...
        WordEntity(
            ...
            definition = "תּוֹפָעָה שֶׁבָּהּ הַיָּרֵחַ מַסְתִּיר אֶת הַשֶּׁמֶשׁ וְהַיּוֹם נֶחְשַׁךְ לִזְמַן קָצָר.",
            definitionNative = "Явление, когда луна закрывает солнце, и день на короткое время темнеет.",
            example = "לִקּוּי חַמָּה הִתְרַחֵשׁ אֶמֶשׁ וְהַשָּׁמַיִם הֶחְשִׁיכוּ פִּתְאוֹם בַּצָּהֳרַיִם.",
        ...
        WordEntity(
            ...
            definition = "בְּזְמַן שֶׁאַחֲרֵי הָאֵרוּעַ — כְּשֶׁמְּחַשְּׁבִים אוֹ מַחְלִיטִים עַל מָה שֶּׁכְּבָר הָיָה.",
        ...
        WordEntity(
            ...
            definition = "מִזְּמַנִּים עַתִּיקִים מְאוֹד — מִתְּקוּפוֹת הָרְחוֹקוֹת שֶׁל הָעֳבַר.",
        ...
        WordEntity(
            ...
            definition = "זְמַן קָצָר שֶׁל הֲקָלָה בְּאֶמְצַע מַאֲבָק אוֹ עֲבוֹדָה קָשָׁה — לִפְנֵי שֶׁמַּמְשִׁיכִים.",
        ...
        WordEntity(
            ...
            definition = "בְּחִירָה מְדֻיֶּקֶת שֶׁל הָרֶגַע הַנָּכוֹן לְבַצֵּעַ פְּעֻלָּה — לֹא מֻקְדַּם וְלֹא מְאֻחָר.",
