...
object WordDataHebrewAutomobilePartial {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הוּא לָחַץ עַל הַצּוֹפָר בְּאַגְרֵסִיבִיּוּת.",
        ...
        WordEntity(
            ...
            example = "קָשַׁרְנוּ אֶת האופניים עַל הַגַּגּוֹן.",
        ...
        WordEntity(
            ...
            example = "הַמַּזְגָן בָּרֶכֶב הִתְקַלְקֵל בְּאֶמְצַע אוֹגוּסְט.",
        ...
        WordEntity(
            ...
            example = "הוּא לָחַץ עַל הַדַּוְשָׁה עַד הָרִצְפָּה.",
        ...
        WordEntity(
            ...
            example = "אָטַם רֹאשׁ נִשְׂרַף בִּגְלַל הִתְחַמְּמוּת יֶתֶר.",
