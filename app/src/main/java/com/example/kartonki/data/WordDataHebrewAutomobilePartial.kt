...
object WordDataHebrewAutomobilePartial {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "להפחית מְהִירוּת לפני סיבוב, אור אדום או מכשול בכביש.",
        ...
        WordEntity(
            ...
            example = "קָשֶׁה לְהַחְנוֹת ליד השוק בשעות העומס.",
        ...
        WordEntity(
            ...
            definition = "לעבור רֶכֶב אחר משמאל ולחזור לנתיב לפניו.",
        ...
        WordEntity(
            ...
            definition = "צליל חזק וחוזר של רֶכֶב חירום הקורא לפנות מהדרך.",
        ...
        WordEntity(
            ...
            example = "אֶבֶן עפה ונסדק מָגֵן רוּחַ.",
        ...
        WordEntity(
            ...
            definition = "השעון שמראה לנהג כַּמָּה קילומטרים לשעה הוא נוסע.",
        ...
        WordEntity(
            ...
            definition = "הסמל בלוח שמראה כַּמָּה בנזין נשאר במיכל.",
        ...
        WordEntity(
            ...
            definition = "כַּפְתּוֹר גדול ברגל שלוחצים עליו כדי לְהָאִיץ או לבלום.",
        ...
        WordEntity(
            ...
            definition = "חישוק דק שמקיף את הבוכנה ושומר על אֲטִימוּת בתוך הציליינדר.",
        ...
        WordEntity(
            ...
            example = "מַעֲגָל קֵרוּר איבד לחץ אחרי הקילומטר האחרון.",
        ...
        WordEntity(
            ...
            example = "כַּיּוּל מַזְרֵקִים נעשה במכשיר אִבְחוּן מתקדם.",
        ...
        WordEntity(
            ...
            definition = "השעון בלוח שמראה כַּמָּה פעמים המנוע מסתובב בדקה.",
