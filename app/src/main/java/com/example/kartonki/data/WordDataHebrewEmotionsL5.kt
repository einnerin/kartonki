...
object WordDataHebrewEmotionsL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            exampleNative = "Поэт описывал יִרְאָה вышнюю, что охватила его перед лицом гор.", isFillInBlankSafe = false),

        WordEntity(
            id = 183102, setId = 1831, languagePair = "he-ru", rarity = "LEGENDARY",
            pos = "noun", semanticGroup = "emotions_l5_biblical",
            original = "אֵבֶל", translation = "скорбь, траур (Танах)",
            definition = "מַצָּב נַפְשִׁי שֶׁל צַעַר כָּבֵד עַל מֵת אוֹ עַל אָבְדָן עָצוּם — מֻשָּׂג מִקְרָאִי.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁל הִתְמַסְּרוּת מֻחְלֶטֶת לְרֶגֶשׁ עַז — אַהֲבָה, יְצִירָה אוֹ נִצָּחוֹן.",
        ...
        WordEntity(
            ...
            exampleNative = "תְּשׁוּקָה к ней пылала в нём, как огонь, которого не угасить.", isFillInBlankSafe = false),
        ...
        WordEntity(
            ...
            definition = "מִי שֶׁאַהֲבָתָהּ עַזָּה כָּל כָּךְ עַד שֶׁהִיא חָשָׁה כְּחוֹלָה — צֵרוּף מִשִּׁיר הַשִּׁירִים.",
        ...
        WordEntity(
            ...
            example = "הִתְעַלּוּת רוּחָנִית אָחֲזָה אוֹתוֹ בְּעֵת הַתְּפִלָּה לִפְנֵי הַשַּׁחַר.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ פְּנִימִי שֶׁבּוֹ אָדָם מַכִּיר בֶּאֱמֶת מָרָה אַחֲרֵי שָׁנִים שֶׁל הַשְׁלָיָה.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁל אִזּוּן פְּנִימִי שָׁלֵם שֶׁבּוֹ שׁוֹם רֶגֶשׁ אֵינוֹ מָפֵּר אֶת הַסֵּדֶר הַפְּנִימִי.",
        ...
        WordEntity(
            ...
            example = "הָאֵם נִשְׁאֲרָה חַסֶּרֶת נֶחָמָה לְאַחַר אָבְדַן בְּנָהּ הַיָּחִיד.",
        ...
        WordEntity(
            ...
            definition = "מִי שֶׁרוּחוֹ הוּרְמָה מֵעַל הַיּוֹמְיוֹם בִּזְכוּת רֶגֶשׁ עַז שֶׁל שִׂמְחָה אוֹ אַהֲבָה.",
        ...
        WordEntity(
            ...
            example = "כְּמֵהַּ לְקוֹל הַיָּם, חָזַר הַסּוֹפֵר הַזָּקֵן אֶל בֵּית יַלְדוּתוֹ.",
