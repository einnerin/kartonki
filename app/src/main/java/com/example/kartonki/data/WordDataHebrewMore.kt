...
object WordDataHebrewMore {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            example = "בֵּית קָפֶה נָעִים נִמְצָא בָּרְחוֹב הַזֶּה.",
        ...
        WordEntity(
            ...
            definition = "מָקוֹם לְצַפּוֹת בְּסָרְטֵי קוֹלְנוֹעַ.",
            definitionNative = "Место для просмотра кинофильмов.",
            example = "סִינֶמָה זוֹ מַקְרִינָה סָרְטֵי חוּץ לָאָרֶץ.",
        ...
        WordEntity(
            ...
            definition = "יִשּׁוּב קָטָן בְּאֵזוֹר חַקְלָאִי.",
            definitionNative = "Небольшой населённый пункт в сельской местности.",
            example = "סַבָּא שֶׁלִּי גָּר בְּכְּפָר קָטָן.",
        ...
        WordEntity(
            ...
            example = "לְבָשְׁתִּי בֶּגֶד חַם הַיּוֹם.",
        ...
        WordEntity(
            ...
            example = "הַחֲגוֹר שֶׁלִּי עָשׂוּי עוֹר.",
        ...
        WordEntity(
            ...
            definition = "בְּגָדִים אֲחִידִים הַנִּלְבָּשִׁים בִּידֵי אַנֲשֵׁי מִקְצוֹעַ.",
        ...
        WordEntity(
            ...
            definition = "תְּנוּעָה שֶׁל הָאֲוִיר בַּטֶּבַע.",
        ...
        WordEntity(
            ...
            example = "הָחֳרֵף בְּיִשְׂרָאֵל לֹא קַר מְאוֹד.",
        ...
        WordEntity(
            ...
            definition = "שְׁכָבָה צְפוּפָה שֶׁל אֵדֵי מַיִם בָּאֲוִיר.",
