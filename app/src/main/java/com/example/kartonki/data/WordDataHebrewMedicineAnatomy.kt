...
object WordDataHebrewMedicineAnatomy {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 189502, setId = 1895, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "סוּכֶּרֶת מִסּוּג רִאשׁוֹן מִתְפַּתַּחַת כְּשֶׁהַלַּבְלַב מַפְסִיק לְיַצֵּר אִינְסוּלִין.",
        ...
        WordEntity(id = 189505, setId = 1895, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הָרוֹפֵא מָצָא אָצִיר בַּקֵּיבָה וְהִפְנָה אוֹתָהּ לְגַסְטְרוֹסְקוֹפְּיָה.",
        ...
        WordEntity(id = 189506, setId = 1895, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "רֹב הַבַּרְזֶל מֵהַמָּזוֹן נִסְפָּג בַּמֵּעַיִם הַדַּקִּים.",
        ...
        WordEntity(id = 189507, setId = 1895, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "הַחֵלֶק הָרִאשׁוֹן וְהַקָּצָר שֶׁל הַמֵּעִי הַדַּק שֶׁבּוֹ הַמָּזוֹן נִפְגַּשׁ עִם מָרָה וְעִם מִיץ הַלַּבְלַב.",
        ...
        WordEntity(id = 189509, setId = 1895, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "צִלּוּם הַחֲזֵה הֶרְאָה גִּדּוּל הַחוֹסֵם אֶת אַחַד הַסִּמְפּוֹנוֹת.",
        ...
        WordEntity(id = 189511, setId = 1895, languagePair = "he-ru", rarity = "RARE",
            original = "רֵאָה",
            translation = "лёгкое",
            definition = "אֵיבָר נְשִׁימָה גָּדוֹל בַּחֲזֵה שֶׁבּוֹ עוֹבֵר חַמְצָן מֵהָאֲוִיר אֶל הַדָּם.",
            definitionNative = "Большой дыхательный орган в грудной клетке: через него кислород из воздуха переходит в кровь.",
            example = "הַמְּעַשְּׁנִים מַסְכִּימִים שֶׁפְּגִיעָה בָּרֵאָה הִיא הַסַּכָּנָה הַגְּדוֹלָה בְּיוֹתֵר.",
        ...
        WordEntity(id = 189515, setId = 1895, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "קְרִיעָה בְּאַב הָעוֹרְקִים הִיא מַצַּב חֵרוּם מְסַכֵּן חַיִּים.",
        ...
        WordEntity(id = 189523, setId = 1895, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "בַּלּוּטָה בְּצוּרַת פַּרְפַּר בִּקְדֶמַת הַצַּוָּאר הַמְּוַסֶּתֶת אֶת קֶצֶב חִלּוּף הַחֳמָרִים בַּגּוּף.",
        ...
        WordEntity(id = 189524, setId = 1895, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "לַחַץ כְּרוֹנִי בָּעֲבוֹדָה שׁוֹחֵק עִם הַשָּׁנִים אֶת יוֹתֶרֶת הַכִּלְיָה.",
        ...
        WordEntity(id = 189525, setId = 1895, languagePair = "he-ru", rarity = "EPIC",
            ...
            translation = "гипофиз",
            definition = "בַּלּוּטָה קְטַנָּה בְּגֹדֶל אָפוּן בְּבָסִיס הַמֹּחַ הַמְּנַהֶלֶת אֶת רֹב הַהוֹרְמוֹנִים שֶׁל הַגּוּף.",
