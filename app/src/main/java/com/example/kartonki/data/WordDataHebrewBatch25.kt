...
object WordDataHebrewBatch25 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 109901, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_defense_arch",
        ...
        WordEntity(id = 109902, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_identity_pki",
        ...
        WordEntity(id = 109903, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הַדַּפְדְּפָן דּוֹחֶה אֶת הָאֲתָר אִם אִישּׁוּר דִּיגִיטָלִי פָּג תֹּקֶף.",
        ...
        WordEntity(id = 109904, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_resilience",
            original = "גִּבּוּי נְתוּנִים", translation = "резервное копирование данных",
            definition = "הֶעְתֵּק שָׁמוּר שֶׁל מֵידָע, שֶׁמְּאַפְשֵׁר שִׁיחְזוּר לְאַחַר תַּקָּלָה אוֹ תְּקִיפָה.",
        ...
        WordEntity(id = 109905, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_threat_concepts",
            ...
            example = "סְרִיקַת חוּלְשׁוֹת חָדְשִׁית מְגַלָּה רְכִיבִים שֶׁדּוֹרְשִׁים עִדְכּוּן דָּחוּף.",
        ...
        WordEntity(id = 109906, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "פִּיצּוּל הַתַּשְׁתִּית לְאֵזוֹרִים מְבוּדָדִים, כְּדֵי לְהַקְשׁוֹת עַל תּוֹקֵף לְהִתְפַּשֵּׁט בְּתוֹכָהּ.",
            ...
            example = "חֲלוּקַת רְשַׁת קְפֵדָנִית מוֹנַעַת הִתְפַּשְּׁטוּת תְּקִיפָה בֵּין מַחְלָקוֹת.",
        ...
        WordEntity(id = 109907, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "cyber_offensive",
            ...
            example = "צֶבַע אָדוֹם מְשַׁמֵּשׁ כְּלֵי פְּרִיצָה לֵגָלִיִּים בִּתְרְגוּלִים פְּנִימִיִּים.",
        ...
        WordEntity(id = 109908, setId = 1099, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "דֹּאַר אֶלֶקְטְרוֹנִי נוֹתַר נְקוּדַת כְּנִיסָה הַשְּׁכִיחָה בְּיוֹתֵר.",
        ...
        WordEntity(id = 109909, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "הַחְדָּרַת קוֹד זֲדוֹנִי לְמַחְשֵׁב הַקָּרְבָּן מִמָּקוֹם אַחֵר, בְּלִי גִּישָׁה פִיזִית אֵלָיו.",
        ...
        WordEntity(id = 109910, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מַעֲרֶכֶת הַמְּנַהֶלֶת הַנְפָּקָה וְאִימּוּת שֶׁל אִישּׁוּרִים דִּיגִיטָלִיִּים לְחִבּוּרִים מוּגַנִּים.",
        ...
        WordEntity(id = 109911, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מַכָּה בְּסַפַּק תּוֹכְנָה מְהֵימָן, כְּדֵי לְהַגִּיעַ דַּרְכּוֹ אֶל כָּל לָקוֹחוֹתָיו.",
        ...
        WordEntity(id = 109912, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "תַּרְגִּיל מְבֻקָּר שֶׁבּוֹ צֶוֶת תּוֹקֵף יְזוּם בּוֹחֵן אֶת הַגַּנּוֹת הָאִרְגוּן.",
            ...
            example = "הַדָּמַיַת צֶבַע אָדוֹם חָשְׂפָה כָּשֶׁל בִּמְעָרֶכֶת הַזִּיהוּי הָאַרְגּוּנִית.",
        ...
        WordEntity(id = 109914, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "עֲמִידוּת בְּמֶרְחַב הַסַּיְיבֶּר נִבְחֶנֶת בִּתְרְגוּלִים שְׁנָתִיִּים.",
        ...
        WordEntity(id = 109916, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "טֶכְנִיקוֹת מַסְוֶה הַגּוֹרְמוֹת לְקוֹד זֲדוֹנִי לְהֵירָאוֹת תָּמִים בְּעֵינֵי כְּלֵי אַבְטָחָה.",
        ...
        WordEntity(id = 109917, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "אֹסֶף סְטַנְדַּרְטִים וּפְרַקְטִיקוֹת מְקוּבָּלוֹת שֶׁעַל פִּיהֶם נִבְנֵית הַ|גַּנָּה אַחֲדוּתִית בָּאִרְגוּן.",
            definitionNative = "Набор стандартов и правил, на котором строится единая защита всей информационной системы предприятия.",
            example = "הַחֶבְרָה אִימְּצָה מִסְגֶּרֶת אַבְטָחָה לְפִי תֶּקֶן NIST.",
        ...
        WordEntity(id = 109918, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "תְּחוּם הָעוֹסֵק בְּהֲגָּנַת מַחְשְׁבִים, רְשָׁתוֹת וּמֵידָע מִפְּנֵי חֲדִירוֹת וּתְקִיפוֹת זְדוֹנִיּוֹת.",
        ...
        WordEntity(id = 109920, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "נִיהוּל זֶהוּיוֹת תְּקִין מוֹנַעַ הַרְשָׁאוֹת מְיוּתָּרוֹת לְעוֹבְדִים יוֹצְאִים.",
        ...
        WordEntity(id = 109922, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "תְּקִיפָה הַמְּשַׁתֶּמֶת בְּפִרְצָה שֶׁעֲדַיִן לֹא יְדוּעָה לְיַצְרַן הַתּוֹכְנָה וְאֵין לָהּ טְלַאי.",
        ...
        WordEntity(id = 109923, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הָגְנָהּ בִּשְׂכָבוֹת הִצִּילָה אֶת הַמַּעֲרֶכֶת לְמָרוֹת פְּרִיצַת חוֹמַת אֵשׁ.",
        ...
        WordEntity(id = 109925, setId = 1099, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "חֲקִירָה שֶׁל עִקְבוֹת דִּיגִיטָלִיִּים אַחֲרֵי תְּקִיפָה, כְּדֵי לְהָבִין כֵּיצַד וּמִי חָדַר.",
