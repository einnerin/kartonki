...
object WordDataHebrewAnimals {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הַגִּ'ינְשִׁי הִתְגַּנֵּב בִּשְׁבִיל הַיַּעַר בִּלְעָדֵי קוֹל צְעָדִים.",
        ...
        WordEntity(
            ...
            definitionNative = "Южноамериканское млекопитающее с густой шерстью, используется для перевозок в горах.",
