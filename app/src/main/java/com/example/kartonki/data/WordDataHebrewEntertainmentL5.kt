...
object WordDataHebrewEntertainmentL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 179501, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            pos = "phrase", semanticGroup = "entertainment_theory",
        ...
        WordEntity(id = 179505, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "לְכָל גִּבּוֹר בַּסָּאגָה יֵשׁ לֵיטְמוֹטִיב מוּסִיקָלִי מִשֶּׁלּוֹ.",
        ...
        WordEntity(id = 179506, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            pos = "phrase", semanticGroup = "entertainment_criticism",
        ...
        WordEntity(id = 179507, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הַמָּגָּזִין פִּרְסֵם כַּתָּבָה אֲרֻכָּה עַל הַמְּחַבֵּר הַסּוֹדִי שֶׁל הַסִּדְרָה.",
        ...
        WordEntity(id = 179511, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הַסֶּרֶט הָעָנוּג חוֹלֵל חֲוָיָה אָמָנוּתִית עֲמוּקָה בְּכָל הָאוּלָם.",
        ...
        WordEntity(id = 179514, setId = 1795, languagePair = "he-ru", rarity = "LEGENDARY",
            ...
            definition = "תְּחוּשַׁת רוֹמְמוּת מְעוֹרֶבֶת בְּחָרְדָהּ מוּל יְצִירָה רַבַּת עָצְמָה.",
            definitionNative = "Чувство восторга, смешанного с трепетом, перед произведением огромной мощи.",
            example = "הַסְּצֵנָה הֲרָחֲבָה שֶׁל הַיָּם מַעֲבֶרֶת אֶת הַנִּשְׂגָּב לַצּוֹפֶה.",
        ...
        WordEntity(id = 179515, setId = 1795, languagePair = "he-ru", rarity = "LEGENDARY",
            ...
            example = "וַגְנֶר חָלַם עַל יְצִירָה כּוֹלֶלֶת שֶׁתְּאַחֵד אֶת כָּל הָאָמָנוּיוֹת.",
        ...
        WordEntity(id = 179516, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            pos = "phrase", semanticGroup = "entertainment_economics",
        ...
        WordEntity(id = 179517, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            pos = "noun", semanticGroup = "entertainment_economics",
            ...
            example = "הַזַּמָּר חַי בַּשָּׁנִים הָאַחֲרוֹנוֹת מִתַּמְלוּגִים שֶׁל לָהִיט יָשָׁן.",
        ...
        WordEntity(id = 179518, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הַכְנָסוֹת נִלְווֹת מֵהַסֵּרֶט עָבְרוּ אֶת רֶוַח הַקֻּפָּה עַצְמָהּ.",
        ...
        WordEntity(id = 179520, setId = 1795, languagePair = "he-ru", rarity = "LEGENDARY",
            ...
            definition = "יַחַס בֵּין הַכְנָסַת הַסֶּרֶט לְבֵין הַסְּכוּם שֶׁהֻצָּא עַל הֲפָקָתוֹ וְשִׁוּוּקוֹ.",
        ...
        WordEntity(id = 179521, setId = 1795, languagePair = "he-ru", rarity = "EPIC",
            pos = "phrase", semanticGroup = "entertainment_advanced_genres",
        ...
        WordEntity(id = 179523, setId = 1795, languagePair = "he-ru", rarity = "LEGENDARY",
            ...
            example = "לַבְקְרַפְט נֶחְשַׁב לְאָבִי הַבִּדְיוֹן הַמּוּזָר הַמּוֹדֶרְנִי.",
        ...
        WordEntity(id = 179525, setId = 1795, languagePair = "he-ru", rarity = "LEGENDARY",
            pos = "noun", semanticGroup = "entertainment_advanced_genres",
