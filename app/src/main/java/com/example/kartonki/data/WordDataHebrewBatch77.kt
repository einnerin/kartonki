...
object WordDataHebrewBatch77 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "סַבָּא שֶׁלִּי מְשַׂחֵק גוֹלֶף בְּכָל יוֹם רִאשׁוֹן.",
        ...
        WordEntity(
            ...
            example = "אָחִי לוֹמֵד אָמָנוּת לָחֲמָה כְּבָר חָמֵשׁ שָׁנִים.",
        ...
        WordEntity(
            ...
            definition = "מִשְׂחָק קְבוּצָה עִם מַקְלוֹת וְדִיסְקִית, מְשַׂחֲקִים עִם מַחֲלִיקַיִם עַל זִירָה קָרָה.",
        ...
        WordEntity(
            ...
            definition = "תְּנוּעָה בַּמַּיִם בְּעֶזְרַת יָדַיִם וְרַגְלַיִם, סְפּוֹרְט אוֹ פְּעֻלָּה לְהֲנָאָה.",
        ...
        WordEntity(
            ...
            definition = "תְּחוּם סְפּוֹרְט הַכּוֹלֵל רִיצָה, קְפִיצָה וּזְרִיקָה שֶׁל כֵּלִים.",
        ...
        WordEntity(
            ...
            definition = "סְפּוֹרְטַאי שֶׁמְּחַכֶּה בְּצַד הַמִּגְרָשׁ וְעוֹלֶה לְשַׂחֵק בִּמְקוֹם חֲבֵר אַחֵר.",
        ...
        WordEntity(
            ...
            definition = "הַסְּפּוֹרְטַאי הָרָאשִׁי שֶׁמּוֹבִיל אֶת הַחֲבֵרִים בַּמִּגְרָשׁ וּמְקַבֵּל הַחְלָטוֹת.",
            definitionNative = "Главный игрок, ведёт партнёров на поле и принимает решения во время игры.",
            example = "הַקַּפִּיטָן לוֹחֵץ יָד לַשּׁוֹפֵט לִפְנֵי הַמִּשְׂחָק.",
        ...
        WordEntity(
            ...
            example = "הַשּׁוֹפֵט נָתַן עֹנֶשׁ עַל הָעֲבֵרָה.",
        ...
        WordEntity(
            ...
            definition = "אָרְגוּן שֶׁל קְבוּצוֹת הַמְּשַׂחֲקוֹת זוֹ נֶגֶד זוֹ בְּאוֹתָהּ רָמָה.",
        ...
        WordEntity(
            ...
            example = "הַכְּשָׁלוֹן בַּגָּמָר הָיָה כּוֹאֵב לְכֻלָּנוּ.",
        ...
        WordEntity(
            ...
            example = "הַגָּמָר יִתְקַיֵּם בַּשַּׁבָּת בְּשָׁעָה תֵּשַׁע.",
        ...
        WordEntity(
            ...
            example = "כֻּלָּם צָפוּ בַּמּוּנְדִּיָּאָל בַּקֵּיץ.",
