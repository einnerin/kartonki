...
object WordDataHebrewLawL1 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "הַמִּסְמָךְ הָרִשְׁמִי שֶׁמְּזַהֶה תּוֹשַׁב יִשְׂרָאֵל לְכָל גּוּף מֶמְשַׁלְתִּי.",
        ...
        WordEntity(
            ...
            definition = "כְּתָב רִשְׁמִי קָצָר הַמְאַשֵּׁר עֻבְדָּה אוֹ מַעֲמַד מְסֻיָּם שֶׁל אָדָם.",
        ...
        WordEntity(
            ...
            definition = "כָּל דַּף רִשְׁמִי הַחֲתוּם אוֹ הֶחָתוּם בְּחוֹתֶמֶת, כְּמוֹ חוֹזֶה אוֹ אִישּׁוּר.",
        ...
        WordEntity(
            ...
            example = "צָרִיךְ רִשָּׁיוֹן מִיֻּוָּחָד לְהַפְעִיל מַסְעָדָה.",
        ...
        WordEntity(
            ...
            example = "הָלַכְנוּ לַנּוֹטַרְיוֹן לְאִמּוּת חֲתִימָה עַל הַחוֹזֶה.",
        ...
        WordEntity(
            ...
            definition = "הֶעְתֵּק נֶאֱמָן לַמְּקוֹר שֶׁמּוּכָן בְּמַכְשִׁיר צִילּוּם וּמְצוֹרָף לַטֹּפֶס.",
        ...
        WordEntity(
            ...
            definition = "הַגָּעָה אִישִׁית לְמִשְׂרַד אוֹ לִרְשׁוּת לְפִי הַזְמָנָה רִשְׁמִית.",
