...
object WordDataHebrewCleaningL4 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            example = "הָעוֹבֵד פִּזֵּר מֵפִיג כְּתָמִים אֶנְזִימָטִי עַל הַשָּׁטִיחַ.",
        ...
        WordEntity(
            ...
            definition = "תַּכְשִׁיר בָּזִיסִי בִּ-pH גָּבוֹהַ הַמְסַלֵּק שׁוּמָן וְלִכְלוּךְ כָּבֵד.",
        ...
        WordEntity(
            ...
            definition = "פְּעוּלָה מִקְצוֹעִית לִמְחִיקַת צִיּוּרֵי רַסָּסִים מִמִּשְׁטְחֵי בִּנְיָן.",
            definitionNative = "Профессиональная обработка для стирания краски-аэрозоля со стен.",
            example = "הָעִירִיָּה הִזְמִינָה הֲסָרַת גְּרָפִיטִי מִכּוֹתֶל הַסֵּפֶר.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ פּוּמְבִּי בּוֹ חֲבָרוֹת מַגִּישׁוֹת הַצָּעוֹת לְזַכִּיָּה בְּחוֹזֶה נִקּוּי.",
            definitionNative = "Открытая процедура, в которой компании подают заявки на контракт по уборке.",
            example = "הַמִּשְׂרָד פִּרְסֵם מִכְרָז שֵׁרוּתֵי נִקּוּי לִשְׁלוֹשׁ קוֹמוֹת.",
        ...
        WordEntity(
            ...
            example = "מְנַהֵל הַאוֹבְּיֵקְט אִשֵּׁר אֶת לוּחַ זְמַנֵּי בִּצּוּעַ לְשָׁבוּעַ הַבָּא.",
        ...
        WordEntity(
            ...
            example = "הַלָּקוֹחַ דָּרַשׁ סְעִיף קְנָסוֹת בְּמִקְרֶה אִחוּר.",
        ...
        WordEntity(
            ...
            definition = "אֹסֶף תִּקְנוֹת אִיכוּת מוּכָּרִים בִּמְדִינוֹת אוֹסְטְרַלְיָה וְנִיּוֹ זִילַנְד.",
        ...
        WordEntity(
            ...
            example = "כָּל מְפַעֵל קִבֵּל הַסְמָכַת אוֹפֵּרָטוֹר לִפְנֵי תְּחִילַּת הָעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            definition = "תְּעוּדָה אֶקוֹלוֹגִית אָמֵרִיקָאִית לַמּוּצְרֵי נִקּוּי בְּטוּחֵי סְבִיבָה.",
        ...
        WordEntity(
            ...
            definition = "חִישּׁוּב מַסְפַּר שְׁעוֹת אָדָם הַנִּדְרָשׁ לְהַשְׁלָמַת מְשִׂימָה מֻגְדֶּרֶת.",
