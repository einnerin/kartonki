...
object WordDataHebrewPmL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מַסְגֶּרֶת מְסֻדֶּרֶת שֶׁמְּחַלֶּקֶת עֲבוֹדָה לְמַחְזוֹרִים קְצוּבִים עִם פְּגִישׁוֹת קְבוּעוֹת.",
            definitionNative = "Упорядоченная рамка — делит работу на короткие циклы с фиксированными встречами.",
            example = "צֶוֶות הַמּוּצָר אִמֵּץ סְקְרָאם בִּגְלַל הַצֹּרֶךְ בְּצַפִּיּוּת לַשּׁוּתָפִים.",
        ...
        WordEntity(
            ...
            example = "לוּחַ קַנְבָּן בַּפְּרוֹיֶקְט הֶרְאָה שֶׁשְּׁתַיִם מַטְלוֹת תְּקוּעוֹת אֵצֶל הַטֶּסְטֶר.",
        ...
        WordEntity(
            ...
            example = "כָּתַבְתִּי אַפְדֵּייט שְׁבוּעִי בַּעֲרוּץ שֶׁל הַצֶּוֶות בְּסְלַאק.",
        ...
        WordEntity(
            ...
            example = "מִקְרֵה קָצֶה שֶׁל לָקוֹחַ בְּלִי שֵׁם פְּרָטִי גָּרַם לִקְרִיסָה בַּטּוֹפֶס.",
        ...
        WordEntity(
            ...
            definition = "תְּנַאי בָּהִיר שֶׁעַל פִּיו הַטֶּסְטֶר מַחְלִיט אִם הַפִיצֶ׳ר עָבַד אוֹ עוֹד דּוֹרֵשׁ עֲבוֹדָה.",
        ...
        WordEntity(
            ...
            definition = "צִיּוּר גַּס בְּעִפָּרוֹן עַל נְיָר — רַעְיוֹן רִאשׁוֹנִי לִפְנֵי שֶׁעוֹבְרִים לְמָסָּךְ דִּיגִיטָלִי.",
        ...
        WordEntity(
            ...
            example = "שִׁחְרוּר מוּצָר לְשׁוּק יַפָּן נִדְחָה בִּגְלַל בְּעָיוֹת תַּרְגּוּם.",
        ...
        WordEntity(
            ...
            definition = "טֶקְסְט קָצָר לַקָּהָל שֶׁמְּסַפֵּר מָה חָדָשׁ בַּגִּרְסָה — מָה נוֹסָף, מָה תֻּקַּן וּמָה הִשְׁתַּפֵּר.",
        ...
        WordEntity(
            ...
            definition = "מַטָּלָה קוֹנְקְרֶטִית עִם שֵׁם אַחְרָאִי וְתַאֲרִיךְ סִיּוּם — תּוֹצָאָה יְשִׁירָה שֶׁל פְּגִישָׁה.",
            definitionNative = "Конкретное дело с именем ответственного и сроком — прямой результат встречи.",
            example = "כָּל פְּרִיט פְּעֻלָּה מֵהַסִּיכּוּם הוּקְצָה לְאָדָם בָּהִיר וְלְזְמַן יָדוּעַ.",
        ...
        WordEntity(
            ...
            example = "פְּגִישַׁת תֵּאוּם עִם הַטֵּק לִיד גָּמְרָה שָׁלוֹשׁ מַחְלוֹקוֹת בְּחָצִי שָׁעָה.",
        ...
        WordEntity(
            ...
            definition = "תְּמוּנָה דִּיגִיטָלִית שֶׁל מָה שֶׁמּוֹפִיעַ בָּרֶגַע עַל הַתֵּצוּגָה — נוֹחָה לְהַסְבִּיר בְּלִי מִלִּים.",
