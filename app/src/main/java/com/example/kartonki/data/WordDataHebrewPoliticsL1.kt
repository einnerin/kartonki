...
object WordDataHebrewPoliticsL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "פִּסַּת בַּד עִם סֵמֶל הַמְּדִינָה הַמּוּנַפֶת בְּטֶקֶס רִשְׁמִי.",
            definitionNative = "Кусок ткани с гербом страны, что поднимают на официальной церемонии.",
            example = "הַדֶּגֶל הָיָה תָּלוּי בְּכָל בִּנְיָן צִבּוּרִי בְּיוֹם הָעַצְמָאוּת.",
        ...
        WordEntity(
            ...
            example = "הוּא קִבֵּל אֶזְרָחוּת יִשְׂרְאֵלִית מִיָּד עִם הַנְּחִיתָה.",
        ...
        WordEntity(
            ...
            definition = "שִׁיר רִשְׁמִי שֶׁל מְדִינָה הַמּוּשָׁר בְּטֶקֶס לְאֻמִּי.",
        ...
        WordEntity(
            ...
            definition = "גּוּף מֶמְשַׁלְתִּי הָאַחְרָאִי עַל תְּחוּם מְסֻיָּם כְּמוֹ חִנּוּךְ אוֹ בְּרִיאוּת.",
        ...
        WordEntity(
            ...
            definition = "תָּכְנִית כַּסְפִּית שֲׁנָתִית שֶׁל הַמְּדִינָה לְהוֹצָאוֹת וְהַכְנָסוֹת.",
        ...
        WordEntity(
            ...
            definition = "סַמְכוּת רִשְׁמִית לִדְחוֹת הַחְלָטָה אוֹ לַעֲצוֹר חוֹק לִפְנֵי הַחֲתִּימָה.",
        ...
        WordEntity(
            ...
            example = "הַחֻקָּה מַגִּינָה עַל הַדֵּמוֹקְרַטְיָה וְעַל זְכוּת הַהַצְבָּעָה.",
        ...
        WordEntity(
            ...
            definition = "בֵּית מְחוֹקְקִים נִבְחַר הַמּוֹשְׁבֵי אֶת הַחֻקִּים שֶׁל הַמְּדִינָה.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי הַמַּהְפֵּכָה כָּל הָעֵרֶךְ הַפּוֹלִיטִי הִשְׁתַּנָּה.",
        ...
        WordEntity(
            ...
            definition = "הַאֶרֶץ שֶׁבָּהּ אָדָם נוֹלַד וּמַרְגִּישׁ קֶשֶׁר עָמֹק וְלֵאֻמִּי.",
        ...
        WordEntity(
            ...
            definition = "קְבוּצָה גְּדוֹלָה שֶׁל אֲנָשִׁים עִם שָׂפָה, הִיסְטוֹרְיָה וְתְרְבּוּת מְשֻׁתָּפוֹת.",
            definitionNative = "Большая группа людей с общим языком, историей и культурой.",
            example = "הַמְּדִינָה הִיא בַּיִת לִלְאֹם אֶחָד עִקָּרִי.",
        ...
        WordEntity(
            ...
            example = "כָּל תּוֹשַׁב הָעִיר זַכַּאי לִשְׁתּוֹת מַיִם נְקִיִּים.",
        ...
        WordEntity(
            ...
            example = "הַחוֹק מָגִּין עַל זְכֻיּוֹת הַמִּיעוּט בְּכָל אֵזוֹר.",
        ...
        WordEntity(
            ...
            definition = "תְּקוּפָה רִשְׁמִית שֶׁבָּהּ נִבְחַר מְמַלֵּא תַּפְקִיד צִבּוּרִי לִפְנֵי בְּחִירוֹת חֲדָשׁוֹת.",
