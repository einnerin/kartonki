...
object WordDataHebrewAppearanceL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "אֵזוֹר הַמָּתְנַיִם וְהָאַגָּן בִּלְשׁוֹן הַמִּקְרָא — מָקוֹם שֶׁל כֹּחַ וְשׁוֹשֶׁלֶת.",
        ...
        WordEntity(
            ...
            example = "הַמְּשׁוֹרֵר תֵּאֵר אֶת חוֹטְמָהּ הַעֲדִין שֶׁל הַגְּבִירָה הַזְּקֵנָה.",
        ...
        WordEntity(
            ...
            example = "כְּשֶׁיָּצָא הַחַתָּן מֵהַחֻפָּה הָיָה לוֹ זִיו פָּנִים מְיֻחָד.",
        ...
        WordEntity(
            ...
            example = "הַחַיָּל הַזָּקֵן זָקַף אֶת גֵּווֹ בְּגַאֲוָה לִפְנֵי הַטֶּקֶס.",
        ...
        WordEntity(
            ...
            example = "הַכֹּהֵן הַגָּדוֹל לָבַשׁ אֶת בִּגְדֵי הָהֳדַר לִקְרַאת הֶחָג.",
        ...
        WordEntity(
            ...
            example = "הָרַקְדָּנִית נָעָה בַּעֲדִינוּת שֶׁל פֶּרַח שֶׁמִּתְפַּתֵּחַ בָּאוֹר.",
        ...
        WordEntity(
            ...
            example = "הָאַלְמָנָה הַזְּקֵנָה הָלְכָה שֲׁחוּחָה לְבֵית הַקְּבָרוֹת בַּגֶּשֶׁם.",
