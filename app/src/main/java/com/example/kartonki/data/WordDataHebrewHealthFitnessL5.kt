...
object WordDataHebrewHealthFitnessL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "health_endocrine",
            ...
            example = "רָמַת כּוֹרְטִיזוֹל גְּבוֹהָה בַּבֹּקֶר שׁוֹבֶרֶת אֶת הַשֶּׁנָּה הָעֲמֻקָּה.",
        ...
        WordEntity(
            ...
            example = "אִמּוּן כֹּחַ קָבוּעַ מְשַׁפֵּר רְגִישׁוּת לְאִינְסוּלִין תּוֹךְ חֳדָשָׁיִם.",
        ...
        WordEntity(
            ...
            example = "חֹסֶר בְּהוֹרְמוֹן הַתְּרִיס גּוֹרֵם לַעֲיֵפוּת כְּרוֹנִית וַעֲלִיָּה בַּמִּשְׁקָל.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי שָׁנָה שֶׁל לְחָצִים בָּעֲבוֹדָה הִיא חָוְתָה תְּשִׁישׁוּת יוֹתֶרֶת הַכִּלְיָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "health_physiology",
        ...
        WordEntity(
            ...
            definition = "הַפְּעוּלָה שֶׁל מִפְעֲלוֹת הָאֶנֶרְגְיָה הַזְּעִירוֹת בְּתוֹךְ כָּל תָּא חַי.",
        ...
        WordEntity(
            ...
            definition = "יְכֹלֶת הַמֹּחַ לִיצֹר וְלִשְׁנוֹת קִשּׁוּרִים בֵּין תָּאֵי עֲצַבִּים בְּכָל גִּיל.",
        ...
        WordEntity(
            ...
            definition = "כָּבָע מָגֵן בַּקְצֵה הַכְּרוֹמוֹסוֹם שֶׁמִּתְקַצֵּר בְּכָל חֲלֻקַּת תָּא.",
            definitionNative = "Защитный колпачок на конце хромосомы — он укорачивается с каждым делением клетки.",
            example = "אֹרֶךְ טֶלוֹמֵר מְשַׁמֵּשׁ הַיּוֹם כְּסַמַּן בִּיוֹלוֹגִי שֶׁל הַזְדַּקְּנוּת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "health_pathology",
            ...
            example = "דַּלֶּקֶת כְּרוֹנִית בַּמֵּעַיִם נֶחְשֶׁבֶת לְשֹׁרֶשׁ מַחֲלוֹת לֵב רַבּוֹת.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁל עֹדֶף רָדִּיקָלִים חָפְשִׁיִּים שֶׁפּוֹגְעִים בִּדְנָ\"א וּבִקְרוּמֵי תָאִים.",
        ...
        WordEntity(
            ...
            example = "תִּסְמֹנֶת מֵטַבּוֹלִית פּוֹגַעַת בִּכְשְׁלִישׁ מֵהָאוּכְלוּסִיָּה הַבּוֹגֶרֶת.",
        ...
        WordEntity(
            ...
            definition = "אִבּוּד הַדְרָגָתִי שֶׁל מַסַּת שְׁרִיר וְכֹחַ שֶׁמְּלַוֶה הַזְּקֵנִים בְּלִי הִתְעַמְּלוּת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "health_pharmacology",
        ...
        WordEntity(
            ...
            example = "הֵרָיוֹן הוּא הוֹרָאַת נֶגֶד לְהַרְבֵּה תְּרוּפוֹת לְכָאֲבֵי גַּב חֲזָקִים.",
        ...
        WordEntity(
            ...
            definition = "מַתַּן תְּרוּפָה לְמַטָּרָה שֶׁלֹּא רְשׁוּמָה רִשְׁמִית בַּעֲלוֹן הַמְאֻשָּׁר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "health_clinical",
            original = "מֶחְקָר מְבֻקָּר אַקְרָאִי", translation = "РКИ (рандомизированное контролируемое исследование)",
            definition = "נִסּוּי שֶׁבּוֹ מְשַׁתְּפִים מְחֻלָּקִים בְּהַגְרָלָה לִקְבוּצַת טִיפּוּל וְלִקְבוּצַת בִּקֹּרֶת.",
        ...
        WordEntity(
            ...
            example = "אֶפֶקְט נוֹצֵבּוֹ גָּרַם לִמְשַׁתְּפִים לָחוּשׁ בְּחִילָה גַּם מִכַּדּוּר סַכָּר.",
        ...
        WordEntity(
            ...
            example = "פְּרַקְטִיקָה מְבוּסֶּסֶת רְאָיוֹת הַחֲלִיפָה אֶת רֹב הַמָּסּוֹרוֹת הַיְשָׁנוֹת בָּרְפוּאָה.",
