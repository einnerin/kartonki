...
object WordDataHebrewImmigrantExtra {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "הַחֶדֶר הַמְּיוּעָד לִשְׁנַת לַיְלָה.",
        ...
        WordEntity(
            ...
            example = "הַמִּטְבָּח וְחֶדֶר הָאֳכֵל הַחִיפְּנוּ בְּדִירָה הַחֲדָשָׁה.",
        ...
        WordEntity(
            ...
            example = "מֶרְחַב הַדִּירָה הוּא 75 מֶטְרִים רְבוּעִים.",
        ...
        WordEntity(
            ...
            example = "עַמֲלַת הַתִּיּוּךְ הִיא בְּדֶרֶךְ כְּלָל מֶחֱצִית חוֹדֶשׁ שְׂכִירוּת.",
        ...
        WordEntity(
            ...
            definition = "חֶבְרָה הַמְּסַפֶּקֶת גִּישָׁה לָאִינְטֶרְנֵט.",
            definitionNative = "Компания, предоставляющая доступ к интернету.",
            example = "עָבַרְתִּי לִפְּרוֹבַיְדֶר אַחֵר כִּי הַמְּהִירוּת הָיְתָה נְמוּכָּה.",
        ...
        WordEntity(
            ...
            example = "שִׁמּוּשׁ בְּאֵנֶרְגְּיָה סוֹלָרִית מוֹרִיד אֶת הַחֶשְׁבּוֹן.",
        ...
        WordEntity(
            ...
            definition = "מֶחֱצִית שֶׁל שַׁנַּת הַלִּימּוּדִים בְּמוֹסָד אָקָדֵמִי.",
        ...
        WordEntity(
            ...
            definition = "מִסְמָךְ רִשְׁמִי הַמֵּעִיד עַל לִימּוּדִים, הִישֵׂגִים אוֹ כִּשּׁוּרִים.",
        ...
        WordEntity(
            ...
            definition = "שֵׁרוּת מִשְׁלוֹחַ בִּזְמַן קָצָר מֵהָרָּגִיל, לְרוֹב בְּמְחִיר גָּבֹהַּ יוֹתֵר.",
        ...
        WordEntity(
            ...
            definition = "פֶּתֶק דָּבִיק שֶׁמַּדְבִּיקִים עַל חֲבִילוֹת עִם פְּרָטִים אוֹ לְעִיטּוּר.",
        ...
        WordEntity(
            ...
            definition = "הַזְּמַן בָּעֶרֶב כַּאֲשֶׁר נִרְאִים שְׁלוֹשָׁה כּוֹכָבִים בַּשָּׁמַיִם, סִיּוּם יוֹם הַמְּנוּחָה הַשְּׁבוּעִי.",
        ...
        WordEntity(
            ...
            definition = "רֶכֶס הָרִים בְּחֵיפָה וּסְבִיבוֹתֶיהָ, מְפָרְסָם בְּיַעֲרוֹת וּנְחָלִים.",
        ...
        WordEntity(
            ...
            definition = "הָהָר הַגָּבֹהַּ בְּיוֹתֵר בְּיִשְׂרָאֵל בְּצָפוֹן הַגּוֹלָן, עִם אָזוֹר סְקִי בַּחֹרֶף.",
            definitionNative = "Самая высокая гора в Израиле на севере Голан, с горнолыжным районом зимой.",
            example = "בַּחֹרֶף עוֹלִים לַחֶרְמוֹן לִגְלִישָׁה עַל הַשֶּׁלֶג.",
