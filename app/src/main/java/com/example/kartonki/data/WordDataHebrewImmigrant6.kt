...
object WordDataHebrewImmigrant6 {
    ...
    val sets = listOf(
                WordSetEntity(id = 1146, name = "Армия",         description = "Призыв, служба, резерв и военный быт",  languagePair = "he-ru", orderIndex = 146,
    topic = "Армия", level = 2),
        WordSetEntity(id = 1147, name = "Религия и праздники",  description = "Кашрут, сертификаты, разделение",       languagePair = "he-ru", orderIndex = 147,
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "חֵפֶץ אוֹ אָדָם הַחוֹסֶה עַל מִישֶׁהוּ מִפְּנֵי סַכָּנָה וּמַכּוֹת; גַּם סֵמֶל לְבִטָּחוֹן.",
        ...
        WordEntity(
            ...
            definition = "שֵׁרוּת צְבָאִי תְּקוּפָתִי לְחַיָּלֵי מִילוּאִים לְאַחַר הַשֵּׁרוּת הַסָּדִּיר.",
        ...
        WordEntity(
            ...
            example = "הוּא קִיבֵּל פָּטוּר מֵהַצָּבָא מִסִּיבּוֹת רְפוּאִיּוֹת.",
        ...
        WordEntity(
            ...
            definition = "תַּרְגִּיל הַמְּאַמֵּן חַיָּלִים בְּמָשִּׂימוֹת קְרָבִיּוֹת אוֹ טֶכְנִיּוֹת.",
            definitionNative = "Упражнение, обучающее солдат боевым или техническим задачам.",
            example = "לֵאֵמוּן הַלַּיְלָה הֵם יָצְאוּ עִם כָּל הַצִּיּוּד.",
        ...
        WordEntity(
            ...
            definition = "שִׁחְרוּרוֹ הֲרַשְּׁמִי שֶׁל חַיָּל מֵהַשֵּׁרוּת הַצְּבָאִי.",
        ...
        WordEntity(
            ...
            example = "מִשְׂרַד הַהֲגַנָּה אַחְרָאִי עַל בִּטְחוֹן הַמְּדִינָה.",
        ...
        WordEntity(
            ...
            definition = "הַעֲבָרַת מֵידָע בֵּין חַיָּלִים אוֹ יְחִידוֹת בְּרַדְיוֹ אוֹ בְּאֶמְצָעִים אֲחֵרִים.",
            definitionNative = "Передача информации между солдатами или подразделениями по радио или другим средствам.",
            example = "חַיַּל הַקֶּשֶׁר שָׁלַח דִּוּוּחַ לַמַּפְקֵד.",
        ...
        WordEntity(
            ...
            definition = "הָאֵזוֹר הָרָחוֹק מִקַּו הַחֲזִית הַמְּשַׁמֵּשׁ לְאַסְפָּקָה וְהַגַּנָּה אֵזְרָחִית.",
            definitionNative = "Район вдали от линии фронта, служащий для снабжения и гражданской обороны.",
            example = "פִּקּוּד הָעוֹרֵף מְנַהֵל אֶת הַהֲגַנָּה הָאֵזְרָחִית.",
        ...
        WordEntity(
            ...
            example = "מִבְצַע עַמּוּד עָנָן הָיָה בְּשָׁנַת אַלְפַּיִם וּשְׁתֵּים עֶשְׂרֵה.",
        ...
        WordEntity(
            ...
            definition = "מָקוֹם בּוֹ מַפְקְדִים מְקַבְּלִים הַחְלָטוֹת וּמְנַהֲלִים פְּעוּלּוֹת צְבָאִיּוֹת.",
        ...
        WordEntity(
            ...
            example = "כָּל צַנָּן בַּיְּחִידָה עָבַר אִמּוּן צְנִיחָה קָשֶׁה.",
        ...
        WordEntity(
            ...
            definition = "מִסְפַּר הַמַּשְׂרוֹת הַמְּאוּשָּׁרוֹת בְּיְחִידָה אוֹ בְּמִשְׂרַד.",
            definitionNative = "Число утверждённых должностей в воинской части или ведомстве.",
            example = "הַמְּפַקֵּד אִשֵּׁר תֶּקֶן חָדָשׁ לְקָצִּין מוֹדִיעִין נוֹסָף.",
        ...
        WordEntity(
            ...
            definition = "חַיָּל הַמְּשַׁמֵּשׁ וּמְפַעֵל תּוֹתָחִים אוֹ נֶשֶׁק כָּבֵד.",
        ...
        WordEntity(
            ...
            definition = "תְּנוּעַת כּוֹחוֹת צְבָאִיִּים לָאָחוֹר כְּדֵי לְהִמָּנַע מִתְּבוּסָה.",
        ...
        WordEntity(
            ...
            example = "מַשְׁקִיפֵי הָאוּ\"ם עָקְבוּ אַחֲרֵי הַהֶסְכֵּם.",
        ...
        WordEntity(
            ...
            definition = "כּוֹחַ צְבָאִי זְמַנִּי שֶׁהוּרְכַּב לְמָשִּׂימָה סְפֵּצִיפִית.",
            definitionNative = "Временная военная группа, сформированная для выполнения конкретной задачи.",
            example = "כּוֹחַ הַמְּשִׂימָה הֻרְכַּב מִחֲיָּלִים שֶׁל כַּמָּה יְחִידוֹת.",
        ...
        WordEntity(
            ...
            definition = "מוּצָר חֲלָבִי הַנֶּעֱשֶׂה מֵחָלָב מְקוּרָשׁ.",
        ...
        WordEntity(
            ...
            example = "הָרַבִּי מְבָרֵךְ עַל כּוֹס יַיִן בְּשַׁבָּת.",
        ...
        WordEntity(
            ...
            definition = "חוֹבָה לְהַבְדִּיל בֵּין כֵּלִים, אֹכֶל וְהַכַּנָּה שֶׁל בָּשָׂר לְעֻמַּת חָלָב.",
            definitionNative = "Обязанность разделять посуду, еду и приготовление мясного от молочного.",
            example = "בַּמִּטְבָּח הַכָּשֵׁר יֵשׁ שְׁתֵּי עַרֱכוֹת כֵּלִים — לְהַפְרָדָה.",
        ...
        WordEntity(
            ...
            definition = "מָזוֹן הַמֵּכִיל חָלָב אוֹ נִגְזָרָיו וְחָסוּר לְאָכְלוֹ עִם בָּשָׂר.",
        ...
        WordEntity(
            ...
            definition = "אָדָם הַמְפַקֵּחַ עַל יְרָקוֹת וּמָזוֹן וּמְעַיֵּן בָּהֶם כְּדֵי לְוַדֵּא שֶׁאֵין חֲרָקִים אוֹ פְּגָמִים.",
            definitionNative = "Специалист, который осматривает овощи и другую еду на жучков и нарушения кашрута.",
            example = "הַבּוֹדֵק בָּדַק אֶת הַחַסָּה לִפְנֵי הַסָּלָט.",
        ...
        WordEntity(
            ...
            definition = "נוֹזֵל אָדֹם הַזּוֹרֵם בְּגוּף הַחַי; אָסוּר לַאֲכִילָה בְּהַלָּכָהּ.",
        ...
        WordEntity(
            ...
            definition = "עִקָּרוֹן הֲלַכָּתִי שֶׁלְּפִיו חוֹמֶר אָסוּר נִבְטַל בְּרֹב הַמִּקְרִים בְּיַחַס שֶׁל אֶחָד לְשִׁשִּׁים.",
        ...
        WordEntity(
            ...
            example = "עַל הַבַּקָּר כָּתוּב בַּד\"ץ — לְמַאֲמִינֵי הַחֲרֵדִים.",
        ...
        WordEntity(
            ...
            definition = "דַּרְגַּת כַּשְׁרוּת גְּבוֹהָה יוֹתֵר מִן הַבָּסִיסִי, לְמַחְמִירִים בְּהַלָּכָהּ.",
        ...
        WordEntity(
            ...
            definition = "אָדָם מוּסְמָךְ הַמְּבַצֵּעַ שְׁחִיטָה כְּשֵׁרָה שֶׁל בְּעַלֵּי חַיִּים.",
        ...
        WordEntity(
            ...
            example = "לִפְנֵי פֶּסַח מוֹכְרִים אֶת הַחֲמֵץ לְגוֹי.",
