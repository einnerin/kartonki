...
object WordDataHebrewCookL4 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "סְגָן שֶׁל רֹאשׁ הַמִּטְבָּח שֶׁמְּנַהֵל אֶת הַמִּשְׁמֶרֶת בִּזְמַן הֶעְדֵּר.",
        ...
        WordEntity(
            ...
            example = "שֶׁף פַּטִּיסְרִי הִכִין סוּפְלֶה שׁוֹקוֹלָד לְכָל הָאוֹרְחִים בָּעֶרֶב.",
        ...
        WordEntity(
            ...
            definition = "טַבָּח שֶׁמְּתַמְחֶה בִּמְנוֹת מַחֲבַת חַמָּה עִם רֹטֶב מָהִיר.",
            definitionNative = "Повар, специализирующийся на сковороде с быстрым соусом.",
            example = "שֶׁף סוֹטֶה זָרַק חַמָּאָה לַמַּחֲבַת בְּדִיּוּק בָּרֶגַע הַנָּכוֹן.",
        ...
        WordEntity(
            ...
            example = "שֶׁף גָּרִיל בָּדַק כָּל סְטֵיְק בְּמַד חֹם פְּנִימִי.",
        ...
        WordEntity(
            ...
            definition = "הֲפִיכַת נוֹזֵל לְכַדּוּרִים זְעִירִים בְּקַלְצְיוּם — טֶכְנִיקָה מוֹלֶקוּלָרִית.",
        ...
        WordEntity(
            ...
            example = "שִׁלּוּב טַעֲמִים שֶׁל מַנְגּוֹ וְצִ'ילִי הִפְתִּיעַ אֶת הַסּוֹעֲדִים.",
        ...
        WordEntity(
            ...
            definition = "בְּחִירַת מַשְׁקֶה שֶׁמַּדְגִּישׁ אוֹ מְאַזֵּן אֶת טַעַם הָאֳכֵל.",
            definitionNative = "Подбор напитка, который подчеркивает или уравновешивает блюдо.",
            example = "שִׁדּוּךְ יַיִן מֻצְלָח לְמָנַת הַסְּטֵיְק הָיָה מָאלְבֶּק אַרְגֶּנְטִינָאִי.",
        ...
        WordEntity(
            ...
            example = "יַיִן מְלַוֶּה לַקִּנּוּחַ הָיָה מוֹסְקָטֶל אִיטַלְקִי קַלִּיל.",
        ...
        WordEntity(
            ...
            definition = "תּוֹפָעָה שֶׁבָּהּ הַמַּשְׁקֶה וְהָאֳכֵל מַגְדִּילִים זֶה אֶת זֶה בַּפֶּה.",
            definitionNative = "Явление, когда напиток и еда усиливают друг друга во рту.",
            example = "רֵזוֹנַנְס טַעֲמִים בֵּין שׁוֹקוֹלָד לְפּוֹרְט הָיָה מֻשְׁלָם.",
        ...
        WordEntity(
            ...
            example = "בִּישּׁוּל לְבַּנְקֵט שֶׁל מָאתַיִם אִישׁ דּוֹרֵשׁ תִּכְנוּן מֻקְפָּד.",
