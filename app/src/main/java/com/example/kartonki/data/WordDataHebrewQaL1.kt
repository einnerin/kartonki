...
object WordDataHebrewQaL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "מָצָאתִי בְּעָיָה קְטַנָּה בַּדַּף הָרָאשִׁי שֶׁל הָאֲתָר.",
        ...
        WordEntity(
            ...
            definition = "אוֹסֶף שֶׁל חֲלָקִים שֶׁעוֹבְדִים יַחַד — לְמָשָׁל אֲתָר, שָׂרָת וּמַסַּד נְתוּנִים.",
        ...
        WordEntity(
            ...
            definition = "אֵיזוֹר קָטָן עַל הַמָּסָךְ שֶׁכּוֹתֵב טֶקְסְט וּמְקַבֵּל לְחִיצָה מִמִּישֶׁהוּ.",
            definitionNative = "Маленькая зона на экране — там написан текст, по ней щёлкают.",
            example = "הַכַּפְתּוֹר הַכָּתֹם בָּרֹאשׁ שׁוֹלֵחַ אֶת הַטֹּפֶס מִיָּד לַ|שָּׁרָת.",
        ...
        WordEntity(
            ...
            definition = "לָגַעַת בְּאֶצְבַּע אוֹ בָּעַכְבָּר עַל מַשֶּׁהוּ קָטָן עַל הַמָּסָךְ.",
        ...
        WordEntity(
            ...
            example = "צָרִיךְ לְמַלֵּא שֵׁם וְכָתֹּבֶת לִפְנֵי שֶׁאֶפְשָׁר לְהִתְקַדֵּם.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁל מַכְשִׁיר אוֹ שֵׁרוּת שֶׁאֵינוֹ מָגִּיב לַפְּעֻלּוֹת שֶׁל הַמִּשְׁתַּמֵּשׁ.",
            definitionNative = "Состояние устройства или сервиса — не отзывается на действия пользователя.",
            example = "הַחִפּוּשׂ בָּאֲתָר לֹא עוֹבֵד מֵהַבֹּקֶר וְלָקוֹחוֹת מִתְלוֹנְנִים.",
        ...
        WordEntity(
            ...
            example = "הָאֲתָר הֶחְזִיר תּוֹצָאָה לֹא נְכוֹנָה לַחִבּוּר שֶׁל שְׁנֵי מִסְפָּרִים.",
        ...
        WordEntity(
            ...
            definition = "סִיוּם פִּתְאוֹמִי שֶׁל תּוֹכְנָה — הַמָּסָךְ נֶעֱלַם וְהַכֹּל נִסְגַּר בְּלִי אַזְהָרָה.",
        ...
        WordEntity(
            ...
            example = "הָאֲתָר אִטִּי בַּעַרְבּוּ וְכִמְעַט אַף לָקוֹחַ לֹא מַצְלִיחַ לְשַׁלֵּם.",
        ...
        WordEntity(
            ...
            definition = "אָדָם שֶׁמַּחְלִיט מָה הַצֶּוֶות יַעֲשֶׂה הַיּוֹם וְעוֹזֵר כְּשֶׁמִּישֶׁהוּ נִתְקַע.",
        ...
        WordEntity(
            ...
            example = "הַצֶּוֶות שֶׁלָּנוּ נִפְגַּשׁ כָּל בֹּקֶר בְּתֵשַׁע לְעֶשֶׂר דַּקּוֹת.",
