...
object WordDataEnglishPhrasalVerbsL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 41403, setId = 414, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Срубить что-то — обычно дерево — тяжёлыми ударами топора или меча.",
        ...
        WordEntity(id = 41409, setId = 414, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Согласиться на просьбу или требование — обычно после обдумывания в формальной обстановке.",
        ...
        WordEntity(id = 41410, setId = 414, languagePair = "en-ru", rarity = "LEGENDARY",
            ...
            definitionNative = "Отправиться в какое-то место — формально или в старинном литературном стиле.",
