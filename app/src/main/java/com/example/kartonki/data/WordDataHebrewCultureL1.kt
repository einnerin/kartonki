...
object WordDataHebrewCultureL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "הָרֹשֶׁם הַחָזוּתִי שֶׁמַּבְדִּיל בֵּין אָדוֹם, כָּחוֹל וְיָרוֹק.",
        ...
        WordEntity(
            ...
            definition = "חֶדֶר עֲבוֹדָה לְצַיָּר, צַלָּם אוֹ נַגַּן הַמַּקְלִיט שָׁם.",
        ...
        WordEntity(
            ...
            definition = "אָדָם שֶׁכּוֹתֵב סִפְרֵי מַחֲשָׁבָה אוֹ עֲלִילוֹת לַקּוֹרְאִים.",
        ...
        WordEntity(
            ...
            definition = "אִשָּׁה שֶׁכּוֹתֶבֶת סִפְרֵי מַחֲשָׁבָה אוֹ עֲלִילוֹת לַקּוֹרְאִים.",
        ...
        WordEntity(
            ...
            example = "אִמָּא קוֹרֵאת לִי סִפּוּר לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            example = "הַמַּקְהֵלָה הוֹפִיעָה בִּכְנֵסִיָּה בָּעֶרֶב חַג הַמּוֹלָד.",
        ...
        WordEntity(
            ...
            definition = "אָמָּנוּת שֶׁל צְלִילִים עֲרוּכִים לְפִי קֶצֶב וְהַרְמוֹנְיָה.",
        ...
        WordEntity(
            ...
            definition = "מַנְגִּינָה רַכָּה שֶׁאֵם שָׁרָה לַתִּינוֹק לִפְנֵי הַשֶּׁנָּה.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר שֶׁמְּשַׁדֵּר קוֹל וּמַנְגִּינוֹת לְהַאֲזָנָה בַּבַּיִת אוֹ בָּרֶכֶב.",
            definitionNative = "Прибор, передающий голос и мелодии для прослушивания дома или в машине.",
            example = "אַבָּא הִדְלִיק אֶת הָרַדְיוֹ כְּדֵי לִשְׁמוֹעַ חֲדָשׁוֹת בַּבֹּקֶר.",
        ...
        WordEntity(
            ...
            definition = "אוֹר צִבְעוֹנִי בְּמוֹדָעוֹת רְחוֹב שֶׁל קוֹלְנוֹעַ אוֹ מוֹעֲדוֹן.",
