...
object WordDataEnglishTimeL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 38607, setId = 386, languagePair = "en-ru", rarity = "UNCOMMON",
            ...
            definitionNative = "Сдвинуть запланированное событие на новый день или час.",
        ...
        WordEntity(id = 38610, setId = 386, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "Происходящий каждые 14 дней — как встреча по пятницам через одну.",
        ...
        WordEntity(id = 38615, setId = 386, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "Самые жаркие и длинные дни в году — июль с его солнцем и зноем.",
        ...
        WordEntity(id = 38619, setId = 386, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "До того, как событие началось — чтобы успеть подготовиться.",
