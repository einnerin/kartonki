...
object WordDataHebrewAdvanced {
    ...
    val words = listOf(
        ...
        WordEntity(id = 101508, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "תַּפְקִיד", transliteration = "tafkid", translation = "должность; роль", pos = "noun", semanticGroup = "work",
            definition = "a role or position assigned to a person in an organisation",
            example = "הִתְמַנֵּיתִי לְתַּפְקִיד מנהל פרויקטים.",
            definitionNative = "Роль или должность, возложенная на человека в организации.",
            exampleNative = "Я был назначен на תַּפְקִיד менеджера проектов."),

        WordEntity(id = 101509, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "פְּגִישָׁה", transliteration = "pgisha", translation = "встреча; совещание", pos = "noun", semanticGroup = "work",
            definition = "a scheduled gathering of colleagues to discuss work matters",
            example = "יש לנו פְּגִישָׁה עם הלקוח ביום שני.",
            definitionNative = "Запланированная встреча коллег для обсуждения рабочих вопросов.",
            exampleNative = "В понедельник у нас פְּגִישָׁה с клиентом."),
        ...
        WordEntity(id = 101511, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "שְׁכִיר", transliteration = "skhir", translation = "наёмный работник; сотрудник", pos = "noun", semanticGroup = "work",
            ...
            exampleNative = "Он שְׁכִיר в хайтек-компании."),

        WordEntity(id = 101512, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "יַעַד", transliteration = "ya'ad", translation = "цель; ориентир", pos = "noun", semanticGroup = "work",
            definition = "an objective or target that a person or organisation aims to achieve",
            example = "קָבַעְנוּ יַעַד מְכִירוֹת לְרֶבַע הַשָּׁנָה.",
            definitionNative = "Задача или цель, которую человек или организация стремится достичь.",
            exampleNative = "Мы установили יַעַד продаж на квартал."),
        ...
        WordEntity(id = 101513, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "הִדְרָכָה", transliteration = "hidrakhah", translation = "инструктаж; обучение", pos = "noun", semanticGroup = "work",
            ...
            exampleNative = "Мы прошли הִדְרָכָה перед началом работы."),
        ...
        WordEntity(id = 101608, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "חֲרָדָה", transliteration = "kharada", translation = "тревога; беспокойство", pos = "noun", semanticGroup = "emotion",
            ...
            exampleNative = "חֲרָדָה перед экзаменом — распространённое явление."),
        ...
        WordEntity(id = 101609, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "מְבוּכָה", transliteration = "mevukha", translation = "замешательство; смущение", pos = "noun", semanticGroup = "emotion",
            ...
            exampleNative = "Его охватила мְבוּכָה, когда он упал на людях."),
        ...
        WordEntity(id = 101610, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "אַכְזָבָה", transliteration = "akhzavah", translation = "разочарование", pos = "noun", semanticGroup = "emotion",
            ...
            exampleNative = "Я испытал большую אַכְזָבָה, когда игра была отменена."),
        ...
        WordEntity(id = 101611, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "סְקָרָנוּת", transliteration = "skranut", translation = "любопытство", pos = "noun", semanticGroup = "character",
            ...
            exampleNative = "סְקָרָנוּת — двигатель любого обучения."),
        ...
        WordEntity(id = 101707, setId = 1017, languagePair = "he-ru", rarity = "RARE", original = "טֶבַע הָאָדָם", transliteration = "teva ha-adam", translation = "природа человека", pos = "noun", semanticGroup = "abstract",
            ...
            exampleNative = "Философия спрашивает: что такое טֶבַע הָאָדָם?"),
        ...
        WordEntity(id = 101709, setId = 1017, languagePair = "he-ru", rarity = "RARE", original = "לוֹגִיקָה", transliteration = "logika", translation = "логика", pos = "noun", semanticGroup = "abstract",
            definition = "the study of correct reasoning and valid inference",
            example = "לוֹגִיקָה פורמלית עוסקת בכללי הסקה תקינה.",
            definitionNative = "Изучение правильного рассуждения и допустимых умозаключений.",
            exampleNative = "Формальная לוֹגִיקָה занимается правилами корректных выводов."),

        WordEntity(id = 101710, setId = 1017, languagePair = "he-ru", rarity = "RARE", original = "אֶסְתֶּטִיקָה", transliteration = "estetika", translation = "эстетика", pos = "noun", semanticGroup = "abstract",
            definition = "the philosophical study of beauty and taste in art and nature",
            example = "אֶסְתֶּטִיקָה עוסקת בשאלה: מה הופך דבר לאמנות?",
            definitionNative = "Философское изучение красоты и вкуса в искусстве и природе.",
            exampleNative = "אֶסְתֶּטִיקָה спрашивает: что делает вещь искусством?"),
        ...
        WordEntity(id = 101520, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "בּוֹנוּס", transliteration = "bonus", translation = "бонус; премия", pos = "noun", semanticGroup = "work",
            ...
            exampleNative = "В конце года я получил בּוֹנוּס."),
        ...
        WordEntity(id = 101522, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "לוּחַ זְמַנִּים", transliteration = "luakh zmaniim", translation = "расписание; график работ", pos = "noun", semanticGroup = "work",
            definition = "a timetable showing when tasks or meetings are planned",
            example = "שלחתי לצוות לוּחַ זְמַנִּים לשבוע.",
            definitionNative = "Расписание, показывающее, когда запланированы задачи или встречи.",
            exampleNative = "Я отправил команде לוּחַ זְמַנִּים на неделю."),
        ...
        WordEntity(id = 101523, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "כִּשָּׁרוֹן", transliteration = "kisharon", translation = "талант; умение", pos = "noun", semanticGroup = "work",
            ...
            exampleNative = "כִּשָּׁרוֹן в общении важен в любой сфере."),

        WordEntity(id = 101524, setId = 1015, languagePair = "he-ru", rarity = "UNCOMMON", original = "צִיּוּד", transliteration = "tziyud", translation = "оборудование; снаряжение", pos = "noun", semanticGroup = "work",
            definition = "tools, machines, or materials needed to carry out a job",
            example = "הַחֶבְרָה סיפקה צִיּוּד משרדי לכל עובד.",
            definitionNative = "Инструменты, машины или материалы, необходимые для выполнения работы.",
            exampleNative = "Компания предоставила каждому сотруднику צִיּוּד."),
        ...
        WordEntity(id = 101618, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "דְּאָגָה", transliteration = "de'agah", translation = "беспокойство; забота", pos = "noun", semanticGroup = "emotion",
            ...
            exampleNative = "דְּאָגָה о будущем детей — естественное чувство."),
        ...
        WordEntity(id = 101619, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "עִנְיָן", transliteration = "inyan", translation = "интерес", pos = "noun", semanticGroup = "character",
            ...
            exampleNative = "Я обнаружил большой עִנְיָן к теме психологии."),
        ...
        WordEntity(id = 101620, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "פֶּסִימִיּוּת", transliteration = "pesimiyut", translation = "пессимизм", pos = "noun", semanticGroup = "character",
            ...
            exampleNative = "Излишняя פֶּסִימִיּוּת может мешать успеху."),
        ...
        WordEntity(id = 101621, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "לְחַץ", transliteration = "lekhatz", translation = "стресс; давление", pos = "noun", semanticGroup = "emotion",
            ...
            exampleNative = "Рабочий לְחַץ повлиял на его здоровье."),
        ...
        WordEntity(id = 101622, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "הֲנָאָה", transliteration = "hana'a", translation = "удовольствие; наслаждение", pos = "noun", semanticGroup = "emotion",
            ...
            exampleNative = "הֲנָאָה от музыки — универсальное ощущение."),


        WordEntity(id = 101623, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "שַׁלְוָה", transliteration = "shalva", translation = "покой; безмятежность", pos = "noun", semanticGroup = "character",
            definition = "a state of calm, peacefulness, and freedom from disturbance",
            example = "שַׁלְוָה פְּנִימִית הִיא מַטָּרָה בְּמֶדִיטַצְיָה.",
            definitionNative = "Состояние спокойствия, безмятежности и внутреннего мира.",
            exampleNative = "Внутренняя שַׁלְוָה — цель медитации."),


        WordEntity(id = 101624, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "הֶרְגֵּל", transliteration = "hergel", translation = "привычка", pos = "noun", semanticGroup = "character",
            definition = "a behaviour that is repeated regularly and becomes automatic",
            example = "הֶרְגֵּל של קריאה יומית משפר את הזיכרון.",
            definitionNative = "Поведение, регулярно повторяемое до автоматизма.",
            exampleNative = "הֶרְגֵּל ежедневного чтения улучшает память."),
        ...
        WordEntity(id = 101711, setId = 1017, languagePair = "he-ru", rarity = "RARE", original = "פוּנְקְצְיוֹנָלִיזְם", transliteration = "funktsionalizm", translation = "функционализм", pos = "noun", semanticGroup = "abstract",
            definition = "a philosophical view that mental states are defined by their functional roles",
            example = "פוּנְקְצְיוֹנָלִיזְם בְּפִילוֹסוֹפְיַת הַנֶּפֶשׁ מִתְמַקֵּד בְּתַפְקוּד הַמַּצָּבִים.",
            definitionNative = "Философский взгляд, что психические состояния определяются своими функциональными ролями.",
            exampleNative = "פוּנְקְצְיוֹנָלִיזְם в философии разума фокусируется на функции состояний."),
        ...
        WordEntity(id = 101714, setId = 1017, languagePair = "he-ru", rarity = "RARE", original = "פּלּוּרָלִיזְם", transliteration = "pluralizm", translation = "плюрализм", pos = "noun", semanticGroup = "abstract",
            ...
            exampleNative = "Ценностный פּלּוּרָלִיזְם признаёт многообразие жизненных путей."),
        ...
        WordEntity(id = 101718, setId = 1017, languagePair = "he-ru", rarity = "RARE", original = "קוֹסְמוֹלוֹגְיָה", transliteration = "kosmologiya", translation = "космология", pos = "noun", semanticGroup = "abstract",
            definition = "the philosophical and scientific study of the origin and structure of the universe",
            example = "קוֹסְמוֹלוֹגְיָה עַכְשָׁווִית עוֹסֶקֶת בְּמָקוֹר הַיְּקוּם.",
            definitionNative = "Философское и научное изучение происхождения и структуры Вселенной.",
            exampleNative = "Современная קוֹסְמוֹלוֹגְיָה занимается происхождением Вселенной."),
        ...
        // ━━━ RARE ━━━
        WordEntity(id = 101814, setId = 1018, languagePair = "he-ru", rarity = "UNCOMMON", original = "מַפָּה", transliteration = "mapa", translation = "карта (уровня/мира)", pos = "noun", semanticGroup = "gaming",
            definition = "a visual representation of the game world or level layout",
            example = "פתחתי אֶת הַמַּפָּה כדי למצוא את הדרך.",
            definitionNative = "Визуальное представление игрового мира или схемы уровня.",
            exampleNative = "Я открыл מַפָּה, чтобы найти дорогу."),

        WordEntity(id = 101815, setId = 1018, languagePair = "he-ru", rarity = "UNCOMMON", original = "פְּרוֹפִיל", transliteration = "profil", translation = "профиль игрока", pos = "noun", semanticGroup = "gaming",
            definition = "a player's account page showing stats, achievements, and history",
            example = "בדקתי אֶת הַפְּרוֹפִיל שלו לפני ההתאמה.",
            definitionNative = "Страница аккаунта игрока со статистикой, достижениями и историей.",
            exampleNative = "Перед матчем я проверил его פְּרוֹפִיל."),
        ...
        WordEntity(id = 101816, setId = 1018, languagePair = "he-ru", rarity = "UNCOMMON", original = "אַוָּטָאר", transliteration = "avatar", translation = "аватар; игровой образ", pos = "noun", semanticGroup = "gaming",
            ...
            exampleNative = "Я выбрал אַוָּטָאר с острыми зубами."),

        WordEntity(id = 101817, setId = 1018, languagePair = "he-ru", rarity = "UNCOMMON", original = "טוּרְנִיר", transliteration = "turnir", translation = "турнир; соревнование", pos = "noun", semanticGroup = "gaming",
            definition = "a competitive event where multiple players compete to win a prize",
            example = "הירשמתי לְטוּרְנִיר עולמי בשחמט.",
            definitionNative = "Соревновательное мероприятие, в котором несколько игроков борются за приз.",
            exampleNative = "Я записался на мировой טוּרְנִיר по шахматам."),
        ...
        WordEntity(id = 101818, setId = 1018, languagePair = "he-ru", rarity = "UNCOMMON", original = "אוֹנְלַיְן", transliteration = "onlayn", translation = "онлайн; в сети", pos = "adjective", semanticGroup = "gaming",
            ...
            exampleNative = "Мы играли в режим אוֹנְלַיְן с игроками со всего мира."),
        ...
        WordEntity(id = 101819, setId = 1018, languagePair = "he-ru", rarity = "UNCOMMON", original = "מֻלְטִיפְּלֵייֶר", transliteration = "multiplayer", translation = "мультиплеер; многопользовательский", pos = "noun", semanticGroup = "gaming",
            ...
            exampleNative = "מֻלְטִיפְּלֵייֶר увеличивает удовольствие в несколько раз."),
        ...
        WordEntity(id = 101822, setId = 1018, languagePair = "he-ru", rarity = "UNCOMMON", original = "מִשְׂחָק תַּפְקִידִים", transliteration = "miskhak tafkidim", translation = "ролевая игра; RPG", pos = "noun", semanticGroup = "gaming",
            ...
            exampleNative = "מִשְׂחָק תַּפְקִידִים предлагает открытый мир для исследования."),
