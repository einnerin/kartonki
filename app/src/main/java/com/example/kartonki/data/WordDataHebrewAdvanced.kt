...
object WordDataHebrewAdvanced {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "עותק של נתונים הנשמר בנפרד לצורך שִׁחְזוּר במקרה של אובדן.",
        ...
        WordEntity(
            ...
            definition = "הֲגַנָּה על מערכות ורשתות מפני מתקפות דיגיטליות.",
        ...
        WordEntity(
            ...
            definition = "תהליך שיפור ביצועי קוד או מערכת כדי להגיע לתוצאות מְהִירוֹת יותר.",
            definitionNative = "Процесс улучшения производительности кода или системы для достижения более быстрых результатов.",
            example = "אוֹפְּטִימִיזַצְיָה של שאילתות ה-SQL הפחיתה את זמן התגובה בחמישים אָחוּז.",
        ...
        WordEntity(
            ...
            example = "עדכנו לַגֵּרְסָה החדשה של המערכת.",
        ...
        WordEntity(
            ...
            definition = "תוכנה המיועדת לביצוע מְשִׂימָה ספציפית על גבי מכשיר.",
        ...
        WordEntity(
            ...
            example = "מְעַבֵּד חזק נחוץ לעיבוד קבצי וידאו.",
        ...
        WordEntity(
            ...
            definition = "תחושה של חֲרָדָה בפני סכנה או הלא נודע.",
        ...
        WordEntity(id = 101611, setId = 1016, languagePair = "he-ru", rarity = "UNCOMMON", original = "סַקְרָנוּת", translation = "любопытство", pos = "noun", semanticGroup = "character",
            ...
            example = "סַקְרָנוּת היא מָנוֹעַ לכל למידה.",
        ...
        WordEntity(
            ...
            definition = "הִתְנַהֲגוּת לפי עקרונות מוסריים של שוויון ויושר.",
        ...
        WordEntity(
            ...
            example = "הַצְפָּנַת נְתוּנִים שומרת על פְּרָטִיּוּת התקשורת.",
        ...
        WordEntity(
            ...
            example = "אַחְרָיוּת היא ערך בסיסי בכל תַּפְקִיד ניהולי.",
        ...
        WordEntity(id = 101621, setId = 1016, languagePair = "he-ru", rarity = "COMMON", original = "לַחַץ", translation = "стресс; давление", pos = "noun", semanticGroup = "emotion",
            ...
            example = "לַחַץ בעבודה השפיע על בריאותו.",
        ...
        WordEntity(
            ...
            definition = "עֲנַף הפילוסופיה העוסק בטיב, במקור ובגבולות הידע האנושי.",
        ...
        WordEntity(
            ...
            definition = "פעילות עם כללים שנועדה לשעשוע, לרוב על מָסַךְ מחשב או קונסולה.",
        ...
        WordEntity(
            ...
            definition = "דְּמוּת עוינת הנשלטת על ידי המחשב ומנסה לפגוע בשחקן.",
        ...
        WordEntity(
            ...
            definition = "הַגָּעָה לסוף המשחק בהצלחה, לרוב אחרי ביסה של כל האויבים.",
        ...
        WordEntity(
            ...
            example = "קיבלתי מִ|שִּׁימָה לאסוף עשרה פרחים נדירים מהיער.",
        ...
        WordEntity(
            ...
            example = "בחרתי דֵּמוּת לוחם עם שִׁרְיוֹן כבד ולחימה בחרב.",
        ...
        WordEntity(
            ...
            definition = "אויב חזק במיוחד המופיע בסוף שלב ודורש תִּכְנוּן מיוחד לביסה.",
        ...
        WordEntity(id = 101819, setId = 1018, languagePair = "he-ru", rarity = "UNCOMMON", original = "מֻלְטִיפְּלֵייֶר", translation = "мультиплеер; многопользовательский", pos = "noun", semanticGroup = "gaming",
            ...
            example = "מֻלְטִיפְּלֵייֶר מגביר את ההנאה פי כַּמָּה.",
