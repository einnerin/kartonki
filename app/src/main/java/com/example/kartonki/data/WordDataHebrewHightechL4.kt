...
object WordDataHebrewHightechL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "גִּישָׁה שֶׁבָּהּ שֵׁרַתִּים, רְשָׁתוֹת וּמַאֲגָרִים מֻגְדָּרִים בְּקֹבֶץ טֶקְסְט שֶׁמְּנוּהָל בִּגְ׳יט.",
            definitionNative = "Подход: серверы, сети и БД описаны в текстовом файле под Git-управлением.",
            example = "מַעֲבָר לְאִינְפְרַסְטְרוּקְטוּרָה כְּקוֹד חָסַךְ לָנוּ שָׁעוֹת קוֹנְפִיגוּרַצְיָה יַדָּנִית.",
        ...
        WordEntity(
            ...
            example = "אַרְטֵפַקְט בְּנִיָּה נִשְׁמַר בָּרֶגִיסְטְרִי הַפְּרָטִי שֶׁל הַחֶבְרָה.",
        ...
        WordEntity(
            ...
            example = "אַלֶרְט הִתְקַבֵּל בַּסֶּלֶק בִּשְׁתַּיִם בַּלַּיְלָה עַל זִכָּרוֹן מָלֵא.",
        ...
        WordEntity(
            ...
            definition = "פְּנִיָּה תְּקוּפָתִית קְצָרָה לַ|שֵּׁרֶת שֶׁבּוֹדֶקֶת אִם הוּא חַי וְעוֹנֶה כָּרָאוּי.",
        ...
        WordEntity(
            ...
            definition = "אִחוּד שׁוּרוֹת מֵהַרְבֵּה שֵׁרַתִּים לִמְקוֹם אֶחָד שֶׁבּוֹ קַל לְחַפֵּשׂ וּלְסַנֵּן.",
        ...
        WordEntity(
            ...
            definition = "מִסְגֶּרֶת רְבְעוֹנִית שֶׁל יַעַד שְׁאַפְתָּנִי וּכְמַסְפַּר תּוֹצָאוֹת מְדִידוֹת לְבִיצּוּעוֹ.",
        ...
        WordEntity(
            ...
            definition = "אֲחוּז הָאֲנָשִׁים שֶׁמַּמְשִׁיכִים לְהִכָּנֵס לַמּוּצָר אַחֲרֵי שָׁבוּעַ אוֹ חֹדֶשׁ.",
        ...
        WordEntity(
            ...
            definition = "אֲחוּז הַלָּקוֹחוֹת שֶׁמַּפְסִיקִים לְשַׁלֵּם אוֹ לְהִכָּנֵס בְּתוֹךְ פֶּרֶק זְמַן מֻגְדָּר.",
            definitionNative = "Доля клиентов, переставших платить или заходить за определённый период.",
            example = "נְטִישַׁת מִשְׁתַּמְּשִׁים גָּבוֹהַּ סִמֵּן לְבָעָיָה בִּשְׁלַב הָאוֹנְבּוֹרְדִּינְג.",
        ...
        WordEntity(
            ...
            definition = "הַשְׁוָאָה בֵּין שְׁתֵּי גִּרְסָאוֹת שֶׁל מָסָךְ כְּדֵי לִרְאוֹת אֵיזוֹ מֲבִּיאָה תּוֹצָאָה טוֹבָה יוֹתֵר.",
        ...
        WordEntity(
            ...
            example = "פִיצֶ׳ר פְּלָג אִפְשֵׁר לָנוּ לְהַחֲזִיר אֶת הַשִּׁנּוּי תּוֹךְ דַּקָּה.",
        ...
        WordEntity(
            ...
            definition = "בְּדִיקָה מְכֻוֶּנֶת שֶׁבָּהּ אִישׁ חִיצוֹנִי מְנַסֶּה לִפְרֹץ לַמַּעֲרֶכֶת כְּדֵי לִמְצֹא חוּלְשׁוֹת.",
        ...
        WordEntity(
            ...
            example = "מִבְדַּק אַבְטָחָה לִקְרַאת הַעֲלָאָה לַעֲנַן נִמְשָׁךְ שִׁשָּׁה שָׁבוּעוֹת.",
