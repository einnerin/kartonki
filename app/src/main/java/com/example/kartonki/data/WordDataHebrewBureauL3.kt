...
object WordDataHebrewBureauL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "אִם נוֹלַד יֶלֶד מוֹסִיפִים לָאֵם נִקּוּדוֹת זִכּוּי בַּטֹּפֶס.",
        ...
        WordEntity(
            ...
            exampleNative = "Новый репатриант получает פָּטוֹר מִמַּס на иностранную пенсию.", fillInBlankExclusions = listOf(180901L, 180902L, 180903L, 180904L)),
        ...
        WordEntity(
            ...
            exampleNative = "Зарплата пришла сегодня обычной הֶעֲבָרָה בַּנְקָאִית.", fillInBlankExclusions = listOf(180906L, 180908L, 180909L)),
        ...
        WordEntity(
            ...
            example = "הַקּוֹנֶה דָּרַשׁ נֶסַח טַאבּוּ עַדְכָּנִי לִפְנֵי הַחֲתִימָה.",
        ...
        WordEntity(
            ...
            example = "הַמִּנְהָל הוֹצִיא שֶׁטַר חֲכִירָה לְתִשְׁעִים וְתֵשַׁע שָׁנִים.",
            exampleNative = "Управление выдало שֶׁטָר חֲכִירָה на 99 лет.", fillInBlankExclusions = listOf(180911L, 180912L, 180913L, 180914L)),
        ...
        WordEntity(
            ...
            example = "עוֹרֵךְ הַדִּין הִסְבִּיר אֵילוּ סַעֲדִים יָשׁ לַמְּבֻטָּח.",
        ...
        WordEntity(
            ...
            example = "בְּלִי תְּעוּדַת בַּגְרוּת קָשֶׁה לְהִתְקַבֵּל לָאוּנִיבֶרְסִיטָה.",
        ...
        WordEntity(
            ...
            example = "מַעֲסִיקִים בִּקְּשׁוּ לִרְאוֹת תְּעוּדַת שִׁחְרוּר בָּרֵאָיוֹן.",
        ...
        WordEntity(
            ...
            example = "הַמַּעֲסִיק דָּרַשׁ מִרְשָׁם פְּלִילִי נָקִי לַעֲבוֹדָה עִם יְלָדִים.",
            exampleNative = "Работодатель потребовал чистый מִרְשָׁם פְּלִילִי для работы с детьми.", fillInBlankExclusions = listOf(180921L, 180922L, 180923L, 180924L)),
    )
}
