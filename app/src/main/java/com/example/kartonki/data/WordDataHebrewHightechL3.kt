...
object WordDataHebrewHightechL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "hightech_frontend",
        ...
        WordEntity(
            ...
            example = "כָּתַבְתִּי קוֹמְפּוֹנֶנְט שֶׁמּוּשַׁמַּשׁ בְּחָמֵשׁ עַמּוּדִים שׁוֹנִים בָּאֲתָר.",
        ...
        WordEntity(
            ...
            definition = "הַשָּׁלָב שֶׁבּוֹ הַדַּפְדְּפָן הוֹפֵךְ קוֹד לִתְּמוּנָה אֲמִיתִּית עַל הַמָּסָךְ.",
        ...
        WordEntity(
            ...
            definition = "כְּלִי שֶׁמְּאַחֵד הַרְבֵּה קָבְצֵי קוֹד לִקְבָצִים מְעַטִים שֶׁהַדַּפְדְּפָן טוֹעֵן מַהֵר.",
            definitionNative = "Инструмент, объединяющий много файлов кода в несколько — браузер грузит их быстрее.",
            example = "הַבַּנְדְּלֶר הֶחָדָשׁ הוֹרִיד אֶת זְמַן הַטְּעִינָה לְשַׁנִּיָּה אַחַת.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "hightech_backend",
        ...
        WordEntity(
            ...
            definition = "סִפְרִיָּה שֶׁמְּתַרְגֶּמֶת קוֹד תּוֹכְנָה לִשְׁאִילְתוֹת מַסָּד בְּלִי לִכְתֹּב SQL בַּיָּד.",
        ...
        WordEntity(
            ...
            definition = "תֵּאוּר שֶׁל מִבְנֶה הַמַּסָּד — אֵילוּ טַבְלָאוֹת קַיָּמוֹת וְאֵילוּ שָׂדוֹת בָּהֶן.",
        ...
        WordEntity(
            ...
            definition = "פְּקוּדָה שֶׁמַּגִּיעָה לַמַּסָּד וּמְבַקֶּשֶׁת לִקְרֹא אוֹ לְשַׁנּוֹת רְשׁוּמוֹת.",
        ...
        WordEntity(
            ...
            definition = "סְקְרִיפְּט שֶׁמְּשַׁנֶּה אֶת הַמַּסָּד מִגִּרְסָה אַחַת לַחֲדָשָׁה בְּלִי לְאַבֵּד נְתוּנִים.",
        ...
        WordEntity(
            ...
            definition = "הַעְתָּקָה אוֹטוֹמָטִית שֶׁל נְתוּנִים מִשָּׂרַת רָאשִׁי לְשָׂרָתִים מִשְׁנִיִּים.",
            definitionNative = "Автоматическое копирование данных с главного сервера на дополнительные.",
            example = "רֶפְּלִיקַצְיָה הִצִּילָה אוֹתָנוּ כְּשֶׁהַשָּׁרַת הָרִאשִׁי קָרַס בַּלַּיְלָה.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "hightech_cloud",
        ...
        WordEntity(
            ...
            example = "סְקֵיילִינְג אוֹטוֹמָטִי הַצִּיל אֶת הָאֲתָר בְּסוֹף שָׁבוּעַ שֶׁל מִבְצָע.",
        ...
        WordEntity(
            ...
            definition = "אֵזוֹר גֵּאוֹגְרָפִי שֶׁבּוֹ סַפַּק הָעֳנַן מַחֲזִיק חַוַּת שָׂרָתִים פִיסִית.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "hightech_arch_patterns",
        ...
        WordEntity(
            ...
            example = "שִׁכְבַת קֵישׁ מוּל הַמַּסָּד הוֹרִידָה אֶת זְמַן הַתְּגוּבָה לְעֶשֶׂר אַלַּפִּית הַשָּׁנִיָּה.",
        ...
        WordEntity(
            ...
            example = "הוֹסַפְנוּ לוֹאוּד בַּלַּנְסֶר מוּל שִׁשָּׁה שָׂרָתִים בִּשְׁעוֹת הַשִּׂיא.",
