...
object WordDataHebrewMobileL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "סְפְרִיָּה הַצְהָרָתִית לִבְנִיַּת מָסַכִּים בְּשׂוֹרוֹת קוֹד מְעַטוֹת.",
        ...
        WordEntity(
            ...
            definition = "מַעֲרֶכֶת הַמַּעֲבָרִים בֵּין מָסַכִּים — אֵיךְ הַמִּשְׁתַּמֵּשׁ מַגִּיעַ מִדַּף לְדַף.",
        ...
        WordEntity(
            ...
            definition = "רֶצֶף הַשְּׁלַבִּים שֶׁמָּסָךְ בְּאַנְדְרוֹייד עוֹבֵר — מֵהַיְצִירָה וְעַד הַסְּגִירָה.",
        ...
        WordEntity(
            ...
            definition = "רְכִיב שֶׁמַּחְזִיק נְתוּנֵי מָסָךְ וְשׂוֹרֵד סִיבּוּב מַכְשִׁיר וְשִׁנּוּי תֵּצוּגָה.",
