...
object WordDataHebrewHightechL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "כָּל הַחֶבְרָה הַחֲדָשָׁה רָצָה עַל פְּלַטְפוֹרְמָה אַחַת בַּעֲנַן.",
        ...
        WordEntity(
            ...
            example = "הָסַּיְט שֶׁל הַחֶבְרָה לֹא נִטְעַן הַבֹּקֶר בִּגְלַל תַּקָּלָה.",
        ...
        WordEntity(
            ...
            definition = "מְכוֹנָה חַשְׁמַלִּית שֶׁמְּעַבֶּדֶת מֵידָע וּמָרִיצָה תּוֹכְנוֹת.",
        ...
        WordEntity(
            ...
            definition = "מַכְשִׁיר קָטָן בַּיָּד שֶׁמָּזִיז אֶת הַסַּמָּן עַל הַמָּסָךְ.",
        ...
        WordEntity(
            ...
            example = "בָּאוֹפֶּן סְפֵייס שֶׁלָּנוּ קָשֶׁה לְהִתְרַכֵּז בְּלִי אָזְנִיּוֹת.",
        ...
        WordEntity(
            ...
            definition = "חֶדֶר סָגוּר עִם שֻׁלְחָן וּמָסַךְ לְשִׂיחוֹת חֲשׁוּבוֹת בְּלִי רַעַשׁ מִבַּחוּץ.",
        ...
        WordEntity(
            ...
            example = "אֲנִי אוֹהֵב לִכְתֹּב קוֹד עִם מוּזִיקָה בָּאָזְנִיּוֹת בַּלַּיְלָה.",
