...
object WordDataHebrewReligionYamimNoraim {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190702, setId = 1907, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "אַחֲרֵי הַסְּעוּדָה הָלַכְנוּ לְתַשְׁלִיךְ לְיַד הַנַּחַל.",
        ...
        WordEntity(id = 190705, setId = 1907, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "חֵלֶק מֶרְכָּזִי שֶׁל מוּסַף הַחַג, שֶׁעוֹסֵק בְּשִׁלְטוֹן הָאֵל עַל הָעוֹלָם וּמְלֻוֶּה בִּתְקִיעוֹת.",
        ...
        WordEntity(id = 190706, setId = 1907, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "חֵלֶק שֵׁנִי שֶׁל מוּסַף הַחַג, שֶׁמַּזְכִּיר אֶת זְכֻיּוֹת הָאָבוֹת וְאֶת בְּרִיתוֹת הֶעָבָר.",
            definitionNative = "Вторая часть праздничной службы мусаф — она напоминает о заслугах предков и заветах прошлого.",
            example = "בְּזִכְרוֹנוֹת הוּא תָּמִיד נִזְכַּר בְּאַבָּא שֶׁלּוֹ.",
        ...
        WordEntity(id = 190709, setId = 1907, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "טֶקֶס שֶׁבּוֹ הַמִּתְפַּלֵּל מוֹדֶה בְּכָל קוֹלוֹ בְּחֶלְקוֹ בָּעֲוְלוֹת שֶׁל הַצִּבּוּר, תּוֹךְ הַכָּאָה עַל הַחֲזֵה.",
            definitionNative = "Обряд, в котором молящийся вслух признаёт свою долю в общественных провинностях, ударяя себя по груди.",
            example = "בִּזְמַן הַוִּידּוּי הוּא הִכָּה עַל הַחֲזֵה לְאַט וּבְקוֹל.",
        ...
        WordEntity(id = 190711, setId = 1907, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "פְּתִיחָה קְצָרָה שֶׁל הַוִּידּוּי, שֶׁמּוֹנָה לְפִי סֵדֶר הָאוֹתִיּוֹת אֶת סוּגֵי הַעַוְלוֹת.",
            definitionNative = "Краткое вступление исповеди, перечисляющее в алфавитном порядке виды провинностей.",
            example = "כָּל הַקָּהָל פָּתַח בְּאַשָּׁמְנוּ בְּאוֹתוֹ הַטַּעַם.",
        ...
        WordEntity(id = 190713, setId = 1907, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תְּפִלָּה מֵרְכֶּזֶת בִּסְדָר הָעֲמִּידָה, שֶׁפּוֹתֵחַ כָּל בַּקָּשָׁה בְּפְנִיָּה כְּפוּלָה אֶל הָאֵל.",
            definitionNative = "Центральная молитва в порядке стоячего обращения — каждая просьба открывается двойным воззванием к Творцу.",
            example = "אָבִינוּ מַלְכֵּנוּ נֶאֱמַר עֲשָׂרוֹת פְּעָמִים בְּמֶשֶׁךְ הַחַג.",
        ...
        WordEntity(id = 190714, setId = 1907, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִזְמוֹר תְּהִילִּים קֶבוּעַ שֶׁפּוֹתֵחַ כָּל אַחַת מִשָּׁלוֹשׁ הַתְּפִלּוֹת שֶׁל הַיּוֹם.",
        ...
        WordEntity(id = 190719, setId = 1907, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מַעֲשֶׂה פְּנִימִי שֶׁל בְּדִיקַת הַמַּעֲשִׂים מֵרֹאשׁ הַחֹדֶשׁ אֱלוּל, כְּדֵי לְזַהוֹת אֶת הַטַּעֻיּוֹת.",
        ...
        WordEntity(id = 190720, setId = 1907, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "הִיא חָתְמָה אֶת הַמִּכְתָּב בְּגְּמַר חֲתִימָה טוֹבָה.",
        ...
        WordEntity(id = 190721, setId = 1907, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "בְּיוֹם הַדִּין הָאֲוִיר בְּבֵית הַכְּנֶסֶת קְשֵׁה וְשָׁקֵט.",
        ...
        WordEntity(id = 190723, setId = 1907, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "סָבַתָּא חָתְמָה אֶת הַגְּלוּיוֹת בְּלְשָׁנָה טוֹבָה תִּכָּתֵבוּ.",
        ...
        WordEntity(id = 190725, setId = 1907, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "חֵלֶק מְיֻחָד שֶׁל מוּסַף הַיּוֹם הַקָּדוֹשׁ, שֶׁמֻּקְדָּשׁ לִקְרוֹבִים שֶׁמֵּתוּ וּלְחַלְלֵי הָעָם.",
