...
object WordDataHebrewIdiomsL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definitionNative = "Чувство покоя и радости — без забот и душевной тяжести.",
        ...
        WordEntity(
            ...
            definitionNative = "Глубокая грусть или большая тревога, которая долго не отпускает.",
        ...
        WordEntity(
            ...
            definitionNative = "Глубокая эмоциональная боль после большого разочарования — обычно в любви.",
        ...
        WordEntity(
            ...
            definitionNative = "Что-то очень дорогое — цена огромная и платить сложно.",
        ...
        WordEntity(
            ...
            definitionNative = "Действует против собственных интересов — наносит себе вред без умысла.",
        ...
        WordEntity(
            ...
            definitionNative = "Молча принимает что-то тяжёлое и неприятное — за неимением выбора.",
