...
object WordDataHebrewIdiomsL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "סְכוּם קָטָן וְלֹא חָשׁוּב — לֹא שַׁוֵּה הַתִּעֲסָקוּת.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב לֹא נָעִים וְקָשֶׁה — קָשֶׁה לִמְצֹא פִּתְרוֹן וְהַכֹּל מִסְתַּבֵּךְ.",
            definitionNative = "Неприятное и тяжёлое положение — сложно найти выход, всё запутано. Дословно: «дрянное положение».",
            example = "בְּלִי עֲבוֹדָה וְעִם הַלְוָאָה זֶה מַצָּב בִּיֵּשׁ מְאֹד.",
        ...
        WordEntity(
            ...
            example = "הַסִּפּוּר שֶׁהוּא מְסַפֵּר זֶה מַשֶּׁהוּ הָזוּי לְגַמְרֵי.",
        ...
        WordEntity(
            ...
            example = "הָאֳכֵל בַּמִּסְעָדָה הַזֹּאת זֶה מַשֶּׁהוּ אַחֵר לְגַמְרֵי.",
        ...
        WordEntity(
            ...
            definition = "לֹא מְעַנְיֵן אוֹתוֹ — אֵין לוֹ עֶמְדָּה בְּעִנְיַן וְהוּא לֹא רוֹצֶה לְהִתְעַסֵּק.",
