...
object WordDataHebrewDataEngL3 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "מַסָּד מֶרְכָּזִי גָּדוֹל שֶׁאוֹסֵף נְתוּנִים מִמְּקוֹרוֹת רַבִּים — בְּשַׁבִּיל דּוּחוֹת וְאָנָלִיטִיקָה.",
            definitionNative = "Большая центральная база — собирает данные из многих источников для отчётов и аналитики.",
            example = "הַעֲבָרָה לְדָּאטָה וֵייְארְהָאוּס חָדָשׁ הוֹרִידָה אֶת זְמַן הַדּוּחוֹת.",
        ...
        WordEntity(
            ...
            definition = "אַחְסוּן זוֹל לְקָבְצֵי גַּלְמִי שׁוֹנִים — לוֹגִים, תְּמוּנוֹת, JSON — בְּלִי סְכֵמָה קְבוּעָה.",
        ...
        WordEntity(
            ...
            example = "כָּל הַקְבָצִים הַסְּטָטִיִּים שֶׁל הָאֲתָר יוֹשְׁבִים בְּ-S3.",
        ...
        WordEntity(
            ...
            definition = "פוֹרְמַט קְבָצִים דָּחוּס שֶׁשּׁוֹמֵר לְפִי עַמּוּדוֹת — קָרִיא מָהִיר בִּשְׁאֵילְתוֹת אָנָלִיטִיוֹת.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטַת שְׁמִירָה שֶׁבָּהּ כָּל עַמּוּדָה יוֹשֶׁבֶת בְּקֹבֶץ נִפְרָד — מְצֻיָּן לִקְרִיאָה שֶׁל שָׂדוֹת בּוֹדְדִים.",
        ...
        WordEntity(
            ...
            example = "עִבּוּד בָּאצ׳ יוֹמִי מְסַכֵּם אֶת כָּל הַעִסְקוֹת וְשׁוֹלֵחַ דּוּחַ לַהַנְהָלָה.",
        ...
        WordEntity(
            ...
            definition = "קְלִיטַת אֵירוּעִים אֶחָד אֶחָד מִיָּד עִם הַגָּעָתָם — בְּלִי לְחַכּוֹת לַחֲבִילָה גְּדוֹלָה.",
        ...
        WordEntity(
            ...
            definition = "שַׁרְשֶׁרֶת שֶׁל שְׁלַבִּים שֶׁמַּעֲבִירָה נְתוּנִים מִמָּקוֹר אֶחָד דֶּרֶךְ עִבּוּדִים עַד לַתּוֹצָאָה.",
            definitionNative = "Цепочка шагов, ведущая данные от источника через обработки к итогу.",
            example = "כָּל פַּיְיפְּלַיְין מְתֻעַד בִּקְרַיוֹן עִם בְּעָלִים אַחַרַאִי.",
        ...
        WordEntity(
            ...
            definition = "מָנוֹעַ עִבּוּד מַקְבִּילִי לְכַמֻּיּוֹת עֲצוּמוֹת — מְחַלֵּק עֲבוֹדָה בֵּין הַרְבֵּה מְכוֹנוֹת בַּעַת.",
        ...
        WordEntity(
            ...
            definition = "תַּבְנִית עִבּוּד מַקְבִּילִי בִּשְׁנֵי שְׁלַבִּים — קוֹדֶם מְמַפִּים כָּל פְּרִיט וְאַחַר כָּךְ מְצַמְצְמִים יַחַד.",
        ...
        WordEntity(
            ...
            definition = "שְׁלַב יָקָר שֶׁבּוֹ נְתוּנִים זוֹרְמִים בֵּין מְכוֹנוֹת בְּאֶשְׁכּוֹל כְּדֵי לְקַבֵּץ לְפִי מַפְתֵּחַ מְשֻׁתָּף.",
            definitionNative = "Дорогой шаг — данные текут между машинами в кластере, чтобы сгруппироваться по общему ключу.",
            example = "צִמְצַמְנוּ שַׁאפְּל וְהוֹרַדְנוּ אֶת מֶשֶׁךְ הַג׳וֹב מִשָּׁעָה לִשְׁמוֹנֶה דַּקּוֹת.",
        ...
        WordEntity(
            ...
            example = "אֵיירְפְלוֹאוּ שׁוֹלֵחַ הַתְרָעָה לִסְלֶק כְּשֶׁמְּשִׂימָה נוֹפֶלֶת בָּאֶמְצַע הַלַּיְלָה.",
        ...
        WordEntity(
            ...
            definition = "תַּרְשִׁים שֶׁל מְשִׂימוֹת בְּלוּלְאוֹת — חִצִּים מַרְאִים מָה רָץ אַחֲרֵי מָה וְלֹא חוֹזְרִים אָחוֹרָה.",
            definitionNative = "Схема задач без циклов — стрелки показывают, что после чего идёт, и не возвращаются назад.",
            example = "כָּל פַּיְיפְּלַיְין מוּגְדָּר בִּקְוַבֶץ פַּיְתוֹן שֶׁמַּחְזִיר דֵּיאַג שָׁלֵם.",
        ...
        WordEntity(
            ...
            example = "הַמְּתַזְמֵן הִפְעִיל אֶת הָעִבּוּד מִיָּד אַחֲרֵי שֶׁהַקֹּבֶץ נָחַת בְּ-S3.",
        ...
        WordEntity(
            ...
            example = "בֶּקְפִיל שֶׁל חֹדֶשׁ אֶחָד לָקַח לָאֶשְׁכּוֹל אַרְבַּע שָׁעוֹת רְצוּפוֹת.",
        ...
        WordEntity(
            ...
            example = "צֶוֶות אֵיכוּת דָּאטָה מָרִיץ מֵאָה בְּדִיקוֹת אוֹטוֹמָטִיּוֹת בְּכָל בֹּקֶר.",
        ...
        WordEntity(
            ...
            example = "אֲכִיפַת סְכֵמָה בִּכְנִיסָה תָּפְסָה שָׂדֶה חָדָשׁ שֶׁהוֹסִיפוּ בְּלִי לְעַדְכֵּן.",
