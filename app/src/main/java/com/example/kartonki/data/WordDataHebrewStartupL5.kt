...
object WordDataHebrewStartupL5 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_finance",
            original = "רַאנְוֵוי", translation = "runway (запас денег по времени)",
            definition = "מִסְפַּר הַחָדָשִׁים שֶׁבָּהֶם הַסְּטַרְטְאַפּ שׂוֹרֵד עַד שֶׁהַכֶּסֶף נִגְמַר.",
            definitionNative = "Сколько месяцев стартап продержится, пока деньги на счёте не кончатся.",
            example = "נִשְׁאַר לָנוּ רַאנְוֵוי שֶׁל שִׁשָּׁה חֳדָשִׁים בִּלְבַד.",
        ...
        WordEntity(
            ...
            definition = "מָה שֶׁנִּשְׁאַר מֵהַהַכְנָסוֹת אַחֲרֵי כָּל הוֹצָאוֹת הַתִּפְעוּל לִפְנֵי מִסִּים וְרִיבִּית.",
            definitionNative = "Что остаётся от выручки после всех операционных расходов — до налогов и процентов.",
            example = "שׁוּלֵי תְפִעוּל שְׁלִילִיִּים בָּרֶבַע הָאַחֲרוֹן הִדְלִיקוּ נוּרָה אֲדֻמָּה אֵצֶל הַבּוֹרֵד.",
        ...
        WordEntity(
            ...
            example = "בְּלִי יוּנִיט אֵקוֹנוֹמִיקְס חִיּוּבִי אֵין סִכּוּי לִצְמוֹחַ בְּרִיא.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_governance",
            original = "בּוֹרְד", translation = "совет директоров",
            definition = "קְבוּצָה שֶׁל אֲנָשִׁים בַּכִּירִים שֶׁמְּפַקְּחִים עַל הַמְּנַכָּ\"ל וְעַל הַחֲלָטוֹת אֶסְטְרָטֶגִיּוֹת.",
            definitionNative = "Группа старших людей, которые контролируют гендиректора и стратегические решения.",
            example = "הַבּוֹרֵד הִתְכַּנֵּס בְּחֵיפָה כְּדֵי לְאַשֵּׁר אֶת תַּקְצִיב הַשָּׁנָה הַבָּאָה.",
        ...
        WordEntity(
            ...
            definition = "חֲבֵר בּוֹרְד שֶׁאֵין לוֹ אִינְטֶרֶס בַּחֶבְרָה — נִכְלַל לְשִׁמּוּר אִיזוּן וְשַׁקִּיפוּת.",
            definitionNative = "Член борда без личного интереса в компании — нужен для баланса и прозрачности.",
            example = "הוֹסַפְנוּ דִּירֶקְטוֹר חִיצוֹנִי לִפְנֵי הָרַאוּנְד הַבָּא לְהַרְאוֹת בַּגְרוּת אִרְגוּנִית.",
        ...
        WordEntity(
            ...
            definition = "חוֹבָה שֶׁל הַחֶבְרָה לִשְׁלֹחַ נְתוּנִים פִינַנְסִיִּים לְבַעֲלֵי מְנָיוֹת בִּזְמַן קָבוּעַ.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_growth",
        ...
        WordEntity(
            ...
            definition = "אֲחוּז הַמִּשְׁתַּמְּשִׁים שֶׁעוֹזְבִים אֶת הַשֵּׁרוּת בְּתוֹךְ פֶּרֶק זְמַן קָבוּעַ.",
        ...
        WordEntity(
            ...
            definition = "כֶּסֶף נוֹסָף שֶׁבָּא מִלָּקוֹחוֹת קַיָּמִים שֶׁעָבְרוּ לַחֲבִילָה גְּדוֹלָה יוֹתֵר.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_late_stage",
            original = "הַלְוָאַת גֶּשֶׁר", translation = "бридж-раунд (промежуточное финансирование)",
            definition = "מַתַּן כֶּסֶף קָצָר טְוָח שֶׁמַּחֲזִיק אֶת הַחֶבְרָה עַד הַסִּיבּוּב הַגָּדוֹל הַבָּא.",
        ...
        WordEntity(
            ...
            definition = "סְעִיף שֶׁמֵּגֵן עַל מַשְׁקִיעַ מִיְּרִידָה בְּשׁוֹוִי הַחֵלֶק שֶׁלּוֹ בַּסִּיבּוּב הַבָּא.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "startup_exit_paths",
            ...
            example = "רוֹכֵשׁ אִסְטְרָטֶגִי מֵאָמֵרִיקָה סָגַר אִתָּנוּ עִסְקָה שֶׁל מִילְיַארְד.",
        ...
        WordEntity(
            ...
            example = "קוֹנֶה פִינַנְסִי נִגְשַׁר עִמָּנוּ עַל הַעֲרָכָה נְמוּכָה מֵהַתַּאֲגִיד.",
        ...
        WordEntity(
            ...
            definition = "חֶשְׁבּוֹן צַד שְׁלִישִׁי שֶׁמַּחֲזִיק כֶּסֶף עַד שֶׁכָּל הַתְּנָאִים שֶׁל הָעִסְקָה מִתְמַלְּאִים.",
