...
object WordDataHebrewEntertainmentL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הַמְּפַקֵּחַ עֶלְיוֹן הִגִּיעַ לַסְּטוּדְיוֹ לְפַקֵּחַ עַל הָעֲרִיכָה הַסּוֹפִית.",
        ...
        WordEntity(
            ...
            definition = "מְלָאכָה שֶׁל מְצִיאַת מְקוֹמוֹת אֲמִתִּיִּים שֶׁבָּהֶם נִתַּן לְצַלֵּם סֵרֶט.",
        ...
        WordEntity(
            ...
            definition = "כָּל מָה שֶּׁעוֹשִׂים לַסֵּרֶט אַחֲרֵי הַצִּלּוּם — עֲרִיכָה, צֶבַע, מוּסִיקָה וְאֶפֶקְטִים.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "entertainment_festivals",
        ...
        WordEntity(
            ...
            example = "הַבְּכוֹרָה עוֹלָמִית הִתְקַיְּמָה בְּקָאן עִם הַשַּׂחְקָנִים עַל הַשָּׁטִיחַ הָאָדֹם.",
        ...
        WordEntity(
            ...
            example = "סִרְטָם הַקָּצָר נִכְנַס לְמִבְחַר רִשְׁמִי בִּשְׁלוֹשָׁה פֶסְטִיבָלִים גְּדוֹלִים.",
        ...
        WordEntity(
            ...
            example = "הַקּוֹמֶדְיָה הָעַנְוָה לָקְחָה אֶת פְּרָס הַקָּהָל בָּעֶרֶב הַסִּיּוּם.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "entertainment_gaming",
        ...
        WordEntity(
            ...
            example = "הוּא קָנָה בָּטֶל פָּאס חָדָשׁ כְּדֵי לְקַבֵּל אֶת מַעֲרֶכֶת הַסְּקִינִים הַנַּדִּירָה.",
        ...
        WordEntity(
            ...
            definition = "מֲשִּׂימוֹת, מַפּוֹת אוֹ פְּרִיטִים נוֹסָפִים שֶׁמּוֹסִיפִים לַמִּשְׂחָק אַחֲרֵי יְצִיאָתוֹ.",
        ...
        WordEntity(
            ...
            definition = "מִפְגַּשׁ מְקֻוָּן שֶׁבּוֹ חֲבֵרִים רוֹאִים יַחַד אֶת אוֹתָהּ הַתָּכְנִית עִם צַ'אט.",
        ...
        WordEntity(
            ...
            example = "הַשֵּׁרוּת בָּחַר בְּשִׁחְרוּר מָסִּיבִי כְּדֵי לְעוֹדֵד מָרָתוֹן עַל הַסַּפָּה.",
        ...
        WordEntity(
            ...
            definition = "מִסְפַּר הַמַּרְאֶה כַּמָּה אֲנָשִׁים הִתְחַבְּרוּ לְתָכְנִית אוֹ שִׁדּוּר.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "entertainment_creative",
        ...
        WordEntity(
            ...
            example = "רַכַּז אִינְטִימִיּוּת מִצְטָרֵף הַיּוֹם כִּמְעַט לְכָל צִלּוּם גָּדוֹל מִיּוֹם הַפְּתִיחָה.",
