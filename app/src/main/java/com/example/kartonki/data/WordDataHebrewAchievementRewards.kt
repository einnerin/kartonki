...
object WordDataHebrewAchievementRewards {
    ...
    fun achievementRewardWords(): List<WordEntity> = listOf(
        ...
        WordEntity(id = 999900, original = "דֶּגֶם", translation = "образец / шаблон / парадигма", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999901, original = "לְהַשִּׂיג", translation = "достигать / добиваться", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999902, original = "עִקְבִי", translation = "последовательный / постоянный", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999903, original = "לְהַקְדִּישׁ", translation = "посвящать / уделять (время, силы)", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999904, original = "לְהִצְטַיֵּין", translation = "преуспевать / выделяться", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999905, original = "מַסְקָנָה", translation = "вывод / умозаключение", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999906, original = "הַשְׁעָרָה", translation = "гипотеза / предположение", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999907, original = "לְהַפְרִיךְ", translation = "опровергать", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999908, original = "לְבָאֵר", translation = "разъяснять", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999909, original = "שׁוֹטֵף", translation = "свободно владеющий / беглый", rarity = "EPIC", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999910, original = "שָׁקוּף", translation = "прозрачный", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999911, original = "קוֹדֵר", translation = "мрачный / угрюмый", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999912, original = "סוֹעֵר", translation = "бурный / буйный", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999913, original = "סָבוּךְ", translation = "запутанный / сложный для понимания", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999914, original = "רַאֲוָתָנִי", translation = "показной / мишурный", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999915, original = "צָלוּל", translation = "ясный / кристально чистый", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999916, original = "שִׁגְרָתִי", translation = "рутинный / банальный", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999917, original = "כָּמוּס", translation = "скрытый / сокровенный", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999918, original = "רַעַם", translation = "гром / громовой раскат", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999919, original = "בִּלְתִּי-נִמְחָק", translation = "неизгладимый / нестираемый", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999920, original = "נִצְחִי", translation = "вечный", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999921, original = "צֹרֶךְ", translation = "насущная потребность / нужда", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999922, original = "דִּמּוּי", translation = "сравнение / образ (фигура речи)", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999923, original = "סוֹלִיפְּסִיזְם", translation = "солипсизм", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999924, original = "חַד-עַיִן", translation = "проницательный / зоркий", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999925, original = "פָּלִימְפְּסֶסְט", translation = "палимпсест (рукопись поверх стёртой)", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999926, original = "אֲנִי-מֶרְכָּזִי", translation = "эгоцентричный / солипсистский", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999927, original = "בֵּין-טֶקְסְטוּאָלִיּוּת", translation = "интертекстуальность", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999928, original = "הַקְדָּמָה", translation = "предвосхищение / упреждение", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999929, original = "אָדִישׁ", translation = "безразличный / беззаботный", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999930, original = "מְלִיצִי", translation = "высокопарный / цветистый", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999931, original = "פַּחְדָן", translation = "трусливый / малодушный", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "adjective", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999932, original = "לְהִתְאַבֵּן", translation = "окостеневать / коснеть", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999933, original = "לְהָחִישׁ", translation = "ускорять / приближать наступление", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999934, original = "לְכַלּוֹת", translation = "изнашивать / истощать", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999935, original = "לְמַמֵּשׁ", translation = "овеществить / воплотить", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999936, original = "לְהִסְתַּעֵף", translation = "разветвляться", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999937, original = "פְּרִיחָה", translation = "расцвет / пышное цветение", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "noun", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999938, original = "לְהִתְפַּשֵּׁט", translation = "распространяться / разрастаться", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
        ...
        WordEntity(id = 999939, original = "לְהַפְרוֹת", translation = "приносить плоды / оплодотворять идеей", rarity = "LEGENDARY", setId = 0, languagePair = "he-ru", pos = "verb", semanticGroup = "achievement_reward",
