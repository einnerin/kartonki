...
object WordDataHebrewAppearanceL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הֲרוֹקֶר עָלָה לַבָּמָה עִם רַעְמָה שְׁחֹרָה וּפְרוּעָה.",
        ...
        WordEntity(
            ...
            example = "סַבָּא מַחְבִּיא אֶת הַקָּרַחַת מִתַּחַת לְכוֹבַע מַצְחִיָּה.",
        ...
        WordEntity(
            ...
            example = "הוּא עָשָׂה הַעֲוָיָה כְּשֶׁטַּעַם אֶת הַמָּרָק הַחֲמוּץ.",
        ...
        WordEntity(
            ...
            definition = "מִי שֶׁגּוּפוֹ נָמוּךְ וְצָפוּף, רָחָב וְחָזָק לְמַרְאֶה.",
        ...
        WordEntity(
            ...
            example = "חֲתוּל רְחוֹב כָּחוּשׁ הִתְקָרֵב לַשֻּׁלְחָן וְחִכָּה לְפֵרוּרִים.",
        ...
        WordEntity(
            ...
            example = "הוּא לִחֶץ עַל הָרַקָּה בְּגַלַּל כְּאֵב רֹאשׁ חָזָק.",
        ...
        WordEntity(
            ...
            definition = "צִיּוּר אוֹ מִלָּה שֶׁמַּכְנִיסִים לְתוֹךְ הָעוֹר בְּדְיוֹ — נִשְׁאַר לְכָל הַחַיִּים.",
        ...
        WordEntity(
            ...
            definition = "נְקֻדָּה חוּמָה אוֹ שְׁחֹרָה קְטַנָּה עַל הָעוֹר שֶׁאָדָם נוֹלַד אִתָּהּ אוֹ צוֹמֵחַ.",
