...
object WordDataHebrewPsychologyBiases {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190001, setId = 1900, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "נְטִיָּה לִשְׂיִם לֵב לָעֻבְדּוֹת שֶׁתּוֹמְכוֹת בְּעֶמְדָּתְךָ וּלְהִתְעַלֵּם מִכָּל מָה שֶּׁסּוֹתֵר אוֹתָהּ.",
            definitionNative = "Привычка замечать факты в поддержку своей позиции и обходить вниманием то, что ей мешает.",
            example = "הוּא קוֹרֵא רַק שְׁלוֹשָׁה אֲתָרִים שֶׁל דֵּעוֹתָיו — הַטָּיַת אִישּׁוּר טִיפּוּסִית.",
        ...
        WordEntity(id = 190002, setId = 1900, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "נְטִיָּה לִזְכֹּר טוֹב יוֹתֵר אֶת מָה שֶּׁקָּרָה לָאַחֲרוֹנָה וְלִשְׁכֹּחַ מָה שֶּׁהָיָה קֹדֶם.",
            definitionNative = "Склонность лучше запоминать последнее по времени и забывать всё, что было раньше.",
            example = "הַמְּנַהֵל זָכַר רַק אֶת הַחֹדֶשׁ הָאַחֲרוֹן — הַטָּיַת הָאַחֲרוֹנוּת בַּהַעֲרָכָה.",
        ...
        WordEntity(id = 190003, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "אַחֲרֵי הַמַּשְׁבֵּר כָּל הָאַנָּלִיסְטִים אָמְרוּ «רָאִינוּ» — הַטָּיַת בְּדִיעֲבַד טְהוֹרָה.",
        ...
        WordEntity(id = 190004, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "מוּעֲמָדִים שֶׁדִּבְּרוּ רִאשׁוֹנִים בָּרֵאָיוֹן זָכוּ בְּיֶתֶר זְכִירָה — אֶפֶקְט הָרִאשׁוֹנוּת.",
        ...
        WordEntity(id = 190005, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "כְּלַל הַשִּׂיא וְהַסּוֹף מַסְבִּיר לָמָּה כְּאֵב חַד בַּסּוֹף מַשְׁכִּיחַ שָׁעוֹת נוֹחוֹת.",
        ...
        WordEntity(id = 190007, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            definition = "מַתַּן מִשְׁקַל יֶתֶר לְמִקְרֶה פְּרָטִי חַי וְהִתְעַלְּמוּת מִכַּמָּה נָדִיר אוֹ שָׁכִיחַ הָאֵרוּעַ בָּאֻכְלוּסִיָּה.",
        ...
        WordEntity(id = 190009, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "בִּקֹּרֶת אַחַת קְשַׁה זְכוּרָה יוֹתֵר מֵעֶשֶׂר מַחְמָאוֹת — הַטָּיָה שְׁלִילִית.",
        ...
        WordEntity(id = 190010, setId = 1900, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "הִיצָּמְדוּת לַמִּסְפָּר אוֹ לָעֻבְדָּה הָרִאשׁוֹנָה שֶׁשּׁוֹמְעִים וְשִׁפּוּט כָּל מָה שֶּׁבָּא אַחֲרֶיהָ מוּלָהּ.",
            definitionNative = "Прицепление к первому услышанному числу или факту и оценка всего последующего относительно него.",
            example = "תִּמְחוּר סַפָּה בְּתִשַׁע מֵאוֹת הוֹפֵךְ אַרְבַּע מֵאוֹת לְזוֹל — הַטָּיַת עִגּוּן.",
        ...
        WordEntity(id = 190013, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "זָכָה — «הָיִיתִי טוֹב»; הִפְסִיד — «הַשּׁוֹפֵט גָּנַב» — הַטָּיָה שֶׁל שֵׁרוּת עַצְמִי.",
        ...
        WordEntity(id = 190014, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הַמְּנַהֵל מְקַדֵּם בּוֹגְרֵי אוֹתָהּ אוּנִיבֶרְסִיטָה — הַטָּיַת קְבוּצַת פְּנִים בְּגִיּוּס.",
        ...
        WordEntity(id = 190015, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הוּא הָיָה בָּטוּחַ שֶׁכֻּלָּם נֶגֶד הַחֹק — אֶפֶקְט הַקּוֹנְסֶנְזוּס הַשַּׁקְרִי.",
        ...
        WordEntity(id = 190017, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הִיא לֹא הֶחְלִיפָה קֻפַּת חוֹלִים יְקָרָה שָׁנִים — הַטָּיַת סְטָטוּס קְווֹ.",
        ...
        WordEntity(id = 190020, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "הוּא לֹא בָּדַק תִּיק הַשְׁקָעוֹת חֲצִי שָׁנָה — אֶפֶקְט הַיָּעֵן בַּמַּשְׁבֵּר.",
        ...
        WordEntity(id = 190022, setId = 1900, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "אֲנָשִׁים מַעֲרִיכִים שֶׁדְּבָרִים רָעִים יִקְרוּ דַּוְקָא לַאֲחֵרִים וְלֹא לָהֶם.",
            definitionNative = "Люди считают, что плохое случится скорее с другими, а не с ними.",
            example = "הוּא נָהַג בְּלִי חֲגוֹרָה — «לִי זֶה לֹא יִקְרֶה» — הַטָּיַת אוֹפְטִימִיזְם.",
        ...
        WordEntity(id = 190025, setId = 1900, languagePair = "he-ru", rarity = "EPIC",
            ...
            example = "סִפּוּרֵי מִילְיַארְדֵרִים מַסְתִּירִים אַלְפֵי כִּשְׁלוֹנוֹת — הַטָּיַת הַשּׂוֹרְדִים.",
