...
object WordDataHebrewIdiomsModernSlang {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 191204, setId = 1912, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "בִּטּוּי מַשְׁבָּח לִתְכוּנָה אוֹ חֲוָיָה — בֶּאֱמֶת אֵין הֶמְשֵׁךְ מֵעֵבֶר לְכָךְ.",
        ...
        WordEntity(id = 191206, setId = 1912, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "תְּמִיהָה עַל מַצָּב לֹא הָגְיוֹנִי, רֵיק מִתַּכְלִית: אֵיךְ הִגַּעְנוּ לְכָאן.",
        ...
        WordEntity(id = 191214, setId = 1912, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מִילַּת מַעֲבָר לְנְקֻדָּה הָעִקָּרִית בְּלִי הַקְדָּמוֹת — נְפוֹצָה בְּדִיּוּן עִסְקִי וְחֶבְרָתִי.",
        ...
        WordEntity(id = 191220, setId = 1912, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "תֵּאוּר עֲבוֹדָה שֶׁנַּעֲשְׂתָה בְּחֹסֶר רְצִינוּת — בִּמְהִירוּת, בְּלִי תְּשׂוּמַת לֵב לַפְּרָטִים.",
        ...
        WordEntity(id = 191222, setId = 1912, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מִילַּת מַעֲבָר לְמַשֶּׁהוּ זַנִּיחַ אוֹ הַבְהָרָה שֶׁאֵין מַשְׁמָעוּת מְיֻחֶדֶת לְמַעֲשֶׂה.",
