...
object WordDataHebrewWaiterL4 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "הַגָּשַׁת בַּקְבּוּק כָּךְ שֶׁהַמְּחִיר אֵינוֹ נֶחְשָׂף לִשְׁאַר הַסּוֹעֲדִים.",
            definitionNative = "Подача бутылки так, чтобы цена не показывалась остальным сидящим за столом.",
            example = "הַסְתָּרַת תָּו חוֹסֶכֶת מֲבוּכָה בִּפְגִישׁוֹת עִסְקִיּוֹת.",
        ...
        WordEntity(
            ...
            example = "עִרְעוּר עַל חֶשְׁבּוֹן נִפְתַּר אַחֲרֵי שֶׁהַמַּלְצָר הִדְפִּיס פֵּרוּט מְחוּדָּשׁ.",
        ...
        WordEntity(
            ...
            definition = "מַתַּן שֵׁרוּת אוֹ מָנָה בְּחִנָּם כְּדֵי לְפַיֵּס מִישֶׁהוּ שֶׁנִּפְגַּע מֵהָעָסֵּק.",
        ...
        WordEntity(
            ...
            example = "טַעֲנָה לֵגִיטִימִית לְגַבֵּי בָּשָׂר חַי הוֹבִילָה לְהַחְלָפָה מִיָּדִית.",
        ...
        WordEntity(
            ...
            example = "פְּרִיסַת מְזַלְּגוֹת לְבַּנְקֵט גְּדוֹלָה אוֹרֶכֶת שָׁעָה בְּמוּחָץ.",
        ...
        WordEntity(
            ...
            definition = "מִלִּים קַצָּרוֹת וְחִיּוּךְ שֶׁמְּקַדְּמִים בָּהֶם אֶת הַבָּאִים בַּפֶּתַח.",
            definitionNative = "Короткие слова и улыбка, которыми встречают входящих в зале у двери.",
            example = "בִּרְכַּת קַבָּלַת פָּנִים נֶאֶמְרָה תָּמִיד בִּשְׁתֵּי שָׂפוֹת לַתַּיָּרִים.",
        ...
        WordEntity(
            ...
            example = "מֶרְחָק מְקֻצָּעִי נִשְׁמַר גַּם כְּשֶׁהָאוֹרֵחַ נִסָּה לֶהֱיוֹת חָבֵר.",
        ...
        WordEntity(
            ...
            example = "פָּעוֹלוֹת בְּדִיסְקְרֶצְיָה אִפְשְׁרוּ לַחֲבֵר לְהַפְתִּיעַ אֶת בַּת הַזּוּג בְּטַבַּעַת.",
        ...
        WordEntity(
            ...
            example = "טֲעִימָה רִשְׁמִית הִתְבַּצְּעָה עַל פִּי כָּל הַכְּלָלִים הַמְּקֻבָּלִים.",
