...
object WordDataHebrew {
    ...
    val prebuiltDecks: List<DeckSeed> = listOf(
        ...
        // 1 ── Иврит: Базовый компьютер (★★, set 1001, 21 words) ─────────────────
        DeckSeed(
        ...
        // 2 ── Иврит: Программирование (★★★★, sets 1002-1003, 21 words) ──────────
        DeckSeed(
        ...
        // 3 ── Иврит: Быт и общение (★, sets 1004-1007, 21 words) ────────────────
        DeckSeed(
        ...
        // 4 ── Иврит: IT и ИИ (★★★★★, sets 1014-1017, 21 words) ─────────────────
        DeckSeed(
            name = "Иврит: IT и ИИ",
            level = 5,
            languagePair = "he-ru",
        ...
        // 5 ── Иврит: Компьютерные игры (★★★★, set 1018, 21 words) ──────────────
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                // UNCOMMON ×7
                "נֶשֶׁק", "מִשִׁימָה", "דֶּמוּת", "רָמָה", "קְרָב", "צֶוֶת", "בּוֹס",
                // RARE ×6
                "אוֹצָר", "פֶּגַע", "מַגֵּן", "הִתְגַּנְּבוּת", "יְכוֹלֶת", "כֶּלֶא",
                // EPIC ×3
