...
object WordDataHebrew {
    ...
    val sets: List<WordSetEntity> = listOf(
        WordSetEntity(id = 1001, name = "Технологии", description = "Базовая компьютерная лексика", orderIndex = 0, languagePair = "he-ru",
            topic = "Технологии",
            level = 1),
        WordSetEntity(id = 1002, name = "Технологии",     description = "Термины программирования",          orderIndex = 1, languagePair = "he-ru",
            topic = "Технологии",
            level = 2),
        WordSetEntity(id = 1003, name = "Технологии",          description = "Продвинутая терминология",        orderIndex = 2, languagePair = "he-ru",
            topic = "Технологии",
            level = 4),
    )
