...
object WordDataHebrew {
    ...
    val sets: List<WordSetEntity> = listOf(
        WordSetEntity(id = 1001, name = "Технологии: основы — базовая компьютерная лексика", description = "Базовая компьютерная лексика", orderIndex = 0, languagePair = "he-ru",
            topic = "Технологии",
            level = 1),
        WordSetEntity(id = 1002, name = "Технологии: продвинутый — термины программирования",     description = "Термины программирования",          orderIndex = 1, languagePair = "he-ru",
            topic = "Технологии",
            level = 2),
        WordSetEntity(id = 1003, name = "Технологии: профессиональный — продвинутая терминология",          description = "Продвинутая терминология",        orderIndex = 2, languagePair = "he-ru",
            topic = "Технологии",
            level = 4),
    )
    ...
    private fun set3() = listOf(
        ...
        WordEntity(id = 100321, original = "מְכוֹנָה וִירְטוּאָלִית", transliteration = "mekhona virtualit", translation = "виртуальная машина",
            ...
            exampleNative = "Kubernetes — наиболее широко используемый manhe для контейнеризованных рабочих нагрузок.", isFillInBlankSafe = false),
        WordEntity(id = 100323, original = "אִרְגּוּן מֵחָדָשׁ", transliteration = "irgun mekhadash", translation = "рефакторинг",
            ...
            exampleNative = "Встроенная yetirut гарантирует, что сервис остаётся онлайн, даже если один сервер выходит из строя.", isFillInBlankSafe = false),
