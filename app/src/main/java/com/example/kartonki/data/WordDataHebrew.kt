...
object WordDataHebrew {
    ...
    private fun set1() = listOf(
        WordEntity(id = 100101, original = "מַחְשֵׁב", translation = "компьютер",
            definition = "מַכְשִׁיר אלקטרוני לעיבוד וְאִחְסוּן מֵידָע.",
            definitionNative = "Электронное устройство для хранения и обработки данных.",
            example = "מַחְשֵׁב מָהִיר יָכוֹל לְעַבֵּד מִילְיוֹנֵי פעולות בשנייה.",
        ...
        WordEntity(id = 100102, original = "עַכְבָּר", translation = "мышь (компьютерная)",
            definition = "הֶתְקֵן קֶלֶט שֶׁמְּזִיזִים עַל מִשְׁטָח לִשְׁלִיטָה בַּסַּמָּן הַמָּסָךְ.",
            definitionNative = "Устройство ввода, которое двигают по поверхности для управления курсором.",
            example = "עַכְבָּר אַלְחוּטִי נוֹחַ לשימוש עַל שולחן.",
        ...
        WordEntity(id = 100103, original = "מַקְלֶדֶת", translation = "клавиатура",
            definition = "הֶתְקֵן קֶלֶט עִם מַקְּשֵׁי אוֹתִיּוֹת, מִסְפָּרִים ופקודות.",
            definitionNative = "Устройство ввода с клавишами букв, цифр и команд.",
            example = "מַקְלֶדֶת מֵכָנִית יְקָרָה אַךְ נוֹחָה מְאוֹד.",
        ...
        WordEntity(id = 100104, original = "מָסָךְ", translation = "экран, монитор",
            definition = "תְּצוּגָה הַמַּצִּיגָה אֶת תְּמוּנַת הַמַּחְשֵׁב אוֹ הטלפון.",
            definitionNative = "Дисплей, на котором отображается изображение компьютера или телефона.",
            example = "מָסָךְ גָּדוֹל עוֹזֵר בַּעֲבוֹדָה עִם מִסְמָכִים.",
        ...
        WordEntity(id = 100105, original = "מַדְפֶּסֶת", translation = "принтер",
            definition = "מַכְשִׁיר הַמַּדְפִּיס טקסט וּתְמוּנוֹת מֵהַמַּחְשֵׁב עַל נייר.",
            definitionNative = "Устройство, которое переносит текст или изображения с компьютера на бумагу.",
            example = "מַדְפֶּסֶת לייזר מַדְפִּיסָה עֶשְׂרִים דַּפִּים בְּדַקָּה.",
        ...
        WordEntity(id = 100106, original = "קוֹבֶץ", translation = "файл",
            definition = "אוסף נְתוּנִים בַּעַל שֵׁם, שָׁמוּר בַּמַּחְשֵׁב.",
            definitionNative = "Именованный набор данных, хранящийся на компьютере.",
            example = "קוֹבֶץ גָּדוֹל לוֹקֵחַ זְמַן רַב לִפְתִיחָה.",
        ...
        WordEntity(id = 100107, original = "תִּיקִיָּה", translation = "папка",
            definition = "מִיכַל בְּמַעֲרֶכֶת הַקְּבָצִים לְאִחְסוּן וְאִרְגּוּן קְבָצִים.",
            definitionNative = "Контейнер в файловой системе для организации и хранения файлов.",
            example = "תִּיקִיָּה חֲדָשָׁה נוֹצְרָה בשולחן הָעֲבוֹדָה.",
        ...
        WordEntity(id = 100108, original = "שְׁמִירָה", translation = "сохранение",
            definition = "כְּתִיבַת נְתוּנִים לַדִּיסְק כְּדֵי לשמור שינויים.",
            definitionNative = "Запись данных на диск, чтобы не потерять изменения.",
            example = "שְׁמִירָה אוֹטוֹמָטִית מְגִנָּה עַל הָעֲבוֹדָה שֶׁלְּךָ.",
        ...
        WordEntity(id = 100109, original = "מְחִיקָה", translation = "удаление",
            definition = "הֲסָרַת קובץ אוֹ נְתוּנִים מֵהַמַּכְשִׁיר.",
            definitionNative = "Стирание файла или данных с устройства.",
            example = "מְחִיקָה שֶׁל קובץ שָׁגוּי גָּרְמָה לַבְּעָיָה.",
        ...
        WordEntity(id = 100110, original = "הַעְתָּקָה", translation = "копирование",
            definition = "יְצִירַת עותק מדויק שֶׁל קובץ אוֹ טקסט.",
            definitionNative = "Создание точной копии файла или текста.",
            example = "הַעְתָּקָה שֶׁל הקובץ אוֹרֶכֶת כַּמָּה שְׁנִיּוֹת.",
        ...
        WordEntity(id = 100111, original = "הַדְבָּקָה", translation = "вставка",
            definition = "הַנָּחַת טקסט אוֹ קובץ שהועתק במיקום חָדָשׁ.",
            definitionNative = "Размещение скопированного текста или файла в новом месте.",
            example = "הַדְבָּקָה שֶׁל הטקסט בוצעה בְּהַצְלָחָה.",
        ...
        WordEntity(id = 100112, original = "אֲתַר", translation = "сайт, веб-сайт",
            definition = "אוסף דַּפֵּי אינטרנט בַּעֲלֵי כתובת משותפת.",
            definitionNative = "Набор веб-страниц с общим адресом в интернете.",
            example = "אֲתָר חָדָשׁ נִפְתַּח לְהַרְשָׁמָה הַשָּׁבוּעַ.",
            exampleNative = "Найди информацию на официальном אֲתַר компании.",
        ...
        WordEntity(id = 100113, original = "דַּפְדְּפָן", translation = "браузер",
            definition = "תוכנה לִגְלִישָׁה וצפייה בַּאֲתָרֵי אינטרנט.",
            definitionNative = "Программа для просмотра сайтов в интернете.",
            example = "דַּפְדְּפָן מָהִיר חוֹסֵךְ זְמַן בִּגְלִישָׁה.",
        ...
        WordEntity(id = 100114, original = "דּוֹאַר אֶלֶקְטְרוֹנִי", translation = "электронная почта",
            definition = "מַעֲרֶכֶת לִשְׁלִיחָה וְקַבָּלָה שֶׁל הוֹדָעוֹת דֶּרֶךְ האינטרנט.",
            definitionNative = "Система отправки и получения сообщений через интернет.",
            example = "דּוֹאַר אֶלֶקְטְרוֹנִי הִגִּיעַ מֵהַמְּנַהֵל עִם מִסְמָךְ.",
        ...
        WordEntity(id = 100115, original = "סִיסְמָה", translation = "пароль",
            definition = "קוֹד סוֹדִי לְגִישָׁה לַחֶשְׁבּוֹן אוֹ לְמַכְשִׁיר.",
            definitionNative = "Секретная комбинация символов для доступа к аккаунту или устройству.",
            example = "סִיסְמָה חֲזָקָה מְגַנָּה עַל הַחֶשְׁבּוֹן שֶׁלְּךָ.",
        ...
        WordEntity(id = 100116, original = "קִישׁוּר", translation = "ссылка, гиперссылка",
            definition = "טקסט לָחִיץ אוֹ תְּמוּנָה הַמּוֹבִילִים לְדַף אַחֵר.",
            definitionNative = "Кликабельный текст или изображение, ведущее на другую страницу.",
            example = "קִישׁוּר שָׁבוּר לֹא מוֹבִיל לְשׁוּם מָקוֹם.",
        ...
        WordEntity(id = 100117, original = "הוֹרָדָה", translation = "скачивание, загрузка",
            definition = "הַעֲבָרַת קובץ מֵהָאִינְטֶרְנֵט אֶל הַמַּכְשִׁיר שֶׁלְּךָ.",
            definitionNative = "Перенос файла с интернета на ваше устройство.",
            example = "הוֹרָדָה שֶׁל הקובץ הושֶׁלמה בְּהַצְלָחָה.",
        ...
        WordEntity(id = 100118, original = "הַעֲלָאָה", translation = "загрузка на сервер",
            definition = "הַעֲבָרַת קובץ מֵהַמַּכְשִׁיר שֶׁלְּךָ אֶל האינטרנט אוֹ השרת.",
            definitionNative = "Перенос файла с вашего устройства в интернет или на сервер.",
            example = "הַעֲלָאָה שֶׁל תְּמוּנוֹת לוֹקַחַת זְמַן רַב.",
        ...
        WordEntity(id = 100119, original = "חִיפּוּשׁ", translation = "поиск",
            definition = "מְצִיאַת מֵידָע בְּאֶמְצָעוּת שְׁאִילְתָה.",
            definitionNative = "Процесс нахождения информации или файла с помощью запроса.",
            example = "חִיפּוּשׁ מָהִיר מָצָא אֶת הקובץ הַנָּכוֹן.",
        ...
        WordEntity(id = 100120, original = "עֵדְכּוּן", translation = "обновление",
            definition = "הַתְקָנַת גִּרְסָה חֲדָשָׁה שֶׁל תוכנה אוֹ מַעֲרֶכֶת הַפְעָלָה.",
            definitionNative = "Установка новой версии программы или операционной системы.",
            example = "עֵדְכּוּן חָדָשׁ זָמִין לְהוֹרָדָה הַיּוֹם.",
        ...
        WordEntity(id = 100121, original = "לְחִיצָה", translation = "клик, нажатие",
            definition = "פְּעוּלַת בְּחִירָה עַל כַּפְתּוֹר עַכְבָּר אוֹ מָסַךְ מַגָּע.",
            definitionNative = "Нажатие кнопки мыши или тачскрина для выбора или активации элемента.",
            example = "לְחִיצָה כְּפוּלָה עַל הַסֵּמֶל פּוֹתַחַת אֶת התוכנה.",
        ...
        WordEntity(id = 100122, original = "טֶלֶפוֹן", translation = "телефон, смартфон",
            definition = "מַכְשִׁיר נייד לְשִׂיחוֹת, הוֹדָעוֹת וּגְלִישָׁה באינטרנט.",
            definitionNative = "Мобильное устройство для звонков, сообщений и доступа в интернет.",
            example = "טֶלֶפוֹן חָכָם מחובר לָאִינְטֶרְנֵט תָּמִיד.",
        ...
        WordEntity(id = 100123, original = "טַבְלֶט", translation = "планшет",
            definition = "מַחְשֵׁב נייד עִם מָסַךְ מַגָּע לְלֹא מִקְלֶדֶת נִפְרֶדֶת.",
            definitionNative = "Мобильный компьютер с сенсорным экраном без отдельной клавиатуры.",
            example = "טַבְלֶט קַל לִנְשִׂיאָה וְנוֹחַ לִקְרִיאָה.",
        ...
        WordEntity(id = 100124, original = "אַפְלִיקַצְיָה", translation = "приложение",
            definition = "תוכנה המותקנת עַל טלפון, טאבלט אוֹ מַחְשֵׁב.",
            definitionNative = "Программа, установленная на телефон, планшет или компьютер.",
            example = "אַפְלִיקַצְיָה חֲדָשָׁה פורסמה בַּחֲנוּת היישומים.",
        ...
        WordEntity(id = 100125, original = "וִירוּס", translation = "вирус (компьютерный)",
            definition = "תוכנה זְדוֹנִית שֶׁמַּדְבִּיקָה מַכְשִׁיר וַעֲלוּלָה לְהַשְׁמִיד נְתוּנִים.",
            definitionNative = "Вредоносная программа, которая заражает устройство и может уничтожать данные.",
            example = "וִירוּס מסוכן הִדְבִּיק אֶת הַמַּחְשֵׁב.",
    ...
    val prebuiltDecks: List<DeckSeed> = listOf(
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                "סָבְתָא", "יֶלֶד", "יַלְדָּה", "תִּינוֹק",
                // UNCOMMON ×9
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                // COMMON ×12
                "קַנְיוֹן", "מִדָּה", "תָּא מְדִידָה", "מוֹדָה",
                "תָּוִית מְחִיר", "שְׁכֵנָה", "דַּיָּר", "לוּחַ מוֹדָעוֹת",
                "פַּח אַשְׁפָּה", "רַעַשׁ", "גֶּדֶר", "פַּעֲמוֹן",
                // UNCOMMON ×9
                "קִמְעוֹנָאִי", "קוּפּוֹן", "הַחְזָרַת מוּצָר", "הֶחְזֵר כֶּסֶף",
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                "כַּדּוּרְסַל", "יוֹגָה", "מֵרוֹץ", "גוֹלֶף",
                // UNCOMMON ×6
                "הִתְאַמְּנוּת", "מְאַמֵּן", "מַשְׁקֹלֶת", "קֵירוּר",
                "שְׁרִירִים", "תַּחֲרוּת",
                // RARE ×4
                "פֶּנַלְטִי", "הַדְחָקָה", "רוּגְבִּי", "אַלּוּפוֹת",
                // EPIC ×2
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                "הֲגַנָּה", "אִשּׁוּם", "תְּעוּדַת זֶהוּת", "מִסְמָךְ",
                // UNCOMMON ×6
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                // UNCOMMON ×7 — סִיסְמָה убран: cross-topic коллизия с Batch75/CyberL1 (там он COMMON);
                //                заменён на הַעֲלָאָה (upload) — только в setId=1001, без коллизий
                "מַדְפֶּסֶת", "מְחִיקָה", "הַעְתָּקָה", "הַדְבָּקָה",
                "דַּפְדְּפָן", "הַעֲלָאָה", "קִישׁוּר",
                // RARE ×6
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                // UNCOMMON ×7
                "דְּמֵי נְסִיעָה", "רִישְׁיוֹן", "תְּאוּנָה", "עֹדֶף",
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                "בּוֹנוּס שְׁנָתִי", "אוֹפְּצִיּוֹת", "הַכָּרָה רִשְׁמִית", "שְׁחִיקָה תַּעֲסוּקָתִית",
                // EPIC ×5
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                // EPIC ×7 — פוֹבְּיָה убран: cross-topic коллизия (Batch71 setId=1439 → UNCOMMON
                //                перезаписывает EPIC из Batch21 setId=1087). Заменён на
                //                פְּסִיכוֹדִינַמִיקָה (psychodynamics) — без коллизий, EPIC.
                "נוֹרוֹזָה", "פְּסִיכוֹדִינַמִיקָה", "סְכִיזוֹפְרֵנְיָה", "הִתְמַכְּרוּת",
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                "מַהֲלַךְ נֶטוֹ אֶפֶס", "טְבִיעַת רֶגֶל אֶקוֹלוֹגִית", "מִגְוָון בִּיוֹלוֹגִי", "שִׁיקּוּם סְבִיבָתִי",
                // EPIC ×7
        ...
        DeckSeed(
            ...
            wordOriginals = listOf(
                ...
                "שָׂר", "קוֹאָלִיצְיָה",
                // EPIC ×10 — גָּלוּת/יְשִׁיבָה поменяны местами (effective rarity была обратной)
                "הַכְרָזַת הָעַצְמָאוּת", "כ״ט בְּנוֹבֶמְבֶּר", "מְגִלַּת הָעַצְמָאוּת", "מִלְחֶמֶת שֵׁשֶׁת הַיָּמִים",
                "מִלְחֶמֶת יוֹם הַכִּפּוּרִים", "יְשִׁיבָה", "אִינְתִיפָאדָה", "דָּוִד בֶּן-גּוּרְיוֹן",
                "גּוֹלְדָה מֵאִיר", "תֵּאוֹדוֹר הֶרְצֶל",
                // LEGENDARY ×5
                "הֲלָכָה", "תְּפוּצוֹת", "שְׁטֶעטְל", "גָּלוּת",
                "תַּלְמוּד",
            ),
        ),
