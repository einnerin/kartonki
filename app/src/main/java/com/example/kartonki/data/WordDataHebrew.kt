...
object WordDataHebrew {
    ...
    private fun set1() = listOf(
        ...
        WordEntity(id = 100104, original = "מָסָךְ", translation = "экран, монитор",
            definition = "תְּצוּגָה המציגה את תמונת המחשב או הטלפון.",
        ...
        WordEntity(id = 100110, original = "הַעְתָּקָה", translation = "копирование",
            ...
            example = "הַעְתָּקָה של הקובץ אורכת כַּמָּה שניות.",
        ...
        WordEntity(id = 100112, original = "אֲתַר", translation = "сайт, веб-сайт",
            ...
            example = "אֲתָר חדש נפתח להרשמה השבוע.",
        ...
        WordEntity(id = 100114, original = "דּוֹאַר אֶלֶקְטְרוֹנִי", translation = "электронная почта",
            ...
            example = "דּוֹאַר אֶלֶקְטְרוֹנִי הגיע מהמנהל עם מִסְמָךְ.",
        ...
        WordEntity(id = 100115, original = "סִיסְמָה", translation = "пароль",
            ...
            example = "סִיסְמָה חֲזָקָה מגנה על החשבון שלך.",
        ...
        WordEntity(id = 100119, original = "חִיפּוּשׁ", translation = "поиск",
            definition = "מציאת מידע באמצעות שְׁאִילְתָה.",
        ...
        WordEntity(id = 100120, original = "עֵדְכּוּן", translation = "обновление",
            definition = "התקנת גִּרְסָה חדשה של תוכנה או מערכת הפעלה.",
        ...
        WordEntity(id = 100123, original = "טַבְלֶט", translation = "планшет",
            definition = "מחשב נייד עם מָסַךְ מגע ללא מקלדת נפרדת.",
