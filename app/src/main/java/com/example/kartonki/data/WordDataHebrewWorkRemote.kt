...
object WordDataHebrewWorkRemote {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 190301, setId = 1903, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "הִיא עָבְרָה לַעֲבוֹדָה מִן הַבַּיִת אַחֲרֵי הוֹלֶדֶת בְּנָהּ.",
        ...
        WordEntity(id = 190304, setId = 1903, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "מָקוֹם בִּתְשָׁלוּם שַׁעֲתִי אוֹ חוֹדְשִׁי שֶׁבּוֹ פְרִילַנְסֵרִים וּצְוָתוֹת קְטַנִּים יוֹשְׁבִים יַחַד.",
            definitionNative = "Место с почасовой или месячной оплатой, где фрилансеры и маленькие команды сидят рядом.",
            example = "WeWork פָּתְחָה מֶרְחַב עֲבוֹדָה מְשׁוּתָּף בַּקּוֹמָה הָעֶשְׂרִים.",
        ...
        WordEntity(id = 190305, setId = 1903, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "אַחַת מֵרְצוּעוֹת הַכַּדּוּר שֶׁבָּהּ הַשָּׁעוֹן מַרְאֶה אוֹתָהּ שָׁעָה בְּכָל הַעֲרִים.",
            definitionNative = "Одна из полос земного шара, где часы показывают одно и то же время во всех городах.",
            example = "פָּגִישַׁת הַצֶּוֶת מְתֻאֶמֶת לְאֵזוֹר זְמַן שֶׁל קָלִיפוֹרְנְיָה.",
        ...
        WordEntity(id = 190308, setId = 1903, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "הוּא הֶעֱלָה אֶת תַּעֲרִיף שַׁעֲתִי לַחֲמִישִּׁים דּוֹלָר אַחֲרֵי שָׁנָה.",
        ...
        WordEntity(id = 190310, setId = 1903, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "זְחִילַת הֶיקֵף דָּחֲפָה אֶת הַאֲסַפְּקָהּ בִּשְׁלוֹשָׁה שָׁבוּעוֹת.",
        ...
        WordEntity(id = 190312, setId = 1903, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "הַצֶּוֶת מַחֲזִיק קַנְבָּן עַל קִיר הַחֶדֶר וּמֵזִיז פֶּתֶק כָּל יוֹם.",
        ...
        WordEntity(id = 190314, setId = 1903, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "כָּל אִיטֶרַצְיָה אָרְכָה שְׁבוּעַיִם וְהִסְתַּיְּמָה בְּהַדְגָּמָה לַלָּקוֹחַ.",
        ...
        WordEntity(id = 190315, setId = 1903, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "גִּישַׁת פִּתּוּחַ בְּמַחֲזוֹרִים קְצָרִים, שֶׁמַּעֲדִיפָה לָקוֹחַ עַל הֶסְכֵּם וּמְהִירוּת עַל תַּכְּנוּן רָחָב.",
        ...
        WordEntity(id = 190317, setId = 1903, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            definition = "מַצָּב שֶׁבּוֹ הָעוֹבֵד מַשְׁקִיעַ שָׁעוֹת רַבּוֹת מֵעַל הַנּוֹרְמָה וּמַגִּיעַ לַעֲיֵפוּת חֲמוּרָה.",
            definitionNative = "Состояние, когда сотрудник вкладывает много часов сверх нормы и доходит до сильной усталости.",
            example = "עֲבוֹדַת יֶתֶר שֶׁל שִׁשָּׁה חֳדָשִׁים פָּגְעָה לָהּ בַּשֵּׁנָה.",
        ...
        WordEntity(id = 190320, setId = 1903, languagePair = "he-ru", rarity = "RARE",
            ...
            definition = "תַּהֲלִיךְ סִיּוּם מְסוּדָּר שֶׁל עוֹבֵד עוֹזֵב: הַחֲזָרַת צִיּוּד, סְגִירַת גִּישׁוֹת וּפְגִישַׁת מָשְׁוֶב.",
            definitionNative = "Упорядоченное завершение работы увольняющегося: возврат техники, закрытие доступов и итоговая встреча.",
            example = "פְּרֵדָה אִרְגּוּנִית כָּלְלָה הַחֲזָרַת מַחְשֵׁב נַיָּד וּמָשְׁוֶב גָּלוּי.",
        ...
        WordEntity(id = 190323, setId = 1903, languagePair = "he-ru", rarity = "RARE",
            ...
            example = "תַּחֲנַת בִּקּוֹרֶת בַּחֲצִי הַדֶּרֶךְ חָשְׂפָה בָּעָיָה בָּעִיצּוּב.",
        ...
        WordEntity(id = 190324, setId = 1903, languagePair = "he-ru", rarity = "UNCOMMON",
            ...
            example = "הוּא הִנְפִּיק חֶשְׁבּוֹנִית עַל שְׁלוֹשִׁים שָׁעוֹת בְּסוֹף הַחֹדֶשׁ.",
