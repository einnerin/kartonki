...
object WordDataHebrewInterviewL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "פְּגִישָׁה רִשְׁמִית בֵּין מֻעָמָד לְמַעֲסִיק לִפְנֵי קַבָּלָה לָעֲבוֹדָה.",
        ...
        WordEntity(
            ...
            example = "הַמַּשְׂכֹּרֶת מִתְקַבֶּלֶת בַּחֶשְׁבּוֹן בַּעֲשִׂירִי לַחֹדֶשׁ.",
        ...
        WordEntity(
            ...
            example = "שָׁלְחוּ לִי כְּתֹבֶת מְדֻיֶּקֶת בְּוַואטְסְאַפּ לִפְנֵי הַשִּׂיחָה.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175206L, 175207L, 175208L, 175209L, 175212L)),
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175211L, 175212L, 175213L, 175214L)),
        ...
        WordEntity(
            ...
            example = "יֵשׁ לִי נִסָּיוֹן שֶׁל חָמֵשׁ שָׁנִים בְּתָחוּם הָעִצּוּב.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(175216L, 175217L, 175218L, 175219L)),
        ...
        WordEntity(
            ...
            definition = "מָה שֶּׁאָדָם אוֹמֵר אוֹ כּוֹתֵב כְּשֶׁמַּפְנִים אֵלָיו שְׁאֵלָה אוֹ פְּנִיָּה.",
         ...
         fillInBlankExclusions = listOf(175221L, 175222L, 175223L, 175224L)),
    )
}
