...
object WordDataHebrewBatch9 {
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "תְּכְשִׁיר לְטִיפּוּל בָּעּוֹר הַמְּשַׁמֵּשׁ לְלַחֲלוּחַ אוֹ הֲגְּנָה.",
        ...
        WordEntity(
            ...
            definition = "מָקוֹם הַמַּצִּיעַ שֵׁרוּתֵי אֱפּוּר, טִיפּוּחַ וְעִיצּוּב מַרְאֶה.",
            definitionNative = "Место, предлагающее услуги по макияжу, уходу и стайлингу.",
            example = "הָלְכָה לְסָלוֹן הַיֹּפִי לְעִיצּוּב שֵׂעָר לִפְנֵי הַחֲתוּנָּה.",
        ...
        WordEntity(
            ...
            example = "הִיא לֹא יוֹצֵאת מִן הַבַּיִת בְּלִי אֱפּוּר בָּסִיסִי.",
        ...
        WordEntity(
            ...
            definition = "תַּכְשִׁיר קוֹסְמֶטִי הַמְשַׁנֶּה אֶת גּוֹן הַתִּסְפֹּרֶת אוֹ מְכַסֶּה שֵׂיבוֹת.",
        ...
        WordEntity(
            ...
            exampleNative = "Он заказал массаж после напряжённой недели.",
        ),
        WordEntity(
            ...
            example = "עִיצְּבָה אֶת הַגַּבּוֹת אֵצֶל הַקּוֹסְמֶטִיקָאִית.",
        ...
        WordEntity(
            ...
            definition = "תְּכְשִׁיר שֶׁמּוֹרְחִים עַל הַפָּנִים לִזְמַן מָה לְטִיפּוּל הָעוֹר.",
        ...
        WordEntity(
            ...
            definition = "קוֹסְמֶטִיקָה בְּצוּרַת עִפָּרוֹן אוֹ שַׁפִּיץ לִצְבִיעַת הַשְּׂפָתַיִם.",
        ...
        WordEntity(
            ...
            definition = "קוֹסְמֶטִיקָה לְהַאֲרָכַת הָרִיסִים וְהַבְלָטָתָם.",
            definitionNative = "Косметика для удлинения ресниц и их выделения.",
            example = "מַסְקָרָה עֲמִידָה לְמַיִם הִיא חִיּוּנִית בַּקַּיִץ.",
        ...
        WordEntity(
            ...
            definition = "קוֹסְמֶטִיקָה שֶׁמּוֹרְחִים עַל הַפָּנִים לְהַשְׁוָוָאַת גֶּוַע הָעוֹר.",
            definitionNative = "Косметика, наносимая на лицо для выравнивания тона кожи.",
            example = "בָּחֲרָה קְרֵם בָּסִיס בְּגֵוָן הַמַּתְאִים לִצְבַע עוֹרָהּ.",
        ...
        WordEntity(
            ...
            definition = "אַבְקַת קוֹסְמֶטִיקָה הַמּוּרֶחֶת עַל הַפָּנִים לְקִיבּוּעַ הָאֱפּוּר וְהַמַּתָּת הַבְּהָקִים.",
            definitionNative = "Косметический порошок, который наносят на лицо для матового и ровного тона.",
            example = "הוֹסִיפָה פָּוְדֶר עַל הַגָּרוֹן לִפְנֵי הַצִּילּוּם כְּדֵי לְמַנֵּעַ בְּהַק.",
        ...
        WordEntity(
            ...
            example = "צַיְּיְרָה קַו אֵיילַיְנֶר דַּק לְאֹרֶךְ הָרִיס הָעֶלְיוֹן.",
        ...
        WordEntity(
            ...
            example = "צָבְעָה אֶת הַצִּיפּוֹרְנַיִם בְּלָק אָדֹם לִקְרַאת הָאֵירוּעַ.",
        ...
        WordEntity(
            ...
            definition = "מִרְפָּאָה הַמִּתְמַחָּה בְּטִיפּוּלֵי עוֹר, אֱפּוּר רְפוּאִי וּפְּרוֹצֵדוּרוֹת יוֹפִי.",
        ...
        WordEntity(
            ...
            example = "מוֹרַחַת טוֹנֵר בְּכוֹתְנָה לְאַחַר הַנִּיקּוּי הַיּוֹמִי.",
        ...
        WordEntity(
            ...
            definition = "הֲלִיכָה בַּטֶּבַע לְמֶרְחַקִּים שׁוֹנִים לְשֵׁם בִּדּוּר וְחִינּוּךְ.",
            definitionNative = "Пешеходный поход на природе на разные расстояния для развлечения и образования.",
            example = "יָצָאנוּ לְטִיּוּל רֶגֶל בְּנַחַל עֲרוּגוֹת לְמַשֵּׁךְ שָׁלוֹשׁ שָׁעוֹת.",
        ...
        WordEntity(
            ...
            example = "הַנָּתִיב הוֹבִיל אוֹתָנוּ לְצוּקוֹת עֲצוּמִים.",
        ...
        WordEntity(
            ...
            example = "הֶקַּמְנוּ אֶת הַמַּחֲנֶה לְיַד הַנְּחָלָה לִפְנֵי שֲׁקִיעָה.",
        ...
        WordEntity(
            ...
            definition = "מִבְנֶה נַיָּיד עָשׂוּי בַּד אוֹ נַיְלוֹן לִשְׁנַת לַיְלָה בַּחוּץ.",
        ...
        WordEntity(
            ...
            example = "הַנּוֹף מֵהַפִּסְגָּה הָיָה מַדְהִים — רָאִינוּ עַד הַיָּם.",
        ...
        WordEntity(
            ...
            definition = "נְפִילַת מַיִם מִגּוֹבַה לִנְמִיכוּת בְּאֶמְצָעוּת סֶלַע אוֹ מָצּוּק.",
        ...
        WordEntity(
            ...
            definition = "שַׂקִּית חַמָּה לִשְׁנִיָּה בְּחוּץ בִּמְקוֹם שֶׁמִּיכָה.",
        ...
        WordEntity(
            ...
            definition = "חֲרָקִים טְפִילִים קְטַנִּים שֶׁעֱלוּלִים לְהִדָּבֵק אָלֵינוּ בַּשֶּׂטַח.",
        ...
        WordEntity(
            ...
            example = "אֲגַם הַכִּנֶּרֶת הוּא מַקּוֹר הַמַּיִם הַמִּתּוּקִים הַגָּדוֹל בְּיִשְׂרָאֵל.",
            exampleNative = "אֲגַם הַכִּנֶּרֶת — крупнейший источник пресной воды в Израиле.",
        ...
        WordEntity(
            ...
            definition = "מָקוֹם מוּגְדָּר בְּשֶׁטַח טִיּוּל הַמַּיְיעֵד לִשְׁנַת לַיְלָה בְּאֹהָלִים.",
        ...
        WordEntity(
            ...
            definition = "אִישׁ מִקְצוֹעַ הַמַּנְחֶה קְבוּצוֹת בְּטִיּוּלֵי שֶׁטַח וּמַסְבִּיר עַל הַטֶּבַע.",
            definitionNative = "Специалист, ведущий группы в пеших походах и рассказывающий о природе.",
            example = "הַמַּדְרִיךְ הֶרְאָה לָנוּ אֶת הַנְּתִיבִים הַנְּסַתָּרִים שֶׁלֹּא מוּפִיעִים בַּמַּפָּה.",
        ...
        WordEntity(
            ...
            definition = "זְרִימַת מַיִם קְטַנָּה הַזּוֹרֶמֶת בְּעֵמֶק אוֹ בְּאֵזוֹר הָרִים.",
            definitionNative = "Малый поток, текущий в долине или горной местности.",
            example = "הַנַּחַל הַקַּר עוֹבֵר בְּיֵן הֶהָרִים וּמְוֹשֵׁךְ אֶל הַיָם.",
            exampleNative = "Холодный נָחַל течёт между горами и впадает в море."),
        WordEntity(
            id = 105224, setId = 1052, languagePair = "he-ru", rarity = "UNCOMMON",
            pos = "noun", semanticGroup = "hiking_water",
            original = "בִּצָּה", translation = "болото; заболоченные угодья",
            definition = "שֶׁטַח לֵחַ וְרָטוּב מָלֵא צְמָחִים הָעוֹלִים בְּמַיִם.",
            definitionNative = "Увлажнённая низкая местность с водными растениями.",
            example = "הַבִּצָּה שֶׁבְּאֵזוֹר הַטֶּבַע הִיא בֵּית גִדְוּל לְצִפּוֹרֵי מַיִם.",
        ...
        WordEntity(
            ...
            definition = "נָתִיב מְסֻמַּן לַהֲלִיכָה בְּרַגְלַיִם בְּאֵיזוֹר טִיּוּל אוֹ פַּרְק.",
