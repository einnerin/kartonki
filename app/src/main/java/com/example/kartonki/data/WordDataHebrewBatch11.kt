...
object WordDataHebrewBatch11 {
    ...
    val sets = listOf(
        WordSetEntity(id = 1056, name = "Природа и экология",                description = "Погода, климат и природные явления Израиля", languagePair = "he-ru", orderIndex = 56,
            topic = "Природа и экология",
            level = 2),
        WordSetEntity(id = 1057, name = "Природа и экология",     description = "Питомцы, уход и ветеринария",                languagePair = "he-ru", orderIndex = 57,
            topic = "Природа и экология",
            level = 2),
        WordSetEntity(id = 1058, name = "Психология",  description = "Эмоции, стресс и психологическая помощь",   languagePair = "he-ru", orderIndex = 58,
            topic = "Психология",
            level = 2),
    )
    ...
    val words = listOf(
        ...
        WordEntity(
            ...
            definition = "עָנָן כָּבֵד וְאָפֹר שֶׁמֶּמֶּנּוּ יוֹרֵד גֶּשֶׁם.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(105601L, 105603L, 105605L, 105610L, 105620L, 105622L, 105623L, 105624L)),
        ...
        WordEntity(
            ...
            example = "גַּל הַחוֹם נָמְשָׁךְ שָׁבוּעַ — הַטֶּמְפֶּרָטוּרָה לֹא יָרְדָה מ-40 מַעֲלוֹת.",
        ...
        WordEntity(
            ...
            definition = "שֶׁמֶשׁ חָזְקָה בִּמְיֻחָד הַשּׂוֹרֶפֶת אֶת הָעוֹר וּמַרְגִּישָׁה חַמָּה.",
        ...
        WordEntity(
            ...
            definition = "מַיִם בְּמַצָּב גַּזִּי הַנּוֹצָר כַּאֲשֶׁר הַנּוֹזֵל מִתְחַמֵּם.",
        ...
        WordEntity(
            ...
            definition = "שֶׁכַּבַּת קֶרַח דַּקָּה הַנּוֹצֶרֶת עַל פָּנִים כְּשֶׁהַטֶּמְפֶּרָטוּרָה יוֹרֶדֶת מִתַּחַת לְאֶפֶס.",
        ...
        WordEntity(
            ...
            definition = "מֶזֶג אֲוִיר חָזָק עִם רוּחוֹת עַזּוֹת, גֶּשֶׁם כָּבֵד וְלִפְעָמִים בְּרָקִים.",
        ...
        WordEntity(
            ...
            example = "עוֹנַת הַגְּשָׁמִים בְּיִשְׂרָאֵל נִמְשֶׁכֶת מֵאוֹקְטוֹבֶּר עַד מָרְץ.",
            exampleNative = "עוֹנַת הַגְּשָׁמִים в Израиле длится с октября по март.",
         fillInBlankExclusions = listOf(105625L)),

        WordEntity(
            id = 105617, setId = 1056, languagePair = "he-ru", rarity = "UNCOMMON",
            pos = "noun", semanticGroup = "weather_precipitation",
            original = "פֶּרֶץ גֶּשֶׁם", translation = "ливень; шквальный дождь",
            definition = "גֶּשֶׁם עַז וּפִתְאוֹמִי הַנּוֹפֵל בְּכַמּוּת גְּדוֹלָה בְּזְמַן קָצָר.",
        ...
        WordEntity(
            ...
            example = "בַּהֲרִים נוֹשְׁמִים אֲוִיר נַקִּי וּמְרַעֲנֵן.",
        ...
        WordEntity(
            ...
            example = "עָנָן גָּבוֹהַּ בַּשָּׁמַיִם מֵעִיד בְּדֶרֶךְ כְּלָל עַל מֶזֶג אֲוִיר יַצִּיב.",
        ...
        WordEntity(
            ...
            example = "בְּיוֹם גְּשׁוּם נִשְׁאַרְנוּ בַּבַּיִת וְשִׂחַקְנוּ מִשְׂחֲקֵי קוּפְסָה.",
        ...
        WordEntity(
            ...
            definition = "אֲוִיר עִם רָמַת לַחוּת נְמוּכָה, אוֹפְיֵינִי לְאֵיזוֹרִים צֲחִיחִים.",
        ...
        WordEntity(
            ...
            definition = "שִׁנּוּיִים אֲרֻכֵּי טְוָח בְּדְפּוּסֵי מֶזֶג הָאֲוִיר הַגְּלוֹבָלִי.",
            definitionNative = "Долгосрочные изменения в глобальных погодных паттернах.",
            example = "שִׁינּוּי אַקְלִים מֵעָלֶה אֶת הַסְּבִירוּת לִגְלֵי חוֹם קִיצוֹנִיִּים.",
        ...
        WordEntity(
            ...
            example = "חוֹרֶף קָשֶׁה הֵבִיא שְׁלָגִים לִירוּשָׁלַיִם וְסָגַר כְּבִישִׁים.",
            exampleNative = "חוֹרֶף קָשֶׁה принёс снег в Иерусалим и закрыл дороги.",
         fillInBlankExclusions = listOf(105616L)),
        ...
        WordEntity(
            ...
            example = "הַחֲתוּל שֶׁלִּי נֵם כָּל הַיּוֹם עַל הַסַּפָּה.",
        ...
        WordEntity(
            ...
            definition = "יוֹנֵק קָטָן עִם אָזְנַיִם אֲרֻכּוֹת, נִיתָן לְגִידּוּל בַּבַּיִת.",
        ...
        WordEntity(
            ...
            definition = "הַחֵלֶק הָאַחֲרוֹן שֶׁל גּוּף הַחַיָּה, מֵאֲחוֹרֵי הַגּוּף.",
        ...
        WordEntity(
            ...
            example = "לָקַחְנוּ אֶת הַחֲתוּל לַוֶּטֶרִינָר לִבְּדִיקָה שֲׁנָתִית.",
        ...
        WordEntity(
            ...
            definition = "דָּגִים קְטַנִּים הַמְּגֻדָּלִים בְּאַקְוַרְיוּם בַּבַּיִת.",
            definitionNative = "Маленькие рыбы, которых держат в домашнем аквариуме.",
            example = "יֵשׁ לִי אַקְוַרְיוּם עִם דְּגִיגִים צִבְעוֹנִיִּים בַּסָּלוֹן.",
        ...
        WordEntity(
            ...
            definition = "מִגֵּשׁ מָלֵא חוֹל מְיֻחָד שֶׁבּוֹ הַחֲתוּל עוֹשֶׂה אֶת צֲרָכָיו.",
            definitionNative = "Поддон со специальным наполнителем, куда кошка ходит в туалет.",
            example = "חָשׁוּב לְנַקּוֹת אֶת תֵּיבַת הַחוֹל שֶׁל הַחֲתוּל כָּל יוֹם.",
        ...
        WordEntity(
            ...
            definition = "מַכְרְסֵם קָטָן עִם לֵחָיַיִם גְּדוֹלוֹת, חַיַּת מַחְמָד פּוֹפּוּלָרִית לַיְּלָדִים.",
        ...
        WordEntity(
            ...
            example = "מָצָאנוּ גּוּרְיוֹן קָטָן בָּרְחוֹב וְאִמַּצְנוּ אוֹתוֹ.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(105708L, 105710L, 105725L)),
        ...
        WordEntity(
            ...
            example = "לַיְּלָדָה שֶׁלָּנוּ יֵשׁ חֲזִיר גִּינֵאָה בַּצֶּבַע לָבָן.",
        ...
        WordEntity(
            ...
            definition = "מִבְנֶה קָטָן בַּחוּץ הַמְּיֻעָד לִמְנוּחַת הַכֶּלֶב.",
        ...
        WordEntity(
            ...
            definition = "מָזוֹן מְעֻבָּד בְּצוּרַת גְּרַגֵּרִים יְבֵשִׁים לְחַיּוֹת מַחְמָד.",
        ...
        WordEntity(
            ...
            definition = "שֶׁטַח מְגֻדָּר הַמְּיֻעָד לִכְּלָבִים לָרוּץ וּלְהִשְׁתַּחְרֵר בְּחוֹפְשִׁיּוּת.",
        ...
        WordEntity(
            ...
            example = "כֶּלֶב שֶׁמֶר נוֹבֵחַ כְּשֶׁזָּר מִתְקָרֵב לַבַּיִת.",
        ...
        WordEntity(
            ...
            example = "קָנִינוּ צַעֲצוּעַ חָדָשׁ לַחַיּוֹת — הַחֲתוּל לֹא יָרַד מֶמֶּנּוּ כָּל הַיּוֹם.",
        ...
        WordEntity(
            ...
            example = "יְלָדִים עִם הַפְרָעַת קֶשֶׁב נֶעֱזָרִים מֵהוֹרָאָה מִבְנֵית וּסְדִירָה.",
        ...
        WordEntity(
            ...
            definition = "הַיְּכֹלֶת לְהִסְתַּגֵּל לְמַצָּב חָדָשׁ אוֹ מְשַׁנֶּה.",
            definitionNative = "Способность приспосабливаться к новым или изменяющимся условиям.",
            example = "הִסְתַּגְּלוּת מֲהִירָה לִסְבִיבָה חֲדָשָׁה מִסְמֶּנֶת בְּרִיאוּת נַפְשִׁית.",
            exampleNative = "Быстрая הִסְתַּגְּלוּת к новой среде свидетельствует о психическом здоровье.",
         fillInBlankExclusions = listOf(105810L, 105811L, 105814L, 105818L)),
        ...
        WordEntity(
            ...
            definition = "תַּרְגּוּל שֶׁל רִכּוּז וְשַׁקֶּטֶת הַמַּחְשָׁבוֹת לְשַׁפֵּר אֶת הַרְוָחָה הַנַּפְשִׁית.",
        ...
        WordEntity(
            ...
            example = "הִיא חָוְתָה פָּנִיקָה בָּרַכֶּבֶת הַתַּחְתִּית וְיָצְאָה בַּתַּחֲנָה הַמִּיַּד.",
        ...
        WordEntity(
            ...
            definition = "הַכֹּחַ הַפְּנִימִי הַמֵּנִיעַ אֶת הָאָדָם לְפָעַל לְהַשָּׂגַת מַטָּרוֹת.",
        ...
        WordEntity(
            ...
            definition = "אֱמוּנָה בְּיְכֹלוֹת שֶׁלָּנוּ לְהַתְמוֹדֵד עִם אַתָּגָרִים.",
        ...
        WordEntity(
            ...
            example = "קוֹנְפְלִיקְט לֹא פָּתוּר בַּמִּשְׁפָּחָה גּוֹרֵם לְלַחַץ מְצַטַּבֵּר.",
        ...
        WordEntity(
            ...
            definition = "מַצָּב שֶׁל בְּרִיאוּת רִגְשִׁית וְנַפְשִׁית הַמְּאַפְשֵׁר חַיִּים מְשַׁמְּעוּתִיִּים.",
         ...
         fillInBlankExclusions = listOf(105804L, 105810L, 105811L, 105818L)),
        ...
        WordEntity(
            ...
            example = "טִיפּוּל נַפְשִׁי בִּקוֹגְנִיטִיבִי-הִתְנַהֲגוּתִי יָעִיל לַחֲרָדָה.",
        ...
        WordEntity(
            ...
            example = "הֶעְדֵּר שֵׁנָה כְּרוֹנִי מְחַמִּיר דִּכָּאוֹן וַחֲרָדָה.",
        ...
        WordEntity(
            ...
            example = "חֻסֵּן נַפְשִׁי נִבְנֶה דֶּרֶךְ נִסָּיוֹן, בְּכִי וּלְמִידָה.",
        ...
        WordEntity(
            ...
            definition = "הַגְּדָרַת הַמֶּרְחָב הַפִּיזִי וְהָרִגְשִׁי שֶׁאָדָם מוֹכֵן לְקַבֵּל מֵאֲחֵרִים.",
        ...
        WordEntity(
            ...
            example = "מִינְדְפוּלְנֶס נֶחְקַר כְּכְּלִי יָעִיל לְהַפְחָתַת לַחַץ וַחֲרָדָה.",
        ...
        WordEntity(
            ...
            definition = "הַפְרָעָה נַפְשִׁית עִם תְּנוּדוֹת קִיצוֹנִיּוֹת בֵּין מַצְבֵּי רוּחַ גְּבוֹהִים וּנְמוּכִים.",
        ...
        WordEntity(
         ...
         fillInBlankExclusions = listOf(105803L, 105807L, 105808L, 105817L, 105823L, 105824L)),
    )
}
