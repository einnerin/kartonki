...
object WordDataHebrewSchoolL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "school_special_ed",
        ...
        WordEntity(
            ...
            definition = "מוֹרֶה מְיֻמָּן שֶׁעוֹזֵר לִתְלַמִּידִים בְּמַשְׁבֵּר רִגְשִׁי אוֹ קֹשִׁי לִמּוּדִי.",
        ...
        WordEntity(
            ...
            pos = "noun", semanticGroup = "school_special_ed",
        ...
        WordEntity(
            ...
            exampleNative = "Школьная סַיַּעַת сидит рядом с ним на каждом уроке.",
        ...
        WordEntity(
            ...
            example = "אַחֲרֵי הַ אִבְחוּן דִּידַקְטִי קִבַּלְנוּ הַתְאָמוֹת בִּבְחִינוֹת.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "school_pedagogy",
            ...
            example = "הָ שִׁיטַת מוֹנְטֶסּוֹרִי דּוֹרֶשֶׁת מוֹרִים מְאֻמָּנִים בְּקֹשִׁי.",
            exampleNative = "Подход שִׁיטַת מוֹנְטֶסּוֹרִי требует особой подготовки педагогов — иначе теряется суть.",
        ...
        WordEntity(
            ...
            exampleNative = "В школе לְמִידָה מְבֻסֶּסֶת פְּרוֹיֶקְטִים заменяет контрольные — ученики защищают исследования.",
        ...
        WordEntity(
            ...
            definition = "מִבְחַן הֲכָנָה רִשְׁמִי שֶׁמְּדַמֶּה אֶת תְּנָאֵי הַמִּבְחָן הָאֲמִתִּי בַּכִּתָּה.",
            definitionNative = "Подготовительный официальный экзамен, имитирующий условия настоящего испытания.",
            example = "הָ בְּחִינַת מַתְכּוֹנֶת מִתְקַיֶּמֶת חֹדֶשׁ לִפְנֵי הָמּוֹעֵד הָרִשְׁמִי.",
            exampleNative = "Школьная בְּחִינַת מַתְכּוֹנֶת идёт за месяц до основной сессии.",
        ...
        WordEntity(
            ...
            definition = "מִבְחָן כַּמּוּתִי וּמִלּוּלִי שֶׁמַּכְרִיעַ קַבָּלָה לְלִימּוּדִים אָקָדֵמָאִיִּים.",
        ...
        WordEntity(
            ...
            example = "הַ תְּעוּדָה הָרִאשׁוֹנָה שֶׁל הַשָּׁנָה הִגִּיעָה בְּחַנֻּכָּה.",
        ...
        WordEntity(
            ...
            exampleNative = "Итоговая צִיּוּן שְׁנָתִי определяет, переходит ли ученик в следующий класс.",
        ...
        WordEntity(
            ...
            example = "בָּחַרְתִּי מַסְלוּל מַגְמָה שֶׁל בִּיוֹלוֹגְיָה וְכִימְיָה.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "school_parents",
            original = "יוֹשֵׁב־רֹאשׁ הַוַּעַד", translation = "председатель комитета",
            definition = "הַהוֹרֶה שֶׁמּוֹבִיל אֶת קְבוּצַת הַהוֹרִים וּמְתָאֵם בֵּינָם לְבֵין בֵּית הַסֵּפֶר.",
            ...
            exampleNative = "Наш יוֹשֵׁב־רֹאשׁ הַוַּעַד каждый месяц рассылает родителям протокол встречи.",
        ...
        WordEntity(
            ...
            definition = "מוֹרֶה שֶׁמְּתָאֵם בֵּין כָּל הַכִּתּוֹת שֶׁל אוֹתָהּ שִׁכְבַת גִּיל בְּבֵית הַסֵּפֶר.",
            definitionNative = "Учитель, согласующий работу всех классов одного возраста параллели в школе.",
            example = "הַ רַכַּז שְׁכָבָה אוֹסֵף אֶת מַחְנְכוֹת ז עַל פִּגּוּשׁ בְּיוֹם רֹאשׁוֹן.",
            exampleNative = "Школьный רַכָּז שְׁכָבָה собирает классруков седьмых на встречу в воскресенье.",
        ...
        WordEntity(
            ...
            pos = "phrase", semanticGroup = "school_events",
        ...
        WordEntity(
            ...
            example = "בָּ טֶקֶס סִיוּם הַהוֹרִים מְצַלְּמִים אֶת הַיְּלָדִים בְּכֻלָּן.",
        ...
        WordEntity(
            ...
            definition = "יוֹם בְּחוּץ עִם הַכִּתָּה לַטֶּבַע אוֹ לְמוּזֵיאוֹן בִּלְוִיַּת הַמּוֹרָה.",
            ...
            exampleNative = "В этом месяце טִיּוּל בֵּית סֵפֶר пройдёт в заповеднике Эйн-Геди.",
         fillInBlankExclusions = listOf(181521L, 181522L)),
        WordEntity(
            id = 181524, setId = 1815, languagePair = "he-ru", rarity = "LEGENDARY",
            pos = "noun", semanticGroup = "school_events",
