...
object WordDataHebrewIsraeliCuisineL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "שִׁיטַת בִּשּׁוּל אִטִּי שֶׁבָּהּ הַמַּצְרַךְ נֶאֱטַם בְּשַׂקִּית פְּלַסְטִיק וּמְבֻשָּׁל בְּמַיִם בְּטֶמְפֶּרָטוּרָה מְדֻיֶּקֶת.",
        ...
        WordEntity(
            ...
            example = "הַמִּסְעָדָה הָאָוַנְגַּרְדִּית מַגִּישָׁה מָנוֹת בְּגָסְטְרוֹנוֹמְיָה מוֹלֵקוּלָרִית.",
        ...
        WordEntity(
            ...
            definition = "מִרְקָם אֲוִירִי שֶׁל רֹטֶב אוֹ צִיר עִם לֵצִיטִין הַמּוּגָשׁ עַל הַצַּלַּחַת בְּמִסְעֲדוֹת שֶׁף.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטַת בִּשּׁוּל בָּהּ הַמַּצְרַךְ טָבוּל לְגַמְרֵי בְּשֶׁמֶן רוֹתֵחַ עַד לִקְבִיעַת קְרוּם זָהֹב.",
        ...
        WordEntity(
            ...
            example = "אִמָּא הִכִינָה קְצִיצָה בְּרֹטֶב עַגְבָנִיּוֹת לַאֲרוּחַת שִׁשִּׁי.",
        ...
        WordEntity(
            ...
            example = "בַּמַּנְגָּל שַׂמְנוּ שִׁפּוּד שֶׁל לֵב עוֹף עִם בָּצָל וְשׁוּם.",
        ...
        WordEntity(
            ...
            definition = "בָּשָׂר מְתֻבָּל הַנִּצְלֶה עַל שִׁפּוּד אֲנָכִי וְנֶחְתַּךְ בִּפְרוּסוֹת דַּקּוֹת לְהַגָּשָׁה בְּפִיתָה.",
            definitionNative = "Маринованное мясо, что жарится на вертикальном вертеле и срезается тонкими ломтями для подачи в пите.",
            example = "הוּא עוֹמֵד מֵאֲחוֹרֵי דּוּכַן שְׁוַוַארְמָה בִּשְׁכוּנַת הַתִּקְוָה כְּבָר עֶשְׂרִים שָׁנָה.",
        ...
        WordEntity(
            ...
            definition = "מִשְׁטַח מַתֶּכֶת חַם וְשָׁטוּחַ לִצְלִיָּה מְהִירָה שֶׁל בָּשָׂר וִירָקוֹת בְּמִטְבָּח מִקְצוֹעִי.",
        ...
        WordEntity(
            ...
            example = "הַסְּעוּדָה כָּלְלָה קֶבָּב טָרִי עִם סָלָט יְרֻקִּים וְטָחִינָה.",
        ...
        WordEntity(
            ...
            definition = "מָקוֹם בְּמִפְעָל שֶׁבּוֹ בּוֹדְקִים מַרְכִּיבִים וּמְזוֹנוֹת לִקְבִיעַת הַתְאָמַת הַכַּשְׁרוּת.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ הֲלַכָּתִי שֶׁל הַטְבָּלָה וּמַיִם רוֹתְחִים לְהֲפְּכַת כְּלִי לְכָשֵׁר לְשִׁמּוּשׁ.",
            definitionNative = "Галахический процесс погружения и кипячения, что делает посуду пригодной для кошерного использования.",
            example = "לִפְנֵי פֶּסַח עוֹשִׂים הַכְשָׁרַת כֵּלִים שֶׁל סִירִים וּמַחְבַּתּוֹת בְּמַיִם רוֹתְחִים.",
        ...
        WordEntity(
            ...
            definition = "עֲנַף תַּעֲשִׂיָּה הַמְעַבֵּד חָמְרֵי גֶלֶם חַקְלָאִיִּים לְמוּצְרֵי מָזוֹן מוּכָנִים לִצְרִיכָה.",
        ...
        WordEntity(
            ...
            definition = "אִישׁ מִקְצוֹעַ הָאַחְרַאי לְבַקֵּר תַּהֲלִיכֵי יִצּוּר וּמוּצָרִים לַעֲמִידָה בְּתֶקֶן.",
        ...
        WordEntity(
            ...
            example = "הַתָּו הָרֱכִיב מְפָרֵט אֶת כָּל תּוֹסְפֵי הַמָּזוֹן עִם מִסְפָּר אֵירוֹפִּי.",
        ...
        WordEntity(
            ...
            definition = "שִׁיטַת אֲרִיזָה שֶׁבָּהּ הָאֲוִיר נִשְׁאַב מֵהַשַּׂקִּית לִפְנֵי הָאֲטִימָה לְהַאֲרָכַת חַיֵּי הַמַּדָּף.",
        ...
        WordEntity(
            ...
            example = "הָסַּפַּקַּנּוּ קָנִינוּ שְׁמָרִים טְרִיִּים בְּכִיכָּר לְכָל לֶחֶם הַשַּׁבָּת.",
        ...
        WordEntity(
            ...
            definition = "תַּהֲלִיךְ שֶׁבּוֹ הַבָּצֵק נָח בְּמָקוֹם חַם וְלַח כְּדֵי שֶׁיִּתְמַלֵּא אֲוִיר וְיִגְדַּל בִּנְפָחוֹ.",
        ...
        WordEntity(
            ...
            example = "לִישַׁת בָּצֵק יֲדָנִית אוֹרֶכֶת כְּעֶשֶׂר דַּקּוֹת עַד שֶׁהָעִיסָה הוֹפֶכֶת חֲלָקָה.",
        ...
        WordEntity(
            ...
            definition = "תּוֹסֶפֶת שֶׁל וִיטָמִינִים, מִינֵרָלִים אוֹ אֶנְזִימִים לַקֶּמַח לְשִׁפּוּר עֵרֶךְ תְּזוּנָתִי וּתְכוּנוֹת אֲפִיָּה.",
