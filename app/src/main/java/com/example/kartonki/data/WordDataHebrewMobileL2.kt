...
object WordDataHebrewMobileL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "עָרְכַּת כֵּהָה חוֹסֶכֶת סוֹלְלָה בְּמָסַּכִּים מִסּוּג אוֹלֶד.",
        ...
        WordEntity(
            ...
            example = "עָרְכַּת בְּהִירָה מַתְאִימָה לְשִׁמּוּשׁ בַּחוּץ בְּאוֹר חָזָק.",
        ...
        WordEntity(
            ...
            definition = "הַשָּׂפָה שֶׁבָּהּ מוּצָגוֹת כָּל הַכַּפְתּוֹרִים, הַתַּפְרִיטִים וְהוֹדָעוֹת הַמַּעֲרֶכֶת.",
        ...
        WordEntity(
            ...
            definition = "קֶשֶׁר אַלְחוּטִי קָצָר טְוָח לַנַּתְבַּב בַּבַּיִת אוֹ בְּבֵית הַקָּפֶה.",
        ...
        WordEntity(
            ...
            definition = "תִּקְרָה חָדְשִׁית שֶׁל בַּיְטִים שֶׁמֵּעַל לָהּ הַסֶּפֵּק יוֹרֵד אוֹ הַגְּלִישָׁה נֶחְסֶמֶת.",
        ...
        WordEntity(
            ...
            example = "בִּקְּשָׁה לְהַרְשָׁאַת מַצְלֵמָה קוֹפֶצֶת בַּפְּעַם הָרִאשׁוֹנָה.",
        ...
        WordEntity(
            ...
            example = "הַתּוֹכְנָה בִּקְּשָׁה לְהִכָּנֵס לְאַלְבּוֹם תְּמוּנוֹת לִפְנֵי שֶׁהֶעֶלְתָה אֶת הָאָוּטָר.",
        ...
        WordEntity(
            ...
            example = "אִיתּוּר מִיקּוּם נִדְרָשׁ כְּדֵי שֶׁהַמַּפָּה תַּצִּיג אוֹתִי בִּנְקֻדָּה הַנְּכוֹנָה.",
        ...
        WordEntity(
            ...
            example = "שַׂמְתִּי אֶת קֹבֶץ הַנְּתוּנִים בְּתוֹךְ תִּיקִיַּת אַסֵטְס וְקָרָאתִי אוֹתוֹ בִּזְמַן רִיצָה.",
        ...
        WordEntity(
            ...
            definition = "טֶקְסְט שָׁמוּר בְּקֹבֶץ נִפְרָד עִם מַזַּהֶה — כָּךְ קַל לְהַחֲלִיפוֹ אוֹ לְתַרְגְּמוֹ.",
            definitionNative = "Текст лежит в отдельном файле с идентификатором — так его легко заменить или перевести.",
            example = "כָּל הַכּוֹתָרוֹת בָּאַפְּלִיקַצְיָה כְּתוּבוֹת כְּמַשָּׁאָב מַחְרֹזֶת לְפִי הַשָּׂפָה.",
        ...
        WordEntity(
            ...
            definition = "הַתְאָמַת הַתּוֹכְנָה לִשְׂפָה וְלִתְרְבּוּת שֶׁל מְדִינָה — תַּרְגּוּם, מַטְבֵּעַ, פוֹרְמַט תַּאֲרִיךְ.",
            definitionNative = "Подгонка программы под язык и культуру страны — перевод, валюта, формат даты.",
            example = "לוֹקַלִיזַצְיָה לְעִבְרִית דָּרְשָׁה לְהַפֹּךְ אֶת כָּל הַמָּסַכִּים לְכִוּוּן יָמִין.",
        ...
        WordEntity(
            ...
            definition = "כַּמּוּת הַנְּקֻדּוֹת בְּכָל אֹרֶךְ וְרֹחַב — קוֹבַעַת אֶת חַדּוּת הַתְּצוּגָה.",
            definitionNative = "Количество точек по длине и ширине — определяет чёткость изображения.",
            example = "רֶזוֹלוּצְיָה גְּבוֹהָה שֶׁל הָאַייקוֹן נִרְאֲתָה מְטֻשְׁטֶשֶׁת בְּמָסַּכִּים יְשָׁנִים.",
        ...
        WordEntity(
            ...
            example = "שַׂמְתִּי בְּרֵייקְפּוֹינְט בַּלּוּלָאָה כְּדֵי לִתְפֹּס בְּדִיּוּק מָתַי הָאִינְדֶּקְס מִתְקַלְקֵל.",
