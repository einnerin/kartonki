...
object WordDataHebrewMobileL2 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "שִׁנִּיתִי שְׂפַת מִמְשָׁק לְעִבְרִית אַחֲרֵי הָעֲלִיָּה לִישְׂרָאֵל.",
        ...
        WordEntity(
            ...
            definition = "הַתְאָמַת הַתּוֹכְנָה לִשְׂפָה וְלִתְרְבּוּת שֶׁל מְדִינָה — תַּרְגּוּם, מַטְבֵּעַ, פוֹרְמָט תַּאֲרִיךְ.",
