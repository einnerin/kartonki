...
object WordDataEnglishIdiomsL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(id = 40813, setId = 408, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "Человек, нарочно возражающий чужой идее ради проверки её прочности.",
        ...
        WordEntity(id = 40815, setId = 408, languagePair = "en-ru", rarity = "EPIC",
            ...
            definitionNative = "Положение, в котором человек далёк от реальных, бытовых проблем и людей.",
        ...
        WordEntity(id = 40816, setId = 408, languagePair = "en-ru", rarity = "RARE",
            ...
            definitionNative = "Понимать скрытый смысл за словами — то, что прямо не сказано, но подразумевается.",
