...
object WordDataHebrewTimeL4 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            example = "הַסָּרֶט נִכְשַׁל בִּגְלַל אֲנַכְרוֹנִיזְם בּוֹלֵט בְּלִבוּשׁ הַדְּמֻיּוֹת.",
        ...
        WordEntity(
            ...
            definition = "מִתְיַחֵס לְהִסְתַּכְּלוּת אָחוֹרָה עַל אֵרוּעִים אוֹ תְּקוּפוֹת שֶׁכְּבָר עָבְרוּ.",
        ...
        WordEntity(
            ...
            example = "אַקְוִינוֹקְס הַסְּתָו הִפְעִיל אֶת חֲגִּיגוֹת הַקָּצִיר בְּעַמִּים עַתִּיקִים.",
        ...
        WordEntity(
            ...
            definition = "הַנְּקֻדָּה בִּמְסִלַּת כּוֹכָב הָרְחוֹקָה בְּיוֹתֵר מֵהַשֶּׁמֶשׁ — נְקֻדַּת זְמַן הֲפוּכָה לְפֶּרִיהֶלְיוֹן.",
        ...
        WordEntity(
            ...
            definition = "בִּזְמַן הַנָּכוֹן וְהָרָאוּי שֶׁנִּקְבַּע מֵרֹאשׁ — לֹא מֻקְדַּם וְלֹא מְאֻחָר.",
        ...
        WordEntity(
            ...
            definition = "לִפְנֵי שֶׁכְּבָר מְאֻחָר — בִּזְמַן שֶׁעוֹד נִתַּן לִפְעוֹל וּלְתַקֵּן.",
            definitionNative = "Прежде чем уже поздно — во время, когда ещё можно действовать и поправлять.",
            example = "כְּדַאי לְהוֹדִיעַ עַל הַתַּקָּלָה בְּעוֹד מוֹעֵד וְלֹא אַחֲרֵי הַפָּגִישָׁה.",
        ...
        WordEntity(
            ...
            definition = "בְּזְמַן כָּלְשֶׁהוּ בֶּעָבָר אוֹ בֶּעָתִיד — בְּלִי לִקְבֹּעַ נְקֻדָּה מְדֻיֶּקֶת.",
        ...
        WordEntity(
            ...
            example = "אֱפֶמֶרִיּוּת שֶׁל הַסְּטוֹרִי בָּרֶשֶׁת הוֹפֶכֶת אוֹתוֹ לְכָלִּי שִׁוּוּק יָעִיל.",
