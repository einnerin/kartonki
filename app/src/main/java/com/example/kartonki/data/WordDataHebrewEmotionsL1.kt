...
object WordDataHebrewEmotionsL1 {
    ...
    val words: List<WordEntity> = listOf(
        ...
        WordEntity(
            ...
            definition = "תְּחוּשָׁה כְּבֵדָה בִּפְנִים כְּשֶׁמַשֶּׁהוּ עָצוּב קוֹרֶה אוֹ נִגְמָר.",
        ...
        WordEntity(
            ...
            example = "הַיֶּלֶד הִתְחִיל לִבְכּוֹת כְּשֶׁאִבֵּד אֶת הַבָּלּוֹן בָּרוּחַ.",
        ...
        WordEntity(
            ...
            example = "הִיא הִתְחִילָה לְחַיֵּךְ כְּשֶׁרָאֲתָה אֶת הַחֲתוּל הַקָּטָן.",
        ...
        WordEntity(
            ...
            definition = "מִי שֶׁמַּרְגִּישׁ פַּחַד חָזָק — רוֹעֵד וְלֹא יוֹדֵעַ מָה לַעֲשׂוֹת.",
        ...
        WordEntity(
            ...
            example = "הוּא נִשְׁאַר רָגוּעַ אֲפִלּוּ בִּזְמַן הַסָּעָרָה הַחֲזָקָה.",
        ...
        WordEntity(
            ...
            definitionNative = "Слово, что усиливает описание — например, «сильно рад» или «совсем устал».",
