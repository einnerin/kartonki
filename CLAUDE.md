...
7. **Каждый набор должен содержать ровно 25 слов.** После написания каждого набора — обязательно подсчитай слова командой:
   ```
   grep 'setId = XXXX,' ФайлДанных.kt | wc -l
   ```
...
- Написал 20 слов вместо 25 — ошибка повторялась многократно (наборы 1022–1037). Всегда считай слова после написания каждого набора.
