...
| **Карта всего pipeline'а одной страницей** | [`docs/claude/pipeline-overview.md`](docs/claude/pipeline-overview.md) — компоненты, жизненные циклы, навигация |
...
```bash
# Полный набор из 20 проверок для одного setId
